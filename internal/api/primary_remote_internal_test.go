...
func TestApplyRetentionSkipsPruneForImmutableRemotePrimary(t *testing.T) {
	...
	s.applyRetention(context.Background(), "s3:bucket/containers", settings, restic.Mode{}, tagIdentity("container:plex"), "containers", anomalyScope{})
...
func TestApplyRetentionStillPrunesLocalPrimary(t *testing.T) {
	...
	s.applyRetention(context.Background(), "/mnt/user/bombvault/containers", settings, restic.Mode{}, tagIdentity("container:plex"), "containers", anomalyScope{})
	if n := eng.forgetCalls(); n != 1 {
