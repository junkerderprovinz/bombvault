...
func (h *Handler) Router() http.Handler {
	...
	mux.HandleFunc("POST /api/containers/{name}/takeover", h.handleTakeOverContainer)
	mux.HandleFunc("DELETE /api/containers/{name}/alias/{old}", h.handleUnlinkContainerAlias)
	...
	mux.HandleFunc("POST /api/vms/{name}/takeover", h.handleTakeOverVM)
	mux.HandleFunc("DELETE /api/vms/{name}/alias/{old}", h.handleUnlinkVMAlias)
