...
!!! warning "Самый новый снимок не всегда тот, который нужно восстанавливать"
...
## Как достать дамп базы данных обратно {#database-dumps}
...
!!! warning "Дамп, снятый под root, несёт с собой пользователей сервера"
