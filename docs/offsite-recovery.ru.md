...
- **Только внешнее** записывает элемент прямо в место под **Отправить в**: прямой репозиторий рядом с внешней целью, либо удалённый репозиторий, настроенный в Настройки, Хранилище, Репозитории.
