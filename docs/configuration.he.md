...
לכל פריט יכולים להיות רגישות ומינימום התראות משלו. הגדר אותם בלשונית **פריטים** של העמוד **חריגות**, או בחלונית של הפריט עצמו: באזור התיקיות של קונטיינר ובהגדרות של מכונה וירטואלית (שניהם במצב מתקדם), בעורך התיקיות של ערכת תיקיות ובעמודים **Flash** ו-**גיבוי עצמי**.
