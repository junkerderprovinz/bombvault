...
У каждого элемента может быть своя чувствительность и свой минимум уведомлений. Задайте их на вкладке **Объекты** страницы **Аномалии** или в панели самого элемента: в разделе папок контейнера и в настройках ВМ (оба в расширенном режиме), в редакторе папок набора папок и на страницах **Flash** и **Автобэкап**.
