...
| `TZ` | Nem | Időzóna az ütemezőhöz (például `Europe/Berlin`). **Ha nincs beállítva, minden ütemezés UTC szerint fut**: a 02:30-ra állított ütemezés ekkor 02:30 UTC-kor indul, nem a helyi idő szerint. |
