...
Кожне з шести полів шляху (Контейнери, Віртуальні машини, Flash, Конфігурація, Файли, Набори даних ZFS) має прямо поруч перемикач **Локально / Віддалено**:
...
4. **Знаходить** контейнери, VM, набори файлів і набори даних ZFS, збережені в ньому.
5. **Відновлює контейнери та VM за один раз** (залишеними зупиненими, тож ви запускаєте їх свідомо) і показує набори файлів та елементи ZFS, які відновлюються по одному; елементи ZFS повертаються вимкненими. Набір для відновлення в одному кліку.
...
!!! warning "Найновіший знімок не завжди той, який слід відновлювати"
...
## Як дістати дамп бази даних назад {#database-dumps}
...
!!! warning "Дамп, знятий під root, несе із собою користувачів сервера"
