...
| `list_items` | คอนเทนเนอร์ VM และชุดโฟลเดอร์ที่ได้รับการปกป้องทั้งหมด แฟลชไดรฟ์ และการตั้งค่าแอป พร้อมกำหนดการ สิ่งที่การสำรองจะหยุด การสำรองล่าสุดและเวลาที่ใช้ คอนเทนเนอร์ฐานข้อมูลยังแสดง dump ล่าสุดด้วย | อ่าน |
| `list_runs` | ประวัติการทำงาน เรียงจากใหม่ไปเก่า กรองตามโดเมน รายการ สถานะ ประเภท และเวลาได้ | อ่าน |
| `list_restore_points` | จุดกู้คืนของรายการหนึ่งจากรีพอสิทอรีหลักของมัน และสำหรับคอนเทนเนอร์จะรวม dump ฐานข้อมูลด้วย | อ่าน |
