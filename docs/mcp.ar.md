...
| `list_items` | كل حاوية وآلة افتراضية ومجموعة مجلدات محمية، وذاكرة الفلاش وإعدادات التطبيق، مع الجدولة وما يوقفه النسخ الاحتياطي وآخر نسخة ومدتها؛ وتعرض حاويات قواعد البيانات آخر تفريغ لها أيضًا | قراءة |
| `list_runs` | سجل التشغيلات، الأحدث أولًا، مع ترشيح حسب النطاق والعنصر والحالة والنوع والوقت | قراءة |
| `list_restore_points` | نقاط الاستعادة لعنصر واحد من مستودعه الأساسي، ولحاوية أيضًا تفريغات قواعد بياناتها | قراءة |
...
النسخ الاحتياطي الذي يبدؤه المساعد هو نفسه الذي تبدؤه واجهة الويب. تتوقف الحاوية العاملة حتى تنتهي نسختها، ومعها الحاويات المضبوطة على التوقف معها. وتُطفأ الآلة الافتراضية ذات الطريقة "graceful" ثم تُشغّل من جديد. أما مجموعات المجلدات وذاكرة الفلاش والإعدادات فتواصل العمل. بعد ذلك يطبق BombVault سياسة الاحتفاظ وقد ينسخ إلى المستودع الخارجي. تخبر `list_items` المساعد بما يوقفه العنصر وبمدة آخر نسخة له، وتطلب منه أوصاف الأدوات أن يخبرك بذلك قبل أن يبدأ أي شيء.
