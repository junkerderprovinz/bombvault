...
يحتفظ BombVault بإدخالات كل مفتاح لمدة تصل إلى 30 يومًا: أحدث 500 عملية بدء وإلغاء ورفض وخطأ، وإلى جانبها أحدث 200 عملية قراءة ناجحة، فلا يستطيع مساعد يستعلم مرارًا عن نسخ احتياطي جارٍ أن يُخرج بدء ذلك النسخ من السجل. يخزّن لكل استدعاء الأداة والنتيجة والتشغيل الذي ذكره الإلغاء. لا يخزّن أبدًا ما أرسله المساعد، ولا المفتاح ولا بصمته. حزمة التشخيص تعدّ الإدخالات فقط، وتصدير الإعدادات يستبعدها.
