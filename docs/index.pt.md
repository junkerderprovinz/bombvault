...
| **Conjuntos de dados ZFS** | Um conjunto de dados com todos os que estão abaixo dele, lido de um instantâneo ZFS e guardado como uma pasta. Veja [Conjuntos de dados ZFS](zfs-datasets.md). |
