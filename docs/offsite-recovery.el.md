...
- **Μόνο εκτός τόπου** γράφει το στοιχείο απευθείας στο σημείο κάτω από το **Αποστολή σε**: ένα άμεσο αποθετήριο δίπλα σε έναν στόχο εκτός τόπου, ή ένα απομακρυσμένο αποθετήριο που ρυθμίζετε στις Ρυθμίσεις, Αποθήκευση, Αποθετήρια.
