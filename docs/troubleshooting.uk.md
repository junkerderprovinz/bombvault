...
- Переконайтеся, що SSH увімкнено на хості й публічний ключ BombVault авторизований у `/root/.ssh/authorized_keys` (Налаштування, Система, SSH хоста показує ключ і кнопку **Перевірити з'єднання**).
