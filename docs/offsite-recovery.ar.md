...
كل حقل من حقول المسار الستة (الحاويات، الأجهزة الافتراضية، Flash، التهيئة، الملفات، مجموعات بيانات ZFS) يحمل بجانبه مباشرة مفتاح **محلي / بعيد**:
...
4. **يكتشف** الحاويات والـ VMs ومجموعات الملفات ومجموعات بيانات ZFS المخزَّنة فيه.
5. **يستعيد الحاويات والـ VMs دفعة واحدة** (متوقفة، فتشغّلها عمداً)، ويعرض مجموعات الملفات وعناصر ZFS لتستعيدها واحداً تلو الآخر؛ تعود عناصر ZFS مُطفأة. حقيبة الاستعادة الخاصة بك على بُعد نقرة.
...
!!! warning "أحدث لقطة ليست دائمًا التي يجب استعادتها"
