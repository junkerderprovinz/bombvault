...
يمكن لكل عنصر أن تكون له حساسية خاصة وحد أدنى خاص للإشعارات. اضبطهما في تبويب **العناصر** في صفحة **الحالات الشاذة**، أو في لوحة العنصر نفسه: قسم المجلدات في الحاوية وإعدادات الآلة الافتراضية (كلاهما في الوضع المتقدم)، ومحرر المجلدات لمجموعة المجلدات، وصفحتي **Flash** و**النسخ الذاتي**.
