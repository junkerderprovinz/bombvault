...
| `TZ` | لا | المنطقة الزمنية للمجدوِل (مثلاً `Europe/Berlin`). **إذا تُرك غير مضبوط فستعمل كل الجداول بتوقيت UTC**: الجدول المضبوط على 02:30 ينطلق عندئذ في 02:30 بتوقيت UTC وليس بالتوقيت المحلي. |
