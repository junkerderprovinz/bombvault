...
| `TZ` | Nej | Tidszon för schemaläggaren (till exempel `Europe/Berlin`). **Om den inte anges körs alla scheman i UTC**: ett schema satt till 02:30 startar då 02:30 UTC och inte enligt lokal tid. |
