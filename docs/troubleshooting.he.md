...
חריגה קריטית פתוחה מחזיקה אותם: המקור של הפריט כמעט ריק, התכווץ מאוד, או שגיבוי שמר מחדש את רוב הנתונים. פתח את החריגה מהתג שליד הפריט. אם חסרים נתונים או שהם הוצפנו, שחזר קודם מהגיבוי הטוב האחרון שמקושר. אחר כך אשר את החריגה, או סמן אותה כצפויה אם השינוי היה שלך, והריצה הבאה מנקה כרגיל. תצוגת השמירה המקדימה מסמנת פריט כזה כנשמר.
...
הדף [שרת MCP](mcp.md#troubleshooting) מסביר מה המשמעות של כל קוד מצב ושל כל סירוב של נקודת החיבור של MCP, ומה אפשר לעשות.
