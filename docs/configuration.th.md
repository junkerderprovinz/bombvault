...
| `TZ` | ไม่ | เขตเวลาสำหรับตัวจัดตารางเวลา (เช่น `Europe/Berlin`) **หากไม่กำหนด กำหนดการทั้งหมดจะทำงานตามเวลา UTC**: กำหนดการที่ตั้งไว้ 02:30 จะเริ่มเวลา 02:30 UTC ไม่ใช่ตามเวลาท้องถิ่น |
