...
แต่ละรายการมีความไวและระดับการแจ้งเตือนขั้นต่ำของตัวเองได้ ตั้งค่าได้ที่แท็บ **รายการ** ของหน้า **ความผิดปกติ** หรือในแผงของรายการนั้นเอง: ส่วนโฟลเดอร์ของคอนเทนเนอร์และการตั้งค่าของ VM (ทั้งสองอยู่ในโหมดขั้นสูง) ตัวแก้ไขโฟลเดอร์ของชุดโฟลเดอร์ และหน้า **Flash** กับ **สำรองข้อมูลตัวเอง**
