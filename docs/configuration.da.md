...
| `TZ` | Nej | Tidszone for planlæggeren (for eksempel `Europe/Berlin`). **Hvis den ikke sættes, kører alle planer i UTC**: en plan sat til 02:30 starter da 02:30 UTC og ikke efter lokal tid. |
