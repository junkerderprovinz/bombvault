...
- **ปลายทาง:** พาธในเครื่อง หรือ นอกสถานที่ SMB/CIFS และ NFS (เมานต์แชร์บน Unraid แล้วชี้ Backup Path ไปยังมัน), แบ็กเอนด์ restic ดั้งเดิมโดยไม่ใช้ rclone (`s3:...`, `rest:http://host:8000/repo`, `sftp:user@host:/repo`) หรือรีโมต rclone ใดก็ได้ผ่าน `rclone:<remote>:<bucket>/path` ข้อมูลรับรองทั้งหมดถูกเก็บแบบเข้ารหัส
...
- **การจัดวางต่อรายการ** การ์ดของทุก container, VM และชุดไฟล์เลือกได้ระหว่าง **ในเครื่อง**, **ในเครื่อง + นอกสถานที่** หรือ **นอกสถานที่เท่านั้น** และภายใต้ในเครื่อง + นอกสถานที่ก็เลือกได้ว่าปลายทางใดจะได้รับสำเนา แชร์ที่อยู่บน NAS อยู่แล้วไม่ต้องไปที่ B2 อีกต่อไป ตำแหน่งจะคงที่ตั้งแต่การสำรองข้อมูลครั้งแรก ส่วนสำเนาสามารถเปลี่ยนได้ตลอดเวลา และการ์ดจะบอกว่ามีกี่ไซต์ที่ถือครองรายการนั้นและเป็นไปตามกฎ 3-2-1 หรือไม่ ดู [การจัดวางต่อรายการ](offsite-recovery.md#placement)
