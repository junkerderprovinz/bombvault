...
- **Backends:** SMB/CIFS και NFS (προσαρτήστε τον κοινόχρηστο πόρο και κατευθύνετε μια Backup Path σε αυτόν), εγγενή backend του restic χωρίς rclone (`s3:...`, `rest:http://host:8000/repo`, `sftp:user@host:/repo`), ή οποιοδήποτε remote rclone (`rclone:<remote>:<bucket>/path`).
