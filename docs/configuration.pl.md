...
| `TZ` | Nie | Strefa czasowa dla harmonogramu (na przykład `Europe/Berlin`). **Jeśli nie zostanie ustawiona, wszystkie harmonogramy działają w UTC**: harmonogram ustawiony na 02:30 uruchomi się wtedy o 02:30 UTC, a nie według czasu lokalnego. |
