...
| **Наборы данных ZFS** | Набор данных со всеми наборами под ним, прочитанный из одного снимка ZFS и сохранённый как папка. См. [Наборы данных ZFS](zfs-datasets.md). |
