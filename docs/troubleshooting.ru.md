...
- Убедитесь, что SSH включён на хосте и публичный ключ BombVault авторизован в `/root/.ssh/authorized_keys` (Настройки, Система, SSH хоста показывает ключ и кнопку **Проверить соединение**).
