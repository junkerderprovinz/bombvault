...
| `TZ` | Nein | Zeitzone für den Planer (zum Beispiel `Europe/Berlin`). **Nicht gesetzt bedeutet, dass alle Zeitpläne in UTC laufen**: ein Plan mit 02:30 startet dann um 02:30 UTC und nicht nach der lokalen Uhrzeit. |
