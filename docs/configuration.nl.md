...
| `TZ` | Nee | Tijdzone voor de planner (bijvoorbeeld `Europe/Berlin`). **Niet ingesteld betekent dat alle planningen in UTC draaien**: een planning op 02:30 start dan om 02:30 UTC en niet op de lokale klok. |
