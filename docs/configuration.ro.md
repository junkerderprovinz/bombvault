...
| `TZ` | Nu | Fusul orar pentru programator (de exemplu `Europe/Berlin`). **Dacă nu este setată, toate programările rulează în UTC**: o programare la 02:30 pornește atunci la 02:30 UTC, nu la ora locală. |
