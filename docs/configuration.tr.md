...
| `TZ` | Hayır | Zamanlayıcı için saat dilimi (örneğin `Europe/Berlin`). **Ayarlanmazsa tüm zamanlamalar UTC olarak çalışır**: 02:30 olarak ayarlanan bir zamanlama yerel saatte değil 02:30 UTC'de başlar. |
