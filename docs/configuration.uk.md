...
Кожен елемент може мати власну чутливість і власний мінімум сповіщень. Задайте їх на вкладці **Об'єкти** сторінки **Аномалії** або на панелі самого елемента: у розділі тек контейнера й у налаштуваннях ВМ (обидва в розширеному режимі), у редакторі тек набору тек і на сторінках **Flash** та **Автобекап**.
