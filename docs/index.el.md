...
| **Σύνολα δεδομένων ZFS** | Ένα σύνολο δεδομένων με όλα όσα βρίσκονται από κάτω του, διαβασμένο από ένα στιγμιότυπο ZFS και αποθηκευμένο σαν φάκελος. Δες [Σύνολα δεδομένων ZFS](zfs-datasets.md). |
