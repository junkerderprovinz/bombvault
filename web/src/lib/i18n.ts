...
export const en = {
  ...
  "placementCode.copyRuleTaken": "That name already has copy rules. Choose another name.",
...
export const de: Translations = {
  ...
  "placementCode.copyRuleTaken": "Für diesen Namen gibt es schon Kopierregeln. Bitte einen anderen Namen wählen.",
