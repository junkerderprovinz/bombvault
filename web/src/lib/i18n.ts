...
export const en = {
  ...
  "settings.dashTileCa": "It may also be available in Community Applications — search for BombVault Dashboard.",
  "settings.dashTileNotInstalled": "The dashboard tile plugin is not installed.",
  "settings.dashTileConfirm": "Install installs the bombvault-dashboard plugin on your Unraid host via the regular Unraid plugin mechanism. It shows up under Plugins like any other plugin and can be removed there (or here) anytime.",
...
export const de: Translations = {
  ...
  "settings.dashTileCa": "Eventuell ist es auch in den Community Applications verfügbar — nach BombVault Dashboard suchen.",
  "settings.dashTileNotInstalled": "Das Dashboard-Kachel-Plugin ist nicht installiert.",
  "settings.dashTileConfirm": "Installieren installiert das bombvault-dashboard-Plugin über den regulären Unraid-Plugin-Mechanismus auf deinem Unraid-Host. Es erscheint wie jedes andere Plugin unter Plugins und kann dort (oder hier) jederzeit entfernt werden.",
