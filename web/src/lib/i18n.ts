...
export const en = {
  ...
  "coverage.hint": "Everything on this server that no automatic backup covers. The protection card above says whether the scheduled backups ran on time; this says what is not scheduled at all, which is the gap that stays invisible everywhere else. A switched-off backup type is a decision and is not counted here. ZFS datasets you have not added are not counted either; the ZFS page lists them.",
  ...
  "activityLog.domainZFS": "ZFS datasets",
...
export const de: Translations = {
  ...
  "jobs.zfsSection": "ZFS-Datasets",
  "jobs.zfsIncludeHint": "Sichert jedes ZFS-Element mit aktiviertem „Im Zeitplan einschließen“, jeweils mit allen Unter-Datasets. Mit Zeitplänen pro Element kann ein Element stattdessen einen eigenen Rhythmus tragen, der es auch aus „Alles sichern“ herausnimmt.",
