...
export const en = {
  ...
  "offsite.wizard.credsShared": "These credentials apply to every destination without its own set, not just this type.",
...
export const de: Translations = {
  ...
  "offsite.wizard.credsShared": "Diese Zugangsdaten gelten für jedes Ziel ohne eigenen Satz, nicht nur für diesen Typ.",
