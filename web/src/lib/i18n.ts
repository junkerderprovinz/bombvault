...
export const en = {
  ...
  "mcp.outcomeCooldown": "Refused: the item was backed up through MCP a few minutes ago",
...
export const de: Translations = {
  ...
  "mcp.outcomeCooldown": "Abgelehnt: Das Element wurde vor wenigen Minuten über MCP gesichert",
