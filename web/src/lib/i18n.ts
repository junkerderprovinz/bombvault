...
export const en = {
  ...
  "zfs.add.truncated": "Only the first {n} datasets are shown. Use the filter to find the rest.",
...
export const de: Translations = {
  ...
  "zfs.add.hiddenLegacy": "Docker-Layer-Datasets: {n}",
  "zfs.add.truncated": "Es werden nur die ersten {n} Datasets gezeigt. Nutze den Filter, um die übrigen zu finden.",
