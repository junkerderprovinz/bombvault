...
export const en = {
  ...
  "settings.labelsHint": "How much of a control is shown: its words, its symbol, or both. Buttons keep the same width in all three, so switching never reshuffles the page.",
...
export const de: Translations = {
  ...
  "settings.labelsHint": "Wie viel von einem Bedienelement gezeigt wird: seine Wörter, sein Symbol oder beides. Buttons behalten in allen drei Fällen dieselbe Breite, das Umschalten verschiebt also nichts.",
  "settings.labels.buttons": "Buttons",
