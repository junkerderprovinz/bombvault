...
export const en = {
  ...
  "placementCode.copyRuleTaken": "That name already has copy rules of its own. Reset them there first.",
...
export const de: Translations = {
  ...
  "placementCode.copyRuleTaken": "Für diesen Namen gibt es schon eigene Kopierregeln. Zuerst dort zurücksetzen.",
