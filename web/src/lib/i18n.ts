...
const en = {
  ...
  "recovery.foreignLocationHint": "A folder under the host mount (e.g. a mounted share holding the other server's backups) or a remote repo URL (rest / S3 / B2 / sftp / rclone — your saved cloud credentials are used).",
...
const de: Translations = {
  ...
  "recovery.foreignLocationHint": "Ein Ordner unter dem Host-Mount (z. B. eine eingebundene Freigabe mit den Backups des anderen Servers) oder eine Remote-Repo-URL (rest / S3 / B2 / sftp / rclone — deine gespeicherten Cloud-Zugangsdaten werden verwendet).",
