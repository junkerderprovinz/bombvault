...
export const en = {
  ...
  "repos.itemHint": "Where this item's backups go. Leave it on the domain repository unless this one needs its own - a large, rarely changing item that only wants an off-site copy is the usual reason. Off-site replication does not copy a remote repository or one marked as already off site a second time. The list holds what you set up under Settings, so a location is written down once and picked here.",
  ...
  "repos.offsite": "Already off site",
  "repos.offsiteHint": "For a share on another machine, such as a NAS used as cold storage. Off-site replication leaves this repository out, as it does a remote one, so its backups are not copied a second time. Leave it off for a disk or share on this box, which still needs the off-site copy.",
  "repos.offsiteRemote": "off site",
  "repos.offsiteRemoteHint": "A remote repository is already off site, so off-site replication never copies it again.",
...
export const de: Translations = {
  ...
  "repos.offsite": "Bereits off site",
  "repos.offsiteHint": "Für ein Share auf einem anderen Gerät, etwa ein NAS als Kaltlager. Die Off-site-Replikation lässt dieses Repository dann aus, so wie ein entferntes, und seine Sicherungen werden kein zweites Mal kopiert. Für eine Platte oder ein Share auf diesem Rechner aus lassen, die brauchen die Off-site-Kopie weiterhin.",
  "repos.offsiteRemote": "off site",
  "repos.offsiteRemoteHint": "Ein entferntes Repository liegt bereits off site, deshalb kopiert die Off-site-Replikation es nie ein zweites Mal.",
