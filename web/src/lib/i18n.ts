...
const en = {
  ...
  "offsite.s3Unverified": "Configured, but not automatically verified — I confirm bucket versioning + deny-delete are set manually. The scorecard shows this domain as unverified.",
...
const de: Translations = {
  ...
  "offsite.s3Unverified": "Konfiguriert, aber nicht automatisch verifiziert — ich bestätige, dass Bucket-Versionierung + Delete-Verbot manuell gesetzt sind. Die Scorecard zeigt diese Domäne als unverifiziert.",
