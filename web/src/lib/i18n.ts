...
export const en = {
  ...
  "mcp.keyCanStart": "Can start backups",
  ...
  "anomaly.filter.domain": "Backup type",
...
export const de: Translations = {
  ...
  "coverage.reason.zfsMemberSkipped": "ein Dataset, das die letzte Sicherung seines geplanten ZFS-Elements nicht lesen konnte",
  ...
  "zfs.connection.hint": "BombVault führt zfs-Befehle über SSH auf diesem Server aus, über dieselbe Verbindung wie die VM-Sicherungen. Scheitert die Verbindung, zeigt diese Karte den Schlüssel von BombVault und den Befehl, der ihn freigibt.",
  ...
  "zfs.code.docker-storage": "In diesem Baum liegt der Image-Speicher von Docker. Ein Snapshot davon würde Docker daran hindern, während der Sicherung Images zu löschen.",
  ...
  "zfs.code.containers-busy": "Die Container konnten nicht gestoppt werden, weil noch eine Container-Sicherung lief.",
  ...
  "zfs.code.zvol": "Volume, übersprungen. Diese Sicherungsart liest Dateisysteme.",
  ...
  "zfs.code.backup-failed": "Die Sicherung dieses Datasets ist fehlgeschlagen.",
  "zfs.code.not-reached": "Nicht gesichert, der Lauf endete vor diesem Dataset.",
  "zfs.code.gone": "Nicht mehr auf dem Server. Die Sicherungen bleiben wiederherstellbar.",
  ...
  "zfs.fix.overlaps-item": "Lösche zuerst das andere Element und behalte seine Sicherungen. Seine Historie läuft in diesem Element weiter.",
  ...
  "zfs.fix.containers-busy": "Starte die Sicherung erneut, sobald die Container-Sicherung fertig ist. Geplante Läufe warten von selbst.",
  ...
  "zfs.repoHint": "Wo die Sicherungen dieses Elements liegen. Leer bedeutet: das ZFS-Datasets-Repository. In der Liste stehen die Repositories, die du in den Einstellungen angelegt hast.",
  "zfs.repoLocked": "Das lässt sich nicht mehr ändern, sobald das Element Sicherungen hat: sie bleiben in dem Repository, in das sie geschrieben wurden. Lösche erst die Sicherungen dieses Elements.",
  "zfs.membersSummary": "Datasets: {n}",
  ...
  "zfs.stopContainersHint": "BombVault stoppt sie, legt den Snapshot an und startet sie sofort wieder, meist innerhalb von Sekunden. Die Sicherung liest danach den Snapshot, während die Apps schon wieder laufen. Nimm das für Datenbanken und andere Apps, die ständig schreiben.",
  "zfs.stopContainersPlaceholder": "Container hinzufügen",
  "zfs.stopContainersNone": "Keine. Der Snapshot entsteht, während alles läuft.",
  "zfs.overlapContainers": "Wird auch auf der Container-Seite gesichert: {names}. Die Daten liegen doppelt, und „Alles sichern“ stoppt sie zweimal.",
  ...
  "zfs.hooksHint": "Läuft im gewählten Container. Nimm das zum Beispiel, um kurz vor dem Snapshot eine Datenbank in dieses Dataset zu schreiben, ohne etwas zu stoppen. Scheitert der Befehl vor dem Snapshot, entsteht keine Sicherung.",
  ...
  "zfs.leftoversHint": "BombVault konnte diese Snapshots nach einer Sicherung nicht entfernen. Solange sie da sind, halten sie gelöschte Daten im Pool fest.",
  ...
  "zfs.deleteRowConfirm": "Dieses Element aus der Liste nehmen? Seine Sicherungen bleiben erhalten und lassen sich später wiederfinden.",
  "zfs.deleteSafetyToo": "Auch seine Sicherheits-Snapshots auf dem Server löschen",
  "zfs.deleteBackupsConfirm": "ALLE Sicherungen dieses Elements und seiner Datasets löschen? Die Snapshots verschwinden endgültig, das Repository wird aufgeräumt und das Element aus der Liste genommen. Das lässt sich nicht rückgängig machen.",
  ...
  "zfs.add.probeFailed": "Der Snapshot-Zugriff für {dataset} ließ sich gerade nicht testen. Die erste Sicherung prüft ihn noch einmal.",
  "zfs.add.done": "Fertig",
  "zfs.restore.title": "{dataset} wiederherstellen",
  "zfs.restore.point": "Sicherung vom",
  "zfs.restore.dataset": "Dataset",
  "zfs.restore.wholeTree": "Alle Datasets dieser Sicherung",
  "zfs.restore.inPlace": "In das Dataset zurückschreiben",
  "zfs.restore.inPlaceHint": "Dateien aus der Sicherung werden nach {path} geschrieben. Gleichnamige Dateien werden überschrieben, andere bleiben liegen. Das Dataset selbst wird nie zurückgerollt oder ersetzt.",
  ...
  "zfs.restore.stopContainersHint": "Sie bleiben gestoppt, bis die Wiederherstellung fertig ist, und das kann lange dauern. Container-Sicherungen warten so lange.",
  "zfs.restore.confirm": "Diese Sicherung nach {path} zurückschreiben? Gleichnamige Dateien werden überschrieben.",
  ...
  "mcp.keyCanStart": "Darf Backups starten",
  ...
  "anomaly.cardHint": "BombVault vergleicht jedes Backup eines Elements mit den vorherigen und benennt, was nicht dazu passt: viel mehr neue Daten als sonst, ein Neuschreiben der meisten Daten, eine stark geschrumpfte oder gewachsene Quelle, einen kleiner gewordenen Datenbank-Dump, ein Backup, das plötzlich viel länger dauert, wiederholte Fehlschläge, eine Wiederherstellungsprüfung, die nicht mehr besteht, und einen Datenträger, der bald voll ist. Die meisten Prüfungen brauchen erst 10 Backups eines Elements. Ein ZFS-Element wird Dataset für Dataset geprüft, so fällt ein geleertes untergeordnetes Dataset auch in einem großen Baum auf.",
  ...
  "anomaly.filter.domain": "Backup-Art",
