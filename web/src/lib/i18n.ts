...
export const en = {
  ...
  "notify.channelsHint": "Configure the webhook, Matrix, Healthchecks and email channels that deliver the notifications configured above.",
...
export const de: Translations = {
  ...
  "notify.channelsHint": "Richte die Webhook-, Matrix-, Healthchecks- und E-Mail-Kanäle ein, über die die oben konfigurierten Benachrichtigungen verschickt werden.",
  "notify.webhook": "Webhook-URL",
  "notify.webhookChannel": "Webhook",
  "notify.webhookFormat": "Webhook-Format",
  "notify.apprise": "Apprise",
