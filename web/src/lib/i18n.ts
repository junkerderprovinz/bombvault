...
export const en = {
  ...
  "settings.coresHint": "How many CPU threads a backup may use. 0 means every core, which is restic's own default. Lower it if backups make the machine hot or sluggish.",
...
export const de: Translations = {
  ...
  "settings.coresHint": "Wie viele CPU-Threads ein Backup nutzen darf. 0 heißt alle Kerne, so wie restic es selbst vorgibt. Verringere den Wert, wenn Backups die Maschine heiß oder träge machen.",
  "settings.cacheTitle": "Backup-Engine-Cache",
