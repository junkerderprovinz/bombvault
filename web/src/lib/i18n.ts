...
export const de: Translations = {
  ...
  "jobs.syncSchedulesHint": "Wenn aktiviert, folgen VMs, Flash und Ordner dem Container-Zeitplan statt ihrem eigenen — ausschalten, um für jede Domäne einen eigenen Rhythmus festzulegen.",
