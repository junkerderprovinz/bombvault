...
export const en = {
  ...
  "anomaly.items.hint": "Every backed-up item with its learning progress, its usual values, and its own sensitivity and notification setting. An item follows the global settings unless you choose something else here.",
...
export const de: Translations = {
  ...
  "anomaly.items.hint": "Jedes gesicherte Element mit seinem Lernfortschritt, seinen üblichen Werten und seiner eigenen Empfindlichkeit und Benachrichtigung. Ein Element folgt den globalen Einstellungen, solange du hier nichts anderes wählst.",
