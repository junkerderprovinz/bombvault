...
export const en = {
  ...
  "ransomware.replicationPaused": "off-site paused: confirm placement",
  ...
  "pull.repoLocationHint": "The source instance's repository: rest:, s3: or sftp:, or a subpath under the host mount. An rclone: location is refused, because rclone would reach it with THIS instance's remotes.",
  ...
  "pull.credsHint": "The login for the storage the source's repository lies on: s3: or a rest: server with a password. A pull never uses this box's own credentials, so a source that needs a login and has none chosen here is refused.",
  ...
  "placementCode.invalid": "This placement choice is not valid.",
  "placementCode.copiesNotAllowed": "An item on a remote or direct repository takes no copies.",
  "placementCode.unknownTarget": "That off-site target does not exist in this domain.",
  "placementCode.stackRule": "Project folders follow the containers default and take no rule of their own.",
  "placementCode.copyRuleTaken": "That name already has copy rules of its own.",
  "placementCode.domainBusy": "A backup is running. Choose again once it has finished.",
  "placementCode.hasBackups": "The location cannot change once the item has backups. They stay where they were written.",
  "placementCode.homeUncheckable": "Whether this item holds backups could not be checked, so its location stays as it is. Try again once the repository can be read.",
  "placementCode.stale": "The numbers changed since they were shown. Check them again.",
  "placementCode.repoInvalid": "That repository is missing, switched off or cannot be resolved.",
  "placementCode.repoInUseDefault": "The default for {domains} points at this repository. Change the default first.",
  "placementCode.defaultRepoMissing": "A default in the file points at a repository that is neither in the file nor here.",
  "placementCode.nestedLocation": "This location lies inside another repository or target, or contains one.",
  "placementCode.foreignDomain": "That direct repository belongs to a target of another domain.",
  "placementCode.mirroredField": "This value comes from the target. Change it there.",
  "placementCode.companionTaken": "This target already has a direct repository.",
  "placementCode.exclusionUnsaved": "The target was saved. What it should leave out was not.",
  ...
  "placement.titleHint": "Where this item's backups are written and where they are copied afterwards. The location is fixed from the first backup on, the copies can change at any time.",
  "placement.unreadable": "Placement could not be read",
  "placement.noCopyNow": "No copy at the moment, switched off: {targets}. Tick a target or choose Local.",
  "placement.followsDefault": "Follows the default",
  "placement.ownCopies": "Own copies",
  "placement.homeSet": "Location set: {home}",
  "placement.copiesFollow": "Copies follow the default",
  "placement.reset": "Reset",
  "placement.confirmHome": "Back up {name} to {home} from now on? The location is fixed from the first backup on.",
  "placement.paused": "Off-site paused until the default is confirmed.",
  "placement.uploadIntro": "At the next run, snapshots of {name} are uploaded:",
  "placement.uploadUnknown": "It could not be worked out how much of {name} would be uploaded.",
  ...
  // Status
  "placement.planHome": "On {home}.",
  "placement.planStays": "Stays on {home}: backups of this name are there.",
  "placement.planDefaultHome": "On {home} (the default, applies from the first backup).",
  "placement.planDecides": "The location is decided at the first backup.",
  "placement.planNotBackedUpOff": "Not backed up: the default points at {home}, which is switched off.",
  "placement.planNotBackedUpMissing": "Not backed up: the default points at a repository that no longer exists.",
  "placement.planCopied": "Copied to {targets}.",
  "placement.planNoCopy": "No copy off the premises.",
  "placement.planNoTarget": "No off-site copy is set up for {domain}.",
  "placement.sitesOne": "At one site",
  "placement.sites": "At {n} sites",
  "placement.seen": "{place} last seen {time}",
  "placement.unreachable": "{place} unreachable since {since}, last seen {time}",
  "placement.stateUnknown": "{place}: state unknown since {since}",
  ...
  "recovery.foreignLocationHint": "A folder under the host mount, or a restic remote URL (s3:…, rest:…, sftp:…). Mount the other server's backup share and point at it, or enter its remote repository directly. A remote one then asks for its own credentials below. An rclone remote is not accepted here: it would authenticate with THIS server's rclone configuration, so use the repository's native URL instead.",
...
export const de: Translations = {
  ...
  "snapshots.deleteAllConfirm": "ALLE lokalen Backups dieser VM löschen? Die Snapshots werden dauerhaft entfernt und das lokale Repository wird aufgeräumt. Kopien an Off-site-Zielen bleiben erhalten. Kann nicht rückgängig gemacht werden.",
  ...
  "ransomware.replicationPaused": "Off-site pausiert: Ablage bestätigen",
  ...
  "pull.repoLocationHint": "Das Repositorium der Quelle: rest:, s3: oder sftp:, oder ein Unterpfad unter der Host-Einhängung. Ein rclone:-Ort wird abgelehnt, weil rclone ihn mit den Gegenstellen DIESER Instanz ansprechen würde.",
  ...
  "pull.credsHint": "Die Anmeldung für den Speicher, auf dem das Repositorium der Quelle liegt: s3: oder ein rest:-Server mit Passwort. Ein Abholen greift nie auf die Zugangsdaten dieser Kiste zurück, eine Quelle ohne passende Auswahl wird also abgewiesen.",
  ...
  "placementCode.invalid": "Diese Ablage-Wahl ist ungültig.",
  "placementCode.copiesNotAllowed": "Ein Eintrag auf einem entfernten oder direkten Repository bekommt keine Kopien.",
  "placementCode.unknownTarget": "Dieses Off-site-Ziel gibt es in dieser Domäne nicht.",
  "placementCode.stackRule": "Projektordner folgen der Container-Vorgabe und bekommen keine eigene Regel.",
  "placementCode.copyRuleTaken": "Für diesen Namen gibt es schon eigene Kopierregeln.",
  "placementCode.domainBusy": "Ein Backup läuft. Danach erneut wählen.",
  "placementCode.hasBackups": "Der Ort lässt sich nicht mehr ändern, sobald der Eintrag Backups hat. Sie bleiben, wo sie geschrieben wurden.",
  "placementCode.homeUncheckable": "Ob dieser Eintrag schon Backups hat, ließ sich nicht prüfen, deshalb bleibt sein Ort, wie er ist. Erneut versuchen, sobald sich das Repository lesen lässt.",
  "placementCode.stale": "Die Zahlen haben sich seit der Anzeige geändert. Bitte noch einmal prüfen.",
  "placementCode.repoInvalid": "Dieses Repository fehlt, ist ausgeschaltet oder lässt sich nicht auflösen.",
  "placementCode.repoInUseDefault": "Die Vorgabe für {domains} zeigt auf dieses Repository. Zuerst die Vorgabe ändern.",
  "placementCode.defaultRepoMissing": "Eine Vorgabe in der Datei zeigt auf ein Repository, das weder in der Datei noch hier existiert.",
  "placementCode.nestedLocation": "Dieser Ort liegt in einem anderen Repository oder Ziel oder enthält eins.",
  "placementCode.foreignDomain": "Dieses Direkt-Repository gehört zu einem Ziel einer anderen Domäne.",
  "placementCode.mirroredField": "Dieser Wert kommt vom Ziel. Dort ändern.",
  "placementCode.companionTaken": "Dieses Ziel hat schon ein Direkt-Repository.",
  "placementCode.exclusionUnsaved": "Das Ziel wurde gespeichert. Die Ausnahmen dazu nicht.",
  ...
  "placement.titleHint": "Wo die Sicherungen dieses Eintrags geschrieben werden und wohin sie danach kopiert werden. Der Ort ist ab dem ersten Backup fest, die Kopien lassen sich jederzeit ändern.",
  "placement.unreadable": "Ablage nicht lesbar",
  "placement.noCopyNow": "Derzeit keine Kopie, ausgeschaltet: {targets}. Ziel anhaken oder Lokal wählen.",
  "placement.followsDefault": "Folgt der Vorgabe",
  "placement.ownCopies": "Eigene Kopien",
  "placement.homeSet": "Ort eingetragen: {home}",
  "placement.copiesFollow": "Kopien folgen der Vorgabe",
  "placement.reset": "Zurücksetzen",
  "placement.confirmHome": "{name} ab jetzt nach {home} sichern? Ab dem ersten Backup ist der Ort fest.",
  "placement.paused": "Off-site pausiert, bis die Vorgabe bestätigt ist.",
  "placement.uploadIntro": "Beim nächsten Lauf werden Snapshots von {name} hochgeladen:",
  "placement.uploadUnknown": "Es ließ sich nicht ermitteln, wie viel von {name} hochgeladen wird.",
  ...
  "timeline.deletePartial": "Bereits gelöscht bei: {list}",
  ...
  // Status
  "placement.planHome": "Auf {home}.",
  "placement.planStays": "Bleibt auf {home}, dort liegen Sicherungen dieses Namens.",
  "placement.planDefaultHome": "Auf {home} (Vorgabe, gilt ab dem ersten Backup).",
  "placement.planDecides": "Ort entscheidet sich beim ersten Backup.",
  "placement.planNotBackedUpOff": "Wird nicht gesichert: Die Vorgabe zeigt auf {home}, das ausgeschaltet ist.",
  "placement.planNotBackedUpMissing": "Wird nicht gesichert: Die Vorgabe zeigt auf ein Repository, das es nicht mehr gibt.",
  "placement.planCopied": "Wird nach {targets} kopiert.",
  "placement.planNoCopy": "Keine Kopie außer Haus.",
  "placement.planNoTarget": "Für {domain} ist keine Off-site-Kopie eingerichtet.",
  "placement.sitesOne": "Liegt an einem Standort",
  "placement.sites": "Liegt an {n} Standorten",
  "placement.seen": "{place} zuletzt gesehen {time}",
  "placement.unreachable": "{place} nicht erreichbar seit {since}, zuletzt gesehen {time}",
  "placement.stateUnknown": "{place}: Stand unbekannt seit {since}",
  ...
  "files.deleteBackupsConfirm": "ALLE lokalen Backups dieses Ordner-Sets löschen? Die Snapshots werden dauerhaft entfernt, das lokale Repository wird aufgeräumt und das Set wird vergessen. Kopien an Off-site-Zielen bleiben erhalten, ohne ein Set, das sie kennt. Kann nicht rückgängig gemacht werden.",
  ...
  "recovery.foreignLocationHint": "Ein Ordner unter dem Host-Mount oder eine restic-Remote-URL (s3:…, rest:…, sftp:…). Hänge die Backup-Freigabe des anderen Servers ein und richte dies darauf aus, oder gib sein Remote-Repository direkt an. Bei einem Remote-Repository werden unten dessen eigene Zugangsdaten abgefragt. Ein rclone-Remote wird hier nicht angenommen: Es würde sich mit der rclone-Konfiguration DIESES Servers anmelden, nutze deshalb die native URL des Repositories.",
