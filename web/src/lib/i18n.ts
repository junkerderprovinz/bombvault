...
export const en = {
  ...
  "dbdump.introNotice": "BombVault dumps {count} recognised databases before each backup, as restore points of their own. You can switch this off per container on its card or for all containers in Settings.",
  ...
  "recovery.dumpOnlySkipped": "{count} databases saved only as dumps are left out; restore and import them from their own list.",
...
export const de: Translations = {
  ...
  "dbdump.introNotice": "BombVault dumpt {count} erkannte Datenbanken vor jedem Backup, als eigene Wiederherstellungspunkte. Du kannst das je Container auf dessen Karte abschalten oder in den Einstellungen für alle Container.",
  ...
  "dbdump.fixRepository": "Das Backup-Repository hat den Dump nicht angenommen oder weniger Bytes gespeichert, als gedumpt wurden. Prüfe das Repository in den Einstellungen unter Speicher; der Dump wird mit dem nächsten Backup erneut versucht.",
  ...
  "recovery.dumpOnlySkipped": "{count} Datenbanken, die nur als Dump gesichert sind, bleiben außen vor; stelle sie über ihre eigene Liste wieder her und importiere sie.",
