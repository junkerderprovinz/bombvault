...
export const en = {
  ...
  "notify.unraidPlatformMismatch": "BombVault detected this host as \"{platform}\", not Unraid — Unraid notifications stay off even with this switched on. If this IS an Unraid host, check that the container's /boot path is bind-mounted to /host/boot (see the BombVault Unraid template) and restart the container.",
