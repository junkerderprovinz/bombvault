...
export const en = {
  ...
  "mcp.logCalls": "Calls",
  "mcp.logKeptHint": "BombVault keeps each key's calls for up to a month. It never stores what the assistant sent, or the key itself.",
...
export const de: Translations = {
  ...
  "mcp.logKeptHint": "BombVault hebt die Aufrufe jedes Schlüssels bis zu einem Monat auf. Was der Assistent geschickt hat, speichert es nie, den Schlüssel selbst auch nicht.",
