...
const ko: Partial<Translations> = {
  ...
  "files.empty": "아직 파일 세트가 없습니다. 폴더를 추가하세요 — 공유 폴더, 문서, 사진 등 마운트 아래의 모든 것 — BombVault가 다른 모든 것과 똑같이 보호합니다: 일정, 오프사이트 복사본, 무결성 검사, 복원. 별도의 파일 백업 도구가 필요 없습니다.",
  "files.addSet": "파일 세트 추가",
  "files.editSet": "파일 세트 편집",
  "files.name": "이름",
  "files.path": "폴더",
  ...
  "files.deleteSetConfirm": "이 파일 세트를 목록에서 제거할까요? 백업은 삭제되지 않으며 나중에 다시 발견할 수 있습니다.",
  "files.deleteBackupsConfirm": "이 파일 세트의 모든 백업을 삭제할까요? 스냅샷이 영구적으로 제거되고 저장소가 정리되며 세트는 잊혀집니다. 되돌릴 수 없습니다.",
