...
const ko: Partial<Translations> = {
  ...
  "settings.everythingOverlapWarning": "이 기능은 위의 영역별 일정과 독립적으로 실행됩니다. 둘 다 켜져 있으면 컨테이너, VM, 플래시, 폴더, 셀프 백업이 각각 두 번씩 백업됩니다. 한 번은 여기서, 한 번은 각자의 일정에서. 중복을 원하지 않는 영역은 꺼두세요.",
