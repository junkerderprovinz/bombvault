...
const ko: Partial<Translations> = {
  ...
  "dbdump.introNotice": "BombVault는 백업할 때마다 인식한 데이터베이스를 독립된 복원 지점으로 덤프합니다. 여기서 인식한 수: {count}, 첫 번째는 {name}입니다. 컨테이너별로 그 카드에서, 또는 설정에서 모든 컨테이너에 대해 끌 수 있습니다.",
  ...
  "dbdump.importStopsOne": "가져오는 동안 BombVault는 {app}도 중지합니다. 가져오기가 실패하고 이전 데이터를 되돌리지 못한 경우가 아니면 끝난 뒤 다시 시작합니다.",
  "dbdump.importStopsMany": "가져오는 동안 BombVault는 다음 앱도 중지합니다: {apps}. 가져오기가 실패하고 이전 데이터를 되돌리지 못한 경우가 아니면 끝난 뒤 다시 시작합니다.",
  ...
  "recovery.foreignDbDumps": "이 저장소의 데이터베이스 덤프: {count}개. 복구 키트 설명대로 restic 명령줄로 하나를 꺼내세요.",
  ...
  "recovery.dumpOnlySkipped": "덤프로만 보관된 데이터베이스는 여기서 제외됩니다: {count}. 전용 목록에서 복원하고 가져오세요.",
