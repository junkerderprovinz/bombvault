...
const ko: Partial<Translations> = {
  ...
  "settings.dashTileCa": "Community Applications에서도 제공될 수 있습니다 — BombVault Dashboard로 검색하세요.",
  "settings.dashTileNotInstalled": "대시보드 타일 플러그인이 설치되어 있지 않습니다.",
  "settings.dashTileConfirm": "설치를 누르면 Unraid의 일반 플러그인 메커니즘을 통해 bombvault-dashboard 플러그인이 Unraid 호스트에 설치됩니다. 다른 플러그인처럼 Plugins에 표시되며, 그곳(또는 여기)에서 언제든지 제거할 수 있습니다.",
