...
const ko: Partial<Translations> = {
  ...
  "about.body": "기사 한 사람의 원정. 제가 원하던 모습으로는 없던, 자유롭고 보기 좋은 오픈 소스 도구입니다. 부족한 것이 없어질 때까지 만듭니다. 계정 없음, 텔레메트리 없음, 광고 없음. 체험판 없음, 요금제 없음, 작은 글씨의 별표 없음. 읽을 수 있는 것은 결코 당신의 성벽 밖으로 나가지 않습니다. 저녁과 주말에, 마음과 고집으로 벼렸습니다.",
  "about.coffee": "BombVault가 쓸모 있다면, 후원이 계속 굴러가는 데 드는 비용을 메웁니다. 도메인과 서버, 그리고 여기에 들어가는 저녁 시간입니다. 게다가 이 기사의 심장도 조금 더 빨리 뜁니다. 아래에 세 가지 길이 있으니 편한 쪽으로 하세요.",
