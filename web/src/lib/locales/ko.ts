...
const ko: Partial<Translations> = {
  ...
  "settings.offsiteHint": "로컬 백업이 성공할 때마다 restic copy로 두 번째 저장소에도 복제합니다. 원격(rest:http://host:8000/repo, s3:…) 또는 로컬 하위 경로를 입력하세요. 비활성화하려면 비워 두세요. 로컬 백업이 기본으로 유지됩니다.",
  "source.label": "소스:",
  "source.local": "로컬",
  ...
  "cloud.hint": "rclone 없이 원격 restic 백엔드용 자격 증명. 저장 후 백업 경로를 원격 저장소로 설정하세요. 예: s3:s3.amazonaws.com/bucket/path, rest:http://host:8000/repo 또는 sftp:user@host:/repo. 비밀 값은 암호화되어 저장되며 다시 표시되지 않습니다.",
  ...
  "pull.repoLocationHint": "원본 인스턴스의 저장소: rest:, s3:, sftp:, 또는 호스트 마운트 아래의 하위 경로. rclone: 위치는 거부됩니다. rclone은 이 인스턴스의 원격 설정으로 접근하기 때문입니다.",
  ...
  "pull.credsHint": "원본 저장소가 놓인 스토리지의 로그인 정보입니다. s3: 또는 암호가 걸린 rest: 서버가 해당합니다. 가져오기는 이 장비의 자격 증명을 절대 사용하지 않으므로, 로그인이 필요한데 여기서 아무것도 고르지 않은 원본은 거부됩니다.",
  "pull.domain": "백업 종류",
  ...
  "repos.location": "위치",
  "repos.locationPlaceholder": "backups/cold 또는 s3:s3.eu-central-003.backblazeb2.com/bucket/path",
  "repos.locationHint": "호스트 마운트 아래의 폴더, 또는 s3:..., sftp:..., rest:..., rclone:... 같은 원격 restic 저장소입니다. 원격에는 중간 로컬 사본 없이 바로 기록합니다.",
  ...
  "repos.offPremises": "부지 밖",
  "repos.offPremisesHint": "카드의 사이트 수와 3-2-1 계산에서 별도의 사이트로 간주됩니다. 사본에는 영향을 주지 않습니다. 같은 건물에 있는 rest-server라면 이 설정을 꺼야 합니다.",
  ...
  "placement.titleHint": "이 항목의 백업이 어디에 기록되고 이후 어디로 복사되는지입니다. 위치는 첫 백업 이후 고정되며, 복사본은 언제든 바꿀 수 있습니다.",
  "placement.unreadable": "배치를 읽을 수 없습니다",
  "placement.noCopyNow": "지금은 복사본 없음, 꺼짐: {targets}. 대상을 선택하거나 로컬을 선택하세요.",
  "placement.followsDefault": "기본값을 따름",
  "placement.ownCopies": "자체 복사본",
  "placement.homeSet": "위치 설정됨: {home}",
  "placement.copiesFollow": "복사본이 기본값을 따름",
  "placement.reset": "초기화",
  ...
  // Timeline
  "timeline.deleteAsk": "여기서 이 백업을 삭제하시겠습니까: {list}?",
  ...
  "timeline.onlyHere": "여기에만",
  "timeline.incomplete": "불완전",
  "timeline.incompleteHint": "이 실행의 모든 디스크가 여기 있지 않아 이 위치는 복원 대상으로 선택되지 않습니다.",
  "timeline.snapshotMissing": "{place}에 더 이상 이 백업이 없습니다. {next}에서 복원할까요?",
  "timeline.stackDirMissing": "프로젝트 폴더가 {place}에 없습니다. {home}의 상태를 사용할까요?",
  // Direct repository
  ...
  "placementDefaults.homeOff": "{home}이(가) 꺼져 있습니다. 다시 켜지거나 기본값이 바뀔 때까지 위치가 없는 항목은 백업되지 않습니다.",
  "placementDefaults.homeMissing": "기본값이 더 이상 존재하지 않는 저장소를 가리킵니다. 위치가 없는 항목은 백업되지 않습니다.",
  "placementDefaults.confirmHome": "{domain}의 새 항목은 첫 백업 시 {home}을(를) 물려받습니다. 위치가 있는 항목은 그대로 유지합니다.",
  "placementDefaults.dropAsk": "{target}이(가) 더 이상 받지 않는 항목 및 프로젝트 폴더: {n}개. 그곳에 남는 사본: {copies}개.",
  "placementDefaults.dropAskUnknown": "{target}이(가) 더 이상 받지 않는 항목 및 프로젝트 폴더: {n}개. {target}은(는) 이 도메인에 등록된 적이 없어, 그곳에 사본이 몇 개 남는지 아직 알 수 없습니다.",
  "placementDefaults.addAsk": "{target}이(가) 지금부터 받는 항목 및 프로젝트 폴더: {n}개. 다음 실행 시 업로드되는 스냅샷: 최대 {snapshots}개.",
  "placementDefaults.openTakeHome": "첫 백업 시 {home}을(를) 물려받는, 위치 없는 항목: {n}개.",
  "placementDefaults.apply": "백업이 없는 항목에 적용",
  "placementDefaults.applyAsk": "이 항목들의 위치와 사본이 기본값으로 돌아갑니다: {n}개.",
  "placementDefaults.applyLoses": "이 과정에서 자체 선택을 잃는 항목: {list}",
  "placementDefaults.applyKeptBackups": "그대로 유지됨, 백업이 있음: {list}",
  "placementDefaults.applyKeptUnreadable": "그대로 유지됨, 위치를 읽을 수 없었음: {list}",
  "placementDefaults.applyKeptChanged": "그 사이 변경되어 그대로 둠: {list}",
  "placementDefaults.applyNone": "백업이 없는 항목 중 기본값과 다른 것이 없습니다.",
  "placementDefaults.applyBusy": "백업이 실행 중입니다. 끝난 후 다시 적용하세요.",
  "placementDefaults.paused": "재구축 후 오프사이트 일시 중지됨",
  "placementDefaults.pausedHint": "규칙과 기본값이 이전 구성과 함께 사라졌습니다. 이 기본값이 확인될 때까지 {domain}에서는 아무것도 오프사이트로 복사되지 않습니다. 카드가 있는 항목은 먼저 로컬로 설정할 수 있습니다.",
  "placementDefaults.confirm": "기본값 확인",
  "placementDefaults.confirmAsk": "다음 실행 시 다음이 복사됩니다:",
  "placementDefaults.unmatched": "여기에 항목이 없는, 백업 안의 이름. 체크된 것은 제외됩니다:",
  "placementDefaults.unmatchedLine": "{name}, 스냅샷: {n}개",
  "placementDefaults.confirmed": "기본값이 확인되었습니다. 오프사이트 사본은 다음 실행 시 재개됩니다.",
  ...
  "placement.older": "{target}의 이전 사본: {n}개, 마지막 확인 {date}",
  "placement.noCopyYet": "{place}: 아직 사본 없음",
  "placement.notListedYet": "{place}: 아직 목록에 없음",

  // Removal
  "offsiteRemoval.delete": "{target}에서 삭제",
  "offsiteRemoval.ask": "{target}에 있는 {name}의 모든 사본을 삭제하시겠습니까? 사본 수: {n}.",
  "offsiteRemoval.onlyThere": "이 스냅샷은 다른 곳에는 존재하지 않으며 이후 영구히 사라집니다:",
