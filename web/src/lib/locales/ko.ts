...
const ko: Partial<Translations> = {
  ...
  "about.coffee": "BombVault는 무료이고 앞으로도 무료입니다. 후원은 프로젝트를 살아 있게 하고 비용을 메웁니다. 도메인과 서버, 그리고 여기에 들어가는 저녁 시간입니다.",
  ...
  "files.emptySelectionBlocked": "세트에는 폴더가 최소 하나 필요하므로 마지막 체크는 해제할 수 없습니다. 이 세트가 더 이상 필요 없다면 세트 제거를 사용하세요.",
