...
const sv: Partial<Translations> = {
  ...
  "settings.offsiteHint": "Efter varje lyckad lokal säkerhetskopia, replikera den även till ett andra arkiv med restic copy. Ange ett fjärrarkiv (rest:http://host:8000/repo, s3:…) eller en lokal undersökväg; lämna tomt för att inaktivera. Den lokala säkerhetskopian förblir primär.",
  "source.label": "Källa:",
  "source.local": "Lokal",
  ...
  "pull.repoLocationHint": "Källinstansens arkiv: rest:, s3:, sftp:, eller en undersökväg under värdmonteringen. En rclone:-plats avvisas, eftersom rclone skulle nå den med DEN HÄR instansens fjärrlager.",
  ...
  "pull.credsHint": "Inloggningen till lagringen som källans arkiv ligger på: s3: eller en rest:-server med lösenord. En hämtning använder aldrig den här maskinens egna uppgifter, så en källa som behöver inloggning och inte har något valt här avvisas.",
  ...
  "repos.locationHint": "En mapp under värdmonteringen, eller ett fjärrarkiv för restic som s3:..., sftp:..., rest:... eller rclone:... Till fjärrarkivet skrivs det direkt, utan en lokal mellankopia.",
  ...
  "repos.offPremises": "Utanför lokalerna",
  "repos.offPremisesHint": "Räknas som en egen plats för platserna och 3-2-1 på korten. Kopior påverkas inte. En rest-server i samma byggnad bör ha det här avstängt.",
  ...
  "placementCode.copyRuleTaken": "Det namnet har redan egna kopieringsregler.",
  ...
  "placement.titleHint": "Var den här postens säkerhetskopior skrivs och vart de kopieras efteråt. Platsen är fast från den första säkerhetskopian, kopiorna kan ändras när som helst.",
  "placement.unreadable": "Placeringen kunde inte läsas",
  "placement.noCopyNow": "Ingen kopia just nu, avstängd: {targets}. Markera ett mål eller välj Lokal.",
  "placement.followsDefault": "Följer standarden",
  "placement.ownCopies": "Egna kopior",
  "placement.homeSet": "Plats angiven: {home}",
  "placement.copiesFollow": "Kopior följer standarden",
  "placement.reset": "Återställ",
  "placement.confirmHome": "Säkerhetskopiera {name} till {home} från och med nu? Platsen är fast från den första säkerhetskopian.",
  "placement.paused": "Utanför platsen är pausad tills standarden bekräftas.",
  "placement.uploadIntro": "Vid nästa körning laddas ögonblicksbilder av {name} upp:",
  "placement.uploadUnknown": "Det gick inte att räkna ut hur mycket av {name} som laddas upp.",
  ...
  // Timeline
  "timeline.deleteAsk": "Radera den här säkerhetskopian här: {list}?",
  ...
  "timeline.onlyHere": "endast här",
  "timeline.incomplete": "ofullständig",
  "timeline.incompleteHint": "Inte alla diskar från den här körningen finns här, så den här platsen väljs inte för en återställning.",
  "timeline.snapshotMissing": "{place} har inte längre den här säkerhetskopian. Återställa från {next}?",
  "timeline.stackDirMissing": "Projektmappen finns inte i {place}. Använda tillståndet från {home}?",
  // Direct repository
  ...
  "placementDefaults.homeOff": "{home} är avstängd. Objekt utan plats säkerhetskopieras inte förrän den är på igen eller standarden ändras.",
  "placementDefaults.homeMissing": "Standarden pekar på ett förråd som inte längre finns. Objekt utan plats säkerhetskopieras inte.",
  "placementDefaults.confirmHome": "Nya objekt i {domain} tar över {home} vid sin första säkerhetskopiering. Objekt med en plats behåller den.",
  "placementDefaults.dropAsk": "Objekt och projektmappar som {target} inte längre får: {n}. Kopior som blir kvar där: {copies}.",
  "placementDefaults.dropAskUnknown": "Objekt och projektmappar som {target} inte längre får: {n}. {target} har aldrig varit listad för den här domänen, så hur många kopior som blir kvar där är inte känt ännu.",
  "placementDefaults.addAsk": "Objekt och projektmappar som {target} får från och med nu: {n}. Ögonblicksbilder som laddas upp vid nästa körning: högst {snapshots}.",
  "placementDefaults.openTakeHome": "Objekt utan plats som tar över {home} vid sin första säkerhetskopiering: {n}.",
  "placementDefaults.apply": "Tillämpa på objekt utan säkerhetskopior",
  "placementDefaults.applyAsk": "Plats och kopior går tillbaka till standarden för dessa objekt: {n}.",
  "placementDefaults.applyLoses": "Förlorar därmed sitt eget val: {list}",
  "placementDefaults.applyKeptBackups": "Förblir som de är, de har säkerhetskopior: {list}",
  "placementDefaults.applyKeptUnreadable": "Förblir som de är, deras plats kunde inte läsas: {list}",
  "placementDefaults.applyKeptChanged": "Ändrade under tiden och lämnade ifred: {list}",
  "placementDefaults.applyNone": "Inget objekt utan säkerhetskopior skiljer sig från standarden.",
  "placementDefaults.applyBusy": "En säkerhetskopiering pågår. Tillämpa igen när den är klar.",
  "placementDefaults.paused": "Utanför platsen är pausad efter en ombyggnad",
  "placementDefaults.pausedHint": "Regler och standarder gick förlorade med den gamla konfigurationen. Inget från {domain} kopieras utanför platsen förrän denna standard bekräftas. Objekt med ett kort kan ställas in på Lokal först.",
  "placementDefaults.confirm": "Bekräfta standard",
  "placementDefaults.confirmAsk": "Vid nästa körning kopieras detta:",
  "placementDefaults.unmatched": "Namn i säkerhetskopiorna utan en post här. Ikryssade lämnas utanför:",
  "placementDefaults.unmatchedLine": "{name}, ögonblicksbilder: {n}",
  "placementDefaults.confirmed": "Standard bekräftad. Kopior utanför platsen återupptas vid nästa körning.",
  ...
  "placement.older": "Äldre kopior hos {target}: {n}, senast sedd {date}",
  "placement.noCopyYet": "{place}: ingen kopia ännu",
  "placement.notListedYet": "{place}: inte listad ännu",

  // Removal
  "offsiteRemoval.delete": "Radera hos {target}",
  "offsiteRemoval.ask": "Radera varje kopia av {name} hos {target}? Kopior: {n}.",
  "offsiteRemoval.onlyThere": "Dessa ögonblicksbilder finns ingen annanstans och försvinner för gott efteråt:",
