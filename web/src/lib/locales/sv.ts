...
const sv: Partial<Translations> = {
  ...
  "repos.itemHint": "Vart den här postens säkerhetskopior tar vägen. Låt det stå på domänens arkiv om inte just den här posten behöver ett eget; det vanliga skälet är en stor post som sällan ändras och där bara en kopia utanför huset behövs. Listan innehåller det du skapat under Inställningar. Off-site-replikering kopierar inte ett fjärrarkiv eller ett arkiv märkt som redan utanför huset en gång till.",
  ...
  "repos.offsite": "Redan utanför huset",
  "repos.offsiteHint": "För en utdelning på en annan maskin, till exempel en NAS som kall lagring. Off-site-replikering hoppar då över det här arkivet, precis som ett fjärrarkiv, och dess säkerhetskopior kopieras inte en gång till. Låt det vara av för en disk eller utdelning på den här maskinen, som fortfarande behöver kopian utanför huset.",
  "repos.offsiteRemote": "utanför huset",
  "repos.offsiteRemoteHint": "Ett fjärrarkiv ligger redan utanför huset, så off-site-replikering kopierar det aldrig igen.",
