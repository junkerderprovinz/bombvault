...
const sv: Partial<Translations> = {
  ...
  "settings.everythingOverlapWarning": "Det här körs oberoende av scheman för de enskilda domänerna ovan. Om båda är på säkerhetskopieras containers, VMs, flash, mappar och auto-säkerhetskopian vardera två gånger, en gång här, en gång enligt sitt eget schema. Stäng av de domäner du inte vill ha dubblerade.",
