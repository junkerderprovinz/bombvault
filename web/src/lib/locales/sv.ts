...
const sv: Partial<Translations> = {
  ...
  "settings.everythingHint": "Kör varje domän en gång, i ordning (containers, VMs, flash, mappar och till sist auto-säkerhetskopian), så att en enda ping efteråt (via post-kommandot nedan) bekräftar att hela servern är skyddad. Avstängt som standard och oberoende av varje domäns eget schema ovan.",
  "settings.everythingDuplicateWarning": "Containers, VMs, flash, mappar och auto-säkerhetskopian säkerhetskopieras två gånger så länge både det här schemat och deras eget är påslagna: en gång här och en gång på sitt eget schema. Stäng av de domäner du inte vill ha dubblerade.",
