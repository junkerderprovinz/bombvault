...
const sv: Partial<Translations> = {
  ...
  "dbdump.introNotice": "BombVault dumpar {count} igenkända databaser före varje säkerhetskopia, som egna återställningspunkter. Du kan stänga av det per container på dess kort eller för alla containrar under Inställningar.",
  ...
  "dbdump.fixRepository": "Säkerhetskopie-arkivet tog inte emot dumpen, eller lagrade färre byte än som dumpades. Kontrollera arkivet under Inställningar, Lagring; dumpen försöks igen med nästa säkerhetskopia.",
  ...
  "recovery.dumpOnlySkipped": "{count} databaser som bara finns som dump lämnas utanför; återställ och importera dem från deras egen lista.",
