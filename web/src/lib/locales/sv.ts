...
const sv: Partial<Translations> = {
  ...
  "about.report": "Hittade du något eller saknas något? Öppna ett ärende på GitHub eller skicka ett mejl. Versionen ovan hjälper i båda fallen.",
  "about.repo": "Utvecklingskatalog",
  "about.mail": "Skriv ett mejl",
