...
const sv: Partial<Translations> = {
  ...
  "settings.dashTileCa": "Det kan också finnas i Community Applications — sök efter BombVault Dashboard.",
  "settings.dashTileNotInstalled": "Dashboard-rutans plugin är inte installerat.",
  "settings.dashTileConfirm": "Installera installerar pluginet bombvault-dashboard på din Unraid-värd via Unraids vanliga pluginmekanism. Det dyker upp under Plugins som vilket annat plugin som helst och kan tas bort där (eller här) när som helst.",
