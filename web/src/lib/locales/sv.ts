...
const sv: Partial<Translations> = {
  ...
  "offsite.replicatingSnapshotPercentWithDuration": "Replikerar snapshot {index} av {total} ({percent} %) · {duration}",
  ...
  "activityLog.lineOffsiteRunningSnapshotPercent": "Off-site-uppladdning — {domain} … snapshot {index} av {total} ({percent} %)",
  "activityLog.lineOffsiteRunningSnapshotPercentWithDuration": "Off-site-uppladdning — {domain} … snapshot {index} av {total} ({percent} %) · {duration}",
  ...
  "schedule.overrideHint": "Tomt använder kategorins schema. Åsidosättningar per objekt stöder inte läget var N:e dag.",
