...
const sv: Partial<Translations> = {
  ...
  "runReason.dbimportAppsDown": "de här apparna gick inte att starta igen: {apps}",
  "runReason.dbimportAppsStopped": "de här apparna förblir stoppade tills datamappen är ordnad: {apps}",
  ...
  "dbdump.stackRestoreWarn": "Data för {names} kopieras medan stacken kör. Importera deras senaste databasdump efter återställningen, innan du använder apparna.",
  "dbdump.introNotice": "BombVault dumpar de databaser den känner igen före varje säkerhetskopia, som egna återställningspunkter. Igenkända här: {count}, den första är {name}. Du kan stänga av det per container på dess kort eller för alla containrar under Inställningar.",
  ...
  "dbdump.importStopsOne": "Under importen stoppar BombVault även {app}. Efteråt startas den igen, utom när importen misslyckas och den gamla datan inte kan läggas tillbaka.",
  "dbdump.importStopsMany": "Under importen stoppar BombVault även de här apparna: {apps}. Efteråt startas de igen, utom när importen misslyckas och den gamla datan inte kan läggas tillbaka.",
  ...
  "recovery.foreignDbDumps": "Databasdumpar i det här arkivet: {count}. Hämta en med restics kommandorad, som nödpaketet beskriver.",
  ...
  "recovery.dumpOnlySkipped": "Databaser som bara finns som dump lämnas utanför här: {count}. Återställ och importera dem från deras egen lista.",
