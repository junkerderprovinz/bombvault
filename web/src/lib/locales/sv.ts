...
const sv: Partial<Translations> = {
  ...
  "settings.labelsHint": "Hur mycket av en kontroll som visas: dess ord, dess symbol eller båda. Knappar behåller samma bredd i alla tre, så att byta omorganiserar inte sidan.",
  ...
  "settingsIO.chooseFile": "Välj en inställningsfil",
