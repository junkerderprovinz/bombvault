...
const sv: Partial<Translations> = {
  ...
  "takeover.backup": "1 säkerhetskopia",
  "takeover.backups": "{n} säkerhetskopior",
  ...
  "takeover.historyOne": "Säkerhetskopian av {old} blir en del av historiken för {new}.",
  "takeover.historyMany": "De {n} säkerhetskopiorna av {old} blir en del av historiken för {new}.",
  ...
  "auth.recoveryLeft": "{n} återställningskoder kvar",
  ...
  "receiver.snapshotsCount": "{n} kopior",
  ...
  "pull.snapshotsPulled": "{n} snapshots hämtade",
  "pull.nothingNew": "Inget nytt att hämta.",
  "pull.pulled": "Hämtade {n} snapshots.",
