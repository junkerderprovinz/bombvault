...
const sv: Partial<Translations> = {
  ...
  "dbdump.importStopsOne": "Under importen stoppar BombVault även {app} och startar den igen efteråt.",
  "dbdump.importStopsMany": "Under importen stoppar BombVault även de här apparna och startar dem igen efteråt: {apps}.",
