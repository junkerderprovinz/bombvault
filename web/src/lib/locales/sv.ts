...
const sv: Partial<Translations> = {
  ...
  "about.body": "En enda riddare, ett korståg: fria, snygga verktyg med öppen källkod som inte fanns i den form jag ville ha. Byggda tills ingenting fattas. Inga konton, ingen telemetri, inga annonser. Ingen provperiod, inga betalnivåer, ingen liten asterisk med finstilt text. Inget läsbart lämnar någonsin dina egna murar. Smitt på kvällar och helger, med hjärta och envishet.",
  "about.coffee": "Om BombVault är till nytta för dig täcker en donation vad det kostar att hålla igång: domänen, servern och kvällarna som går åt. Och den får den här riddarens hjärta att slå lite snabbare. Nedan finns tre vägar, ta den som passar dig.",
