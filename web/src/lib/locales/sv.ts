...
const sv: Partial<Translations> = {
  ...
  "files.empty": "Inga filuppsättningar ännu. Lägg till en mapp — utdelningar, dokument, foton, vad som helst under dina monteringar — så skyddar BombVault den som allt annat: scheman, off-site-kopior, integritetskontroller och återställningar. Inget separat filbackupverktyg behövs.",
  "files.addSet": "Lägg till filuppsättning",
  "files.editSet": "Redigera filuppsättning",
  "files.name": "Namn",
  "files.path": "Mapp",
  ...
  "files.deleteSetConfirm": "Ta bort denna filuppsättning från listan? Dess säkerhetskopior tas inte bort och kan återupptäckas senare.",
  "files.deleteBackupsConfirm": "Ta bort ALLA säkerhetskopior av denna filuppsättning? Ögonblicksbilderna tas bort permanent, repositoriet rensas och uppsättningen glöms. Detta kan inte ångras.",
