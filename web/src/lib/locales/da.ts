...
const da: Partial<Translations> = {
  ...
  "about.body": "Én ridder, ét korstog: frie, velformede open source-værktøjer, der ikke fandtes i den form, jeg ville have. Bygget, indtil intet mangler. Ingen konti, ingen telemetri, ingen reklamer. Ingen prøveperiode, ingen betalingstrin, ingen lille stjerne med småt. Intet læsbart forlader nogensinde dine egne mure. Smedet om aftenen og i weekenden, med hjerte og stædighed.",
  "about.coffee": "Hvis BombVault er noget værd for dig, dækker en donation, hvad det koster at holde det i gang: domænet, serveren og aftenerne, der går med det. Og den får denne ridders hjerte til at slå lidt hurtigere. Der er tre veje nedenfor, tag den, der passer dig.",
