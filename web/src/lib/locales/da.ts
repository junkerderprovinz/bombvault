...
const da: Partial<Translations> = {
  ...
  "offsite.replicatingSnapshotPercentWithDuration": "Replikerer snapshot {index} af {total} ({percent}%) · {duration}",
  ...
  "activityLog.lineOffsiteRunningSnapshotPercent": "Off-site-upload — {domain} … snapshot {index} af {total} ({percent}%)",
  "activityLog.lineOffsiteRunningSnapshotPercentWithDuration": "Off-site-upload — {domain} … snapshot {index} af {total} ({percent}%) · {duration}",
  ...
  "schedule.overrideHint": "Tom bruger kategoriens tidsplan. Tilsidesættelser pr. element understøtter ikke hver-N-dage-tilstanden.",
