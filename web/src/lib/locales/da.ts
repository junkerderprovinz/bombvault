...
const da: Partial<Translations> = {
  ...
  "files.empty": "Ingen filsæt endnu. Tilføj en mappe — shares, dokumenter, fotos, hvad som helst under dine monteringer — og BombVault beskytter den som alt andet: tidsplaner, off-site-kopier, integritetstjek og gendannelser. Intet separat filbackupværktøj nødvendigt.",
  "files.addSet": "Tilføj filsæt",
  "files.editSet": "Redigér filsæt",
  "files.name": "Navn",
  "files.path": "Mappe",
  ...
  "files.deleteSetConfirm": "Fjerne dette filsæt fra listen? Dets sikkerhedskopier slettes ikke og kan genopdages senere.",
  "files.deleteBackupsConfirm": "Slet ALLE sikkerhedskopier af dette filsæt? Øjebliksbillederne fjernes permanent, repositoriet beskæres, og sættet glemmes. Kan ikke fortrydes.",
