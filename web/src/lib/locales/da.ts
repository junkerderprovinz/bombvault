...
const da: Partial<Translations> = {
  ...
  "settings.labelsHint": "Hvor meget af en kontrol der vises: dens ord, dens symbol eller begge dele. Knapper beholder samme bredde i alle tre, så skift omrokerer ikke siden.",
