...
const da: Partial<Translations> = {
  ...
  "settings.everythingOverlapWarning": "Dette kører uafhængigt af tidsplanerne for de enkelte områder ovenfor. Hvis begge er slået til, bliver containere, VMs, flash, mapper og auto-sikkerhedskopien hver sikkerhedskopieret to gange: én gang her, én gang på deres egen tidsplan. Slå de områder fra, du ikke vil have dubleret.",
