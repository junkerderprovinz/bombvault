...
const da: Partial<Translations> = {
  ...
  "dbdump.introNotice": "BombVault dumper {count} genkendte databaser før hver sikkerhedskopi som deres egne gendannelsespunkter. Du kan slå det fra pr. container på dens kort eller for alle containere under Indstillinger.",
  ...
  "dbdump.fixRepository": "Sikkerhedskopi-arkivet tog ikke imod dumpen eller gemte færre byte, end der blev dumpet. Tjek arkivet under Indstillinger, Lager; dumpen prøves igen med næste sikkerhedskopi.",
  ...
  "recovery.dumpOnlySkipped": "{count} databaser gemt kun som dump holdes udenfor; gendan og importér dem fra deres egen liste.",
