...
const da: Partial<Translations> = {
  ...
  "repos.itemHint": "Hvor denne posts sikkerhedskopier havner. Lad det stå på domænets depot, medmindre netop denne post har brug for sit eget; den sædvanlige grund er en stor, sjældent ændret post, som kun skal have en kopi uden for huset. Listen indeholder det, du har oprettet under Indstillinger. Off-site-replikering kopierer ikke et fjerndepot eller et depot markeret som allerede uden for huset en gang til.",
  ...
  "repos.offsite": "Allerede uden for huset",
  "repos.offsiteHint": "Til en deling på en anden maskine, fx en NAS brugt som koldt lager. Off-site-replikering springer så dette depot over, som den gør med et fjerndepot, og dets sikkerhedskopier kopieres ikke en gang til. Lad den være slået fra for en disk eller deling på denne maskine, som stadig har brug for kopien uden for huset.",
  "repos.offsiteRemote": "uden for huset",
  "repos.offsiteRemoteHint": "Et fjerndepot er allerede uden for huset, så off-site-replikering kopierer det aldrig igen.",
