...
const da: Partial<Translations> = {
  ...
  "settings.dashTileCa": "Det findes måske også i Community Applications — søg efter BombVault Dashboard.",
  "settings.dashTileNotInstalled": "Dashboard-flisens plugin er ikke installeret.",
  "settings.dashTileConfirm": "Installer installerer pluginet bombvault-dashboard på din Unraid-vært via Unraids almindelige pluginmekanisme. Det dukker op under Plugins som ethvert andet plugin og kan fjernes dér (eller her) når som helst.",
