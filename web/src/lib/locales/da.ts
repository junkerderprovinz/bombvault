...
const da: Partial<Translations> = {
  ...
  "settings.offsiteHint": "Efter hver vellykket lokal sikkerhedskopi replikeres den også til et andet repo med restic copy. Angiv et fjern-repo (rest:http://host:8000/repo, s3:…) eller en lokal understi; lad stå tomt for at deaktivere. Den lokale sikkerhedskopi forbliver den primære.",
  "source.label": "Kilde:",
  "source.local": "Lokal",
  ...
  "settingsIO.previewNotInFile": "ikke i filen, forbliver uændret",
  ...
  "pull.repoLocationHint": "Kildeinstansens arkiv: rest:, s3:, sftp:, eller en understi under værtsmonteringen. En rclone:-placering afvises, fordi rclone ville nå den med DENNE instans' remotes.",
  ...
  "pull.credsHint": "Loginnet til det lager, som kildens repository ligger på: s3: eller en rest:-server med adgangskode. En hentning bruger aldrig denne maskines egne oplysninger, så en kilde, der kræver login og ikke har valgt noget her, bliver afvist.",
  ...
  "repos.locationHint": "En mappe under værtens montering, eller et restic-fjerndepot såsom s3:..., sftp:..., rest:... eller rclone:... Der skrives direkte til fjerndepotet, uden en lokal mellemkopi.",
  ...
  "repos.offPremises": "Uden for bygningen",
  "repos.offPremisesHint": "Tæller som sit eget sted for lokationer og 3-2-1 på kortene. Kopier påvirkes ikke. En rest-server i samme bygning bør have dette slået fra.",

  // Refusals
  "placementCode.unreadable": "Placeringsreglerne kunne ikke læses, så der kopieres intet, før de kan læses igen.",
  "placementCode.invalid": "Dette placeringsvalg er ikke gyldigt.",
  ...
  "placementCode.copyRuleTaken": "Det navn har allerede sine egne kopieringsregler.",
  ...
  "placementCode.defaultRepoMissing": "En standard i filen peger på et depot, der hverken er i filen eller her.",
  "placementCode.nestedLocation": "Denne placering ligger inde i et andet depot eller mål, eller indeholder ét.",
  "placementCode.foreignDomain": "Det direkte depot hører til et mål i et andet domæne.",
  "placementCode.mirroredField": "Denne værdi kommer fra målet. Skift den der.",
  "placementCode.companionTaken": "Dette mål har allerede et direkte depot.",
  "placementCode.exclusionUnsaved": "Målet blev gemt. Det, der skal udelukkes, blev ikke.",
  ...
  // Placement
  "placement.hostGeneric": "Vært",
  "placement.segLocal": "Lokal",
  "placement.segLocalOffsite": "Lokal + ekstern",
  "placement.segOffsiteOnly": "Kun ekstern",
  "placement.homeDomain": "{host} · domænedepot · {path}",
  "placement.homeDomainRemote": "Domænedepot · fjern · {scheme}",
  "placement.homeLocal": "{name} · monteret",
  "placement.homeRemote": "{name} · fjern",
  "placement.homeDirect": "{target} · direkte",
  "placement.directNotYet": "oprettes ved første valg",
  "placement.off": "{name} (fra)",
  "placement.unknown": "{name} (ukendt)",
  "placement.noTarget": "Intet eksternt mål sat op",
  ...
  "placement.titleHint": "Hvor denne enheds sikkerhedskopier skrives, og hvor de kopieres hen bagefter. Placeringen er fast fra første sikkerhedskopi, kopierne kan ændres når som helst.",
  "placement.unreadable": "Placering kunne ikke læses",
  "placement.noCopyNow": "Ingen kopi lige nu, slået fra: {targets}. Sæt flueben ved et mål, eller vælg Lokal.",
  "placement.followsDefault": "Følger standarden",
  "placement.ownCopies": "Egne kopier",
  "placement.homeSet": "Placering angivet: {home}",
  "placement.copiesFollow": "Kopier følger standarden",
  "placement.reset": "Nulstil",
  ...
  // Timeline
  "timeline.deleteAsk": "Slet denne sikkerhedskopi her: {list}?",
  ...
  "timeline.incomplete": "ufuldstændig",
  "timeline.incompleteHint": "Ikke alle diske fra dette kørsel er her, så dette sted vælges ikke til en gendannelse.",
  "timeline.snapshotMissing": "{place} har ikke længere denne sikkerhedskopi. Gendan fra {next}?",
  "timeline.stackDirMissing": "Projektmappen er ikke i {place}. Brug tilstanden fra {home}?",
  // Direct repository
  ...
  "placementDefaults.homeOff": "{home} er slukket. Elementer uden placering sikkerhedskopieres ikke, før det er tændt igen, eller standarden ændres.",
  "placementDefaults.homeMissing": "Standarden peger på et repository, der ikke længere findes. Elementer uden placering sikkerhedskopieres ikke.",
  "placementDefaults.confirmHome": "Nye elementer i {domain} overtager {home} ved deres første sikkerhedskopi. Elementer med en placering beholder den.",
  "placementDefaults.dropAsk": "Elementer og projektmapper, som {target} ikke længere får: {n}. Kopier, der bliver der: {copies}.",
  "placementDefaults.dropAskUnknown": "Elementer og projektmapper, som {target} ikke længere får: {n}. {target} har aldrig været listet for dette domæne, så det vides endnu ikke, hvor mange kopier der bliver der.",
  "placementDefaults.addAsk": "Elementer og projektmapper, som {target} får fra nu af: {n}. Øjebliksbilleder uploadet ved næste kørsel: højst {snapshots}.",
  "placementDefaults.openTakeHome": "Elementer uden placering, der overtager {home} ved deres første sikkerhedskopi: {n}.",
  "placementDefaults.apply": "Anvend på elementer uden sikkerhedskopier",
  "placementDefaults.applyAsk": "Placering og kopier går tilbage til standarden for disse elementer: {n}.",
  "placementDefaults.applyLoses": "Mister deres eget valg: {list}",
  "placementDefaults.applyKeptBackups": "Forbliver som de er, de har sikkerhedskopier: {list}",
  "placementDefaults.applyKeptUnreadable": "Forbliver som de er, deres placering kunne ikke læses: {list}",
  "placementDefaults.applyKeptChanged": "Ændret i mellemtiden og ladt urørt: {list}",
  "placementDefaults.applyNone": "Intet element uden sikkerhedskopier afviger fra standarden.",
  "placementDefaults.applyBusy": "En sikkerhedskopi kører. Anvend igen, når den er færdig.",
  "placementDefaults.paused": "Ekstern sat på pause efter en genopbygning",
  "placementDefaults.pausedHint": "Regler og standarder gik tabt med den gamle konfiguration. Intet fra {domain} kopieres eksternt, før denne standard er bekræftet. Elementer med et kort kan først sættes til Lokal.",
  "placementDefaults.confirm": "Bekræft standard",
  "placementDefaults.confirmAsk": "Ved næste kørsel kopieres dette:",
  "placementDefaults.unmatched": "Navne i sikkerhedskopierne uden en post her. Afkrydsede udelades:",
  "placementDefaults.unmatchedLine": "{name}, øjebliksbilleder: {n}",
  "placementDefaults.confirmed": "Standard bekræftet. Eksterne kopier genoptages ved næste kørsel.",

  // New target
  "newTarget.intro": "Ved sin første kørsel modtager {target} alle elementer, der ikke er sat til Lokal.",
  "newTarget.moved": "Den nye placering for {target} modtager hele historikken.",
  "newTarget.items": "Elementer og projektmapper: {n}",
  "newTarget.snapshots": "Øjeblikksbilleder: op til {n}",
  "newTarget.size": "Størrelse: op til {size}",
  "newTarget.formerly": "Hidtil udelukket hos andre mål: {list}",
  "newTarget.excludeHere": "Udeluk også her",
  "newTarget.excludeDefault": "Udeluk også {target} fra standarden",
  "newTarget.importHeading": "Nyt mål {target} til {domain}",

  // Discover
  "discover.paused": "Eksterne kopier for {domains} er sat på pause, indtil standarden er bekræftet under {where}.",
  "discover.leftOpen": "Placering efterladt åben, fordi en sikkerhedskopi kørte: {list}",
  ...
  "placement.older": "Ældre kopier i {target}: {n}, sidst set {date}",
  "placement.noCopyYet": "{place}: endnu ingen kopi",
  "placement.notListedYet": "{place}: endnu ikke listet",

  // Removal
  "offsiteRemoval.delete": "Slet i {target}",
  "offsiteRemoval.ask": "Slet hver kopi af {name} i {target}? Kopier: {n}.",
  "offsiteRemoval.onlyThere": "Disse snapshots findes ingen andre steder og forsvinder for altid bagefter:",
