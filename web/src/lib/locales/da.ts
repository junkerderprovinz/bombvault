...
const da: Partial<Translations> = {
  ...
  "takeover.backup": "1 sikkerhedskopi",
  "takeover.backups": "{n} sikkerhedskopier",
  ...
  "takeover.historyOne": "Sikkerhedskopien af {old} bliver historik for {new}.",
  "takeover.historyMany": "De {n} sikkerhedskopier af {old} bliver historik for {new}.",
