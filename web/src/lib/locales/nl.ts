...
const nl: Partial<Translations> = {
  ...
  "offsite.replicatingSnapshotPercentWithDuration": "Repliceren: snapshot {index} van {total} ({percent}%) · {duration}",
  ...
  "activityLog.lineOffsiteRunningSnapshotPercent": "Off-site upload — {domain} … snapshot {index} van {total} ({percent}%)",
  "activityLog.lineOffsiteRunningSnapshotPercentWithDuration": "Off-site upload — {domain} … snapshot {index} van {total} ({percent}%) · {duration}",
