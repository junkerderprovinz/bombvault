...
const nl: Partial<Translations> = {
  ...
  "settings.dashTileCa": "Mogelijk is hij ook beschikbaar in Community Applications — zoek naar BombVault Dashboard.",
  "settings.dashTileNotInstalled": "De dashboardtegel-plugin is niet geïnstalleerd.",
  "settings.dashTileConfirm": "Installeren installeert de bombvault-dashboard-plugin op je Unraid-host via het gewone Unraid-pluginmechanisme. Hij verschijnt onder Plugins zoals elke andere plugin en kan daar (of hier) altijd worden verwijderd.",
