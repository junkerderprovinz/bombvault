...
const nl: Partial<Translations> = {
  ...
  "dbdump.introNotice": "BombVault dumpt {count} herkende databases voor elke back-up, als eigen herstelpunten. Je kunt dit per container op zijn kaart uitzetten of voor alle containers in Instellingen.",
  ...
  "dbdump.fixRepository": "De back-upopslag heeft de dump niet aangenomen, of minder bytes bewaard dan er gedumpt zijn. Controleer de opslag in Instellingen, Opslag; de dump wordt bij de volgende back-up opnieuw geprobeerd.",
  ...
  "recovery.dumpOnlySkipped": "{count} databases die alleen als dump bewaard zijn blijven erbuiten; herstel en importeer ze uit hun eigen lijst.",
