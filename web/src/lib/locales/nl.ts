...
const nl: Partial<Translations> = {
  ...
  "settings.offsiteHint": "Na elke geslaagde lokale back-up deze ook repliceren naar een tweede repo met restic copy. Vul een remote in (rest:http://host:8000/repo, s3:…) of een lokaal subpad; laat leeg om uit te schakelen. De lokale back-up blijft primair.",
  "source.label": "Bron:",
  "source.local": "Lokaal",
  ...
  "pull.repoLocationHint": "De repository van de broninstantie: rest:, s3:, sftp:, of een subpad onder de host-koppeling. Een rclone:-locatie wordt geweigerd, omdat rclone die met de remotes van DEZE instantie zou benaderen.",
  ...
  "pull.credsHint": "De aanmeldgegevens voor de opslag waarop de repository van de bron staat: s3: of een rest:-server met wachtwoord. Een ophaalactie gebruikt nooit de gegevens van deze machine, dus een bron die moet aanmelden en hier niets gekozen heeft, wordt geweigerd.",
  ...
  "repos.locationPlaceholder": "backups/cold of s3:s3.eu-central-003.backblazeb2.com/bucket/path",
  "repos.locationHint": "Een map onder de hostkoppeling, of een externe restic-repository zoals s3:..., sftp:..., rest:... of rclone:... Naar de externe wordt rechtstreeks geschreven, zonder lokale tussenkopie.",
  ...
  "repos.offPremises": "Buiten het pand",
  "repos.offPremisesHint": "Telt op de kaarten als een eigen locatie voor de locaties en de 3-2-1. Kopieën worden niet beïnvloed. Een rest-server in hetzelfde gebouw moet dit uit hebben staan.",
  ...
  "placement.titleHint": "Waar de back-ups van dit item worden geschreven en waarheen ze daarna worden gekopieerd. De locatie ligt vast vanaf de eerste back-up, de kopieën kunnen op elk moment veranderen.",
  "placement.unreadable": "Plaatsing kon niet worden gelezen",
  "placement.noCopyNow": "Nu geen kopie, uitgeschakeld: {targets}. Vink een doel aan of kies Lokaal.",
  "placement.followsDefault": "Volgt de standaard",
  "placement.ownCopies": "Eigen kopieën",
  "placement.homeSet": "Locatie ingesteld: {home}",
  "placement.copiesFollow": "Kopieën volgen de standaard",
  "placement.reset": "Herstellen",
  ...
  // Timeline
  "timeline.deleteAsk": "Deze back-up hier verwijderen: {list}?",
  ...
  "timeline.onlyHere": "alleen hier",
  "timeline.incomplete": "onvolledig",
  "timeline.incompleteHint": "Niet alle schijven van deze run staan hier, dus deze plek wordt niet gekozen voor een herstel.",
  "timeline.snapshotMissing": "{place} heeft deze back-up niet meer. Herstellen vanuit {next}?",
  "timeline.stackDirMissing": "De projectmap staat niet in {place}. De toestand van {home} gebruiken?",
  // Direct repository
  ...
  "placementDefaults.homeOff": "{home} staat uit. Items zonder locatie worden niet geback-upt totdat het weer aan staat of de standaard verandert.",
  "placementDefaults.homeMissing": "De standaard wijst naar een repository die niet meer bestaat. Items zonder locatie worden niet geback-upt.",
  "placementDefaults.confirmHome": "Nieuwe items in {domain} nemen {home} over bij hun eerste back-up. Items met een locatie behouden die.",
  "placementDefaults.dropAsk": "Items en projectmappen die {target} niet meer krijgt: {n}. Kopieën die daar blijven: {copies}.",
  "placementDefaults.dropAskUnknown": "Items en projectmappen die {target} niet meer krijgt: {n}. {target} stond nooit vermeld voor dit domein, dus hoeveel kopieën daar blijven is nog niet bekend.",
  "placementDefaults.addAsk": "Items en projectmappen die {target} vanaf nu krijgt: {n}. Snapshots geüpload bij de volgende run: hoogstens {snapshots}.",
  "placementDefaults.openTakeHome": "Items zonder locatie die {home} overnemen bij hun eerste back-up: {n}.",
  "placementDefaults.apply": "Toepassen op items zonder back-ups",
  "placementDefaults.applyAsk": "Locatie en kopieën gaan voor deze items terug naar de standaard: {n}.",
  "placementDefaults.applyLoses": "Verliezen daarbij hun eigen keuze: {list}",
  "placementDefaults.applyKeptBackups": "Blijven zoals ze zijn, ze hebben back-ups: {list}",
  "placementDefaults.applyKeptUnreadable": "Blijven zoals ze zijn, hun locatie kon niet worden gelezen: {list}",
  "placementDefaults.applyKeptChanged": "Ondertussen gewijzigd en met rust gelaten: {list}",
  "placementDefaults.applyNone": "Geen enkel item zonder back-ups wijkt af van de standaard.",
  "placementDefaults.applyBusy": "Er loopt een back-up. Pas opnieuw toe zodra deze klaar is.",
  "placementDefaults.paused": "Off-site gepauzeerd na een herbouw",
  "placementDefaults.pausedHint": "Regels en standaarden gingen verloren met de oude configuratie. Er wordt niets van {domain} off-site gekopieerd totdat deze standaard is bevestigd. Items met een kaart kunnen eerst op Lokaal worden gezet.",
  "placementDefaults.confirm": "Standaard bevestigen",
  "placementDefaults.confirmAsk": "Bij de volgende run wordt dit gekopieerd:",
  "placementDefaults.unmatched": "Namen in de back-ups zonder item hier. Aangevinkte worden weggelaten:",
  "placementDefaults.unmatchedLine": "{name}, snapshots: {n}",
  "placementDefaults.confirmed": "Standaard bevestigd. Off-site kopieën gaan verder bij de volgende run.",
  ...
  "placement.older": "Oudere kopieën bij {target}: {n}, laatst gezien {date}",
  "placement.noCopyYet": "{place}: nog geen kopie",
  "placement.notListedYet": "{place}: nog niet vermeld",

  // Removal
  "offsiteRemoval.delete": "Verwijderen bij {target}",
  "offsiteRemoval.ask": "Elke kopie van {name} bij {target} verwijderen? Kopieën: {n}.",
  "offsiteRemoval.onlyThere": "Deze snapshots bestaan nergens anders en zijn daarna definitief weg:",
