...
const nl: Partial<Translations> = {
  ...
  "settings.everythingOverlapWarning": "Dit loopt onafhankelijk van de planningen per domein hierboven. Als beide aan staan, worden containers, VM's, flash, mappen en de zelf-back-up allemaal twee keer geback-upt: één keer hier, één keer op hun eigen planning. Zet de domeinen uit die je niet dubbel wilt hebben.",
