...
const nl: Partial<Translations> = {
  ...
  "takeover.backup": "1 back-up",
  "takeover.backups": "{n} back-ups",
  ...
  "takeover.historyOne": "De back-up van {old} wordt de geschiedenis van {new}.",
  "takeover.historyMany": "De {n} back-ups van {old} worden de geschiedenis van {new}.",
  ...
  "pull.snapshotsPulled": "{n} snapshots opgehaald",
  "pull.nothingNew": "Niets nieuws om op te halen.",
  "pull.pulled": "{n} snapshots opgehaald.",
