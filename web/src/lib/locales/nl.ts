...
const nl: Partial<Translations> = {
  ...
  "about.report": "Iets gevonden of iets gemist? Open een issue op GitHub of stuur een mail. De versie hierboven helpt in beide gevallen.",
  "about.repo": "Repository",
  "about.mail": "Mail schrijven",
