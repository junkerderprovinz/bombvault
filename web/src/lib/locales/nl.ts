...
const nl: Partial<Translations> = {
  ...
  "dbdump.stackRestoreWarn": "De gegevens van {names} worden gekopieerd terwijl de stack draait. Importeer na het herstel hun nieuwste databasedump voordat je de apps gebruikt.",
  "dbdump.introNotice": "BombVault dumpt de databases die het herkent voor elke back-up, als eigen herstelpunten. Hier herkend: {count}, de eerste is {name}. Je kunt dit per container op zijn kaart uitzetten of voor alle containers in Instellingen.",
  ...
  "dbdump.importStopsOne": "Tijdens het importeren stopt BombVault ook {app}. Daarna start die weer, tenzij het importeren mislukt en de oude gegevens niet terug kunnen.",
  "dbdump.importStopsMany": "Tijdens het importeren stopt BombVault ook deze apps: {apps}. Daarna starten ze weer, tenzij het importeren mislukt en de oude gegevens niet terug kunnen.",
  ...
  "recovery.foreignDbDumps": "Databasedumps in deze repository: {count}. Haal er een op met de restic-opdrachtregel, zoals het noodpakket beschrijft.",
  ...
  "recovery.dumpOnlySkipped": "Databases die alleen als dump bewaard zijn blijven hier buiten: {count}. Herstel en importeer ze uit hun eigen lijst.",
