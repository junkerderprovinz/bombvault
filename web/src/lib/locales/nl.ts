...
const nl: Partial<Translations> = {
  ...
  "repos.offsite": "Al buitenshuis",
  "repos.offsiteHint": "Voor een share op een andere machine, zoals een NAS als koude opslag. Off-site replicatie slaat deze repository dan over, net als een externe, en de back-ups ervan worden niet nog een keer gekopieerd. Laat het uit voor een schijf of share op deze machine, die heeft de kopie buitenshuis nog steeds nodig.",
  "repos.offsiteRemote": "buitenshuis",
  "repos.offsiteRemoteHint": "Een externe repository staat al buitenshuis, dus off-site replicatie kopieert die nooit opnieuw.",
