...
const nl: Partial<Translations> = {
  ...
  "settings.labelsHint": "Hoeveel van een besturingselement wordt getoond: de woorden, het symbool of beide. Knoppen houden in alle drie dezelfde breedte, dus wisselen herschikt de pagina niet.",
