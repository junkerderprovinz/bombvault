...
const nl: Partial<Translations> = {
  ...
  "about.body": "Eén ridder, één kruistocht: vrije, mooie opensourcegereedschappen die niet bestonden in de vorm die ik wilde. Gebouwd tot er niets meer ontbreekt. Geen accounts, geen telemetrie, geen advertenties. Geen proefperiode, geen abonnementen, geen sterretje in de kleine lettertjes. Niets leesbaars verlaat ooit je eigen muren. In avonden en weekenden gesmeed, met hart en koppigheid.",
  "about.coffee": "Als BombVault je van dienst is, dekt een donatie wat het kost om het draaiend te houden: het domein, de server en de avonden die erin gaan. En het laat het hart van deze ridder wat sneller kloppen. Hieronder staan drie wegen, neem die je het beste uitkomt.",
