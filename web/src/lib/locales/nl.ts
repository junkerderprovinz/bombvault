...
const nl: Partial<Translations> = {
  ...
  "files.empty": "Nog geen bestandssets. Voeg een map toe — shares, documenten, foto's, alles onder je mounts — en BombVault beschermt hem zoals al het andere: planningen, off-site kopieën, integriteitscontroles en herstel. Geen aparte tool voor bestandsback-ups nodig.",
  "files.addSet": "Bestandsset toevoegen",
  "files.editSet": "Bestandsset bewerken",
  "files.name": "Naam",
  "files.path": "Map",
  ...
  "files.deleteSetConfirm": "Deze bestandsset uit de lijst verwijderen? De back-ups worden niet verwijderd en kunnen later opnieuw worden ontdekt.",
  "files.deleteBackupsConfirm": "ALLE back-ups van deze bestandsset verwijderen? De snapshots worden permanent verwijderd, de repository wordt opgeschoond en de set wordt vergeten. Kan niet ongedaan worden gemaakt.",
  ...
  "activityLog.domainFiles": "Bestanden",
