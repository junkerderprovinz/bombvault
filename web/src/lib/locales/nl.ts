...
const nl: Partial<Translations> = {
  ...
  "auth.twoFactorEnable": "Inschakelen",
  ...
  "files.emptySelectionBlocked": "Een set heeft minstens één map nodig, dus de laatste vink kan niet worden weggehaald. Gebruik Set verwijderen als je deze set niet meer wilt.",
