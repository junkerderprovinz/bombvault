...
const nl: Partial<Translations> = {
  ...
  "settings.everythingHint": "Voert elk domein één keer uit, in volgorde (containers, VM's, flash, mappen en tot slot de zelf-back-up), zodat één ping achteraf (via het post-commando hieronder) bevestigt dat de hele server beschermd is. Standaard uit, en onafhankelijk van de eigen planning van elk domein hierboven.",
  "settings.everythingDuplicateWarning": "Containers, VM's, flash, mappen en de zelf-back-up krijgen twee back-ups zolang deze planning en hun eigen planning allebei aanstaan: één keer hier en één keer in hun eigen planning. Zet de domeinen uit die je niet dubbel wilt back-uppen.",
