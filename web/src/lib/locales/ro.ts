...
const ro: Partial<Translations> = {
  ...
  "dbdump.stackRestoreWarn": "Datele pentru {names} sunt copiate cât timp stiva rulează. După restaurare, importă cel mai recent dump al bazei lor de date înainte să folosești aplicațiile.",
  "dbdump.introNotice": "BombVault face dump la bazele de date pe care le recunoaște înainte de fiecare copie, ca puncte de restaurare de sine stătătoare. Recunoscute aici: {count}, prima este {name}. Poți opri asta pentru fiecare container pe fișa lui sau pentru toate containerele în Setări.",
  ...
  "dbdump.importStopsOne": "Pe durata importului, BombVault oprește și {app}. După aceea îl pornește din nou, cu excepția cazului în care importul eșuează și datele vechi nu pot fi puse la loc.",
  "dbdump.importStopsMany": "Pe durata importului, BombVault oprește și aceste aplicații: {apps}. După aceea le pornește din nou, cu excepția cazului în care importul eșuează și datele vechi nu pot fi puse la loc.",
  ...
  "recovery.foreignDbDumps": "Copii SQL în acest depozit: {count}. Scoate una cu linia de comandă restic, așa cum descrie trusa de recuperare.",
  ...
  "recovery.dumpOnlySkipped": "Bazele de date păstrate doar ca copie SQL rămân aici pe dinafară: {count}. Restaurează-le și importă-le din lista lor.",
