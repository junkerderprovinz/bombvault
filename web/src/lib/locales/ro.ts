...
const ro: Partial<Translations> = {
  ...
  "takeover.backup": "1 copie de rezervă",
  "takeover.backups": "{n} copii de rezervă",
  ...
  "takeover.historyOne": "Copia de rezervă a intrării {old} devine parte din istoricul intrării {new}.",
  "takeover.historyMany": "Cele {n} copii de rezervă ale intrării {old} devin parte din istoricul intrării {new}.",
