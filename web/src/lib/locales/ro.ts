...
const ro: Partial<Translations> = {
  ...
  "about.coffee": "BombVault este gratuit și rămâne așa. O donație ține proiectul în viață și acoperă ce costă: domeniul, serverul și serile care intră în el.",
  ...
  "files.emptySelectionBlocked": "Un set are nevoie de cel puțin un dosar, deci ultima bifă nu poate fi scoasă. Folosește Elimină setul dacă nu mai vrei acest set.",
