...
const ro: Partial<Translations> = {
  ...
  "settings.everythingOverlapWarning": "Acesta rulează independent de programările fiecărui domeniu de mai sus. Dacă ambele sunt active, containerele, VM-urile, flash-ul, folderele și auto-backup-ul sunt fiecare copiate de două ori: o dată aici, o dată în programarea proprie. Dezactivează domeniile pe care nu vrei să le vezi duplicate.",
