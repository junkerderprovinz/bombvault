...
const ro: Partial<Translations> = {
  ...
  "repos.itemHint": "Unde ajung copiile acestui element. Lasă-l pe depozitul domeniului, dacă nu cumva tocmai acest element are nevoie de al său; motivul obișnuit este un element mare, rar schimbat, de la care se vrea doar o copie în afara locației. Lista conține ce ai creat în Setări. Replicarea externă nu copiază a doua oară un depozit la distanță sau unul marcat ca deja în afara locației.",
  ...
  "repos.offsite": "Deja în afara locației",
  "repos.offsiteHint": "Pentru o partajare pe altă mașină, de pildă un NAS folosit ca stocare rece. Replicarea externă omite atunci acest depozit, la fel ca pe unul la distanță, iar copiile lui nu sunt copiate a doua oară. Lasă-l oprit pentru un disc sau o partajare de pe această mașină, care încă au nevoie de copia din afara locației.",
  "repos.offsiteRemote": "în afara locației",
  "repos.offsiteRemoteHint": "Un depozit la distanță este deja în afara locației, așa că replicarea externă nu îl mai copiază niciodată.",
  "repos.inUse": "{n} în uz",
