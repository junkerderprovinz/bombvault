...
const ro: Partial<Translations> = {
  ...
  "dbdump.introNotice": "BombVault face dump la {count} baze de date recunoscute înainte de fiecare copie, ca puncte de restaurare de sine stătătoare. Poți opri asta pentru fiecare container pe fișa lui sau pentru toate containerele în Setări.",
  ...
  "dbdump.fixRepository": "Depozitul de copii nu a acceptat dumpul sau a stocat mai puțini octeți decât au fost extrași. Verifică depozitul în Setări, Stocare; dumpul se reîncearcă la următoarea copie.",
  ...
  "recovery.dumpOnlySkipped": "{count} baze de date păstrate doar ca copie SQL rămân pe dinafară; restaurează-le și importă-le din lista lor.",
