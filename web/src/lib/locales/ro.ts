...
const ro: Partial<Translations> = {
  ...
  "about.body": "Un singur cavaler, o cruciadă: unelte libere, arătoase și open source, care nu existau în forma pe care o voiam. Construite până nu mai lipsește nimic. Fără conturi, fără telemetrie, fără reclame. Fără perioadă de probă, fără abonamente, fără asterisc cu litere mici. Nimic lizibil nu îți părăsește vreodată zidurile. Făurit seara și în weekend, cu inimă și încăpățânare.",
  "about.coffee": "Dacă BombVault îți este de folos, o donație acoperă cât costă să meargă mai departe: domeniul, serverul și serile care intră în el. Și face inima acestui cavaler să bată puțin mai repede. Mai jos sunt trei căi, alege-o pe cea care ți se potrivește.",
