...
const ro: Partial<Translations> = {
  ...
  "files.empty": "Încă nu există seturi de fișiere. Adăugați un folder — partajări, documente, fotografii, orice se află sub montările dvs. — iar BombVault îl protejează ca pe orice altceva: programări, copii externe, verificări de integritate și restaurări. Nu este nevoie de un instrument separat de backup pentru fișiere.",
  "files.addSet": "Adaugă set de fișiere",
  "files.editSet": "Editează setul de fișiere",
  "files.name": "Nume",
  "files.path": "Folder",
  ...
  "files.deleteSetConfirm": "Eliminați acest set de fișiere din listă? Copiile sale de rezervă nu sunt șterse și pot fi redescoperite mai târziu.",
  "files.deleteBackupsConfirm": "Ștergeți TOATE copiile de rezervă ale acestui set de fișiere? Instantaneele sunt eliminate permanent, depozitul este curățat, iar setul este uitat. Nu poate fi anulat.",
  ...
  "activityLog.domainFiles": "Fișiere",
