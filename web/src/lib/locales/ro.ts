...
const ro: Partial<Translations> = {
  ...
  "settings.dashTileCa": "Ar putea fi disponibil și în Community Applications — căutați BombVault Dashboard.",
  "settings.dashTileNotInstalled": "Pluginul dalei de panou nu este instalat.",
  "settings.dashTileConfirm": "Instalează instalează pluginul bombvault-dashboard pe gazda dvs. Unraid prin mecanismul obișnuit de pluginuri al Unraid. Apare la Plugins ca orice alt plugin și poate fi eliminat de acolo (sau de aici) oricând.",
