...
const ro: Partial<Translations> = {
  ...
  "settings.labelsHint": "Cât se afișează dintr-un control: cuvintele, simbolul sau ambele. Butoanele păstrează aceeași lățime în toate cele trei cazuri, deci comutarea nu rearanjează pagina.",
