...
const ro: Partial<Translations> = {
  ...
  "settings.offsiteHint": "După fiecare backup local reușit, replică-l și într-un al doilea depozit cu restic copy. Introdu un depozit la distanță (rest:http://host:8000/repo, s3:…) sau o subcale locală; lasă gol pentru a dezactiva. Backupul local rămâne principal.",
  "source.label": "Sursă:",
  "source.local": "Local",
  ...
  "pull.repoLocationHint": "Depozitul instanței sursă: rest:, s3:, sftp:, ori o subcale sub punctul de montare al gazdei. O locație rclone: este refuzată, pentru că rclone ar ajunge la ea prin remote-urile ACESTEI instanțe.",
  ...
  "pull.credsHint": "Datele de autentificare pentru spațiul pe care se află depozitul sursei: s3: sau un server rest: cu parolă. O preluare nu folosește niciodată datele acestei mașini, așa că o sursă care are nevoie de autentificare și nu are nimic ales aici este refuzată.",
  ...
  "repos.locationPlaceholder": "backups/cold sau s3:s3.eu-central-003.backblazeb2.com/bucket/path",
  "repos.locationHint": "Un folder sub montarea gazdei, sau un depozit restic la distanță precum s3:..., sftp:..., rest:... ori rclone:... În cel la distanță se scrie direct, fără o copie locală intermediară.",
  ...
  "repos.offPremises": "În afara sediului",
  ...
  // Timeline
  "timeline.deleteAsk": "Ștergi această copie de rezervă aici: {list}?",
  ...
  "timeline.onlyHere": "doar aici",
  "timeline.incomplete": "incomplet",
  "timeline.incompleteHint": "Nu toate discurile acestei rulări sunt aici, așa că acest loc nu este ales pentru o restaurare.",
  "timeline.snapshotMissing": "{place} nu mai are această copie de rezervă. Restaurezi din {next}?",
  "timeline.stackDirMissing": "Folderul proiectului nu este în {place}. Folosești starea din {home}?",
  // Direct repository
  ...
  "placement.older": "Copii mai vechi la {target}: {n}, văzute ultima dată {date}",
  "placement.noCopyYet": "{place}: nicio copie încă",
  "placement.notListedYet": "{place}: încă nelistat",

  // Removal
  "offsiteRemoval.delete": "Șterge în {target}",
  "offsiteRemoval.ask": "Ștergi fiecare copie a {name} din {target}? Copii: {n}.",
  "offsiteRemoval.onlyThere": "Aceste instantanee nu există nicăieri altundeva și dispar definitiv după aceea:",
