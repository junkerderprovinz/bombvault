...
const uk: Partial<Translations> = {
  ...
  "notify.unraidPlatformMismatch": "BombVault визначив цей хост як \"{platform}\", а не як Unraid — сповіщення Unraid залишаються вимкненими, навіть якщо цю опцію увімкнено. Якщо це СПРАВДІ хост Unraid, перевірте, що шлях /boot контейнера змонтовано (bind-mount) до /host/boot (див. шаблон Unraid для BombVault), і перезапустіть контейнер.",
