...
const uk: Partial<Translations> = {
  ...
  "settings.everythingOverlapWarning": "Це працює незалежно від розкладів окремих доменів вище. Якщо увімкнено обидва, контейнери, віртуальні машини, Flash, папки та автобекап резервуються двічі кожен — один раз тут, один раз за власним розкладом. Вимкни домени, які не хочеш дублювати.",
