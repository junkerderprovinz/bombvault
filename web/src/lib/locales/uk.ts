...
const uk: Partial<Translations> = {
  ...
  "settings.discoHint": "Кожен колірний рядок і елемент раз на секунду переходить до наступного кольору палітри, поки увімкнено режим веселки.",
  ...
  "auth.recoveryLeft": "Залишилося {n} резервних кодів",
  "auth.recoverySaved": "Я їх записав",
  "auth.disableCodePrompt": "Введи поточний код, щоб вимкнути",
  "auth.passwordMinHint": "Щонайменше {n} символів.",
  ...
  "pull.snapshotsPulled": "Стягнуто копій: {n}",
  "pull.nothingNew": "Немає нічого нового для стягування.",
  "pull.pulled": "Стягнуто {n} копій.",
