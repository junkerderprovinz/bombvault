...
const uk: Partial<Translations> = {
  ...
  "about.body": "Один лицар, один похід: вільні, гарні на вигляд інструменти з відкритим кодом, яких у тому вигляді, в якому я їх хотів, не було. Будується, доки нічого не бракуватиме. Жодних облікових записів, жодної телеметрії, жодної реклами. Жодного пробного періоду, жодних тарифів, жодної зірочки дрібним шрифтом. Нічого читабельного ніколи не залишає твоїх мурів. Викувано вечорами та у вихідні, з серцем і впертістю.",
  "about.coffee": "Якщо BombVault стає тобі у пригоді, пожертва покриває те, що коштує його утримання: домен, сервер і вечори, які в нього йдуть. А ще від неї серце цього лицаря б'ється трохи швидше. Нижче є три шляхи, бери той, що тобі до вподоби.",
