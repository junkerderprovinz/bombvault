...
const uk: Partial<Translations> = {
  ...
  "excludes.assistPathsUnavailable": "Теки резервної копії цього контейнера зараз недоступні, і немає резервної копії, з якої можна прочитати розміри. Перевірте, чи змонтовано масив або спільний ресурс із цими теками.",
