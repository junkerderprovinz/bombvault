...
const uk: Partial<Translations> = {
  ...
  "folders.resetConfirm": "Скинути вибір папок? Контейнер повернеться до автоматичного виявлення (замовчування appdata), а всі запам'ятовані виключення буде вилучено.",
