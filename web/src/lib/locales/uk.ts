...
const uk: Partial<Translations> = {
  ...
  "ransomware.replicationPaused": "зовнішнє копіювання призупинено: підтвердьте розміщення",
  ...
  "repos.offPremises": "Поза приміщенням",
  "repos.offPremisesHint": "Враховується як окреме місце для підрахунку місць і правила 3-2-1 на картках. На копії це не впливає. На rest-server у тій самій будівлі це слід вимкнути.",
  ...
  "placementCode.invalid": "Цей вибір розміщення недійсний.",
  "placementCode.copiesNotAllowed": "Елемент у віддаленому або прямому репозиторії не отримує копій.",
  "placementCode.unknownTarget": "Ця віддалена ціль не існує в цьому домені.",
  "placementCode.stackRule": "Папки проєкту слідують типовому значенню контейнерів і не мають власного правила.",
  "placementCode.copyRuleTaken": "Це ім'я вже має власні правила копіювання. Спершу скинь їх там.",
  "placementCode.domainBusy": "Триває резервне копіювання. Обери знову, коли воно завершиться.",
  "placementCode.hasBackups": "Розташування більше не можна змінити, щойно елемент матиме резервні копії. Вони залишаються там, куди були записані.",
  "placementCode.homeUncheckable": "Не вдалося перевірити, чи має цей елемент резервні копії, тому його розташування залишається таким, як є. Спробуй знову, коли репозиторій можна буде прочитати.",
  "placementCode.stale": "Числа змінилися відтоді, як були показані. Перевір їх знову.",
  "placementCode.repoInvalid": "Цей репозиторій відсутній, вимкнений або не може бути розв'язаний.",
  "placementCode.repoInUseDefault": "Значення за замовчуванням для {domains} вказує на цей репозиторій. Спочатку зміни значення за замовчуванням.",
  "placementCode.defaultRepoMissing": "Типове значення у файлі вказує на репозиторій, якого немає ні у файлі, ні тут.",
  "placementCode.nestedLocation": "Це розташування лежить усередині іншого репозиторію чи цілі, або містить такий.",
  ...
  "placement.titleHint": "Куди записуються резервні копії цього елемента і куди вони копіюються потім. Розташування фіксується від першого резервного копіювання, копії можна змінювати будь-коли.",
  "placement.unreadable": "Не вдалося прочитати розміщення",
  "placement.noCopyNow": "Зараз копії немає, вимкнено: {targets}. Постав галочку на цілі або вибери Локально.",
  "placement.followsDefault": "Слідує значенню за замовчуванням",
  "placement.ownCopies": "Власні копії",
  "placement.homeSet": "Розташування задано: {home}",
  "placement.copiesFollow": "Копії слідують значенню за замовчуванням",
  "placement.reset": "Скинути",
  ...
  // Timeline
  "timeline.deleteAsk": "Видалити цю резервну копію тут: {list}?",
  ...
  "timeline.onlyHere": "лише тут",
  "timeline.incomplete": "неповний",
  "timeline.incompleteHint": "Не всі диски цього запуску тут, тому це місце не вибирається для відновлення.",
  "timeline.snapshotMissing": "{place} більше не має цієї резервної копії. Відновити з {next}?",
  "timeline.stackDirMissing": "Папки проєкту немає в {place}. Використати стан із {home}?",
  // Direct repository
  ...
  "placementDefaults.homeOff": "{home} вимкнено. Елементи без розташування не резервуються, доки його знову не увімкнуть або значення за замовчуванням не зміниться.",
  "placementDefaults.homeMissing": "Значення за замовчуванням вказує на сховище, якого вже не існує. Елементи без розташування не резервуються.",
  "placementDefaults.confirmHome": "Нові елементи в {domain} переймають {home} при першому резервному копіюванні. Елементи з розташуванням зберігають його.",
  "placementDefaults.dropAsk": "Елементи та папки проєктів, які {target} більше не отримує: {n}. Копії, що там лишаються: {copies}.",
  "placementDefaults.dropAskUnknown": "Елементи та папки проєктів, які {target} більше не отримує: {n}. {target} ніколи не був у списку для цього домену, тому скільки копій там лишається, ще не відомо.",
  "placementDefaults.addAsk": "Елементи та папки проєктів, які {target} отримує відтепер: {n}. Знімки, завантажені під час наступного запуску: не більше {snapshots}.",
  "placementDefaults.openTakeHome": "Елементи без розташування, які переймають {home} при першому резервному копіюванні: {n}.",
  "placementDefaults.apply": "Застосувати до елементів без резервних копій",
  "placementDefaults.applyAsk": "Розташування та копії повертаються до значення за замовчуванням для цих елементів: {n}.",
  "placementDefaults.applyLoses": "Втрачають при цьому власний вибір: {list}",
  "placementDefaults.applyKeptBackups": "Залишаються без змін, мають резервні копії: {list}",
  "placementDefaults.applyKeptUnreadable": "Залишаються без змін, їхнє розташування не вдалося прочитати: {list}",
  "placementDefaults.applyKeptChanged": "Тим часом змінилися й лишилися незачепленими: {list}",
  "placementDefaults.applyNone": "Жоден елемент без резервних копій не відрізняється від значення за замовчуванням.",
  "placementDefaults.applyBusy": "Виконується резервне копіювання. Застосуйте знову, коли воно завершиться.",
  "placementDefaults.paused": "Зовнішнє призупинено після перебудови",
  "placementDefaults.pausedHint": "Правила та значення за замовчуванням було втрачено разом зі старою конфігурацією. З {domain} нічого не копіюється назовні, доки це значення за замовчуванням не підтверджено. Елементи з карткою можна спершу встановити на Локально.",
  "placementDefaults.confirm": "Підтвердити значення за замовчуванням",
  "placementDefaults.confirmAsk": "Під час наступного запуску буде скопійовано це:",
  "placementDefaults.unmatched": "Імена в резервних копіях без запису тут. Позначені лишаються осторонь:",
  "placementDefaults.unmatchedLine": "{name}, знімки: {n}",
  "placementDefaults.confirmed": "Значення за замовчуванням підтверджено. Зовнішні копії відновляться під час наступного запуску.",
  ...
  "placement.older": "Старіші копії в {target}: {n}, востаннє бачено {date}",
  "placement.noCopyYet": "{place}: копії ще немає",
  "placement.notListedYet": "{place}: ще не у списку",

  // Removal
  "offsiteRemoval.delete": "Видалити в {target}",
  "offsiteRemoval.ask": "Видалити кожну копію {name} в {target}? Копій: {n}.",
  "offsiteRemoval.onlyThere": "Ці знімки більше ніде не існують і після цього зникнуть назавжди:",
