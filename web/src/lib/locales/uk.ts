...
const uk: Partial<Translations> = {
  ...
  "takeover.backup": "1 копія",
  "takeover.backups": "{n} копій",
  ...
  "takeover.historyOne": "Резервна копія {old} стане частиною історії {new}.",
  "takeover.historyMany": "Резервні копії {old} (усього {n}) стануть частиною історії {new}.",
  ...
  "settings.discoHint": "Кожен колірний рядок і елемент плавно переходить до наступного кольору палітри, по одному кожні три секунди, поки увімкнено режим веселки.",
