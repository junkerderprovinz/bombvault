...
const uk: Partial<Translations> = {
  ...
  "repos.itemHint": "Куди йдуть копії цього запису. Залиште репозиторій домену, якщо саме цьому запису не потрібен власний; звичайна причина - великий, рідко змінюваний запис, від якого потрібна лише копія поза майданчиком. У списку те, що ви створили в Налаштуваннях. Зовнішня реплікація не копіює вдруге віддалений репозиторій або позначений як уже поза майданчиком.",
  ...
  "repos.offsite": "Уже поза майданчиком",
  "repos.offsiteHint": "Для спільної теки на іншій машині, наприклад NAS для холодного зберігання. Зовнішня реплікація тоді пропускає цей репозиторій, як і віддалений, і його копії не копіюються вдруге. Для диска чи спільної теки на цій машині залиште вимкненим: їм копія поза майданчиком і далі потрібна.",
  "repos.offsiteRemote": "поза майданчиком",
  "repos.offsiteRemoteHint": "Віддалений репозиторій уже поза майданчиком, тож зовнішня реплікація ніколи не копіює його повторно.",
