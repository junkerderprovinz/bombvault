...
const uk: Partial<Translations> = {
  ...
  "settings.offsiteHint": "Після кожного успішного локального резервного копіювання також реплікувати його у другий репозиторій командою restic copy. Вкажіть віддалений репозиторій (rest:http://host:8000/repo, s3:…) або локальний підшлях; залиште порожнім, щоб вимкнути. Локальна копія залишається основною.",
  ...
  "pull.repoLocationHint": "Репозиторій екземпляра-джерела: rest:, s3:, sftp:, чи підшлях під точкою монтування хоста. Розташування rclone: відхиляється, бо rclone дістався б до нього через віддалені сховища ЦЬОГО екземпляра.",
  ...
  "pull.credsHint": "Дані для входу до сховища, на якому лежить репозиторій джерела: s3: або сервер rest: з паролем. Забирання ніколи не використовує дані цієї машини, тож джерело, якому потрібен вхід і для якого тут нічого не вибрано, буде відхилено.",
  ...
  "repos.locationPlaceholder": "backups/cold або s3:s3.eu-central-003.backblazeb2.com/bucket/path",
  "repos.locationHint": "Тека під точкою монтування хоста або віддалений репозиторій restic на кшталт s3:..., sftp:..., rest:... чи rclone:... У віддалений пишеться напряму, без проміжної локальної копії.",
  ...
  "placementCode.copyRuleTaken": "Це ім'я вже має власні правила копіювання.",
