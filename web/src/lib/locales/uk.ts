...
const uk: Partial<Translations> = {
  ...
  "update.afterBackupOrphans":
    "Docker залишає образ, на якому контейнер працював раніше, тепер без тегу, і Unraid показує його як осиротілий образ. Це звичайний залишок УСПІШНОГО оновлення, а не слід невдалого, і саме він потрібен для швидкого повернення до попереднього образу. Видаляйте їх коли завгодно.",
