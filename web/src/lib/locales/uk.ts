...
const uk: Partial<Translations> = {
  ...
  "settings.labelsHint": "Скільки показувати з елемента керування: його слова, його символ або і те, і інше. Кнопки в усіх трьох випадках зберігають однакову ширину, тож перемикання не перебудовує сторінку.",
