...
const uk: Partial<Translations> = {
  ...
  "settings.dashTileCa": "Можливо, він також доступний у Community Applications — шукайте BombVault Dashboard.",
  "settings.dashTileNotInstalled": "Плагін плитки панелі не встановлено.",
  "settings.dashTileConfirm": "«Встановити» встановлює плагін bombvault-dashboard на ваш хост Unraid через звичайний механізм плагінів Unraid. Він з'являється в розділі Plugins, як будь-який інший плагін, і його можна видалити там (або тут) у будь-який момент.",
