...
const uk: Partial<Translations> = {
  ...
  "files.empty": "Наборів файлів поки немає. Додайте папку — шари, документи, фото, будь-що у ваших точках монтування — і BombVault захистить її, як і все інше: розклади, зовнішні копії, перевірки цілісності та відновлення. Окремий інструмент для резервного копіювання файлів не потрібен.",
  "files.addSet": "Додати набір файлів",
  "files.editSet": "Змінити набір файлів",
  "files.name": "Назва",
  "files.path": "Папка",
  ...
  "files.deleteSetConfirm": "Видалити цей набір файлів зі списку? Його резервні копії не видаляються, і їх можна буде знайти знову пізніше.",
  "files.deleteBackupsConfirm": "Видалити ВСІ резервні копії цього набору файлів? Знімки буде безповоротно видалено, репозиторій очищено, а набір забуто. Це не можна скасувати.",
  ...
  "recovery.foreignIntro": "Витягайте окремі контейнери, ВМ або набори файлів із резервних копій ІНШОГО екземпляра BombVault: підключіться лише для читання, перегляньте вміст і відновіть вибране. Інший репозиторій лише читається, там нічого не змінюється — а ваші власні налаштування резервного копіювання залишаються недоторканими.",
