...
const tr: Partial<Translations> = {
  ...
  "settings.dashTileCa": "Community Applications'ta da bulunabilir — BombVault Dashboard diye aratın.",
  "settings.dashTileNotInstalled": "Kontrol paneli kutucuğu eklentisi kurulu değil.",
  "settings.dashTileConfirm": "Kur, bombvault-dashboard eklentisini Unraid'in olağan eklenti mekanizmasıyla Unraid ana makinenize kurar. Diğer tüm eklentiler gibi Plugins altında görünür ve oradan (veya buradan) istediğiniz zaman kaldırılabilir.",
