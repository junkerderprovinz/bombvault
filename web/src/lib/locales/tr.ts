...
const tr: Partial<Translations> = {
  ...
  "offsite.replicatingSnapshotPercentWithDuration": "Anlık görüntü {index}/{total} çoğaltılıyor (%{percent}) · {duration}",
  ...
  "activityLog.lineOffsiteRunningSnapshotPercent": "Site dışı yükleme — {domain} … anlık görüntü {index}/{total} (%{percent})",
  "activityLog.lineOffsiteRunningSnapshotPercentWithDuration": "Site dışı yükleme — {domain} … anlık görüntü {index}/{total} (%{percent}) · {duration}",
  ...
  "schedule.overrideHint": "Boş, kategori zamanlamasını kullanır. Öğe başına geçersiz kılmalar her N günde bir modunu desteklemez.",
