...
const tr: Partial<Translations> = {
  ...
  "takeover.historyOne": "{old} girişinin yedeği {new} girişinin geçmişine katılır.",
  "takeover.historyMany": "{old} girişinin {n} yedeği {new} girişinin geçmişine katılır.",
