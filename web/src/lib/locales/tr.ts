...
const tr: Partial<Translations> = {
  ...
  "settings.offsiteHint": "Her başarılı yerel yedeklemeden sonra, restic copy ile ikinci bir depoya da kopyalanır. Bir uzak depo (rest:http://host:8000/repo, s3:…) veya yerel bir alt yol girin; devre dışı bırakmak için boş bırakın. Yerel yedek birincil olarak kalır.",
  "source.label": "Kaynak:",
  "source.local": "Yerel",
  ...
  "pull.repoLocationHint": "Kaynak örneğin deposu: rest:, s3:, sftp:, veya ana bağlama noktası altındaki bir alt yol. rclone: konumu kabul edilmez, çünkü rclone oraya BU örneğin uzak tanımlarıyla bağlanır.",
  ...
  "pull.credsHint": "Kaynağın deposunun üzerinde durduğu depolama alanının oturum bilgileri: s3: veya parolalı bir rest: sunucusu. Çekme işlemi bu makinenin kendi bilgilerini asla kullanmaz, bu yüzden oturum açması gereken ve burada hiçbir şey seçilmemiş bir kaynak reddedilir.",
  ...
  "repos.locationPlaceholder": "backups/cold veya s3:s3.eu-central-003.backblazeb2.com/bucket/path",
  "repos.locationHint": "Ana makine bağlama noktası altındaki bir klasör ya da s3:..., sftp:..., rest:... veya rclone:... gibi uzak bir restic deposu. Uzağa doğrudan yazılır, arada yerel kopya olmadan.",
  ...
  "repos.offPremises": "Bina dışında",
  ...
  "placement.titleHint": "Bu ögenin yedeklerinin nereye yazıldığı ve sonra nereye kopyalandığı. Konum ilk yedeklemeden itibaren sabittir, kopyalar her zaman değiştirilebilir.",
  "placement.unreadable": "Yerleşim okunamadı",
  "placement.noCopyNow": "Şu anda kopya yok, kapalı: {targets}. Bir hedefi işaretle veya Yerel'i seç.",
  "placement.followsDefault": "Varsayılanı izler",
  "placement.ownCopies": "Kendi kopyaları",
  "placement.homeSet": "Konum ayarlandı: {home}",
  "placement.copiesFollow": "Kopyalar varsayılanı izler",
  "placement.reset": "Sıfırla",
  ...
  // Timeline
  "timeline.deleteAsk": "Bu yedek burada silinsin mi: {list}?",
  ...
  "timeline.onlyHere": "yalnızca burada",
  "timeline.incomplete": "eksik",
  "timeline.incompleteHint": "Bu çalıştırmanın tüm diskleri burada değil, bu yüzden bu yer geri yükleme için seçilmiyor.",
  "timeline.snapshotMissing": "{place} bu yedeğe artık sahip değil. {next} konumundan geri yüklensin mi?",
  "timeline.stackDirMissing": "Proje klasörü {place} içinde değil. {home} durumunu kullan?",
  // Direct repository
  ...
  "placementDefaults.homeOff": "{home} kapalı. Konumu olmayan ögeler, tekrar açılana veya varsayılan değişene kadar yedeklenmez.",
  "placementDefaults.homeMissing": "Varsayılan, artık var olmayan bir depoyu gösteriyor. Konumu olmayan ögeler yedeklenmez.",
  "placementDefaults.confirmHome": "{domain} içindeki yeni ögeler ilk yedeklemelerinde {home} konumunu devralır. Konumu olan ögeler onu korur.",
  "placementDefaults.dropAsk": "{target} tarafından artık alınmayan ögeler ve proje klasörleri: {n}. Orada kalan kopyalar: {copies}.",
  "placementDefaults.dropAskUnknown": "{target} tarafından artık alınmayan ögeler ve proje klasörleri: {n}. {target} bu alan için hiç listelenmemişti, bu yüzden orada kaç kopya kaldığı henüz bilinmiyor.",
  "placementDefaults.addAsk": "{target} tarafından bundan böyle alınan ögeler ve proje klasörleri: {n}. Bir sonraki çalıştırmada yüklenecek anlık görüntüler: en fazla {snapshots}.",
  "placementDefaults.openTakeHome": "İlk yedeklemesinde {home} konumunu devralacak, konumu olmayan ögeler: {n}.",
  "placementDefaults.apply": "Yedeksiz ögelere uygula",
  "placementDefaults.applyAsk": "Bu ögeler için konum ve kopyalar varsayılana döner: {n}.",
  "placementDefaults.applyLoses": "Bu sırada kendi seçimini kaybeder: {list}",
  "placementDefaults.applyKeptBackups": "Oldukları gibi kalır, yedekleri var: {list}",
  "placementDefaults.applyKeptUnreadable": "Oldukları gibi kalır, konumları okunamadı: {list}",
  "placementDefaults.applyKeptChanged": "Bu arada değişti ve dokunulmadan bırakıldı: {list}",
  "placementDefaults.applyNone": "Yedeksiz hiçbir öge varsayılandan farklı değil.",
  "placementDefaults.applyBusy": "Bir yedekleme çalışıyor. Bittikten sonra tekrar uygulayın.",
  "placementDefaults.paused": "Yeniden kurulumdan sonra site dışı duraklatıldı",
  "placementDefaults.pausedHint": "Kurallar ve varsayılanlar eski yapılandırmayla birlikte kayboldu. Bu varsayılan onaylanana kadar {domain} alanından hiçbir şey site dışına kopyalanmaz. Kartlı ögeler önce Yerel olarak ayarlanabilir.",
  "placementDefaults.confirm": "Varsayılanı onayla",
  "placementDefaults.confirmAsk": "Bir sonraki çalıştırmada şu kopyalanır:",
  "placementDefaults.unmatched": "Yedeklerde burada karşılığı olmayan adlar. İşaretlenenler dışarıda bırakılır:",
  "placementDefaults.unmatchedLine": "{name}, anlık görüntüler: {n}",
  "placementDefaults.confirmed": "Varsayılan onaylandı. Site dışı kopyalar bir sonraki çalıştırmada devam eder.",
  ...
  "placement.older": "{target} konumundaki daha eski kopyalar: {n}, son görülme {date}",
  "placement.noCopyYet": "{place}: henüz kopya yok",
  "placement.notListedYet": "{place}: henüz listelenmedi",

  // Removal
  "offsiteRemoval.delete": "{target} içinde sil",
  "offsiteRemoval.ask": "{target} içindeki her {name} kopyası silinsin mi? Kopyalar: {n}.",
  "offsiteRemoval.onlyThere": "Bu anlık görüntüler başka hiçbir yerde yok ve bundan sonra kalıcı olarak kaybolur:",
