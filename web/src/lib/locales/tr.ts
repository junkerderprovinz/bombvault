...
const tr: Partial<Translations> = {
  ...
  "about.body": "Tek bir şövalye, tek bir sefer: istediğim biçimde var olmayan, özgür, güzel görünen açık kaynaklı araçlar. Eksik bir şey kalmayana kadar yapılıyor. Hesap yok, telemetri yok, reklam yok. Deneme süresi yok, ücretli paket yok, küçük puntolu yıldız yok. Okunabilir hiçbir şey kendi surlarının dışına çıkmıyor. Akşamları ve hafta sonları dövüldü, yürekle ve inatla.",
  "about.coffee": "BombVault işine yarıyorsa, bir bağış ayakta kalmasının masrafını karşılar: alan adını, sunucuyu ve ona giden akşamları. Üstelik bu şövalyenin kalbini de biraz daha hızlı çarptırır. Aşağıda üç yol var, hangisi sana uyuyorsa onu seç.",
