...
const tr: Partial<Translations> = {
  ...
  "repos.itemHint": "Bu ögenin yedekleri nereye gidiyor. Tam da bu öge kendine ait bir depoya ihtiyaç duymuyorsa alanın deposunda bırakın; olağan sebep, seyrek değişen büyük bir öge ve ondan yalnızca tesis dışı bir kopya istenmesidir. Listede Ayarlar'da oluşturduklarınız yer alır. Site dışı çoğaltma, uzak bir depoyu ya da zaten site dışında diye işaretlenmiş bir depoyu ikinci kez kopyalamaz.",
  ...
  "repos.offsite": "Zaten site dışında",
  "repos.offsiteHint": "Başka bir makinedeki paylaşım için, örneğin soğuk depolama olarak kullanılan bir NAS. Site dışı çoğaltma bu depoyu da uzak bir depo gibi dışarıda bırakır ve yedekleri ikinci kez kopyalanmaz. Bu makinedeki bir disk ya da paylaşım için kapalı bırakın, onların site dışı kopyaya hâlâ ihtiyacı var.",
  "repos.offsiteRemote": "site dışında",
  "repos.offsiteRemoteHint": "Uzak bir depo zaten site dışındadır, bu yüzden site dışı çoğaltma onu asla yeniden kopyalamaz.",
