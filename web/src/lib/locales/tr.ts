...
const tr: Partial<Translations> = {
  ...
  "settings.everythingOverlapWarning": "Bu, yukarıdaki alan bazlı zamanlamalardan bağımsız çalışır. İkisi de açıksa konteynerler, VM'ler, flash, klasörler ve öz yedek her biri iki kez yedeklenir. Biri burada, biri kendi zamanlamasında. Yinelenmesini istemediğin alanları kapat.",
