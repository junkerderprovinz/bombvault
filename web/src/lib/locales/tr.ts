...
const tr: Partial<Translations> = {
  ...
  "dbdump.introNotice": "BombVault her yedeklemeden önce {count} tanınan veritabanının dökümünü alıyor, kendi başlarına geri yükleme noktaları olarak. Bunu konteyner bazında kartından ya da tüm konteynerler için Ayarlar'dan kapatabilirsin.",
  ...
  "dbdump.fixRepository": "Yedek deposu dökümü kabul etmedi ya da dökülenden daha az bayt sakladı. Depoyu Ayarlar, Depolama bölümünde denetle; döküm bir sonraki yedeklemede yeniden denenir.",
  ...
  "recovery.dumpOnlySkipped": "Yalnızca döküm olarak saklanan {count} veritabanı dışarıda bırakılır; onları kendi listelerinden geri yükleyip içe aktar.",
