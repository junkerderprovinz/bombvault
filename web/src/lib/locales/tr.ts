...
const tr: Partial<Translations> = {
  ...
  "settings.labelsHint": "Bir denetimin ne kadarının gösterileceği: sözcükleri, simgesi ya da her ikisi. Düğmeler üçünde de aynı genişlikte kalır, bu yüzden geçiş sayfayı yeniden dizmez.",
  ...
  "settingsIO.chooseFile": "Bir ayar dosyası seçin",
