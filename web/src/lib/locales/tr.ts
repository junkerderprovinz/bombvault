...
const tr: Partial<Translations> = {
  ...
  "files.empty": "Henüz dosya seti yok. Bir klasör ekleyin — paylaşımlar, belgeler, fotoğraflar, bağlama noktalarınızın altındaki her şey — BombVault onu diğer her şey gibi korur: zamanlamalar, site dışı kopyalar, bütünlük denetimleri ve geri yüklemeler. Ayrı bir dosya yedekleme aracına gerek yok.",
  "files.addSet": "Dosya seti ekle",
  "files.editSet": "Dosya setini düzenle",
  "files.name": "Ad",
  "files.path": "Klasör",
  ...
  "files.deleteSetConfirm": "Bu dosya seti listeden kaldırılsın mı? Yedekleri silinmez ve daha sonra yeniden keşfedilebilir.",
  "files.deleteBackupsConfirm": "Bu dosya setinin TÜM yedekleri silinsin mi? Anlık görüntüler kalıcı olarak kaldırılır, depo budanır ve set unutulur. Geri alınamaz.",
  ...
  "activityLog.domainFiles": "Dosyalar",
