...
const tr: Partial<Translations> = {
  ...
  "settings.everythingHint": "Her alanı sırayla bir kez çalıştırır (konteynerler, VM'ler, flash, klasörler ve son olarak öz yedek), böylece sonrasında tek bir ping (aşağıdaki post komutuyla) tüm sunucunun korunduğunu doğrular. Varsayılan olarak kapalıdır ve yukarıdaki her alanın kendi zamanlamasından bağımsızdır.",
  "settings.everythingDuplicateWarning": "Bu zamanlama ile kendi zamanlamaları aynı anda açıkken konteynerler, VM'ler, flash, klasörler ve öz yedek iki kez yedeklenir: bir kez burada, bir kez de kendi zamanlamalarında. Yedeğinin ikiye katlanmasını istemediğiniz alanları kapatın.",
