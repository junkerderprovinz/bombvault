...
const tr: Partial<Translations> = {
  ...
  "dbdump.stackRestoreWarn": "{names} verileri yığın çalışırken kopyalanıyor. Geri yüklemeden sonra, uygulamaları kullanmadan önce en son veritabanı dökümlerini içe aktar.",
  "dbdump.introNotice": "BombVault her yedeklemeden önce tanıdığı veritabanlarının dökümünü alıyor, kendi başlarına geri yükleme noktaları olarak. Burada tanınan: {count}, ilki {name}. Bunu konteyner bazında kartından ya da tüm konteynerler için Ayarlar'dan kapatabilirsin.",
  ...
  "dbdump.importStopsOne": "Aktarma sürerken BombVault {app} uygulamasını da durdurur ve ardından yeniden başlatır. Yalnızca aktarma başarısız olur ve eski veriler geri konamazsa durdurulmuş kalır.",
  "dbdump.importStopsMany": "Aktarma sürerken BombVault şu uygulamaları da durdurur: {apps}. Ardından onları yeniden başlatır. Yalnızca aktarma başarısız olur ve eski veriler geri konamazsa durdurulmuş kalırlar.",
  ...
  "recovery.foreignDbDumps": "Bu depodaki veritabanı dökümleri: {count}. Kurtarma kitinin anlattığı gibi restic komut satırıyla bir tanesini çek.",
  ...
  "recovery.dumpOnlySkipped": "Yalnızca döküm olarak saklanan veritabanları burada dışarıda bırakılır: {count}. Onları kendi listelerinden geri yükleyip içe aktar.",
