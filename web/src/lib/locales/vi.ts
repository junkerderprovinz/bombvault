...
const vi: Partial<Translations> = {
  ...
  "settings.labelsHint": "Hiển thị bao nhiêu của một điều khiển: chữ, biểu tượng, hay cả hai. Nút giữ nguyên chiều rộng trong cả ba, nên chuyển đổi không xáo trộn trang.",
