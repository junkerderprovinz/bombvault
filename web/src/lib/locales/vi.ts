...
const vi: Partial<Translations> = {
  ...
  "about.body": "Một hiệp sĩ, một cuộc thập tự chinh: những công cụ tự do, mã nguồn mở và đẹp mắt mà trước đó chưa từng có ở hình hài tôi muốn. Làm cho đến khi không còn thiếu gì. Không tài khoản, không đo từ xa, không quảng cáo. Không dùng thử, không gói trả phí, không dấu sao trong dòng chữ nhỏ. Không có gì đọc được rời khỏi những bức tường của bạn. Được rèn vào buổi tối và cuối tuần, bằng trái tim và sự bướng bỉnh.",
  "about.coffee": "Nếu BombVault có ích cho bạn, một khoản đóng góp trang trải chi phí để nó tiếp tục chạy: tên miền, máy chủ và những buổi tối dành cho nó. Và nó cũng làm trái tim của hiệp sĩ này đập nhanh hơn một chút. Bên dưới có ba cách, chọn cách nào hợp với bạn.",
