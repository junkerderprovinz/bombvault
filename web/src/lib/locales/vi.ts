...
const vi: Partial<Translations> = {
  ...
  "settings.everythingHint": "Chạy từng miền một lần, theo thứ tự (containers, VMs, flash, thư mục, rồi đến tự sao lưu) để một lần ping duy nhất sau đó (qua lệnh post bên dưới) xác nhận toàn bộ máy chủ đã được bảo vệ. Mặc định tắt, và độc lập với lịch trình riêng của từng miền ở trên.",
  "settings.everythingDuplicateWarning": "Containers, VMs, flash, thư mục và bản tự sao lưu sẽ được sao lưu hai lần khi lịch trình này và lịch trình riêng của chúng cùng bật: một lần ở đây và một lần theo lịch trình riêng. Hãy tắt những miền mà bạn không muốn sao lưu trùng lặp.",
