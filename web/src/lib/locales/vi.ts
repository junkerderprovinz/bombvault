...
const vi: Partial<Translations> = {
  ...
  "about.report": "Bạn tìm thấy điều gì đó hoặc thiếu điều gì đó? Hãy mở một issue trên GitHub hoặc gửi email. Phiên bản ở trên giúp ích trong cả hai trường hợp.",
  "about.repo": "Kho mã",
  "about.mail": "Viết email",
