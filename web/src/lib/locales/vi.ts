...
const vi: Partial<Translations> = {
  ...
  "settings.dashTileCa": "Plugin cũng có thể có trong Community Applications — hãy tìm BombVault Dashboard.",
  "settings.dashTileNotInstalled": "Plugin ô bảng điều khiển chưa được cài đặt.",
  "settings.dashTileConfirm": "Nút Cài đặt sẽ cài plugin bombvault-dashboard lên máy chủ Unraid của bạn qua cơ chế plugin thông thường của Unraid. Nó xuất hiện trong Plugins như mọi plugin khác và có thể gỡ bỏ ở đó (hoặc ở đây) bất cứ lúc nào.",
