...
const vi: Partial<Translations> = {
  ...
  "settings.everythingOverlapWarning": "Việc này chạy độc lập với lịch trình riêng của từng miền ở trên. Nếu cả hai đều bật, containers, VMs, flash, thư mục và tự sao lưu sẽ mỗi thứ được sao lưu hai lần. Một lần ở đây, một lần theo lịch trình riêng. Hãy tắt những miền bạn không muốn bị trùng lặp.",
