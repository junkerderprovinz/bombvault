...
const vi: Partial<Translations> = {
  ...
  "takeover.historyOne": "Bản sao lưu của {old} trở thành lịch sử của {new}.",
  ...
  "pull.snapshotsPulled": "Đã kéo {n} bản sao lưu",
  "pull.nothingNew": "Không có gì mới để kéo.",
  "pull.pulled": "Đã kéo {n} bản sao lưu.",
