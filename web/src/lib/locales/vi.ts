...
const vi: Partial<Translations> = {
  ...
  "files.empty": "Chưa có bộ tập tin nào. Thêm một thư mục — chia sẻ, tài liệu, ảnh, bất cứ thứ gì dưới các điểm gắn kết của bạn — và BombVault sẽ bảo vệ nó như mọi thứ khác: lịch trình, bản sao off-site, kiểm tra tính toàn vẹn và khôi phục. Không cần công cụ sao lưu tập tin riêng.",
  "files.addSet": "Thêm bộ tập tin",
  "files.editSet": "Sửa bộ tập tin",
  "files.name": "Tên",
  "files.path": "Thư mục",
  ...
  "files.deleteSetConfirm": "Gỡ bộ tập tin này khỏi danh sách? Các bản sao lưu của nó không bị xóa và có thể được phát hiện lại sau.",
  "files.deleteBackupsConfirm": "Xóa TẤT CẢ bản sao lưu của bộ tập tin này? Các snapshot bị xóa vĩnh viễn, kho được dọn bớt và bộ sẽ bị quên. Không thể hoàn tác.",
  ...
  "activityLog.domainFiles": "Tập tin",
