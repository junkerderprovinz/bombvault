...
const vi: Partial<Translations> = {
  ...
  "settings.offsiteHint": "Sau mỗi lần sao lưu cục bộ thành công, cũng sao chép nó sang kho thứ hai bằng restic copy. Nhập kho từ xa (rest:http://host:8000/repo, s3:…) hoặc một đường dẫn con cục bộ; để trống để tắt. Bản sao lưu cục bộ vẫn là chính.",
  "source.label": "Nguồn:",
  "source.local": "Cục bộ",
  ...
  "cloud.hint": "Thông tin đăng nhập cho các backend restic từ xa, không cần rclone. Sau khi lưu, đặt đường dẫn sao lưu tới một repo từ xa, ví dụ s3:s3.amazonaws.com/bucket/path, rest:http://host:8000/repo hoặc sftp:user@host:/repo. Bí mật được lưu mã hóa và không hiển thị lại.",
  ...
  "pull.repoLocationHint": "Kho của phiên bản nguồn: rest:, s3:, sftp:, hoặc một đường dẫn con dưới điểm gắn kết của host. Vị trí rclone: bị từ chối, vì rclone sẽ truy cập nó bằng các remote của CHÍNH phiên bản này.",
  ...
  "pull.credsHint": "Thông tin đăng nhập cho kho lưu trữ mà kho của nguồn nằm trên đó: s3: hoặc máy chủ rest: có mật khẩu. Việc kéo về không bao giờ dùng thông tin của máy này, nên một nguồn cần đăng nhập mà không chọn gì ở đây sẽ bị từ chối.",
  ...
  "repos.locationPlaceholder": "backups/cold hoặc s3:s3.eu-central-003.backblazeb2.com/bucket/path",
  "repos.locationHint": "Một thư mục dưới điểm gắn kết của máy chủ, hoặc kho restic từ xa như s3:..., sftp:..., rest:... hay rclone:... Ghi thẳng vào kho từ xa, không có bản sao cục bộ ở giữa.",
  ...
  "placementCode.copyRuleTaken": "Tên đó đã có quy tắc sao chép riêng.",
  ...
  "placement.titleHint": "Nơi sao lưu của mục này được ghi và nơi chúng được sao chép đến sau đó. Vị trí cố định kể từ bản sao lưu đầu tiên, các bản sao có thể thay đổi bất cứ lúc nào.",
  "placement.unreadable": "Không thể đọc nơi lưu trữ",
  "placement.noCopyNow": "Hiện không có bản sao, đã tắt: {targets}. Đánh dấu một đích hoặc chọn Cục bộ.",
  "placement.followsDefault": "Theo mặc định",
  "placement.ownCopies": "Bản sao riêng",
  "placement.homeSet": "Đã đặt vị trí: {home}",
  "placement.copiesFollow": "Các bản sao theo mặc định",
  "placement.reset": "Đặt lại",
  ...
  // Timeline
  "timeline.deleteAsk": "Xóa bản sao lưu này ở đây: {list}?",
  ...
  "timeline.onlyHere": "chỉ ở đây",
  "timeline.incomplete": "chưa đầy đủ",
  "timeline.incompleteHint": "Không phải tất cả các ổ đĩa của lần chạy này đều ở đây, vì vậy vị trí này không được chọn để khôi phục.",
  "timeline.snapshotMissing": "{place} không còn bản sao lưu này nữa. Khôi phục từ {next}?",
  "timeline.stackDirMissing": "Thư mục dự án không có trong {place}. Dùng trạng thái từ {home}?",
  // Direct repository
  ...
  "placementDefaults.homeOff": "{home} đang tắt. Các mục không có vị trí sẽ không được sao lưu cho đến khi bật lại hoặc mặc định thay đổi.",
  "placementDefaults.homeMissing": "Mặc định trỏ đến một kho lưu trữ không còn tồn tại. Các mục không có vị trí sẽ không được sao lưu.",
  "placementDefaults.confirmHome": "Mục mới trong {domain} sẽ nhận {home} ở lần sao lưu đầu tiên. Mục đã có vị trí sẽ giữ nguyên.",
  "placementDefaults.dropAsk": "Các mục và thư mục dự án mà {target} không còn nhận nữa: {n}. Bản sao vẫn còn ở đó: {copies}.",
  "placementDefaults.dropAskUnknown": "Các mục và thư mục dự án mà {target} không còn nhận nữa: {n}. {target} chưa từng được liệt kê cho miền này, nên chưa biết có bao nhiêu bản sao còn lại ở đó.",
  "placementDefaults.addAsk": "Các mục và thư mục dự án mà {target} sẽ nhận từ nay: {n}. Snapshot được tải lên ở lần chạy tiếp theo: nhiều nhất {snapshots}.",
  "placementDefaults.openTakeHome": "Các mục không có vị trí sẽ nhận {home} ở lần sao lưu đầu tiên: {n}.",
  "placementDefaults.apply": "Áp dụng cho các mục chưa có bản sao lưu",
  "placementDefaults.applyAsk": "Vị trí và bản sao sẽ trở về mặc định cho các mục này: {n}.",
  "placementDefaults.applyLoses": "Qua đó mất lựa chọn riêng: {list}",
  "placementDefaults.applyKeptBackups": "Giữ nguyên vì đã có bản sao lưu: {list}",
  "placementDefaults.applyKeptUnreadable": "Giữ nguyên vì không đọc được vị trí: {list}",
  "placementDefaults.applyKeptChanged": "Đã thay đổi trong lúc đó và được để yên: {list}",
  "placementDefaults.applyNone": "Không có mục nào chưa sao lưu khác với mặc định.",
  "placementDefaults.applyBusy": "Đang có một bản sao lưu chạy. Áp dụng lại sau khi nó hoàn tất.",
  "placementDefaults.paused": "Ngoài site tạm dừng sau khi xây dựng lại",
  "placementDefaults.pausedHint": "Quy tắc và giá trị mặc định đã mất cùng với cấu hình cũ. Không có gì từ {domain} được sao chép ra ngoài site cho đến khi mặc định này được xác nhận. Các mục có thẻ có thể được đặt thành Cục bộ trước.",
  "placementDefaults.confirm": "Xác nhận mặc định",
  "placementDefaults.confirmAsk": "Ở lần chạy tiếp theo, đây là những gì được sao chép:",
  "placementDefaults.unmatched": "Tên trong các bản sao lưu không có mục nhập ở đây. Tên đã đánh dấu sẽ bị bỏ qua:",
  "placementDefaults.unmatchedLine": "{name}, snapshot: {n}",
  "placementDefaults.confirmed": "Đã xác nhận mặc định. Bản sao ngoài site sẽ tiếp tục ở lần chạy tiếp theo.",
  ...
  "placement.older": "Bản sao cũ hơn tại {target}: {n}, thấy lần cuối {date}",
  "placement.noCopyYet": "{place}: chưa có bản sao",
  "placement.notListedYet": "{place}: chưa được liệt kê",

  // Removal
  "offsiteRemoval.delete": "Xóa tại {target}",
  "offsiteRemoval.ask": "Xóa mọi bản sao của {name} tại {target}? Số bản sao: {n}.",
  "offsiteRemoval.onlyThere": "Các bản chụp nhanh này không tồn tại ở nơi nào khác và sẽ biến mất vĩnh viễn sau đó:",
