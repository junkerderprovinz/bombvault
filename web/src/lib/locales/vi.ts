...
const vi: Partial<Translations> = {
  ...
  "repos.itemHint": "Bản sao lưu của mục này đi về đâu. Cứ để ở kho của miền trừ khi chính mục này cần kho riêng; lý do thường gặp là một mục lớn, ít thay đổi và chỉ cần một bản sao ngoài chỗ. Danh sách chứa những gì bạn đã tạo trong Cài đặt. Sao chép ngoài site không sao chép lần thứ hai một kho từ xa hoặc một kho được đánh dấu là đã ở ngoài chỗ.",
  ...
  "repos.offsite": "Đã ở ngoài chỗ",
  "repos.offsiteHint": "Dành cho thư mục chia sẻ trên máy khác, ví dụ một NAS dùng làm kho lạnh. Khi đó, sao chép ngoài site bỏ qua kho này, giống như một kho từ xa, và bản sao lưu của nó không bị sao chép lần thứ hai. Hãy để tắt cho ổ đĩa hoặc thư mục chia sẻ trên máy này, vì chúng vẫn cần bản sao ngoài chỗ.",
  "repos.offsiteRemote": "ngoài chỗ",
  "repos.offsiteRemoteHint": "Kho từ xa vốn đã ở ngoài chỗ, nên sao chép ngoài site không bao giờ sao chép lại nó.",
