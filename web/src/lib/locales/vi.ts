...
const vi: Partial<Translations> = {
  ...
  "dbdump.introNotice": "BombVault kết xuất {count} cơ sở dữ liệu đã nhận ra trước mỗi lần sao lưu, thành các điểm khôi phục riêng. Bạn có thể tắt việc này theo từng container trên thẻ của nó, hoặc cho mọi container trong Cài đặt.",
  ...
  "dbdump.fixRepository": "Kho sao lưu không nhận bản kết xuất, hoặc lưu ít byte hơn số đã kết xuất. Hãy kiểm tra kho trong Cài đặt, Lưu trữ; bản kết xuất sẽ được thử lại ở lần sao lưu sau.",
  ...
  "recovery.dumpOnlySkipped": "{count} cơ sở dữ liệu chỉ được giữ dưới dạng bản kết xuất bị bỏ qua; hãy khôi phục và nhập chúng từ danh sách riêng.",
