...
const vi: Partial<Translations> = {
  ...
  "dbdump.introNotice": "BombVault kết xuất các cơ sở dữ liệu nó nhận ra trước mỗi lần sao lưu, thành các điểm khôi phục riêng. Nhận ra ở đây: {count}, cái đầu tiên là {name}. Bạn có thể tắt việc này theo từng container trên thẻ của nó, hoặc cho mọi container trong Cài đặt.",
  ...
  "dbdump.importStopsOne": "Trong lúc nhập, BombVault cũng dừng {app}. Sau đó sẽ khởi động lại, trừ khi việc nhập thất bại và không thể đưa dữ liệu cũ trở lại.",
  "dbdump.importStopsMany": "Trong lúc nhập, BombVault cũng dừng các ứng dụng sau: {apps}. Sau đó sẽ khởi động lại, trừ khi việc nhập thất bại và không thể đưa dữ liệu cũ trở lại.",
  ...
  "recovery.foreignDbDumps": "Bản kết xuất cơ sở dữ liệu trong kho này: {count}. Lấy một bản bằng dòng lệnh restic như bộ công cụ khôi phục mô tả.",
  ...
  "recovery.dumpOnlySkipped": "Các cơ sở dữ liệu chỉ được giữ dưới dạng bản kết xuất bị bỏ qua ở đây: {count}. Hãy khôi phục và nhập chúng từ danh sách riêng.",
