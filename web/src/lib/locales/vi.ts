...
const vi: Partial<Translations> = {
  ...
  "offsite.replicatingSnapshotPercentWithDuration": "Đang sao chép ảnh chụp nhanh {index}/{total} ({percent}%) · {duration}",
  ...
  "activityLog.lineOffsiteRunningSnapshotPercent": "Đang tải lên ngoài site — {domain} … ảnh chụp nhanh {index}/{total} ({percent}%)",
  "activityLog.lineOffsiteRunningSnapshotPercentWithDuration": "Đang tải lên ngoài site — {domain} … ảnh chụp nhanh {index}/{total} ({percent}%) · {duration}",
