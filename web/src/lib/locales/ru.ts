...
const ru: Partial<Translations> = {
  ...
  "files.empty": "Наборов файлов пока нет. Добавьте папку — шары, документы, фото, что угодно в ваших точках монтирования — и BombVault защитит её, как и всё остальное: расписания, внешние копии, проверки целостности и восстановление. Отдельный инструмент для резервного копирования файлов не нужен.",
  "files.addSet": "Добавить набор файлов",
  "files.editSet": "Изменить набор файлов",
  "files.name": "Имя",
  "files.path": "Папка",
  ...
  "files.deleteSetConfirm": "Удалить этот набор файлов из списка? Его резервные копии не удаляются, и их можно будет найти заново позже.",
  "files.deleteBackupsConfirm": "Удалить ВСЕ резервные копии этого набора файлов? Снимки будут безвозвратно удалены, репозиторий очищен, а набор забыт. Отменить нельзя.",
