...
const ru: Partial<Translations> = {
  ...
  "settings.dashTileCa": "Возможно, он также доступен в Community Applications — ищите BombVault Dashboard.",
  "settings.dashTileNotInstalled": "Плагин плитки панели не установлен.",
  "settings.dashTileConfirm": "«Установить» устанавливает плагин bombvault-dashboard на ваш хост Unraid через обычный механизм плагинов Unraid. Он появляется в разделе Plugins, как любой другой плагин, и его можно удалить там (или здесь) в любой момент.",
