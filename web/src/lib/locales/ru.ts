...
const ru: Partial<Translations> = {
  ...
  "offsite.replicatingSnapshotPercentWithDuration": "Репликация снимка {index} из {total} ({percent}%) · {duration}",
  ...
  "activityLog.lineOffsiteRunningSnapshotPercent": "Загрузка во внешнее хранилище — {domain} … снимок {index} из {total} ({percent}%)",
  "activityLog.lineOffsiteRunningSnapshotPercentWithDuration": "Загрузка во внешнее хранилище — {domain} … снимок {index} из {total} ({percent}%) · {duration}",
  ...
  "schedule.overrideHint": "Пусто использует расписание категории. Переопределения по элементам не поддерживают режим каждые N дней.",
