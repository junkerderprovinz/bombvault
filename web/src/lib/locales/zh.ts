...
const zh: Partial<Translations> = {
  ...
  "settings.dashTileCa": "它也可能已上架 Community Applications — 搜索 BombVault Dashboard。",
  "settings.dashTileNotInstalled": "仪表板磁贴插件尚未安装。",
  "settings.dashTileConfirm": "点击安装会通过 Unraid 常规的插件机制在你的 Unraid 主机上安装 bombvault-dashboard 插件。它会像其他插件一样出现在 Plugins 中，随时可以在那里（或这里）移除。",
