...
const zh: Partial<Translations> = {
  ...
  "about.body": "一位骑士的远征：自由、好看的开源工具，此前并不存在于我想要的模样。一直建到什么都不缺为止。没有账户，没有遥测，没有广告。没有试用，没有付费档位，没有小字里的星号。任何可读的东西都不会离开你自己的城墙。在夜晚和周末锻造，带着心意和固执。",
  "about.coffee": "如果 BombVault 对你有用，一笔捐赠就能覆盖维持它运转的开销：域名、服务器，以及投入其中的夜晚。它也会让这位骑士的心跳得快一些。下面有三条路，挑你顺手的那条。",
