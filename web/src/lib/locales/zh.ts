...
const zh: Partial<Translations> = {
  ...
  "notify.unraidPlatformMismatch": "BombVault 检测到该主机是 “{platform}”，而不是 Unraid — 即使此选项已开启，Unraid 通知仍会保持关闭状态。如果这确实是 Unraid 主机，请检查容器的 /boot 路径是否已绑定挂载（bind-mount）到 /host/boot（参见 BombVault 的 Unraid 模板），然后重启容器。",
  "notify.save": "保存",
  "notify.test": "发送测试",
  "notify.tested": "测试已发送",
