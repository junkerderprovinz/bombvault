...
const zh: Partial<Translations> = {
  ...
  "offsite.replicatingSnapshotPercentWithDuration": "正在复制快照 {index}/{total}（{percent}%，{duration}）",
  ...
  "activityLog.lineOffsiteRunningSnapshotPercent": "异地上传 — {domain} … 快照 {index}/{total}（{percent}%）",
  "activityLog.lineOffsiteRunningSnapshotPercentWithDuration": "异地上传 — {domain} … 快照 {index}/{total}（{percent}%，{duration}）",
