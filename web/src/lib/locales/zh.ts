...
const zh: Partial<Translations> = {
  ...
  "files.empty": "还没有文件集。添加一个文件夹 — 共享、文档、照片，挂载点下的任何内容 — BombVault 会像保护其他内容一样保护它：计划任务、异地副本、完整性检查和恢复。无需单独的文件备份工具。",
  "files.addSet": "添加文件集",
  "files.editSet": "编辑文件集",
  "files.name": "名称",
  "files.path": "文件夹",
  ...
  "files.deleteSetConfirm": "从列表中移除此文件集？其备份不会被删除，之后可以重新发现。",
  "files.deleteBackupsConfirm": "删除此文件集的所有备份？快照将被永久移除，仓库将被清理，文件集将被遗忘。此操作无法撤销。",
