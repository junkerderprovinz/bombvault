...
const cs: Partial<Translations> = {
  ...
  "settings.labelsHint": "Kolik z ovládacího prvku se zobrazí: jeho text, jeho symbol nebo obojí. Tlačítka si ve všech třech případech zachovají stejnou šířku, přepnutí tedy stránku nepřeskládá.",
