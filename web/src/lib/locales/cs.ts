...
const cs: Partial<Translations> = {
  ...
  "files.empty": "Zatím žádné sady souborů. Přidejte složku — sdílení, dokumenty, fotky, cokoli pod vašimi připojeními — a BombVault ji ochrání jako všechno ostatní: plány, kopie mimo lokalitu, kontroly integrity a obnovy. Samostatný nástroj na zálohování souborů není potřeba.",
  "files.addSet": "Přidat sadu souborů",
  "files.editSet": "Upravit sadu souborů",
  "files.name": "Název",
  "files.path": "Složka",
  ...
  "files.deleteSetConfirm": "Odebrat tuto sadu souborů ze seznamu? Její zálohy se nesmažou a lze je později znovu objevit.",
  "files.deleteBackupsConfirm": "Smazat VŠECHNY zálohy této sady souborů? Snímky budou trvale odstraněny, repozitář vyčištěn a sada zapomenuta. Nelze vrátit zpět.",
  ...
  "activityLog.domainFiles": "Soubory",
