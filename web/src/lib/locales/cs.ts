...
const cs: Partial<Translations> = {
  ...
  "settings.dashTileCa": "Možná je k dispozici i v Community Applications — hledejte BombVault Dashboard.",
  "settings.dashTileNotInstalled": "Plugin dlaždice není nainstalovaný.",
  "settings.dashTileConfirm": "Nainstalovat nainstaluje plugin bombvault-dashboard na váš hostitel Unraid běžným mechanismem pluginů Unraidu. Objeví se v Plugins jako každý jiný plugin a lze ho tam (nebo zde) kdykoli odebrat.",
