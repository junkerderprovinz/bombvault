...
const cs: Partial<Translations> = {
  ...
  "settings.everythingOverlapWarning": "Toto běží nezávisle na plánech jednotlivých oblastí výše. Pokud jsou zapnuté oba, kontejnery, VMs, flash, složky i autozáloha se zálohují dvakrát: jednou tady, jednou podle svého vlastního plánu. Vypni oblasti, které nechceš zálohovat duplicitně.",
