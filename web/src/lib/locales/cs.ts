...
const cs: Partial<Translations> = {
  ...
  "repos.itemHint": "Kam jdou zálohy této položky. Nech to na repozitáři domény, pokud tahle položka nepotřebuje vlastní; obvyklým důvodem je velká, zřídka měněná položka, od které se chce jen kopie mimo server. V seznamu je to, co jsi založil v Nastavení. Replikace mimo lokalitu nekopíruje podruhé vzdálený repozitář ani repozitář označený jako už mimo lokalitu.",
  ...
  "repos.offsite": "Už mimo lokalitu",
  "repos.offsiteHint": "Pro sdílenou složku na jiném stroji, třeba NAS jako studené úložiště. Replikace mimo lokalitu pak tento repozitář vynechá, stejně jako vzdálený, a jeho zálohy se nekopírují podruhé. Pro disk nebo sdílenou složku na tomto stroji to nech vypnuté, ty kopii mimo lokalitu dál potřebují.",
  "repos.offsiteRemote": "mimo lokalitu",
  "repos.offsiteRemoteHint": "Vzdálený repozitář už je mimo lokalitu, takže ho replikace mimo lokalitu nikdy znovu nekopíruje.",
