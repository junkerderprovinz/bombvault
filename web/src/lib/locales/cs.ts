...
const cs: Partial<Translations> = {
  ...
  "settings.offsiteHint": "Po každé úspěšné místní záloze ji také replikovat do druhého repozitáře pomocí restic copy. Zadejte vzdálený repozitář (rest:http://host:8000/repo, s3:…) nebo místní podcestu; ponechte prázdné pro vypnutí. Místní záloha zůstává primární.",
  "source.label": "Zdroj:",
  "source.local": "Místní",
  ...
  "settingsIO.previewCopyRules": "Pravidla kopírování",
  "settingsIO.previewNotInFile": "není v souboru, zůstává beze změny",
  ...
  "pull.repoLocationHint": "Repozitář zdrojové instance: rest:, s3:, sftp:, případně podcesta pod připojením hostitele. Umístění rclone: se odmítá, protože rclone by k němu sáhl přes vzdálená úložiště TÉTO instance.",
  ...
  "pull.credsHint": "Přihlášení k úložišti, na kterém leží repozitář zdroje: s3: nebo server rest: s heslem. Stahování nikdy nepoužije přihlašovací údaje tohoto stroje, takže zdroj, který přihlášení potřebuje a nemá zde žádné vybrané, bude odmítnut.",
  ...
  "repos.locationPlaceholder": "backups/cold nebo s3:s3.eu-central-003.backblazeb2.com/bucket/path",
  "repos.locationHint": "Složka pod připojením hostitele, nebo vzdálený restic repozitář jako s3:..., sftp:..., rest:... či rclone:... Do vzdáleného se zapisuje přímo, bez místní mezikopie.",
  ...
  "repos.offPremises": "Mimo objekt",
  "repos.offPremisesHint": "Počítá se jako vlastní lokalita pro lokality a 3-2-1 na kartách. Kopie tím nejsou dotčeny. Rest-server ve stejné budově by měl mít tohle vypnuté.",
  ...
  "placementCode.copyRuleTaken": "Tento název už má vlastní kopírovací pravidla.",
  ...
  "placement.titleHint": "Kam se zapisují zálohy této položky a kam se poté kopírují. Umístění je pevné od první zálohy, kopie lze kdykoli změnit.",
  "placement.unreadable": "Umístění se nepodařilo načíst",
  "placement.noCopyNow": "Teď žádná kopie, vypnuto: {targets}. Zaškrtni cíl nebo zvol Místní.",
  "placement.followsDefault": "Řídí se výchozím nastavením",
  "placement.ownCopies": "Vlastní kopie",
  "placement.homeSet": "Umístění nastaveno: {home}",
  "placement.copiesFollow": "Kopie se řídí výchozím nastavením",
  "placement.reset": "Obnovit",
  ...
  // Timeline
  "timeline.deleteAsk": "Smazat tuto zálohu tady: {list}?",
  ...
  "timeline.onlyHere": "jen tady",
  "timeline.incomplete": "neúplné",
  "timeline.incompleteHint": "Nejsou tu všechny disky tohoto běhu, takže toto místo se pro obnovu nevybírá.",
  "timeline.snapshotMissing": "{place} už tuto zálohu nemá. Obnovit z {next}?",
  "timeline.stackDirMissing": "Složka projektu není v {place}. Použít stav z {home}?",
  // Direct repository
  ...
  "placementDefaults.homeOff": "{home} je vypnuto. Položky bez umístění se nezálohují, dokud se znovu nezapne nebo se výchozí nastavení nezmění.",
  "placementDefaults.homeMissing": "Výchozí nastavení ukazuje na repozitář, který už neexistuje. Položky bez umístění se nezálohují.",
  "placementDefaults.confirmHome": "Nové položky v {domain} přebírají {home} při první záloze. Položky s umístěním si ho ponechají.",
  "placementDefaults.dropAsk": "Položky a projektové složky, které už {target} nedostává: {n}. Kopie, které tam zůstávají: {copies}.",
  "placementDefaults.dropAskUnknown": "Položky a projektové složky, které už {target} nedostává: {n}. {target} nebyl pro tuto doménu nikdy uveden, takže zatím není známo, kolik kopií tam zůstává.",
  "placementDefaults.addAsk": "Položky a projektové složky, které {target} od nynějška dostává: {n}. Snímky nahrané při příštím běhu: nejvýše {snapshots}.",
  "placementDefaults.openTakeHome": "Položky bez umístění, které při první záloze přeberou {home}: {n}.",
  "placementDefaults.apply": "Použít na položky bez záloh",
  "placementDefaults.applyAsk": "Umístění a kopie se u těchto položek vrátí na výchozí nastavení: {n}.",
  "placementDefaults.applyLoses": "Ztrácejí tím vlastní volbu: {list}",
  "placementDefaults.applyKeptBackups": "Zůstávají beze změny, mají zálohy: {list}",
  "placementDefaults.applyKeptUnreadable": "Zůstávají beze změny, jejich umístění se nepodařilo načíst: {list}",
  "placementDefaults.applyKeptChanged": "Mezitím se změnily a zůstaly nedotčeny: {list}",
  "placementDefaults.applyNone": "Žádná položka bez záloh se neliší od výchozího nastavení.",
  "placementDefaults.applyBusy": "Probíhá záloha. Použijte znovu, až skončí.",
  "placementDefaults.paused": "Mimo lokalitu pozastaveno po přestavbě",
  "placementDefaults.pausedHint": "Pravidla a výchozí nastavení se ztratila spolu se starou konfigurací. Z {domain} se nic nekopíruje mimo lokalitu, dokud se toto výchozí nastavení nepotvrdí. Položky s kartou lze nejdřív nastavit na Místní.",
  "placementDefaults.confirm": "Potvrdit výchozí nastavení",
  "placementDefaults.confirmAsk": "Při příštím běhu se zkopíruje toto:",
  "placementDefaults.unmatched": "Názvy v zálohách bez záznamu zde. Zaškrtnuté se vynechají:",
  "placementDefaults.unmatchedLine": "{name}, snímky: {n}",
  "placementDefaults.confirmed": "Výchozí nastavení potvrzeno. Zálohy mimo lokalitu pokračují při příštím běhu.",
  ...
  "placement.older": "Starší kopie v {target}: {n}, naposledy viděno {date}",
  "placement.noCopyYet": "{place}: zatím žádná kopie",
  "placement.notListedYet": "{place}: zatím nezařazeno",

  // Removal
  "offsiteRemoval.delete": "Smazat v {target}",
  "offsiteRemoval.ask": "Smazat každou kopii {name} v {target}? Kopie: {n}.",
  "offsiteRemoval.onlyThere": "Tyto snímky jinde neexistují a poté zmizí navždy:",
