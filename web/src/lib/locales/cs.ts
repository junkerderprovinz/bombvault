...
const cs: Partial<Translations> = {
  ...
  "recovery.foreignDbDumps": "one={n} výpis databáze v tomto repozitáři. Vytáhni si ho pomocí restic CLI, jak to popisuje havarijní balíček.|few={n} výpisy databází v tomto repozitáři. Vytáhni si jeden pomocí restic CLI, jak to popisuje havarijní balíček.|many={n} výpisů databází v tomto repozitáři. Vytáhni si jeden pomocí restic CLI, jak to popisuje havarijní balíček.|other={n} výpisu databází v tomto repozitáři. Vytáhni si jeden pomocí restic CLI, jak to popisuje havarijní balíček.",
  ...
  "recovery.dumpOnlySkipped": "one={n} databáze uložená jen jako výpis tu zůstává stranou. Obnov ji a naimportuj z jejího vlastního seznamu.|few={n} databáze uložené jen jako výpis tu zůstávají stranou. Obnov je a naimportuj z jejich vlastního seznamu.|many={n} databází uložených jen jako výpis tu zůstává stranou. Obnov je a naimportuj z jejich vlastního seznamu.|other={n} databáze uložené jen jako výpis tu zůstávají stranou. Obnov je a naimportuj z jejich vlastního seznamu.",
