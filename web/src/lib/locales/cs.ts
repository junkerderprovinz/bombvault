...
const cs: Partial<Translations> = {
  ...
  "about.body": "Jeden rytíř, jedno tažení: svobodné, pěkně vypadající nástroje s otevřeným kódem, které v podobě, jakou jsem chtěl, neexistovaly. Staví se, dokud nebude nic chybět. Žádné účty, žádná telemetrie, žádné reklamy. Žádná zkušební verze, žádné tarify, žádná hvězdička pod čarou. Nic čitelného nikdy neopustí tvé vlastní hradby. Kováno po večerech a o víkendech, se srdcem a tvrdohlavostí.",
  "about.coffee": "Pokud ti je BombVault k užitku, dar pokryje, co provoz stojí: doménu, server a večery, které do něj jdou. A srdce tohohle rytíře při něm bije o něco rychleji. Dole jsou tři cesty, vyber si tu, která ti sedne.",
