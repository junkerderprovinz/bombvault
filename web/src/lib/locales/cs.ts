...
const cs: Partial<Translations> = {
  ...
  "settings.everythingHint": "Spustí každou oblast jednou, popořadě: kontejnery, VMs, flash, složky a nakonec autozálohu, takže jediný ping poté (přes níže uvedený post-příkaz) potvrdí, že je celý server chráněný. Ve výchozím stavu vypnuto a nezávislé na vlastním plánu každé oblasti výše.",
  "settings.everythingDuplicateWarning": "Kontejnery, VMs, flash, složky i autozáloha se zálohují dvakrát, dokud jsou zapnuté zároveň tento plán i jejich vlastní: jednou zde a jednou ve vlastním plánu. Vypněte oblasti, které nechcete zálohovat dvakrát.",
