...
const cs: Partial<Translations> = {
  ...
  "settings.dbDumpsOffConfirm": "Vypnout výpisy databází pro všechny kontejnery? U {names} je výpis jedinou konzistentní kopií databáze.",
  ...
  "dbdump.stackRestoreWarn": "Data {names} se kopírují za běhu stacku. Po obnově naimportuj jejich nejnovější výpis databáze, než aplikace začneš používat.",
  "dbdump.introNotice": "BombVault před každou zálohou vypisuje rozpoznané databáze jako samostatné body obnovy. Rozpoznáno zde: {count}, první je {name}. Můžeš to vypnout u jednotlivého kontejneru na jeho kartě nebo pro všechny kontejnery v Nastavení.",
  ...
  "dbdump.importStopsOne": "Během importu BombVault zastaví i {app}. Potom ho znovu spustí, ledaže import selže a stará data nepůjde vrátit zpět.",
  "dbdump.importStopsMany": "Během importu BombVault zastaví i tyto aplikace: {apps}. Potom je znovu spustí, ledaže import selže a stará data nepůjde vrátit zpět.",
  ...
  "recovery.foreignDbDumps": "Výpisy databází v tomto repozitáři: {count}. Vytáhni si jeden pomocí restic CLI, jak to popisuje havarijní balíček.",
  ...
  "recovery.dumpOnlySkipped": "Databáze uložené jen jako výpis tu zůstávají stranou: {count}. Obnov je a naimportuj z jejich vlastního seznamu.",
