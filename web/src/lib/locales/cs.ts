...
const cs: Partial<Translations> = {
  ...
  "dbdump.introNotice": "BombVault vypisuje {count} rozpoznaných databází před každou zálohou jako samostatné body obnovy. Můžeš to vypnout u jednotlivého kontejneru na jeho kartě nebo pro všechny kontejnery v Nastavení.",
  ...
  "dbdump.fixRepository": "Úložiště záloh výpis nepřijalo, nebo uložilo méně bajtů, než kolik bylo vypsáno. Zkontroluj úložiště v Nastavení, Úložiště; výpis se zkusí znovu s další zálohou.",
  ...
  "recovery.dumpOnlySkipped": "{count} databází uložených jen jako výpis zůstává stranou; obnov je a naimportuj z jejich vlastního seznamu.",
