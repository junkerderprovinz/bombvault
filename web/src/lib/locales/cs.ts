...
const cs: Partial<Translations> = {
  ...
  "takeover.historyOne": "Záloha položky {old} se stane součástí historie položky {new}.",
  "takeover.historyMany": "{n} záloh položky {old} se stane součástí historie položky {new}.",
  ...
  "pull.snapshotsPulled": "Staženo snímků: {n}",
  "pull.nothingNew": "Není co stahovat.",
  "pull.pulled": "Staženo {n} snímků.",
