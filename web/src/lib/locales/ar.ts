...
const ar: Partial<Translations> = {
  ...
  "files.empty": "لا توجد مجموعات ملفات بعد. أضف مجلداً — مشاركات، مستندات، صور، أي شيء ضمن نقاط التركيب لديك — وسيحميه BombVault مثل كل شيء آخر: جداول زمنية، نسخ خارج الموقع، فحوصات سلامة واستعادة. لا حاجة إلى أداة منفصلة للنسخ الاحتياطي للملفات.",
  "files.addSet": "إضافة مجموعة ملفات",
  "files.editSet": "تعديل مجموعة الملفات",
  "files.name": "الاسم",
  "files.path": "المجلد",
  ...
  "files.deleteSetConfirm": "إزالة مجموعة الملفات هذه من القائمة؟ لن تُحذف نسخها الاحتياطية ويمكن اكتشافها مجدداً لاحقاً.",
  "files.deleteBackupsConfirm": "حذف جميع النسخ الاحتياطية لمجموعة الملفات هذه؟ تُزال اللقطات نهائياً ويُقلَّم المستودع وتُنسى المجموعة. لا يمكن التراجع.",
  ...
  "activityLog.domainFiles": "الملفات",
