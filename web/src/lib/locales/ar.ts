...
const ar: Partial<Translations> = {
  ...
  "settings.everythingOverlapWarning": "يعمل هذا الجدول الزمني بشكل مستقل عن الجداول الزمنية الخاصة بكل نطاق أعلاه. إذا كان كلاهما مفعّلاً، تُنسخ Containers وVMs وFlash والمجلدات والنسخ الذاتي مرتين: مرة هنا ومرة حسب جدولها الخاص. عطّل النطاقات التي لا تريد تكرار نسخها.",
