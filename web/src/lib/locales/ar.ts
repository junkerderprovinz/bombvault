...
const ar: Partial<Translations> = {
  ...
  "dbdump.introNotice": "يفرّغ BombVault {count} من قواعد البيانات المتعرَّف عليها قبل كل نسخة احتياطية، كنقاط استعادة مستقلة. يمكنك تعطيل ذلك لكل container على بطاقته أو لكل الـ containers في الإعدادات.",
  ...
  "dbdump.fixRepository": "لم يقبل مستودع النسخ التفريغ، أو خزّن بايتات أقل مما جرى تفريغه. تحقق من المستودع في الإعدادات، التخزين؛ وستُعاد محاولة التفريغ مع النسخة القادمة.",
  ...
  "recovery.dumpOnlySkipped": "تُترك {count} قاعدة بيانات محفوظة كنسخ فقط خارج ذلك؛ استعدها واستورد نسخها من قائمتها الخاصة.",
