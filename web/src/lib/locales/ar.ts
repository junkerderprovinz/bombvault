...
const ar: Partial<Translations> = {
  ...
  "settings.dashTileCa": "قد تكون متاحة أيضًا في Community Applications — ابحث عن BombVault Dashboard.",
  "settings.dashTileNotInstalled": "إضافة مربع لوحة التحكم غير مثبّتة.",
  "settings.dashTileConfirm": "يقوم زر التثبيت بتثبيت إضافة bombvault-dashboard على مضيف Unraid عبر آلية الإضافات المعتادة في Unraid. تظهر ضمن Plugins مثل أي إضافة أخرى ويمكن إزالتها من هناك (أو من هنا) في أي وقت.",
