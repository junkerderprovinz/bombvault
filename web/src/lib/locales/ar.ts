...
const ar: Partial<Translations> = {
  ...
  "files.emptySelectionBlocked": "يحتاج المجموعة إلى مجلد واحد على الأقل، لذا لا يمكن إزالة العلامة الأخيرة. استخدم إزالة المجموعة إذا لم تعد تريد هذه المجموعة.",
