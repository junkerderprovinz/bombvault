...
const ar: Partial<Translations> = {
  ...
  "offsite.replicatingSnapshotPercentWithDuration": "جارٍ نسخ اللقطة {index} من {total} ({percent}%) · {duration}",
  ...
  "activityLog.lineOffsiteRunningSnapshotPercent": "رفع خارج الموقع — {domain} … اللقطة {index} من {total} ({percent}%)",
  "activityLog.lineOffsiteRunningSnapshotPercentWithDuration": "رفع خارج الموقع — {domain} … اللقطة {index} من {total} ({percent}%) · {duration}",
  ...
  "schedule.overrideHint": "الفراغ يستخدم جدول الفئة. لا تدعم التجاوزات لكل عنصر وضع كل N أيام.",
