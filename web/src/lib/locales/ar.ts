...
const ar: Partial<Translations> = {
  ...
  "about.body": "فارس واحد، حملة واحدة: أدوات حرة مفتوحة المصدر، جميلة المظهر، لم تكن موجودة بالشكل الذي أردته. تُبنى حتى لا ينقصها شيء. لا حسابات، لا قياس عن بُعد، لا إعلانات. لا فترة تجريبية، لا باقات، لا حاشية صغيرة. لا شيء مقروء يغادر أسوارك أبدًا. طُرقت في الأمسيات وعطلات نهاية الأسبوع، بقلب وعناد.",
  "about.coffee": "إذا كان BombVault مفيدًا لك، فالتبرع يغطي تكاليف استمراره: النطاق والخادم والأمسيات التي تذهب إليه. كما أنه يجعل قلب هذا الفارس ينبض أسرع قليلًا. ثلاث طرق في الأسفل، اختر ما يناسبك.",
