...
const ar: Partial<Translations> = {
  ...
  "settings.labelsHint": "مقدار ما يُعرض من عنصر التحكم: كلماته أو رمزه أو كلاهما. تحتفظ الأزرار بالعرض نفسه في الحالات الثلاث، لذا لا يعيد التبديل ترتيب الصفحة.",
