...
const ar: Partial<Translations> = {
  ...
  "takeover.backup": "نسخة احتياطية واحدة",
  "takeover.backups": "{n} نسخة احتياطية",
  "takeover.accept": "دمج",
  ...
  "takeover.historyOne": "تصبح النسخة الاحتياطية الخاصة بـ {old} جزءاً من سجل {new}.",
  "takeover.historyMany": "تصبح {n} نسخة احتياطية من {old} جزءاً من سجل {new}.",
