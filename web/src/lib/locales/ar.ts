...
const ar: Partial<Translations> = {
  ...
  "auth.recoveryLeft": "تبقّى {n} من رموز الاسترداد",
  "auth.recoverySaved": "لقد دوّنتها",
  "auth.disableCodePrompt": "أدخل رمزًا حاليًا للتعطيل",
  "auth.passwordMinHint": "{n} أحرف على الأقل.",
  ...
  "receiver.snapshotsCount": "{n} نسخة",
  ...
  "pull.snapshotsPulled": "تم سحب {n} نسخة",
  "pull.nothingNew": "لا جديد لسحبه.",
  "pull.pulled": "تم سحب {n} نسخة.",
