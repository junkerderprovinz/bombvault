...
const ar: Partial<Translations> = {
  ...
  "settings.offsiteHint": "بعد كل نسخة احتياطية محلية ناجحة، يتم نسخها أيضًا إلى مستودع ثانٍ باستخدام restic copy. أدخل مستودعًا بعيدًا (rest:http://host:8000/repo، s3:…) أو مسارًا فرعيًا محليًا؛ اتركه فارغًا للتعطيل. تبقى النسخة المحلية هي الأساسية.",
  "source.label": "المصدر:",
  "source.local": "محلي",
  ...
  "pull.repoLocationHint": "مستودع نسخة المصدر: rest: أو s3: أو sftp:، أو مسار فرعي ضمن نقطة وصل المضيف. يُرفض الموقع من نوع rclone:، لأن rclone سيصل إليه عبر وحدات remotes الخاصة بهذه النسخة.",
  ...
  "pull.credsHint": "بيانات الدخول إلى وحدة التخزين التي يوجد عليها مستودع المصدر: s3: أو خادم rest: محمي بكلمة مرور. لا يستخدم السحب أبدًا بيانات هذا الجهاز، لذا يُرفض أي مصدر يحتاج إلى تسجيل دخول ولم يُختر له شيء هنا.",
  ...
  "repos.locationPlaceholder": "backups/cold أو s3:s3.eu-central-003.backblazeb2.com/bucket/path",
  "repos.locationHint": "مجلد تحت تحميل المضيف، أو مستودع restic بعيد مثل s3:... أو sftp:... أو rest:... أو rclone:... يُكتب إلى البعيد مباشرة، دون نسخة محلية وسيطة.",
  ...
  "placement.titleHint": "أين تُكتب نسخ هذا العنصر الاحتياطية وإلى أين تُنسخ بعد ذلك. الموقع ثابت منذ أول نسخة احتياطية، أما النسخ فيمكن تغييرها في أي وقت.",
  "placement.unreadable": "تعذّرت قراءة الموضع",
  "placement.noCopyNow": "لا نسخ حاليًا، معطّل: {targets}. حدد هدفًا أو اختر محلي.",
  "placement.followsDefault": "يتبع الافتراضي",
  "placement.ownCopies": "نسخ خاصة",
  "placement.homeSet": "الموقع مُعيَّن: {home}",
  "placement.copiesFollow": "النسخ تتبع الافتراضي",
  "placement.reset": "إعادة تعيين",
  ...
  // Timeline
  "timeline.deleteAsk": "حذف هذه النسخة هنا: {list}؟",
  ...
  "timeline.onlyHere": "هنا فقط",
  "timeline.incomplete": "غير مكتمل",
  "timeline.incompleteHint": "ليست كل أقراص هذا التشغيل هنا، لذا لا يُختار هذا المكان للاستعادة.",
  "timeline.snapshotMissing": "{place} لم تعد تملك هذه النسخة الاحتياطية. الاستعادة من {next}؟",
  "timeline.stackDirMissing": "مجلد المشروع غير موجود في {place}. استخدام الحالة من {home}؟",
  // Direct repository
  ...
  "placementDefaults.homeOff": "{home} مُطفأ. لا تُنسخ العناصر بلا موقع احتياطيًا حتى يعمل من جديد أو تتغيّر القيمة الافتراضية.",
  "placementDefaults.homeMissing": "تشير القيمة الافتراضية إلى مستودع لم يعد موجودًا. لا تُنسخ العناصر بلا موقع احتياطيًا.",
  "placementDefaults.confirmHome": "تأخذ العناصر الجديدة في {domain} الموقع {home} عند أول نسخة احتياطية لها. العناصر ذات الموقع المُعيَّن تحتفظ به.",
  "placementDefaults.dropAsk": "العناصر ومجلدات المشروع التي لن يحصل عليها {target} بعد الآن: {n}. النسخ التي تبقى هناك: {copies}.",
  "placementDefaults.dropAskUnknown": "العناصر ومجلدات المشروع التي لن يحصل عليها {target} بعد الآن: {n}. لم يُدرَج {target} قط لهذه الدومين، لذا عدد النسخ التي تبقى هناك غير معروف بعد.",
  "placementDefaults.addAsk": "العناصر ومجلدات المشروع التي سيحصل عليها {target} من الآن فصاعدًا: {n}. اللقطات المرفوعة في التشغيل التالي: {snapshots} على الأكثر.",
  "placementDefaults.openTakeHome": "العناصر بلا موقع التي تأخذ {home} عند أول نسخة احتياطية لها: {n}.",
  "placementDefaults.apply": "التطبيق على العناصر بلا نسخ احتياطية",
  "placementDefaults.applyAsk": "يعود الموقع والنسخ إلى القيمة الافتراضية لهذه العناصر: {n}.",
  "placementDefaults.applyLoses": "تفقد اختيارها الخاص: {list}",
  "placementDefaults.applyKeptBackups": "تبقى كما هي، لأن لديها نسخًا احتياطية: {list}",
  "placementDefaults.applyKeptUnreadable": "تبقى كما هي، لأن موقعها تعذّرت قراءته: {list}",
  "placementDefaults.applyKeptChanged": "تغيّرت في هذه الأثناء ولم تُمَس: {list}",
  "placementDefaults.applyNone": "لا يوجد عنصر بلا نسخ احتياطية يختلف عن القيمة الافتراضية.",
  "placementDefaults.applyBusy": "نسخة احتياطية قيد التشغيل. طبّق مرة أخرى بعد انتهائها.",
  "placementDefaults.paused": "خارج الموقع متوقف بعد إعادة بناء",
  "placementDefaults.pausedHint": "فُقدت القواعد والقيم الافتراضية مع الإعداد القديم. لا يُنسخ شيء من {domain} خارج الموقع حتى تُؤكَّد هذه القيمة الافتراضية. يمكن ضبط العناصر ذات البطاقة على محلي أولًا.",
  "placementDefaults.confirm": "تأكيد القيمة الافتراضية",
  "placementDefaults.confirmAsk": "في التشغيل التالي، يُنسخ هذا:",
  "placementDefaults.unmatched": "أسماء في النسخ الاحتياطية بلا إدخال هنا. المُؤشَّر عليها تُستبعد:",
  "placementDefaults.unmatchedLine": "{name}، اللقطات: {n}",
  "placementDefaults.confirmed": "أُكِّدت القيمة الافتراضية. تستأنف النسخ خارج الموقع في التشغيل التالي.",
  ...
  "placement.older": "نسخ أقدم في {target}: {n}، آخر ظهور {date}",
  "placement.noCopyYet": "{place}: لا نسخة بعد",
  "placement.notListedYet": "{place}: غير مدرَجة بعد",

  // Removal
  "offsiteRemoval.delete": "حذف في {target}",
  "offsiteRemoval.ask": "حذف كل نسخة من {name} في {target}؟ النسخ: {n}.",
  "offsiteRemoval.onlyThere": "هذه اللقطات لا توجد في أي مكان آخر وستختفي نهائيًا بعد ذلك:",
