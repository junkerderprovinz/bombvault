...
const ar: Partial<Translations> = {
  ...
  "repos.itemHint": "إلى أين تذهب نسخ هذا العنصر. اتركه على مستودع النطاق ما لم يحتج هذا العنصر إلى مستودع خاص؛ السبب المعتاد عنصر كبير نادر التغيّر لا يُراد منه سوى نسخة خارج الموقع. تحتوي القائمة على ما أنشأته في الإعدادات. لا ينسخ النسخ خارج الموقع مستودعًا بعيدًا أو مستودعًا مُعلَّمًا بأنه خارج الموقع مسبقًا مرة ثانية.",
  ...
  "repos.offsite": "خارج الموقع مسبقًا",
  "repos.offsiteHint": "لمشاركة على جهاز آخر، مثل NAS يُستخدم للتخزين البارد. عندها يستبعد النسخ خارج الموقع هذا المستودع كما يستبعد المستودع البعيد، فلا تُنسخ نسخه مرة ثانية. اتركه معطلًا لقرص أو مشاركة على هذا الجهاز، فهذه ما زالت تحتاج إلى النسخة خارج الموقع.",
  "repos.offsiteRemote": "خارج الموقع",
  "repos.offsiteRemoteHint": "المستودع البعيد موجود خارج الموقع أصلًا، لذلك لا ينسخه النسخ خارج الموقع مرة أخرى أبدًا.",
