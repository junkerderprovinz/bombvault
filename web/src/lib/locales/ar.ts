...
const ar: Partial<Translations> = {
  ...
  "excludes.advisoryImmichDb": "يحفظ Immich ألبومات كل صورة ووجوهها وتواريخها في قاعدة بيانات PostgreSQL تعمل في حاوية منفصلة خاصة بها، لذا لا تحتوي هذه النسخة الاحتياطية عليها. الاستعادة من هنا تعيد الصور دون كل ذلك. امنح تلك القاعدة نسخة احتياطية خاصة بها، أو فعّل تفريغ قاعدة البيانات المدمج في Immich ليصل إلى مجلد تغطيه هذه النسخة الاحتياطية.",
  "excludes.advisoryNextcloudDb": "يحفظ Nextcloud الحسابات والمشاركات والوسوم في قاعدة بيانات تعمل عادةً في حاوية منفصلة، لذا لا تحتوي هذه النسخة الاحتياطية عليها. تعود الملفات، أما المشاركة فلا. خذ لتلك القاعدة نسخة احتياطية أيضاً.",
