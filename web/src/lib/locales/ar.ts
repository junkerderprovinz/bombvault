...
const ar: Partial<Translations> = {
  ...
  "dbdump.importStopsOne": "أثناء الاستيراد يوقف BombVault أيضاً {app} ثم يشغّله من جديد بعد ذلك.",
  "dbdump.importStopsMany": "أثناء الاستيراد يوقف BombVault أيضاً هذه التطبيقات ثم يشغّلها من جديد بعد ذلك: {apps}.",
