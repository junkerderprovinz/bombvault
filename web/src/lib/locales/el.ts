...
const el: Partial<Translations> = {
  ...
  "offsite.replicatingSnapshotPercentWithDuration": "Αναπαραγωγή στιγμιότυπου {index} από {total} ({percent}%) · {duration}",
  ...
  "activityLog.lineOffsiteRunningSnapshotPercent": "Μεταφόρτωση εκτός τόπου — {domain} … στιγμιότυπο {index} από {total} ({percent}%)",
  "activityLog.lineOffsiteRunningSnapshotPercentWithDuration": "Μεταφόρτωση εκτός τόπου — {domain} … στιγμιότυπο {index} από {total} ({percent}%) · {duration}",
  ...
  "schedule.overrideHint": "Το κενό χρησιμοποιεί το χρονοδιάγραμμα της κατηγορίας. Οι παρακάμψεις ανά στοιχείο δεν υποστηρίζουν τη λειτουργία κάθε N ημέρες.",
