...
const el: Partial<Translations> = {
  ...
  "settings.labelsHint": "Πόσο από ένα στοιχείο ελέγχου εμφανίζεται: οι λέξεις του, το σύμβολό του ή και τα δύο. Τα κουμπιά διατηρούν το ίδιο πλάτος και στα τρία, οπότε η εναλλαγή δεν αναδιατάσσει τη σελίδα.",
