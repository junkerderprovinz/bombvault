...
const el: Partial<Translations> = {
  ...
  "settings.retentionOffsiteImmutableInfo": "Ένας αμετάβλητος απομακρυσμένος προορισμός δεν κλαδεύεται ποτέ από εδώ, ανεξάρτητα από αυτές τις ρυθμίσεις — δείτε Απομακρυσμένο › Στρατηγική διατήρησης για το πώς να τον κλαδέψετε.",
  ...
  "excludes.assistPathsUnavailable": "Οι φάκελοι του αντιγράφου αυτού του container δεν είναι προσβάσιμοι αυτή τη στιγμή, ούτε υπάρχει αντίγραφο από το οποίο να διαβαστούν μεγέθη. Έλεγξε ότι ο πίνακας ή ο κοινόχρηστος φάκελος που τους περιέχει είναι προσαρτημένος.",
