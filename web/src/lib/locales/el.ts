...
const el: Partial<Translations> = {
  ...
  "about.body": "Ένας ιππότης, μία σταυροφορία: ελεύθερα, καλοφτιαγμένα εργαλεία ανοιχτού κώδικα που δεν υπήρχαν στη μορφή που ήθελα. Φτιάχνονται μέχρι να μη λείπει τίποτα. Κανένας λογαριασμός, καμία τηλεμετρία, καμία διαφήμιση. Καμία δοκιμή, καμία συνδρομή, κανένας αστερίσκος στα ψιλά γράμματα. Τίποτα αναγνώσιμο δεν φεύγει ποτέ από τα δικά σου τείχη. Σφυρηλατημένο τα βράδια και τα σαββατοκύριακα, με καρδιά και πείσμα.",
  "about.coffee": "Αν σου φαίνεται χρήσιμο το BombVault, μια δωρεά καλύπτει όσα κοστίζει να μένει ζωντανό: το domain, τον διακομιστή και τα βράδια που πηγαίνουν σε αυτό. Και κάνει την καρδιά αυτού του ιππότη να χτυπά λίγο πιο γρήγορα. Πιο κάτω υπάρχουν τρεις τρόποι, διάλεξε όποιον σου ταιριάζει.",
