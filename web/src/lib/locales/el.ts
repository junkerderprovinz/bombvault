...
const el: Partial<Translations> = {
  ...
  "files.emptySelectionBlocked": "Ένα σύνολο χρειάζεται τουλάχιστον έναν φάκελο, οπότε το τελευταίο τσεκ δεν μπορεί να αφαιρεθεί. Χρησιμοποιήστε Αφαίρεση συνόλου αν δεν θέλετε πια αυτό το σύνολο.",
