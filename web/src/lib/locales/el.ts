...
const el: Partial<Translations> = {
  ...
  "takeover.backup": "1 αντίγραφο",
  "takeover.backups": "{n} αντίγραφα",
  ...
  "takeover.historyOne": "Το αντίγραφο του {old} γίνεται μέρος του ιστορικού του {new}.",
  "takeover.historyMany": "Τα {n} αντίγραφα του {old} γίνονται μέρος του ιστορικού του {new}.",
  ...
  "settings.discoHint": "Κάθε χρωματιστή γραμμή και στοιχείο περνά ομαλά στο επόμενο χρώμα της παλέτας, ένα κάθε τρία δευτερόλεπτα, όσο η λειτουργία ουράνιου τόξου είναι ενεργή.",
