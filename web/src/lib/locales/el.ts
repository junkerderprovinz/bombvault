...
const el: Partial<Translations> = {
  ...
  "folders.resetConfirm": "Επαναφορά της επιλογής φακέλων; Το container επιστρέφει στην αυτόματη ανίχνευση (προεπιλογή appdata) και όλες οι απομνημονευμένες εξαιρέσεις αφαιρούνται.",
