...
const el: Partial<Translations> = {
  ...
  "settings.discoHint": "Κάθε χρωματιστή γραμμή και στοιχείο περνά στο επόμενο χρώμα της παλέτας μία φορά το δευτερόλεπτο, όσο η λειτουργία ουράνιου τόξου είναι ενεργή.",
  ...
  "pull.snapshotsPulled": "{n} αντίγραφα αντλήθηκαν",
  "pull.nothingNew": "Δεν υπάρχει κάτι νέο για άντληση.",
  "pull.pulled": "Αντλήθηκαν {n} αντίγραφα.",
