...
const el: Partial<Translations> = {
  ...
  "settings.offsiteHint": "Μετά από κάθε επιτυχημένο τοπικό αντίγραφο, αναπαραγωγή του και σε δεύτερο αποθετήριο με restic copy. Δώστε ένα απομακρυσμένο (rest:http://host:8000/repo, s3:…) ή μια τοπική υποδιαδρομή· αφήστε κενό για απενεργοποίηση. Το τοπικό αντίγραφο παραμένει το κύριο.",
  "source.label": "Πηγή:",
  "source.local": "Τοπικό",
  ...
  "pull.repoLocationHint": "Το αποθετήριο της πηγαίας εγκατάστασης: rest:, s3:, sftp:, ή μια υποδιαδρομή κάτω από την προσάρτηση του κεντρικού υπολογιστή. Μια τοποθεσία rclone: απορρίπτεται, επειδή το rclone θα την προσέγγιζε με τα remotes ΑΥΤΗΣ της εγκατάστασης.",
  ...
  "pull.credsHint": "Τα στοιχεία σύνδεσης για τον χώρο αποθήκευσης όπου βρίσκεται το αποθετήριο της πηγής: s3: ή διακομιστής rest: με κωδικό. Η λήψη δεν χρησιμοποιεί ποτέ τα στοιχεία αυτού του μηχανήματος, οπότε μια πηγή που χρειάζεται σύνδεση και δεν έχει επιλεγμένη εδώ απορρίπτεται.",
  ...
  "repos.locationPlaceholder": "backups/cold ή s3:s3.eu-central-003.backblazeb2.com/bucket/path",
  "repos.locationHint": "Ένας φάκελος κάτω από την προσάρτηση του κεντρικού υπολογιστή, ή ένα απομακρυσμένο αποθετήριο restic όπως s3:..., sftp:..., rest:... ή rclone:... Στο απομακρυσμένο γράφει απευθείας, χωρίς ενδιάμεσο τοπικό αντίγραφο.",
  ...
  "repos.offPremises": "Εκτός εγκαταστάσεων",
  "repos.offPremisesHint": "Μετράει ως δική του τοποθεσία για τις τοποθεσίες και το 3-2-1 στις κάρτες. Τα αντίγραφα δεν επηρεάζονται. Ένας rest-server στο ίδιο κτίριο θα έπρεπε να το έχει απενεργοποιημένο.",
  ...
  "placementCode.invalid": "Αυτή η επιλογή τοποθέτησης δεν είναι έγκυρη.",
  "placementCode.copiesNotAllowed": "Ένα στοιχείο σε απομακρυσμένο ή άμεσο αποθετήριο δεν λαμβάνει αντίγραφα.",
  "placementCode.unknownTarget": "Αυτός ο απομακρυσμένος προορισμός δεν υπάρχει σε αυτόν τον τομέα.",
  "placementCode.stackRule": "Οι φάκελοι έργων ακολουθούν την προεπιλογή των κοντέινερ και δεν έχουν δικό τους κανόνα.",
  "placementCode.copyRuleTaken": "Αυτό το όνομα έχει ήδη τους δικούς του κανόνες αντιγραφής.",
  "placementCode.domainBusy": "Εκτελείται αντίγραφο ασφαλείας. Διάλεξε ξανά μόλις τελειώσει.",
  "placementCode.hasBackups": "Η θέση δεν μπορεί πλέον να αλλάξει μόλις το στοιχείο έχει αντίγραφα ασφαλείας. Παραμένουν εκεί όπου γράφτηκαν.",
  "placementCode.homeUncheckable": "Δεν ήταν δυνατό να ελεγχθεί αν αυτό το στοιχείο έχει ήδη αντίγραφα ασφαλείας, οπότε η θέση του παραμένει όπως είναι. Δοκίμασε ξανά μόλις το αποθετήριο μπορεί να διαβαστεί.",
  "placementCode.stale": "Οι αριθμοί άλλαξαν από τότε που εμφανίστηκαν. Έλεγξέ τους ξανά.",
  "placementCode.repoInvalid": "Αυτό το αποθετήριο λείπει, είναι απενεργοποιημένο ή δεν μπορεί να επιλυθεί.",
  "placementCode.repoInUseDefault": "Η προεπιλογή για {domains} δείχνει σε αυτό το αποθετήριο. Άλλαξε πρώτα την προεπιλογή.",
  "placementCode.defaultRepoMissing": "Μια προεπιλογή στο αρχείο δείχνει σε αποθετήριο που δεν υπάρχει ούτε στο αρχείο ούτε εδώ.",
  "placementCode.nestedLocation": "Αυτή η θέση βρίσκεται μέσα σε άλλο αποθετήριο ή προορισμό, ή περιέχει έναν.",
  ...
  "placementCode.snapshotMissing": "Αυτό το αντίγραφο ασφαλείας δεν βρίσκεται πια στο επιλεγμένο σημείο.",
  "placementCode.directAccessDenied": "Το κλειδί δεν μπορεί να διαβάσει αυτή τη θέση. Ένα κλειδί περιορισμένο στον δικό του φάκελο του στόχου δεν μπορεί να φτάσει στον διπλανό φάκελο· περιορίστε αντ' αυτού το κλειδί στον φάκελο πάνω από τον στόχο.",
  ...
  "saveWarning.directAppendOnlyOff": "Το {target} άμεσο δεν είναι πια append-only. Στοιχεία των οποίων το μοναδικό αντίγραφο βρίσκεται εκεί: {n}.",
  "saveWarning.directCredsKept": "Το {target} άμεσο δεν μπορεί να ανοίξει με το νέο κλειδί και διατηρεί το παλιό.",

  // Direct
  "offsite.alsoDirect": "Ισχύει επίσης για το {target} άμεσο. Στοιχεία των οποίων το μοναδικό αντίγραφο βρίσκεται εκεί: {n}.",
  "offsite.directRetentionAsk": "Στοιχεία των οποίων το μοναδικό αντίγραφο βρίσκεται στο {target} άμεσο: {n}. Η μικρότερη διατήρηση διαγράφει μόνιμα τα παλαιότερα στιγμιότυπά τους στην επόμενη εκκαθάριση. Αποθήκευση ούτως ή άλλως;",
  "offsite.directAppendOnlyAsk": "Στοιχεία των οποίων το μοναδικό αντίγραφο βρίσκεται στο {target} άμεσο: {n}. Χωρίς append-only, αυτό το μηχάνημα μπορεί να διαγράψει από αυτό. Αποθήκευση ούτως ή άλλως;",
  ...
  "placement.saveHome": "Ορισμός",
  "placement.fixedSinceFirst": "σταθερό από το πρώτο αντίγραφο ασφαλείας",
  ...
  "placement.titleHint": "Πού γράφονται τα αντίγραφα ασφαλείας αυτού του στοιχείου και πού αντιγράφονται στη συνέχεια. Η τοποθεσία είναι σταθερή από το πρώτο αντίγραφο ασφαλείας, τα αντίγραφα μπορούν να αλλάξουν ανά πάσα στιγμή.",
  "placement.unreadable": "Δεν ήταν δυνατή η ανάγνωση της τοποθέτησης",
  "placement.noCopyNow": "Προς το παρόν κανένα αντίγραφο, απενεργοποιημένο: {targets}. Επίλεξε έναν προορισμό ή διάλεξε Τοπικό.",
  "placement.followsDefault": "Ακολουθεί την προεπιλογή",
  "placement.ownCopies": "Δικά του αντίγραφα",
  "placement.homeSet": "Τοποθεσία ορισμένη: {home}",
  "placement.copiesFollow": "Τα αντίγραφα ακολουθούν την προεπιλογή",
  "placement.reset": "Επαναφορά",
  ...
  // Timeline
  "timeline.deleteAsk": "Διαγραφή αυτού του αντιγράφου εδώ: {list};",
  ...
  "timeline.unchecked": "{place}: δεν ελέγχθηκε",
  "timeline.unreadable": "{place}: μη αναγνώσιμο",
  "timeline.check": "Έλεγχος",
  "timeline.showOlder": "Φόρτωση παλαιότερων",
  "timeline.onlyHere": "μόνο εδώ",
  "timeline.incomplete": "ημιτελές",
  "timeline.incompleteHint": "Δεν βρίσκονται εδώ όλοι οι δίσκοι αυτής της εκτέλεσης, οπότε αυτό το σημείο δεν επιλέγεται για επαναφορά.",
  "timeline.snapshotMissing": "Το {place} δεν έχει πια αυτό το αντίγραφο ασφαλείας. Επαναφορά από {next};",
  "timeline.stackDirMissing": "Ο φάκελος έργου δεν βρίσκεται στο {place}. Χρήση της κατάστασης από {home};",
  // Direct repository
  ...
  "placementDefaults.homeOff": "Το {home} είναι απενεργοποιημένο. Τα στοιχεία χωρίς τοποθεσία δεν αντιγράφονται ασφαλείας μέχρι να ενεργοποιηθεί ξανά ή να αλλάξει η προεπιλογή.",
  "placementDefaults.homeMissing": "Η προεπιλογή δείχνει σε αποθετήριο που δεν υπάρχει πια. Τα στοιχεία χωρίς τοποθεσία δεν αντιγράφονται ασφαλείας.",
  "placementDefaults.confirmHome": "Τα νέα στοιχεία στο {domain} παίρνουν το {home} στο πρώτο τους αντίγραφο ασφαλείας. Τα στοιχεία με τοποθεσία το διατηρούν.",
  "placementDefaults.dropAsk": "Στοιχεία και φάκελοι έργων που το {target} δεν λαμβάνει πια: {n}. Αντίγραφα που παραμένουν εκεί: {copies}.",
  "placementDefaults.dropAskUnknown": "Στοιχεία και φάκελοι έργων που το {target} δεν λαμβάνει πια: {n}. Το {target} δεν είχε ποτέ καταχωριστεί για αυτόν τον τομέα, οπότε πόσα αντίγραφα παραμένουν εκεί δεν είναι ακόμα γνωστό.",
  "placementDefaults.addAsk": "Στοιχεία και φάκελοι έργων που το {target} λαμβάνει από τώρα και στο εξής: {n}. Στιγμιότυπα που μεταφορτώνονται στην επόμενη εκτέλεση: το πολύ {snapshots}.",
  "placementDefaults.openTakeHome": "Στοιχεία χωρίς τοποθεσία που παίρνουν το {home} στο πρώτο τους αντίγραφο ασφαλείας: {n}.",
  "placementDefaults.apply": "Εφαρμογή σε στοιχεία χωρίς αντίγραφα ασφαλείας",
  "placementDefaults.applyAsk": "Η τοποθεσία και τα αντίγραφα επιστρέφουν στην προεπιλογή για αυτά τα στοιχεία: {n}.",
  "placementDefaults.applyLoses": "Χάνουν τη δική τους επιλογή: {list}",
  "placementDefaults.applyKeptBackups": "Παραμένουν όπως είναι, έχουν αντίγραφα ασφαλείας: {list}",
  "placementDefaults.applyKeptUnreadable": "Παραμένουν όπως είναι, η τοποθεσία τους δεν ήταν δυνατό να διαβαστεί: {list}",
  "placementDefaults.applyKeptChanged": "Άλλαξαν στο μεταξύ και παρέμειναν ανέγγιχτα: {list}",
  "placementDefaults.applyNone": "Κανένα στοιχείο χωρίς αντίγραφα ασφαλείας δεν διαφέρει από την προεπιλογή.",
  "placementDefaults.applyBusy": "Εκτελείται αντίγραφο ασφαλείας. Εφαρμόστε ξανά μόλις ολοκληρωθεί.",
  "placementDefaults.paused": "Το εκτός τόπου είναι σε παύση μετά από ανακατασκευή",
  "placementDefaults.pausedHint": "Οι κανόνες και οι προεπιλογές χάθηκαν με την παλιά διαμόρφωση. Τίποτα από το {domain} δεν αντιγράφεται εκτός τόπου μέχρι να επιβεβαιωθεί αυτή η προεπιλογή. Τα στοιχεία με κάρτα μπορούν να οριστούν πρώτα σε Τοπικό.",
  "placementDefaults.confirm": "Επιβεβαίωση προεπιλογής",
  "placementDefaults.confirmAsk": "Στην επόμενη εκτέλεση, αντιγράφεται αυτό:",
  "placementDefaults.unmatched": "Ονόματα στα αντίγραφα ασφαλείας χωρίς καταχώριση εδώ. Τα επιλεγμένα παραλείπονται:",
  "placementDefaults.unmatchedLine": "{name}, στιγμιότυπα: {n}",
  "placementDefaults.confirmed": "Η προεπιλογή επιβεβαιώθηκε. Τα αντίγραφα εκτός τόπου συνεχίζουν στην επόμενη εκτέλεση.",
  ...
  "placement.older": "Παλαιότερα αντίγραφα στο {target}: {n}, τελευταία εμφάνιση {date}",
  "placement.noCopyYet": "{place}: κανένα αντίγραφο ακόμα",
  "placement.notListedYet": "{place}: δεν έχει καταχωριστεί ακόμα",

  // Removal
  "offsiteRemoval.delete": "Διαγραφή στο {target}",
  "offsiteRemoval.ask": "Διαγραφή κάθε αντιγράφου του {name} στο {target}; Αντίγραφα: {n}.",
  "offsiteRemoval.onlyThere": "Αυτά τα στιγμιότυπα δεν υπάρχουν πουθενά αλλού και μετά χάνονται οριστικά:",
