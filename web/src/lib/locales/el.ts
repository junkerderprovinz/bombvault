...
const el: Partial<Translations> = {
  ...
  "settings.dashTileCa": "Ίσως είναι διαθέσιμο και στα Community Applications — αναζητήστε BombVault Dashboard.",
  "settings.dashTileNotInstalled": "Το πρόσθετο πλακιδίου του πίνακα ελέγχου δεν είναι εγκατεστημένο.",
  "settings.dashTileConfirm": "Η Εγκατάσταση εγκαθιστά το πρόσθετο bombvault-dashboard στον κεντρικό υπολογιστή Unraid μέσω του συνηθισμένου μηχανισμού πρόσθετων του Unraid. Εμφανίζεται στο Plugins όπως κάθε άλλο πρόσθετο και μπορεί να αφαιρεθεί εκεί (ή εδώ) ανά πάσα στιγμή.",
