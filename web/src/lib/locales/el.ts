...
const el: Partial<Translations> = {
  ...
  "about.report": "Βρήκατε κάτι ή σας λείπει κάτι; Ανοίξτε ένα ζήτημα στο GitHub ή στείλτε ένα email. Η έκδοση παραπάνω βοηθά και στις δύο περιπτώσεις.",
  "about.repo": "Αποθετήριο",
  "about.mail": "Γράψτε email",
