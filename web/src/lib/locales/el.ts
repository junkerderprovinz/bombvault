...
const el: Partial<Translations> = {
  ...
  "settings.everythingOverlapWarning": "Αυτό εκτελείται ανεξάρτητα από τα χρονοδιαγράμματα κάθε τομέα παραπάνω. Αν είναι ενεργά και τα δύο, τα Containers, τα VMs, το Flash, οι φάκελοι και το αυτο-αντίγραφο αντιγράφονται από δύο φορές το καθένα: μία εδώ, μία στο δικό τους χρονοδιάγραμμα. Απενεργοποίησε τους τομείς που δεν θέλεις να διπλασιάζονται.",
