...
const el: Partial<Translations> = {
  ...
  "repos.itemHint": "Πού πηγαίνουν τα αντίγραφα αυτού του στοιχείου. Άφησέ το στο αποθετήριο του τομέα, εκτός αν αυτό το στοιχείο χρειάζεται δικό του· ο συνήθης λόγος είναι ένα μεγάλο στοιχείο που αλλάζει σπάνια και χρειάζεται μόνο αντίγραφο εκτός έδρας. Η λίστα περιέχει όσα έφτιαξες στις Ρυθμίσεις. Η αναπαραγωγή εκτός τόπου δεν αντιγράφει δεύτερη φορά ένα απομακρυσμένο αποθετήριο ή ένα που έχει σημανθεί ως ήδη εκτός τόπου.",
  ...
  "repos.offsite": "Ήδη εκτός τόπου",
  "repos.offsiteHint": "Για κοινόχρηστο φάκελο σε άλλο μηχάνημα, π.χ. ένα NAS για ψυχρή αποθήκευση. Η αναπαραγωγή εκτός τόπου παραλείπει τότε αυτό το αποθετήριο, όπως και ένα απομακρυσμένο, και τα αντίγραφά του δεν αντιγράφονται δεύτερη φορά. Άφησέ το κλειστό για δίσκο ή κοινόχρηστο φάκελο σε αυτό το μηχάνημα, που χρειάζεται ακόμη το αντίγραφο εκτός τόπου.",
  "repos.offsiteRemote": "εκτός τόπου",
  "repos.offsiteRemoteHint": "Ένα απομακρυσμένο αποθετήριο είναι ήδη εκτός τόπου, οπότε η αναπαραγωγή εκτός τόπου δεν το αντιγράφει ποτέ ξανά.",
