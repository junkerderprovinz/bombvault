...
const el: Partial<Translations> = {
  ...
  "files.deleteSetConfirm": "Αφαίρεση αυτού του συνόλου αρχείων από τη λίστα; Τα αντίγραφά του δεν διαγράφονται και μπορούν να ανακαλυφθούν ξανά αργότερα.",
  "files.deleteBackupsConfirm": "Διαγραφή ΟΛΩΝ των αντιγράφων αυτού του συνόλου αρχείων; Τα στιγμιότυπα αφαιρούνται μόνιμα, το αποθετήριο κλαδεύεται και το σύνολο ξεχνιέται. Μη αναστρέψιμο.",
  ...
  "activityLog.domainFiles": "Αρχεία",
