...
const fi: Partial<Translations> = {
  ...
  "dbdump.stackRestoreWarn": "Kohteiden {names} data kopioidaan pinon ollessa käynnissä. Tuo palautuksen jälkeen niiden uusin tietokantavedos ennen kuin käytät sovelluksia.",
  "dbdump.introNotice": "BombVault vedostaa tunnistamansa tietokannat ennen jokaista varmuuskopiota omiksi palautuspisteikseen. Tunnistettu täällä: {count}, ensimmäinen on {name}. Voit kytkeä tämän pois konttikohtaisesti sen kortilta tai kaikilta konteilta Asetuksista.",
  ...
  "dbdump.importStopsOne": "Tuonnin ajaksi BombVault pysäyttää myös sovelluksen {app}. Sen jälkeen se käynnistetään uudelleen, paitsi jos tuonti epäonnistuu eikä vanhoja tietoja saada palautettua.",
  "dbdump.importStopsMany": "Tuonnin ajaksi BombVault pysäyttää myös nämä sovellukset: {apps}. Sen jälkeen ne käynnistetään uudelleen, paitsi jos tuonti epäonnistuu eikä vanhoja tietoja saada palautettua.",
  ...
  "recovery.foreignDbDumps": "Tietokantavedoksia tässä arkistossa: {count}. Hae yksi restic-komentorivillä, kuten palautuspaketti kuvaa.",
  ...
  "recovery.dumpOnlySkipped": "Vain vedoksena tallessa olevat tietokannat jäävät tässä ulkopuolelle: {count}. Palauta ja tuo ne niiden omasta luettelosta.",
