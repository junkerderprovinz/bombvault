...
const fi: Partial<Translations> = {
  ...
  "settings.everythingHint": "Suorittaa jokaisen osa-alueen kerran, järjestyksessä (kontit, VMs, flash, kansiot ja lopuksi itsevarmuuskopion), jotta yksi ping jälkeenpäin (alla olevan post-komennon kautta) vahvistaa koko palvelimen olevan suojattu. Oletuksena pois päältä ja riippumaton kunkin osa-alueen omasta aikataulusta yllä.",
  "settings.everythingDuplicateWarning": "Kontit, VMs, flash, kansiot ja itsevarmuuskopio varmuuskopioidaan kahdesti niin kauan kuin sekä tämä aikataulu että niiden oma ovat päällä: kerran täällä ja kerran omalla aikataulullaan. Kytke pois ne osa-alueet, joita et halua kahdentaa.",
