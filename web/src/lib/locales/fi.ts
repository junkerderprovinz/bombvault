...
const fi: Partial<Translations> = {
  ...
  "dbdump.introNotice": "BombVault vedostaa {count} tunnistettua tietokantaa ennen jokaista varmuuskopiota omiksi palautuspisteikseen. Voit kytkeä tämän pois konttikohtaisesti sen kortilta tai kaikilta konteilta Asetuksista.",
  ...
  "dbdump.fixRepository": "Varmuuskopiovarasto ei ottanut vedosta vastaan tai talletti vähemmän tavuja kuin vedostettiin. Tarkista varasto kohdassa Asetukset, Tallennus; vedos yritetään uudelleen seuraavan varmuuskopion yhteydessä.",
  ...
  "recovery.dumpOnlySkipped": "{count} vain vedoksena tallessa olevaa tietokantaa jää ulkopuolelle; palauta ja tuo ne niiden omasta luettelosta.",
