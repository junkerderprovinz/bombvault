...
const fi: Partial<Translations> = {
  ...
  "dbdump.importStopsOne": "Tuonnin ajaksi BombVault pysäyttää myös sovelluksen {app} ja käynnistää sen sen jälkeen uudelleen.",
  "dbdump.importStopsMany": "Tuonnin ajaksi BombVault pysäyttää myös nämä sovellukset ja käynnistää ne sen jälkeen uudelleen: {apps}.",
