...
const fi: Partial<Translations> = {
  ...
  "files.emptySelectionBlocked": "Joukko tarvitsee vähintään yhden kansion, joten viimeistä valintaa ei voi poistaa. Käytä Poista joukko -toimintoa, jos et enää tarvitse tätä joukkoa.",
