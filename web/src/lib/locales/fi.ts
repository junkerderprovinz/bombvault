...
const fi: Partial<Translations> = {
  ...
  "about.report": "Löysitkö jotain vai puuttuuko jotain? Avaa issue GitHubissa tai lähetä sähköpostia. Yllä oleva versio auttaa kummassakin tapauksessa.",
  "about.repo": "Repositorio",
  "about.mail": "Kirjoita sähköposti",
