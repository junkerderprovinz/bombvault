...
const fi: Partial<Translations> = {
  ...
  "files.empty": "Ei vielä tiedostojoukkoja. Lisää kansio — jaot, dokumentit, valokuvat, mikä tahansa liitostesi alla — ja BombVault suojaa sen kuten kaiken muunkin: aikataulut, etäkopiot, eheystarkistukset ja palautukset. Erillistä tiedostovarmuuskopiointityökalua ei tarvita.",
  "files.addSet": "Lisää tiedostojoukko",
  "files.editSet": "Muokkaa tiedostojoukkoa",
  "files.name": "Nimi",
  "files.path": "Kansio",
  ...
  "files.deleteSetConfirm": "Poistetaanko tämä tiedostojoukko luettelosta? Sen varmuuskopioita ei poisteta, ja ne voi löytää myöhemmin uudelleen.",
  "files.deleteBackupsConfirm": "Poistetaanko KAIKKI tämän tiedostojoukon varmuuskopiot? Tilannevedokset poistetaan pysyvästi, repositorio karsitaan ja joukko unohdetaan. Tätä ei voi peruuttaa.",
  ...
  "activityLog.domainFiles": "Tiedostot",
