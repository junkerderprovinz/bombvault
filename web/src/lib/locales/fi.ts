...
const fi: Partial<Translations> = {
  ...
  "settings.dashTileCa": "Se voi löytyä myös Community Applications -sovelluksesta — hae nimellä BombVault Dashboard.",
  "settings.dashTileNotInstalled": "Kojelaudan ruutulisäosaa ei ole asennettu.",
  "settings.dashTileConfirm": "Asenna asentaa bombvault-dashboard-lisäosan Unraid-isännällesi Unraidin tavallisen lisäosamekanismin kautta. Se näkyy Plugins-kohdassa kuten mikä tahansa muu lisäosa ja sen voi poistaa sieltä (tai täältä) milloin vain.",
