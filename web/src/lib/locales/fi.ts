...
const fi: Partial<Translations> = {
  ...
  "settings.labelsHint": "Kuinka paljon säätimestä näytetään: sen sanat, sen symboli vai molemmat. Painikkeet säilyttävät saman leveyden kaikissa kolmessa, joten vaihtaminen ei järjestä sivua uudelleen.",
