...
const fi: Partial<Translations> = {
  ...
  "repos.itemHint": "Minne tämän kohteen varmuuskopiot menevät. Jätä se toimialueen arkistoon, ellei juuri tämä kohde tarvitse omaa; tavallinen syy on suuri, harvoin muuttuva kohde, josta halutaan vain etäkopio. Luettelossa on se, minkä olet luonut Asetuksissa. Etäreplikointi ei kopioi toiseen kertaan etäarkistoa eikä arkistoa, joka on merkitty jo etäällä olevaksi.",
  ...
  "repos.offsite": "Jo etäällä",
  "repos.offsiteHint": "Toisen koneen jaetulle kansiolle, esimerkiksi kylmävarastona käytetylle NAS-laitteelle. Etäreplikointi jättää tämän arkiston silloin pois, kuten etäarkistonkin, eikä sen varmuuskopioita kopioida toiseen kertaan. Jätä pois päältä tämän koneen levylle tai jaetulle kansiolle, sillä ne tarvitsevat etäkopion edelleen.",
  "repos.offsiteRemote": "etäällä",
  "repos.offsiteRemoteHint": "Etäarkisto on jo etäällä, joten etäreplikointi ei koskaan kopioi sitä uudelleen.",
