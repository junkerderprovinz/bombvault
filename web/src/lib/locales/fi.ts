...
const fi: Partial<Translations> = {
  ...
  "takeover.backup": "1 varmuuskopio",
  "takeover.backups": "{n} varmuuskopiota",
  ...
  "takeover.historyOne": "Merkinnän {old} varmuuskopio siirtyy osaksi merkinnän {new} historiaa.",
  "takeover.historyMany": "Merkinnän {old} {n} varmuuskopiota siirtyy osaksi merkinnän {new} historiaa.",
  ...
  "pull.snapshotsPulled": "{n} snapshotia noudettu",
  "pull.nothingNew": "Ei mitään uutta noudettavaa.",
  "pull.pulled": "Noudettiin {n} snapshotia.",
