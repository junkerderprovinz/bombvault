...
const fi: Partial<Translations> = {
  ...
  "settings.offsiteHint": "Jokaisen onnistuneen paikallisen varmuuskopion jälkeen se monistetaan myös toiseen repoon komennolla restic copy. Anna etärepo (rest:http://host:8000/repo, s3:…) tai paikallinen alipolku; jätä tyhjäksi poistaaksesi käytöstä. Paikallinen varmuuskopio pysyy ensisijaisena.",
  "source.label": "Lähde:",
  ...
  "ransomware.replicationPaused": "etäkopiointi keskeytetty: vahvista sijoittelu",
  ...
  "pull.repoLocationHint": "Lähde-esiintymän varasto: rest:, s3:, sftp:, tai alipolku isäntäliitoksen alla. rclone:-sijainti hylätään, koska rclone tavoittaisi sen TÄMÄN esiintymän etäsijainneilla.",
  ...
  "pull.credsHint": "Kirjautuminen tallennustilaan, jolla lähteen arkisto sijaitsee: s3: tai salasanalla suojattu rest:-palvelin. Nouto ei koskaan käytä tämän koneen omia tunnuksia, joten lähde, joka vaatii kirjautumisen eikä sillä ole tässä valintaa, hylätään.",
  ...
  "repos.locationPlaceholder": "backups/cold tai s3:s3.eu-central-003.backblazeb2.com/bucket/path",
  "repos.locationHint": "Kansio isäntäliitoksen alla tai restic-etäarkisto kuten s3:..., sftp:..., rest:... tai rclone:... Etäarkistoon kirjoitetaan suoraan, ilman paikallista välikopiota.",
  ...
  "repos.offPremises": "Rakennuksen ulkopuolella",
  "repos.offPremisesHint": "Lasketaan korttien sijainneissa ja 3-2-1-säännössä omaksi sijainnikseen. Kopioihin tämä ei vaikuta. Samassa rakennuksessa olevalla rest-serverillä tämän pitäisi olla pois päältä.",
  ...
  "placementCode.copyRuleTaken": "Sillä nimellä on jo omat kopiointisäännöt.",
  ...
  "placement.titleHint": "Minne tämän kohteen varmuuskopiot kirjoitetaan ja minne ne kopioidaan sen jälkeen. Sijainti on kiinteä ensimmäisestä varmuuskopiosta lähtien, kopioita voi muuttaa milloin tahansa.",
  "placement.unreadable": "Sijoittelua ei voitu lukea",
  "placement.noCopyNow": "Juuri nyt ei kopiota, pois päältä: {targets}. Valitse kohde tai valitse Paikallinen.",
  "placement.followsDefault": "Noudattaa oletusta",
  "placement.ownCopies": "Omat kopiot",
  "placement.homeSet": "Sijainti asetettu: {home}",
  "placement.copiesFollow": "Kopiot noudattavat oletusta",
  "placement.reset": "Palauta",
  ...
  // Timeline
  "timeline.deleteAsk": "Poistetaanko tämä varmuuskopio täältä: {list}?",
  ...
  "timeline.onlyHere": "vain täällä",
  "timeline.incomplete": "vaillinainen",
  "timeline.incompleteHint": "Kaikki tämän ajon levyt eivät ole täällä, joten tätä paikkaa ei valita palautukseen.",
  "timeline.snapshotMissing": "{place}-lla ei ole enää tätä varmuuskopiota. Palautetaanko kohteesta {next}?",
  "timeline.stackDirMissing": "Projektikansiota ei ole kohteessa {place}. Käytetäänkö tilaa kohteesta {home}?",
  // Direct repository
  ...
  "placementDefaults.homeOff": "{home} on pois päältä. Kohteita ilman sijaintia ei varmuuskopioida ennen kuin se on taas päällä tai oletus muuttuu.",
  "placementDefaults.homeMissing": "Oletus osoittaa säilöön, jota ei enää ole. Kohteita ilman sijaintia ei varmuuskopioida.",
  "placementDefaults.confirmHome": "Uudet kohteet kohteessa {domain} ottavat {home} ensimmäisessä varmuuskopioinnissaan. Sijainnin omaavat kohteet säilyttävät sen.",
  "placementDefaults.dropAsk": "Kohteet ja projektikansiot, joita {target} ei enää saa: {n}. Kopiot, jotka jäävät sinne: {copies}.",
  "placementDefaults.dropAskUnknown": "Kohteet ja projektikansiot, joita {target} ei enää saa: {n}. {target} ei ole koskaan ollut listattuna tälle alueelle, joten ei vielä tiedetä, montako kopiota sinne jää.",
  "placementDefaults.addAsk": "Kohteet ja projektikansiot, jotka {target} saa tästä lähtien: {n}. Seuraavalla ajolla ladattavat tilannevedokset: enintään {snapshots}.",
  "placementDefaults.openTakeHome": "Kohteet ilman sijaintia, jotka ottavat {home} ensimmäisessä varmuuskopioinnissaan: {n}.",
  "placementDefaults.apply": "Käytä kohteisiin ilman varmuuskopioita",
  "placementDefaults.applyAsk": "Sijainti ja kopiot palautuvat oletukseen näillä kohteilla: {n}.",
  "placementDefaults.applyLoses": "Menettävät samalla oman valintansa: {list}",
  "placementDefaults.applyKeptBackups": "Pysyvät ennallaan, niillä on varmuuskopioita: {list}",
  "placementDefaults.applyKeptUnreadable": "Pysyvät ennallaan, niiden sijaintia ei voitu lukea: {list}",
  "placementDefaults.applyKeptChanged": "Muuttuneet sillä välin ja jätetty rauhaan: {list}",
  "placementDefaults.applyNone": "Yksikään kohde ilman varmuuskopioita ei eroa oletuksesta.",
  "placementDefaults.applyBusy": "Varmuuskopiointi on käynnissä. Käytä uudelleen sen päätyttyä.",
  "placementDefaults.paused": "Etä on tauolla uudelleenrakennuksen jälkeen",
  "placementDefaults.pausedHint": "Säännöt ja oletukset katosivat vanhan asetuksen mukana. Alueesta {domain} ei kopioida mitään etänä, ennen kuin tämä oletus on vahvistettu. Korttia sisältävät kohteet voi ensin asettaa Paikalliseksi.",
  "placementDefaults.confirm": "Vahvista oletus",
  "placementDefaults.confirmAsk": "Seuraavalla ajolla kopioidaan tämä:",
  "placementDefaults.unmatched": "Nimiä varmuuskopioissa ilman merkintää täällä. Rastitetut jätetään pois:",
  "placementDefaults.unmatchedLine": "{name}, tilannevedokset: {n}",
  "placementDefaults.confirmed": "Oletus vahvistettu. Etäkopiot jatkuvat seuraavalla ajolla.",
  ...
  "placement.planNoCopy": "Ei kopiota rakennuksen ulkopuolella.",
  ...
  "placement.older": "Vanhempia kopioita kohteessa {target}: {n}, viimeksi nähty {date}",
  "placement.noCopyYet": "{place}: ei vielä kopiota",
  "placement.notListedYet": "{place}: ei vielä listattu",

  // Removal
  "offsiteRemoval.delete": "Poista kohteessa {target}",
  "offsiteRemoval.ask": "Poistetaanko jokainen kopio kohteesta {name} kohteessa {target}? Kopioita: {n}.",
  "offsiteRemoval.onlyThere": "Näitä tilannevedoksia ei ole muualla, ja ne katoavat sen jälkeen pysyvästi:",
