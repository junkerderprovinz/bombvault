...
const fi: Partial<Translations> = {
  ...
  "settings.everythingOverlapWarning": "Tämä toimii riippumatta yllä olevista osa-alueiden omista aikatauluista. Jos molemmat ovat päällä, kontit, VMs, flash, kansiot ja itsevarmuuskopio varmuuskopioidaan kumpikin kahdesti: kerran täällä, kerran omalla aikataulullaan. Poista käytöstä ne osa-alueet, joita et halua kahdennettavan.",
