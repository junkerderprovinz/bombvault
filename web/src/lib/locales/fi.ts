...
const fi: Partial<Translations> = {
  ...
  "about.body": "Yksi ritari, yksi ristiretki: vapaita, hyvännäköisiä avoimen lähdekoodin työkaluja, joita ei ollut siinä muodossa kuin halusin. Rakennetaan, kunnes mitään ei puutu. Ei tilejä, ei telemetriaa, ei mainoksia. Ei kokeilujaksoa, ei maksutasoja, ei pientä präntättyä. Mikään luettava ei poistu koskaan omien muuriesi sisältä. Taottu iltaisin ja viikonloppuisin, sydämellä ja jääräpäisyydellä.",
  "about.coffee": "Jos BombVaultista on sinulle hyötyä, lahjoitus kattaa sen, mitä pyörittäminen maksaa: verkkotunnuksen, palvelimen ja illat, jotka siihen kuluvat. Ja saa tämän ritarin sydämen lyömään hieman nopeammin. Alla on kolme tapaa, valitse se joka sinulle sopii.",
  ...
  "auth.twoFactorEnable": "Ota käyttöön",
