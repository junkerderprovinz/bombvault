...
const es: Partial<Translations> = {
  ...
  "dbdump.introNotice": "BombVault vuelca {count} bases de datos reconocidas antes de cada copia, como puntos de restauración propios. Puedes desactivarlo por contenedor en su tarjeta o para todos los contenedores en Ajustes.",
  ...
  "dbdump.fixRepository": "El repositorio de copias no aceptó el volcado, o guardó menos bytes de los que se volcaron. Revisa el repositorio en Ajustes, Almacenamiento; el volcado se reintenta con la próxima copia.",
  ...
  "recovery.dumpOnlySkipped": "{count} bases de datos guardadas solo como volcado se quedan fuera; restáuralas e impórtalas desde su propia lista.",
