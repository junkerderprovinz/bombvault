...
const es: Partial<Translations> = {
  ...
  "settings.labelsHint": "Cuánto se muestra de un control: sus palabras, su símbolo o ambos. Los botones mantienen el mismo ancho en los tres casos, así que cambiar no reorganiza la página.",
