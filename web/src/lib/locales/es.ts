...
const es: Partial<Translations> = {
  ...
  "files.empty": "Aún no hay conjuntos de archivos. Añade una carpeta — shares, documentos, fotos, cualquier cosa bajo tus montajes — y BombVault la protege como todo lo demás: calendarios, copias externas, comprobaciones de integridad y restauraciones. No necesitas una herramienta de copias de archivos aparte.",
  "files.addSet": "Añadir conjunto de archivos",
  "files.editSet": "Editar conjunto de archivos",
  "files.name": "Nombre",
  "files.path": "Carpeta",
  ...
  "files.deleteSetConfirm": "¿Quitar este conjunto de archivos de la lista? Sus copias no se eliminan y podrán redescubrirse más tarde.",
  "files.deleteBackupsConfirm": "¿Eliminar TODAS las copias de este conjunto de archivos? Las instantáneas se eliminan permanentemente, el repositorio se poda y el conjunto se olvida. No se puede deshacer.",
  ...
  "activityLog.domainFiles": "Archivos",
