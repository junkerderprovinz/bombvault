...
const es: Partial<Translations> = {
  ...
  "settings.offsiteHint": "Después de cada copia local correcta, replicarla también a un segundo repositorio con restic copy. Indica un remoto (rest:http://host:8000/repo, s3:…) o una subruta local; deja en blanco para desactivar. La copia local sigue siendo la principal.",
  "source.label": "Origen:",
  "source.local": "Local",
  ...
  "ransomware.replicationPaused": "copia externa en pausa: confirma la ubicación",
  ...
  "settingsIO.previewCopyRules": "Reglas de copia",
  "settingsIO.previewNotInFile": "no está en el archivo, se mantiene igual",
  ...
  "pull.repoLocationHint": "El repositorio de la instancia de origen: rest:, s3:, sftp:, o una subruta bajo el montaje del host. Una ubicación rclone: se rechaza, porque rclone la alcanzaría con los remotos de ESTA instancia.",
  ...
  "pull.credsHint": "Las credenciales del almacenamiento donde está el repositorio del origen: s3: o un servidor rest: con contraseña. Una recogida nunca usa las credenciales de esta máquina, así que un origen que necesite identificarse y no tenga ninguna elegida aquí será rechazado.",
  ...
  "repos.locationHint": "Una carpeta bajo el montaje del anfitrión, o un repositorio remoto de restic como s3:..., sftp:..., rest:... o rclone:... En el remoto se escribe directamente, sin copia local intermedia.",
  ...
  "repos.offPremises": "Fuera del local",
  "repos.offPremisesHint": "Cuenta como una sede propia para las sedes y el 3-2-1 en las tarjetas. No afecta a las copias. Un rest-server en el mismo edificio debería tener esto desactivado.",
  ...
  "placementCode.copyRuleTaken": "Ese nombre ya tiene sus propias reglas de copia.",
  ...
  "placementCode.exclusionUnsaved": "El destino se guardó. Lo que debe excluir, no.",
  ...
  "placement.segLocalOffsite": "Local + externo",
  "placement.segOffsiteOnly": "Solo externo",
  "placement.homeDomain": "{host} · repositorio del dominio · {path}",
  "placement.homeDomainRemote": "Repositorio del dominio · remoto · {scheme}",
  "placement.homeLocal": "{name} · montado",
  "placement.homeRemote": "{name} · remoto",
  "placement.homeDirect": "{target} · directo",
  "placement.directNotYet": "se crea al elegirlo por primera vez",
  "placement.off": "{name} (apagado)",
  "placement.unknown": "{name} (desconocido)",
  "placement.noTarget": "No hay ningún destino externo configurado",
  "placement.lockOwnCredentials": "Tiene sus propias credenciales y ya está fuera de las instalaciones",
  "placement.lockAtTarget": "Ya está en el destino",
  "placement.lockHomeFixed": "Fijo desde la primera copia de seguridad: {home}",
  "placement.droppedKeeps": "{target} conserva sus copias ({n}) y las recorta según su propia regla en la próxima ejecución. No se añaden copias nuevas.",
  "placement.droppedKeepsUnknown": "{target} conserva sus copias y las recorta según su propia regla en la próxima ejecución. No se añaden copias nuevas.",
  "placement.droppedAppendOnly": "{target} es append-only y conserva todas las copias. No se añaden copias nuevas.",
  "placement.saveHome": "Definir",
  "placement.fixedSinceFirst": "fijo desde la primera copia de seguridad",
  ...
  "placement.titleHint": "Dónde se escriben las copias de seguridad de este elemento y adónde se copian después. La ubicación queda fija desde la primera copia de seguridad, las copias pueden cambiar en cualquier momento.",
  "placement.unreadable": "No se pudo leer la ubicación",
  "placement.noCopyNow": "Ahora mismo ninguna copia, desactivado: {targets}. Marca un destino o elige Local.",
  "placement.followsDefault": "Sigue el valor predeterminado",
  "placement.ownCopies": "Copias propias",
  "placement.homeSet": "Ubicación establecida: {home}",
  "placement.copiesFollow": "Las copias siguen el valor predeterminado",
  ...
  // Timeline
  "timeline.deleteAsk": "¿Borrar esta copia de seguridad aquí: {list}?",
  ...
  "timeline.onlyHere": "solo aquí",
  "timeline.incomplete": "incompleta",
  "timeline.incompleteHint": "No todos los discos de esta ejecución están aquí, así que este lugar no se elige para una restauración.",
  "timeline.snapshotMissing": "{place} ya no tiene esta copia de seguridad. ¿Restaurar desde {next}?",
  "timeline.stackDirMissing": "La carpeta del proyecto no está en {place}. ¿Usar el estado de {home}?",
  // Direct repository
  ...
  "directRepo.testEmpty": "Accesible, vacío",
  "directRepo.testExisting": "Ya contiene un repositorio",
  "directRepo.testFailed": "No accesible: {error}",
  "directRepo.bucketRoot": "{target} está en la raíz de su bucket, así que cualquier ruta en ese bucket quedaría dentro de él. Elige otro bucket.",
  "directRepo.pathNeeded": "Este rest-server mantiene repositorios privados. Introduce la ruta para el repositorio directo.",
  "directRepo.addAndUse": "Crear y usar",
  "directRepo.draftNote": "Se crea junto con el conjunto de carpetas.",
  ...
  "placementDefaults.homeOff": "{home} está apagado. Los elementos sin ubicación no se respaldan hasta que vuelva a estar encendido o cambie el valor predeterminado.",
  "placementDefaults.homeMissing": "El valor predeterminado apunta a un repositorio que ya no existe. Los elementos sin ubicación no se respaldan.",
  "placementDefaults.confirmHome": "Los elementos nuevos en {domain} toman {home} en su primera copia de seguridad. Los elementos con ubicación la conservan.",
  "placementDefaults.dropAsk": "Elementos y carpetas de proyecto que {target} deja de recibir: {n}. Copias que se quedan allí: {copies}.",
  "placementDefaults.dropAskUnknown": "Elementos y carpetas de proyecto que {target} deja de recibir: {n}. {target} nunca estuvo listado para este dominio, así que aún no se sabe cuántas copias quedan allí.",
  "placementDefaults.addAsk": "Elementos y carpetas de proyecto que {target} recibe a partir de ahora: {n}. Instantáneas subidas en la próxima ejecución: como máximo {snapshots}.",
  "placementDefaults.openTakeHome": "Elementos sin ubicación que toman {home} en su primera copia de seguridad: {n}.",
  "placementDefaults.apply": "Aplicar a elementos sin copias de seguridad",
  "placementDefaults.applyAsk": "La ubicación y las copias vuelven al valor predeterminado para estos elementos: {n}.",
  "placementDefaults.applyLoses": "Pierden su elección propia: {list}",
  "placementDefaults.applyKeptBackups": "Se quedan como están, tienen copias de seguridad: {list}",
  "placementDefaults.applyKeptUnreadable": "Se quedan como están, su ubicación no se pudo leer: {list}",
  "placementDefaults.applyKeptChanged": "Cambiados mientras tanto y dejados en paz: {list}",
  "placementDefaults.applyNone": "Ningún elemento sin copias de seguridad difiere del valor predeterminado.",
  "placementDefaults.applyBusy": "Hay una copia de seguridad en curso. Aplica de nuevo cuando termine.",
  "placementDefaults.paused": "Externo en pausa tras una reconstrucción",
  "placementDefaults.pausedHint": "Las reglas y los valores predeterminados se perdieron con la configuración antigua. Nada de {domain} se copia externamente hasta que se confirme este valor predeterminado. Los elementos con tarjeta se pueden poner en Local primero.",
  "placementDefaults.confirm": "Confirmar valor predeterminado",
  "placementDefaults.confirmAsk": "En la próxima ejecución, se copia esto:",
  "placementDefaults.unmatched": "Nombres en las copias de seguridad sin entrada aquí. Los marcados se dejan fuera:",
  "placementDefaults.unmatchedLine": "{name}, instantáneas: {n}",
  "placementDefaults.confirmed": "Valor predeterminado confirmado. Las copias externas se reanudan en la próxima ejecución.",

  // New target
  "newTarget.intro": "En su primera ejecución, {target} recibe todos los elementos que no están en Local.",
  "newTarget.moved": "La nueva ubicación de {target} recibe todo el historial.",
  "newTarget.items": "Elementos y carpetas de proyecto: {n}",
  "newTarget.snapshots": "Instantáneas: hasta {n}",
  "newTarget.size": "Tamaño: hasta {size}",
  "newTarget.formerly": "Excluido hasta ahora de otros destinos: {list}",
  "newTarget.excludeHere": "Excluir también aquí",
  "newTarget.excludeDefault": "Excluir también {target} del valor predeterminado",
  "newTarget.importHeading": "Nuevo destino {target} para {domain}",

  // Discover
  "discover.paused": "Las copias externas de {domains} están en pausa hasta que se confirme el valor predeterminado en {where}.",
  "discover.leftOpen": "Ubicación dejada abierta porque había una copia de seguridad en curso: {list}",
  ...
  "placement.older": "Copias más antiguas en {target}: {n}, vista por última vez {date}",
  "placement.noCopyYet": "{place}: todavía sin copia",
  "placement.notListedYet": "{place}: todavía no listada",

  // Removal
  "offsiteRemoval.delete": "Borrar en {target}",
  "offsiteRemoval.ask": "¿Borrar todas las copias de {name} en {target}? Copias: {n}.",
  "offsiteRemoval.onlyThere": "Estas instantáneas no existen en ningún otro lugar y desaparecen para siempre después:",
