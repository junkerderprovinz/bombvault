...
const es: Partial<Translations> = {
  ...
  "about.body": "Un solo caballero, una cruzada: herramientas libres, bien hechas y de código abierto que no existían con la forma que yo quería. Construidas hasta que no falte nada. Sin cuentas, sin telemetría, sin anuncios. Sin periodo de prueba, sin planes de pago, sin letra pequeña. Nada legible sale nunca de tus propios muros. Forjado en tardes y fines de semana, con corazón y cabezonería.",
  "about.coffee": "Si BombVault te sirve, una donación cubre lo que cuesta mantenerlo en pie: el dominio, el servidor y las tardes que se le dedican. Y además hace que el corazón de este caballero lata un poco más rápido. Abajo hay tres caminos, elige el que te venga bien.",
  ...
  "auth.twoFactor": "Autenticación en dos pasos",
