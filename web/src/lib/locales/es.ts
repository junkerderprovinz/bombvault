...
const es: Partial<Translations> = {
  ...
  "dbdump.importStopsOne": "Mientras importa, BombVault también detiene {app} y después lo vuelve a iniciar.",
  "dbdump.importStopsMany": "Mientras importa, BombVault también detiene estas aplicaciones y después las vuelve a iniciar: {apps}.",
