...
const es: Partial<Translations> = {
  ...
  "activityLog.lineOffsiteRunningSnapshotPercent": "Subida externa — {domain} … snapshot {index} de {total} ({percent}%)",
  "activityLog.lineOffsiteRunningSnapshotPercentWithDuration": "Subida externa — {domain} … snapshot {index} de {total} ({percent}%) · {duration}",
  ...
  "schedule.overrideHint": "Vacío usa la programación de la categoría. Las anulaciones por elemento no admiten el modo cada N días.",
