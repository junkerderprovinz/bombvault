...
const es: Partial<Translations> = {
  ...
  "settings.dashTileCa": "Puede que también esté disponible en Community Applications — busca BombVault Dashboard.",
  "settings.dashTileNotInstalled": "El plugin del mosaico del panel no está instalado.",
  "settings.dashTileConfirm": "Instalar instala el plugin bombvault-dashboard en tu host de Unraid mediante el mecanismo de plugins habitual de Unraid. Aparece en Plugins como cualquier otro plugin y puede eliminarse allí (o aquí) en cualquier momento.",
