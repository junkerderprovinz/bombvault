...
const es: Partial<Translations> = {
  ...
  "files.emptySelectionBlocked": "Un conjunto necesita al menos una carpeta, así que no se puede quitar la última marca. Usa Quitar conjunto si ya no quieres este conjunto.",
