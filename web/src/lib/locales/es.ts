...
const es: Partial<Translations> = {
  ...
  "repos.itemHint": "Adónde van las copias de este elemento. Déjalo en el repositorio del dominio salvo que este necesite uno propio; el motivo habitual es un elemento grande y que cambia poco del que solo se quiere una copia externa. La lista contiene lo que hayas creado en Ajustes. La replicación externa no vuelve a copiar un repositorio remoto ni uno marcado como ya externo.",
  ...
  "repos.offsite": "Ya es externo",
  "repos.offsiteHint": "Para una carpeta compartida en otra máquina, como un NAS de almacenamiento en frío. La replicación externa deja fuera este repositorio, igual que uno remoto, y sus copias no se copian una segunda vez. Déjalo desactivado para un disco o carpeta compartida de esta máquina, que sigue necesitando la copia externa.",
  "repos.offsiteRemote": "externo",
  "repos.offsiteRemoteHint": "Un repositorio remoto ya es externo, así que la replicación externa nunca vuelve a copiarlo.",
