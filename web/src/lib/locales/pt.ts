...
const pt: Partial<Translations> = {
  ...
  "settings.everythingOverlapWarning": "Isto é executado de forma independente dos agendamentos de cada domínio acima. Se ambos estiverem ativos, os containers, as VMs, o flash, as pastas e o auto-backup são cada um copiados duas vezes: uma vez aqui, outra no seu próprio agendamento. Desativa os domínios que não queres duplicados.",
