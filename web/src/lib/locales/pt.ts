...
const pt: Partial<Translations> = {
  ...
  "about.coffee": "O BombVault é grátis e assim fica. Um donativo mantém o projeto vivo e cobre o que ele custa: o domínio, o servidor e as noites que lhe são dadas.",
