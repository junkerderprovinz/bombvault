...
const pt: Partial<Translations> = {
  ...
  "dbdump.introNotice": "O BombVault faz o dump de {count} bases de dados reconhecidas antes de cada cópia, como pontos de restauro próprios. Podes desligar isto por contentor no seu cartão ou para todos os contentores nas Definições.",
  ...
  "dbdump.fixRepository": "O repositório de cópias não aceitou o dump, ou guardou menos bytes do que os extraídos. Verifica o repositório em Definições, Armazenamento; o dump é tentado outra vez com a próxima cópia.",
  ...
  "recovery.dumpOnlySkipped": "{count} bases de dados guardadas só como despejo ficam de fora; restaura-as e importa-as da sua própria lista.",
