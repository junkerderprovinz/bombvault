...
const pt: Partial<Translations> = {
  ...
  "settings.offsiteHint": "Após cada backup local bem-sucedido, replicá-lo também para um segundo repositório com restic copy. Informe um remoto (rest:http://host:8000/repo, s3:…) ou um subcaminho local; deixe em branco para desativar. O backup local continua sendo o principal.",
  "source.label": "Origem:",
  "source.local": "Local",
  ...
  "ransomware.replicationPaused": "cópia externa em pausa: confirme a localização",
  ...
  "pull.repoLocationHint": "O repositório da instância de origem: rest:, s3:, sftp:, ou um subcaminho dentro da montagem do anfitrião. Uma localização rclone: é recusada, porque o rclone chegaria lá com os remotos DESTA instância.",
  ...
  "pull.credsHint": "As credenciais do armazenamento onde está o repositório da origem: s3: ou um servidor rest: com senha. Uma recolha nunca usa as credenciais desta máquina, por isso uma origem que precise de autenticação e não tenha nenhuma escolhida aqui é recusada.",
  ...
  "repos.locationHint": "Uma pasta sob a montagem do anfitrião, ou um repositório restic remoto como s3:..., sftp:..., rest:... ou rclone:... No remoto escreve-se diretamente, sem cópia local pelo meio.",
  ...
  "repos.directOf": "pertence a {target} · itens: {n}",
  "repos.companionLost": "ao lado de um destino eliminado",
  "repos.mirroredLocked": "Herdado de {target}. Muda-o lá.",
  "repos.removeWithTarget": "Vai com {target}. Para remover este repositório, remove esse destino.",
  "repos.offPremises": "Fora das instalações",
  ...
  "placement.segOffsiteOnly": "Apenas externo",
  "placement.homeDomain": "{host} · repositório do domínio · {path}",
  "placement.homeDomainRemote": "Repositório do domínio · remoto · {scheme}",
  "placement.homeLocal": "{name} · montado",
  "placement.homeRemote": "{name} · remoto",
  "placement.homeDirect": "{target} · direto",
  "placement.directNotYet": "criado ao ser escolhido pela primeira vez",
  "placement.off": "{name} (desligado)",
  "placement.unknown": "{name} (desconhecido)",
  "placement.noTarget": "Nenhum destino externo configurado",
  "placement.lockOwnCredentials": "Tem credenciais próprias e já está fora das instalações",
  "placement.lockAtTarget": "Já está no destino",
  "placement.lockHomeFixed": "Fixo desde o primeiro backup: {home}",
  "placement.droppedKeeps": "{target} conserva as suas cópias ({n}) e reduz-as à sua própria regra na próxima execução. Não são adicionadas cópias novas.",
  "placement.droppedKeepsUnknown": "{target} conserva as suas cópias e reduz-as à sua própria regra na próxima execução. Não são adicionadas cópias novas.",
  "placement.droppedAppendOnly": "{target} é append-only e conserva todas as cópias. Não são adicionadas cópias novas.",
  "placement.saveHome": "Definir",
  "placement.fixedSinceFirst": "fixo desde o primeiro backup",
  ...
  "placement.titleHint": "Onde os backups deste item são escritos e para onde são copiados depois. A localização fica fixa desde o primeiro backup, as cópias podem mudar a qualquer momento.",
  "placement.unreadable": "Não foi possível ler a localização",
  "placement.noCopyNow": "No momento nenhuma cópia, desligado: {targets}. Marca um destino ou escolhe Local.",
  "placement.followsDefault": "Segue o padrão",
  "placement.ownCopies": "Cópias próprias",
  "placement.homeSet": "Localização definida: {home}",
  "placement.copiesFollow": "As cópias seguem o padrão",
  "placement.reset": "Repor",
  ...
  // Timeline
  "timeline.deleteAsk": "Apagar este backup aqui: {list}?",
  ...
  "timeline.onlyHere": "só aqui",
  "timeline.incomplete": "incompleto",
  "timeline.incompleteHint": "Nem todos os discos desta execução estão aqui, por isso este local não é escolhido para uma restauração.",
  "timeline.snapshotMissing": "{place} já não tem este backup. Restaurar a partir de {next}?",
  "timeline.stackDirMissing": "A pasta do projeto não está em {place}. Usar o estado de {home}?",
  // Direct repository
  "directRepo.title": "Repositório direto em {target}",
  "directRepo.intro": "Itens que o escolhem são copiados diretamente para {target}, com a sua chave, classe de armazenamento, limites e definição de append-only. Mantém os seus snapshots segundo as regras de {target}. Cancelar não deixa nada.",
  "directRepo.test": "Testar ligação",
  "directRepo.testEmpty": "Acessível, vazio",
  "directRepo.testExisting": "Já contém um repositório",
  "directRepo.testFailed": "Não acessível: {error}",
  "directRepo.bucketRoot": "{target} fica na raiz do seu bucket, por isso qualquer caminho nesse bucket ficaria dentro dele. Escolhe outro bucket.",
  "directRepo.pathNeeded": "Este rest-server guarda repositórios privados. Introduz o caminho do repositório direto.",
  "directRepo.addAndUse": "Criar e usar",
  "directRepo.draftNote": "Criado junto com o conjunto de pastas.",
  ...
  "placementDefaults.homeOff": "{home} está desligado. Itens sem localização não são copiados até que volte a estar ligado ou o padrão mude.",
  "placementDefaults.homeMissing": "O padrão aponta para um repositório que não existe mais. Itens sem localização não são copiados.",
  "placementDefaults.confirmHome": "Itens novos em {domain} assumem {home} no primeiro backup. Itens com localização a mantêm.",
  "placementDefaults.dropAsk": "Itens e pastas de projeto que {target} deixa de receber: {n}. Cópias que ficam lá: {copies}.",
  "placementDefaults.dropAskUnknown": "Itens e pastas de projeto que {target} deixa de receber: {n}. {target} nunca esteve listado para este domínio, então quantas cópias ficam lá ainda não é conhecido.",
  "placementDefaults.addAsk": "Itens e pastas de projeto que {target} recebe a partir de agora: {n}. Instantâneos enviados na próxima execução: no máximo {snapshots}.",
  "placementDefaults.openTakeHome": "Itens sem localização que assumem {home} no primeiro backup: {n}.",
  "placementDefaults.apply": "Aplicar a itens sem backups",
  "placementDefaults.applyAsk": "Localização e cópias voltam ao padrão para estes itens: {n}.",
  "placementDefaults.applyLoses": "Perdem com isso a escolha própria: {list}",
  "placementDefaults.applyKeptBackups": "Permanecem como estão, têm backups: {list}",
  "placementDefaults.applyKeptUnreadable": "Permanecem como estão, a localização não pôde ser lida: {list}",
  "placementDefaults.applyKeptChanged": "Alterados nesse meio tempo e deixados em paz: {list}",
  "placementDefaults.applyNone": "Nenhum item sem backups difere do padrão.",
  "placementDefaults.applyBusy": "Um backup está em andamento. Aplique de novo quando terminar.",
  "placementDefaults.paused": "Externo em pausa após uma reconstrução",
  "placementDefaults.pausedHint": "Regras e padrões foram perdidos com a configuração antiga. Nada de {domain} é copiado externamente até que este padrão seja confirmado. Itens com cartão podem ser definidos como Local antes.",
  "placementDefaults.confirm": "Confirmar padrão",
  "placementDefaults.confirmAsk": "Na próxima execução, isto é copiado:",
  "placementDefaults.unmatched": "Nomes nos backups sem entrada aqui. Os marcados ficam de fora:",
  "placementDefaults.unmatchedLine": "{name}, instantâneos: {n}",
  "placementDefaults.confirmed": "Padrão confirmado. As cópias externas retomam na próxima execução.",
  ...
  // Discover
  "discover.paused": "As cópias externas de {domains} estão em pausa até que o padrão seja confirmado em {where}.",
  "discover.leftOpen": "Localização deixada em aberto porque uma cópia de segurança estava em curso: {list}",
  ...
  "placement.older": "Cópias mais antigas em {target}: {n}, vista pela última vez {date}",
  "placement.noCopyYet": "{place}: ainda sem cópia",
  "placement.notListedYet": "{place}: ainda não listado",

  // Removal
  "offsiteRemoval.delete": "Apagar em {target}",
  "offsiteRemoval.ask": "Apagar todas as cópias de {name} em {target}? Cópias: {n}.",
  "offsiteRemoval.onlyThere": "Estes instantâneos não existem em mais nenhum lugar e desaparecem para sempre depois:",
