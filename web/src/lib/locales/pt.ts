...
const pt: Partial<Translations> = {
  ...
  "pull.snapshotsPulled": "{n} snapshots recolhidos",
  "pull.nothingNew": "Nada de novo para recolher.",
  "pull.pulled": "Recolhidos {n} snapshots.",
