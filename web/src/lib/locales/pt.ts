...
const pt: Partial<Translations> = {
  ...
  "files.empty": "Ainda não há conjuntos de ficheiros. Adicione uma pasta — shares, documentos, fotos, qualquer coisa sob os seus mounts — e o BombVault protege-a como tudo o resto: agendamentos, cópias externas, verificações de integridade e restauro. Não é necessária uma ferramenta separada de backup de ficheiros.",
  "files.addSet": "Adicionar conjunto de ficheiros",
  "files.editSet": "Editar conjunto de ficheiros",
  "files.name": "Nome",
  "files.path": "Pasta",
  ...
  "files.deleteSetConfirm": "Remover este conjunto de ficheiros da lista? Os seus backups não são eliminados e podem ser redescobertos mais tarde.",
  "files.deleteBackupsConfirm": "Eliminar TODOS os backups deste conjunto de ficheiros? Os snapshots são removidos permanentemente, o repositório é podado e o conjunto é esquecido. Não pode ser desfeito.",
  ...
  "activityLog.domainFiles": "Ficheiros",
