...
const pt: Partial<Translations> = {
  ...
  "about.body": "Um só cavaleiro, uma cruzada: ferramentas livres, bonitas e de código aberto que não existiam na forma que eu queria. Construídas até não faltar nada. Sem contas, sem telemetria, sem anúncios. Sem período de teste, sem escalões pagos, sem asterisco nas letras miudinhas. Nada legível sai alguma vez das tuas próprias muralhas. Forjado em noites e fins de semana, com coração e teimosia.",
  "about.coffee": "Se o BombVault te dá jeito, um donativo cobre o que custa mantê-lo de pé: o domínio, o servidor e as noites que lhe são dadas. E ainda faz o coração deste cavaleiro bater um pouco mais depressa. Em baixo há três caminhos, escolhe o que te calhar melhor.",
