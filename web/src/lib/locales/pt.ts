...
const pt: Partial<Translations> = {
  ...
  "files.emptySelectionBlocked": "Um conjunto precisa de pelo menos uma pasta, por isso a última marca não pode ser removida. Usa Remover conjunto se já não queres este conjunto.",
