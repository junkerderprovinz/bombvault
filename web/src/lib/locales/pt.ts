...
const pt: Partial<Translations> = {
  ...
  "settings.labelsHint": "Quanto de um controlo é mostrado: as suas palavras, o seu símbolo ou ambos. Os botões mantêm a mesma largura nos três casos, por isso alternar não reorganiza a página.",
