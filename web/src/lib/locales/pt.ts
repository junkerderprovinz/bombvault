...
const pt: Partial<Translations> = {
  ...
  "settings.dashTileCa": "Ele também pode estar disponível nas Community Applications — procure por BombVault Dashboard.",
  "settings.dashTileNotInstalled": "O plugin do bloco do painel não está instalado.",
  "settings.dashTileConfirm": "Instalar instala o plugin bombvault-dashboard no seu host Unraid pelo mecanismo normal de plugins do Unraid. Ele aparece em Plugins como qualquer outro plugin e pode ser removido lá (ou aqui) a qualquer momento.",
