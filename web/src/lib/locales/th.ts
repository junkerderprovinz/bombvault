...
const th: Partial<Translations> = {
  ...
  "settings.dashTileCa": "อาจมีให้ใน Community Applications ด้วย — ค้นหา BombVault Dashboard",
  "settings.dashTileNotInstalled": "ยังไม่ได้ติดตั้งปลั๊กอินไทล์แดชบอร์ด",
  "settings.dashTileConfirm": "ปุ่มติดตั้งจะติดตั้งปลั๊กอิน bombvault-dashboard บนโฮสต์ Unraid ของคุณผ่านกลไกปลั๊กอินปกติของ Unraid โดยจะปรากฏใน Plugins เหมือนปลั๊กอินอื่น ๆ และถอนออกได้ทุกเมื่อจากที่นั่น (หรือที่นี่)",
