...
const th: Partial<Translations> = {
  ...
  "settings.offsiteHint": "หลังจากการสำรองข้อมูลในเครื่องสำเร็จทุกครั้ง จะทำสำเนาไปยังที่เก็บที่สองด้วย restic copy ด้วย ป้อนที่เก็บระยะไกล (rest:http://host:8000/repo, s3:…) หรือพาธย่อยในเครื่อง; เว้นว่างเพื่อปิดใช้งาน การสำรองในเครื่องยังคงเป็นหลัก",
  ...
  "pull.repoLocationHint": "ที่เก็บของอินสแตนซ์ต้นทาง: rest:, s3:, sftp: หรือพาธย่อยใต้จุดเมานต์ของโฮสต์ ตำแหน่งแบบ rclone: จะถูกปฏิเสธ เพราะ rclone จะเข้าถึงมันด้วย remotes ของอินสแตนซ์นี้",
  ...
  "pull.credsHint": "ข้อมูลเข้าใช้ของที่เก็บข้อมูลซึ่งคลังของต้นทางวางอยู่ ได้แก่ s3: หรือเซิร์ฟเวอร์ rest: ที่มีรหัสผ่าน การดึงจะไม่ใช้ข้อมูลของเครื่องนี้เลย ต้นทางที่ต้องเข้าใช้แต่ไม่ได้เลือกไว้ที่นี่จึงถูกปฏิเสธ",
  ...
  "repos.locationPlaceholder": "backups/cold หรือ s3:s3.eu-central-003.backblazeb2.com/bucket/path",
  "repos.locationHint": "โฟลเดอร์ใต้จุดเมานต์ของโฮสต์ หรือที่เก็บ restic ระยะไกล เช่น s3:..., sftp:..., rest:... หรือ rclone:... เขียนไปยังปลายทางระยะไกลโดยตรง ไม่มีสำเนาในเครื่องคั่นกลาง",
  ...
  "repos.offPremises": "นอกสถานที่",
  "repos.offPremisesHint": "นับเป็นไซต์ของตัวเองสำหรับจำนวนไซต์และ 3-2-1 บนการ์ด ไม่มีผลต่อสำเนา rest-server ในอาคารเดียวกันควรปิดตัวเลือกนี้",

  // Refusals
  "placementCode.unreadable": "อ่านกฎการจัดวางไม่ได้ จึงไม่มีการคัดลอกใดๆ จนกว่าจะอ่านได้อีกครั้ง",
  "placementCode.invalid": "ตัวเลือกการจัดวางนี้ไม่ถูกต้อง",
  "placementCode.copiesNotAllowed": "รายการในที่เก็บข้อมูลระยะไกลหรือโดยตรงจะไม่ได้รับสำเนา",
  "placementCode.unknownTarget": "เป้าหมายนอกสถานที่นั้นไม่มีอยู่ในโดเมนนี้",
  "placementCode.stackRule": "โฟลเดอร์โปรเจกต์เป็นไปตามค่าเริ่มต้นของคอนเทนเนอร์ และไม่มีกฎของตัวเอง",
  "placementCode.copyRuleTaken": "ชื่อนั้นมีกฎการคัดลอกของตัวเองอยู่แล้ว",
  "placementCode.domainBusy": "กำลังสำรองข้อมูลอยู่ เลือกอีกครั้งเมื่อเสร็จแล้ว",
  "placementCode.hasBackups": "ตำแหน่งจะเปลี่ยนไม่ได้อีกเมื่อรายการมีข้อมูลสำรองแล้ว ข้อมูลจะคงอยู่ที่ที่เขียนไว้",
  "placementCode.homeUncheckable": "ตรวจสอบไม่ได้ว่ารายการนี้มีข้อมูลสำรองอยู่แล้วหรือไม่ ตำแหน่งของรายการจึงคงเดิม ลองใหม่อีกครั้งเมื่ออ่านที่เก็บข้อมูลได้",
  "placementCode.stale": "ตัวเลขเปลี่ยนไปตั้งแต่แสดงผล ตรวจสอบอีกครั้ง",
  "placementCode.repoInvalid": "ที่เก็บข้อมูลนั้นหายไป ถูกปิดใช้งาน หรือแก้ไม่ได้",
  "placementCode.repoInUseDefault": "ค่าเริ่มต้นสำหรับ {domains} ชี้ไปที่ที่เก็บข้อมูลนี้ เปลี่ยนค่าเริ่มต้นก่อน",
  "placementCode.defaultRepoMissing": "ค่าเริ่มต้นในไฟล์ชี้ไปที่ที่เก็บข้อมูลที่ไม่มีอยู่ทั้งในไฟล์และที่นี่",
  "placementCode.nestedLocation": "ตำแหน่งนี้อยู่ภายในที่เก็บข้อมูลหรือเป้าหมายอื่น หรือมีอันหนึ่งอยู่ภายใน",
  ...
  "placement.titleHint": "ที่ที่ข้อมูลสำรองของรายการนี้ถูกเขียนและที่ที่จะถูกคัดลอกไปหลังจากนั้น ตำแหน่งจะคงที่ตั้งแต่การสำรองข้อมูลครั้งแรก ส่วนสำเนาสามารถเปลี่ยนได้ตลอดเวลา",
  "placement.unreadable": "อ่านการจัดวางไม่ได้",
  "placement.noCopyNow": "ตอนนี้ไม่มีสำเนา ปิดอยู่: {targets} ทำเครื่องหมายที่เป้าหมายหรือเลือกในเครื่อง",
  "placement.followsDefault": "เป็นไปตามค่าเริ่มต้น",
  "placement.ownCopies": "สำเนาของตัวเอง",
  "placement.homeSet": "ตั้งตำแหน่งแล้ว: {home}",
  "placement.copiesFollow": "สำเนาเป็นไปตามค่าเริ่มต้น",
  "placement.reset": "รีเซ็ต",
  ...
  // Timeline
  "timeline.deleteAsk": "ลบการสำรองข้อมูลนี้ที่นี่: {list}?",
  ...
  "timeline.onlyHere": "ที่นี่เท่านั้น",
  "timeline.incomplete": "ไม่ครบถ้วน",
  "timeline.incompleteHint": "ดิสก์ทั้งหมดของการทำงานครั้งนี้ไม่ได้อยู่ที่นี่ทั้งหมด จึงไม่เลือกที่นี้สำหรับการกู้คืน",
  "timeline.snapshotMissing": "{place} ไม่มีการสำรองข้อมูลนี้อีกต่อไป กู้คืนจาก {next}?",
  "timeline.stackDirMissing": "โฟลเดอร์โปรเจกต์ไม่ได้อยู่ใน {place} ใช้สถานะจาก {home}?",
  // Direct repository
  ...
  "placementDefaults.homeOff": "{home} ถูกปิดอยู่ รายการที่ไม่มีตำแหน่งจะไม่ถูกสำรองข้อมูลจนกว่าจะเปิดอีกครั้งหรือค่าเริ่มต้นเปลี่ยนไป",
  "placementDefaults.homeMissing": "ค่าเริ่มต้นชี้ไปยังที่เก็บที่ไม่มีอยู่แล้ว รายการที่ไม่มีตำแหน่งจะไม่ถูกสำรองข้อมูล",
  "placementDefaults.confirmHome": "รายการใหม่ใน {domain} จะรับ {home} ตอนสำรองข้อมูลครั้งแรก รายการที่มีตำแหน่งจะคงไว้",
  "placementDefaults.dropAsk": "รายการและโฟลเดอร์โปรเจกต์ที่ {target} จะไม่ได้รับอีกต่อไป: {n} สำเนาที่ยังคงอยู่ที่นั่น: {copies}",
  "placementDefaults.dropAskUnknown": "รายการและโฟลเดอร์โปรเจกต์ที่ {target} จะไม่ได้รับอีกต่อไป: {n} {target} ไม่เคยถูกระบุไว้สำหรับโดเมนนี้มาก่อน จึงยังไม่ทราบว่าจะมีสำเนาเหลืออยู่ที่นั่นกี่ชุด",
  "placementDefaults.addAsk": "รายการและโฟลเดอร์โปรเจกต์ที่ {target} จะได้รับตั้งแต่นี้ไป: {n} สแนปช็อตที่อัปโหลดในการทำงานครั้งถัดไป: อย่างมาก {snapshots}",
  "placementDefaults.openTakeHome": "รายการที่ไม่มีตำแหน่งซึ่งจะรับ {home} ตอนสำรองข้อมูลครั้งแรก: {n}",
  "placementDefaults.apply": "ใช้กับรายการที่ไม่มีการสำรองข้อมูล",
  "placementDefaults.applyAsk": "ตำแหน่งและสำเนาจะกลับไปเป็นค่าเริ่มต้นสำหรับรายการเหล่านี้: {n}",
  "placementDefaults.applyLoses": "สูญเสียตัวเลือกของตัวเองไปด้วย: {list}",
  "placementDefaults.applyKeptBackups": "คงเดิมเพราะมีการสำรองข้อมูลอยู่แล้ว: {list}",
  "placementDefaults.applyKeptUnreadable": "คงเดิมเพราะอ่านตำแหน่งไม่ได้: {list}",
  "placementDefaults.applyKeptChanged": "เปลี่ยนไปในระหว่างนี้และปล่อยไว้ตามเดิม: {list}",
  "placementDefaults.applyNone": "ไม่มีรายการที่ไม่มีการสำรองข้อมูลใดแตกต่างจากค่าเริ่มต้น",
  "placementDefaults.applyBusy": "กำลังมีการสำรองข้อมูลทำงานอยู่ ใช้อีกครั้งเมื่อเสร็จแล้ว",
  "placementDefaults.paused": "นอกสถานที่หยุดชั่วคราวหลังการสร้างใหม่",
  "placementDefaults.pausedHint": "กฎและค่าเริ่มต้นสูญหายไปพร้อมกับการตั้งค่าเดิม จะไม่มีอะไรจาก {domain} ถูกคัดลอกนอกสถานที่จนกว่าค่าเริ่มต้นนี้จะได้รับการยืนยัน รายการที่มีการ์ดสามารถตั้งเป็นในเครื่องก่อนได้",
  "placementDefaults.confirm": "ยืนยันค่าเริ่มต้น",
  "placementDefaults.confirmAsk": "ในการทำงานครั้งถัดไป จะคัดลอกสิ่งนี้:",
  "placementDefaults.unmatched": "ชื่อในสำเนาสำรองที่ไม่มีรายการที่นี่ รายการที่ทำเครื่องหมายจะถูกเว้นไว้:",
  "placementDefaults.unmatchedLine": "{name} สแนปช็อต: {n}",
  "placementDefaults.confirmed": "ยืนยันค่าเริ่มต้นแล้ว สำเนานอกสถานที่จะดำเนินต่อในการทำงานครั้งถัดไป",
  ...
  "placement.older": "สำเนาเก่ากว่าที่ {target}: {n} รายการ เห็นล่าสุด {date}",
  "placement.noCopyYet": "{place}: ยังไม่มีสำเนา",
  "placement.notListedYet": "{place}: ยังไม่อยู่ในรายการ",

  // Removal
  "offsiteRemoval.delete": "ลบที่ {target}",
  "offsiteRemoval.ask": "ลบทุกสำเนาของ {name} ที่ {target}? สำเนา: {n}",
  "offsiteRemoval.onlyThere": "สแนปช็อตเหล่านี้ไม่มีอยู่ที่อื่นเลย และจะหายไปอย่างถาวรหลังจากนี้:",
