...
const th: Partial<Translations> = {
  ...
  "excludes.advisoryImmichDb": "Immich เก็บอัลบั้ม ใบหน้า และวันที่ของรูปภาพทุกรูปไว้ในฐานข้อมูล PostgreSQL ซึ่งทำงานอยู่ในคอนเทนเนอร์ของตัวเองคนละตัวกับตัวนี้ ข้อมูลสำรองชุดนี้จึงไม่มีฐานข้อมูลนั้นอยู่ด้วย การกู้คืนจากที่นี่จะได้รูปภาพกลับมาแต่ไม่มีข้อมูลเหล่านั้น ให้สำรองฐานข้อมูลนั้นแยกต่างหาก หรือเปิดการส่งออกฐานข้อมูลที่มีมาให้ใน Immich เพื่อให้ไฟล์ไปอยู่ในโฟลเดอร์ที่ข้อมูลสำรองชุดนี้ครอบคลุม",
  "excludes.advisoryNextcloudDb": "Nextcloud เก็บบัญชีผู้ใช้ การแชร์ และแท็กไว้ในฐานข้อมูลที่มักทำงานอยู่ในคอนเทนเนอร์แยกต่างหาก ข้อมูลสำรองชุดนี้จึงไม่มีฐานข้อมูลนั้นอยู่ด้วย ไฟล์จะกลับมา แต่การแชร์จะไม่กลับมา ให้สำรองฐานข้อมูลนั้นไว้ด้วย",
