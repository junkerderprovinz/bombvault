...
const th: Partial<Translations> = {
  ...
  "about.body": "อัศวินคนเดียว การเดินทัพครั้งเดียว เครื่องมือเสรีโอเพนซอร์สที่หน้าตาดี ซึ่งไม่เคยมีในแบบที่ผมอยากได้ สร้างไปจนกว่าจะไม่ขาดอะไรอีก ไม่มีบัญชี ไม่มีการเก็บข้อมูลการใช้งาน ไม่มีโฆษณา ไม่มีช่วงทดลอง ไม่มีแพ็กเกจเสียเงิน ไม่มีดอกจันตัวเล็กท้ายหน้า ไม่มีสิ่งใดที่อ่านได้ออกไปพ้นกำแพงของคุณ ตีขึ้นในยามเย็นและวันหยุดสุดสัปดาห์ ด้วยใจและความดื้อ",
  "about.coffee": "ถ้า BombVault มีประโยชน์กับคุณ การบริจาคช่วยครอบคลุมค่าใช้จ่ายที่ทำให้มันเดินต่อไปได้ ทั้งโดเมน เซิร์ฟเวอร์ และค่ำคืนที่ทุ่มลงไป แถมยังทำให้หัวใจของอัศวินคนนี้เต้นเร็วขึ้นอีกนิด ด้านล่างมีสามทาง เลือกทางที่คุณสะดวก",
