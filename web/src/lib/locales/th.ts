...
const th: Partial<Translations> = {
  ...
  "folders.resetConfirm": "รีเซ็ตการเลือกโฟลเดอร์หรือไม่? คอนเทนเนอร์จะกลับไปใช้การตรวจจับอัตโนมัติ (ค่าเริ่มต้น appdata) และการยกเว้นที่จดจำไว้ทั้งหมดจะถูกลบออก",
