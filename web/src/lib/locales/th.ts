...
const th: Partial<Translations> = {
  ...
  "settings.discoHint": "แถวและรายการที่มีสีทุกอย่างจะเปลี่ยนไปเป็นสีถัดไปในจานสีหนึ่งครั้งต่อวินาที ตลอดเวลาที่เปิดโหมดสายรุ้ง",
  ...
  "folders.exclusions": "{n} รายการที่ยกเว้น",
  ...
  "pull.snapshotsPulled": "ดึงมา {n} สแนปช็อต",
  "pull.nothingNew": "ไม่มีอะไรใหม่ให้ดึง",
  "pull.pulled": "ดึงมาแล้ว {n} สแนปช็อต",
