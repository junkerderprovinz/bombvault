...
const th: Partial<Translations> = {
  ...
  "settings.labelsHint": "จะแสดงตัวควบคุมมากแค่ไหน ทั้งข้อความ สัญลักษณ์ หรือทั้งสองอย่าง ปุ่มยังคงความกว้างเท่าเดิมในทั้งสามแบบ การสลับจึงไม่ทำให้หน้าจัดเรียงใหม่",
