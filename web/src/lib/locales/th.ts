...
const th: Partial<Translations> = {
  ...
  "takeover.backup": "ข้อมูลสำรอง 1 รายการ",
  ...
  "takeover.historyOne": "ข้อมูลสำรองของ {old} จะกลายเป็นประวัติของ {new}",
  "takeover.historyMany": "ข้อมูลสำรอง {n} รายการของ {old} จะกลายเป็นประวัติของ {new}",
  ...
  "settings.discoHint": "แถวและรายการที่มีสีทุกอย่างจะค่อย ๆ เปลี่ยนไปเป็นสีถัดไปในจานสี ทีละสีทุกสามวินาที ตลอดเวลาที่เปิดโหมดสายรุ้ง",
