...
const th: Partial<Translations> = {
  ...
  "settings.everythingOverlapWarning": "การทำงานนี้เป็นอิสระจากกำหนดการของแต่ละโดเมนด้านบน หากเปิดใช้งานทั้งสองอย่าง Containers, VMs, Flash, โฟลเดอร์ และการสำรองข้อมูลตัวเองจะถูกสำรองข้อมูลซ้ำสองครั้ง ครั้งหนึ่งที่นี่ อีกครั้งตามกำหนดการของตัวเอง ปิดโดเมนที่คุณไม่ต้องการให้ทำงานซ้ำ",
