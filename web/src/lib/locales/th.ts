...
const th: Partial<Translations> = {
  ...
  "dbdump.importStopsOne": "ระหว่างนำเข้า BombVault จะหยุด {app} ด้วย แล้วเริ่มใหม่อีกครั้งเมื่อเสร็จ",
  "dbdump.importStopsMany": "ระหว่างนำเข้า BombVault จะหยุดแอปเหล่านี้ด้วย แล้วเริ่มใหม่อีกครั้งเมื่อเสร็จ: {apps}",
