...
const th: Partial<Translations> = {
  ...
  "excludes.assistPathsUnavailable": "ตอนนี้เข้าถึงโฟลเดอร์สำรองของคอนเทนเนอร์นี้ไม่ได้ และไม่มีข้อมูลสำรองให้อ่านขนาดด้วย ตรวจสอบว่าอาเรย์หรือแชร์ที่เก็บโฟลเดอร์เหล่านั้นถูกเมานต์อยู่หรือไม่",
