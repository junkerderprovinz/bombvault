...
const th: Partial<Translations> = {
  ...
  "repos.itemHint": "สำรองข้อมูลของรายการนี้จะไปที่ใด ปล่อยไว้ที่ที่เก็บข้อมูลของโดเมน เว้นแต่รายการนี้ต้องการของตนเอง เหตุผลที่พบบ่อยคือรายการขนาดใหญ่ที่แทบไม่เปลี่ยนและต้องการเพียงสำเนานอกสถานที่ รายการในรายชื่อคือสิ่งที่คุณสร้างไว้ในการตั้งค่า การจำลองนอกสถานที่จะไม่คัดลอกที่เก็บข้อมูลระยะไกลหรือที่เก็บข้อมูลที่ทำเครื่องหมายว่าอยู่นอกสถานที่แล้วเป็นครั้งที่สอง",
  ...
  "repos.offsite": "อยู่นอกสถานที่แล้ว",
  "repos.offsiteHint": "สำหรับโฟลเดอร์แชร์บนเครื่องอื่น เช่น NAS ที่ใช้เป็นที่เก็บข้อมูลเย็น เมื่อเปิดไว้ การจำลองนอกสถานที่จะข้ามที่เก็บข้อมูลนี้เหมือนที่เก็บข้อมูลระยะไกล และจะไม่คัดลอกข้อมูลสำรองซ้ำเป็นครั้งที่สอง สำหรับดิสก์หรือโฟลเดอร์แชร์บนเครื่องนี้ให้ปิดไว้ เพราะยังต้องการสำเนานอกสถานที่",
  "repos.offsiteRemote": "นอกสถานที่",
  "repos.offsiteRemoteHint": "ที่เก็บข้อมูลระยะไกลอยู่นอกสถานที่อยู่แล้ว การจำลองนอกสถานที่จึงไม่คัดลอกซ้ำอีก",
