...
const th: Partial<Translations> = {
  ...
  "files.empty": "ยังไม่มีชุดไฟล์ เพิ่มโฟลเดอร์ — แชร์ เอกสาร รูปภาพ อะไรก็ได้ภายใต้จุดเมานต์ของคุณ — แล้ว BombVault จะปกป้องมันเหมือนทุกอย่างอื่น: ตารางเวลา สำเนานอกสถานที่ การตรวจสอบความสมบูรณ์ และการกู้คืน ไม่ต้องใช้เครื่องมือสำรองไฟล์แยกต่างหาก",
  "files.addSet": "เพิ่มชุดไฟล์",
  "files.editSet": "แก้ไขชุดไฟล์",
  "files.name": "ชื่อ",
  "files.path": "โฟลเดอร์",
  ...
  "files.deleteSetConfirm": "นำชุดไฟล์นี้ออกจากรายการ? การสำรองข้อมูลของมันจะไม่ถูกลบและสามารถค้นพบใหม่ได้ภายหลัง",
  "files.deleteBackupsConfirm": "ลบการสำรองข้อมูลทั้งหมดของชุดไฟล์นี้? สแนปช็อตจะถูกลบอย่างถาวร รีพอสิทอรีจะถูกตัดทิ้ง และชุดจะถูกลืม ไม่สามารถเลิกทำได้",
