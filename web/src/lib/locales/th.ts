...
const th: Partial<Translations> = {
  ...
  "dbdump.introNotice": "BombVault ดัมป์ฐานข้อมูลที่รู้จัก {count} รายการก่อนสำรองทุกครั้ง โดยเป็นจุดกู้คืนของตัวเอง คุณปิดได้ทีละคอนเทนเนอร์บนการ์ดของมัน หรือปิดทุกคอนเทนเนอร์ในการตั้งค่า",
  ...
  "dbdump.fixRepository": "คลังสำรองไม่รับดัมป์ หรือเก็บไบต์น้อยกว่าที่ดัมป์ออกมา ตรวจคลังใน การตั้งค่า, ที่เก็บข้อมูล ดัมป์จะลองใหม่พร้อมการสำรองครั้งถัดไป",
  ...
  "recovery.dumpOnlySkipped": "ฐานข้อมูล {count} รายการที่เก็บไว้เป็นดัมป์เท่านั้นจะถูกข้ามไป กู้คืนและนำเข้าจากรายการของมันเอง",
