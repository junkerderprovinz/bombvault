...
const it: Partial<Translations> = {
  ...
  "settings.offsiteHint": "Dopo ogni backup locale riuscito, replicalo anche su un secondo repository con restic copy. Inserisci un remoto (rest:http://host:8000/repo, s3:…) o un sottopercorso locale; lascia vuoto per disattivare. Il backup locale resta primario.",
  ...
  "ransomware.replicationPaused": "copia off-site in pausa: conferma la collocazione",
  ...
  "settingsIO.previewCopyRules": "Regole di copia",
  "settingsIO.previewNotInFile": "non presente nel file, resta invariato",
  ...
  "pull.repoLocationHint": "Il repository dell'istanza di origine: rest:, s3:, sftp:, oppure un sottopercorso sotto il mount dell'host. Una posizione rclone: viene rifiutata, perché rclone la raggiungerebbe con i remote di QUESTA istanza.",
  ...
  "pull.credsHint": "Le credenziali dello spazio su cui si trova il repository dell'origine: s3: o un server rest: con password. Un prelievo non usa mai le credenziali di questa macchina, quindi un'origine che ha bisogno di accedere e non ne ha nessuna scelta qui viene rifiutata.",
  ...
  "repos.locationPlaceholder": "backups/cold oppure s3:s3.eu-central-003.backblazeb2.com/bucket/path",
  "repos.locationHint": "Una cartella sotto il montaggio dell'host, o un repository restic remoto come s3:..., sftp:..., rest:... o rclone:... Sul remoto si scrive direttamente, senza copia locale intermedia.",
  ...
  "repos.removeWithTarget": "Va insieme a {target}. Per rimuovere questo repository, rimuovi quella destinazione.",
  "repos.offPremises": "Fuori sede",
  ...
  "placementCode.exclusionUnsaved": "La destinazione è stata salvata. Ciò che deve escludere no.",
  ...
  "placement.segLocal": "Locale",
  "placement.segLocalOffsite": "Locale + off-site",
  "placement.segOffsiteOnly": "Solo off-site",
  "placement.homeDomain": "{host} · repository del dominio · {path}",
  "placement.homeDomainRemote": "Repository del dominio · remoto · {scheme}",
  "placement.homeLocal": "{name} · montato",
  "placement.homeRemote": "{name} · remoto",
  "placement.homeDirect": "{target} · diretto",
  "placement.directNotYet": "creato alla prima scelta",
  "placement.off": "{name} (spento)",
  "placement.unknown": "{name} (sconosciuto)",
  "placement.noTarget": "Nessuna destinazione off-site configurata",
  "placement.lockOwnCredentials": "Ha credenziali proprie ed è già fuori sede",
  "placement.lockAtTarget": "Si trova già presso la destinazione",
  "placement.lockHomeFixed": "Fisso dal primo backup: {home}",
  ...
  "placement.title": "Collocazione",
  "placement.storedOn": "Salvato su",
  "placement.copyTo": "Copia su",
  "placement.sendTo": "Invia a",
  "placement.titleHint": "Dove vengono scritti i backup di questo elemento e dove vengono copiati in seguito. La posizione è fissa dal primo backup, le copie possono cambiare in qualsiasi momento.",
  "placement.unreadable": "Impossibile leggere la collocazione",
  "placement.noCopyNow": "Al momento nessuna copia, disattivata: {targets}. Seleziona una destinazione o scegli Locale.",
  "placement.followsDefault": "Segue il valore predefinito",
  "placement.ownCopies": "Copie proprie",
  "placement.homeSet": "Posizione impostata: {home}",
  "placement.copiesFollow": "Le copie seguono il valore predefinito",
  "placement.reset": "Ripristina",
  ...
  // Timeline
  "timeline.deleteAsk": "Eliminare questo backup qui: {list}?",
  ...
  "timeline.onlyHere": "solo qui",
  "timeline.incomplete": "incompleto",
  "timeline.incompleteHint": "Non tutti i dischi di questa esecuzione sono qui, quindi questo luogo non viene scelto per un ripristino.",
  "timeline.snapshotMissing": "{place} non ha più questo backup. Ripristinare da {next}?",
  "timeline.stackDirMissing": "La cartella del progetto non è in {place}. Usare lo stato di {home}?",
  // Direct repository
  ...
  "placementDefaults.homeOff": "{home} è spento. Gli elementi senza posizione non vengono sottoposti a backup finché non torna acceso o il valore predefinito cambia.",
  "placementDefaults.homeMissing": "Il valore predefinito punta a un repository che non esiste più. Gli elementi senza posizione non vengono sottoposti a backup.",
  "placementDefaults.confirmHome": "I nuovi elementi in {domain} assumono {home} al primo backup. Gli elementi con una posizione la mantengono.",
  "placementDefaults.dropAsk": "Elementi e cartelle di progetto che {target} non riceve più: {n}. Copie che vi restano: {copies}.",
  "placementDefaults.dropAskUnknown": "Elementi e cartelle di progetto che {target} non riceve più: {n}. {target} non è mai stato elencato per questo dominio, quindi non si sa ancora quante copie vi restano.",
  "placementDefaults.addAsk": "Elementi e cartelle di progetto che {target} riceve da ora in poi: {n}. Snapshot caricati alla prossima esecuzione: al massimo {snapshots}.",
  "placementDefaults.openTakeHome": "Elementi senza posizione che assumono {home} al primo backup: {n}.",
  "placementDefaults.apply": "Applica agli elementi senza backup",
  "placementDefaults.applyAsk": "Posizione e copie tornano al valore predefinito per questi elementi: {n}.",
  "placementDefaults.applyLoses": "Perdono così la propria scelta: {list}",
  "placementDefaults.applyKeptBackups": "Restano come sono, hanno backup: {list}",
  "placementDefaults.applyKeptUnreadable": "Restano come sono, la loro posizione non è stata leggibile: {list}",
  "placementDefaults.applyKeptChanged": "Cambiati nel frattempo e lasciati stare: {list}",
  "placementDefaults.applyNone": "Nessun elemento senza backup differisce dal valore predefinito.",
  "placementDefaults.applyBusy": "Un backup è in corso. Applica di nuovo una volta terminato.",
  "placementDefaults.paused": "Off-site in pausa dopo una ricostruzione",
  "placementDefaults.pausedHint": "Regole e valori predefiniti sono andati persi con la vecchia configurazione. Nulla di {domain} viene copiato off-site finché questo valore predefinito non viene confermato. Gli elementi con una scheda possono essere impostati prima su Locale.",
  "placementDefaults.confirm": "Conferma valore predefinito",
  "placementDefaults.confirmAsk": "Alla prossima esecuzione, viene copiato questo:",
  "placementDefaults.unmatched": "Nomi nei backup senza una voce qui. Quelli spuntati vengono esclusi:",
  "placementDefaults.unmatchedLine": "{name}, snapshot: {n}",
  "placementDefaults.confirmed": "Valore predefinito confermato. Le copie off-site riprendono alla prossima esecuzione.",
  ...
  "placement.older": "Copie più vecchie in {target}: {n}, visto l'ultima volta {date}",
  "placement.noCopyYet": "{place}: ancora nessuna copia",
  "placement.notListedYet": "{place}: ancora non elencato",

  // Removal
  "offsiteRemoval.delete": "Elimina in {target}",
  "offsiteRemoval.ask": "Eliminare ogni copia di {name} in {target}? Copie: {n}.",
  "offsiteRemoval.onlyThere": "Questi snapshot non esistono da nessun'altra parte e in seguito spariranno per sempre:",
