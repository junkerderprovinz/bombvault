...
const it: Partial<Translations> = {
  ...
  "dbdump.introNotice": "BombVault fa il dump di {count} database riconosciuti prima di ogni backup, come punti di ripristino a sé stanti. Puoi disattivarlo per singolo container sulla sua scheda oppure per tutti i container nelle Impostazioni.",
  ...
  "dbdump.fixRepository": "Il repository di backup non ha accettato il dump, oppure ha memorizzato meno byte di quanti ne siano stati estratti. Controlla il repository in Impostazioni, Archiviazione; il dump viene ritentato con il prossimo backup.",
  ...
  "recovery.dumpOnlySkipped": "{count} database salvati solo come dump restano fuori; ripristinali e importali dal loro elenco.",
