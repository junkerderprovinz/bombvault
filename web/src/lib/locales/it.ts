...
const it: Partial<Translations> = {
  ...
  "settings.everythingOverlapWarning": "Questo viene eseguito indipendentemente dai calendari di ciascun dominio sopra. Se entrambi sono attivi, container, VM, flash, cartelle e auto-backup vengono ciascuno salvati due volte, una qui, una nel proprio calendario. Disattiva i domini che non vuoi vedere duplicati.",
