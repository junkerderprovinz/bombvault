...
const it: Partial<Translations> = {
  ...
  "repos.itemHint": "Dove finiscono i backup di questo elemento. Lascialo sul repository del dominio a meno che proprio questo elemento non ne serva uno suo; il motivo consueto è un elemento grande e che cambia di rado, di cui serve solo una copia fuori sede. L'elenco contiene ciò che hai creato nelle Impostazioni. La replica off-site non ricopia un repository remoto né uno segnato come già fuori sede.",
  ...
  "repos.offsite": "Già fuori sede",
  "repos.offsiteHint": "Per una condivisione su un'altra macchina, come un NAS usato come archivio a freddo. La replica off-site lascia allora fuori questo repository, come fa con uno remoto, e i suoi backup non vengono copiati una seconda volta. Lascialo spento per un disco o una condivisione di questa macchina, che ha ancora bisogno della copia fuori sede.",
  "repos.offsiteRemote": "fuori sede",
  "repos.offsiteRemoteHint": "Un repository remoto è già fuori sede, quindi la replica off-site non lo ricopia mai.",
