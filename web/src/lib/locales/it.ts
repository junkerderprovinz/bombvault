...
const it: Partial<Translations> = {
  ...
  "about.body": "Un solo cavaliere, una crociata: strumenti liberi, ben fatti e open source che nella forma che volevo non esistevano. Costruiti finché non manca più niente. Nessun account, nessuna telemetria, nessuna pubblicità. Nessuna prova, nessun piano a pagamento, nessun asterisco in fondo alla pagina. Niente di leggibile lascia mai le tue mura. Forgiato di sera e nei fine settimana, con cuore e testardaggine.",
  "about.coffee": "Se BombVault ti è utile, una donazione copre quello che costa tenerlo in piedi: il dominio, il server e le sere che ci finiscono dentro. E fa anche battere un po' più in fretta il cuore di questo cavaliere. Qui sotto ci sono tre strade, prendi quella che ti va meglio.",
