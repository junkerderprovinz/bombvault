...
const it: Partial<Translations> = {
  ...
  "files.empty": "Ancora nessun set di file. Aggiungi una cartella — share, documenti, foto, qualsiasi cosa sotto i tuoi mount — e BombVault la protegge come tutto il resto: calendari, copie off-site, controlli d'integrità e ripristini. Nessuno strumento separato di backup dei file necessario.",
  "files.addSet": "Aggiungi set di file",
  "files.editSet": "Modifica set di file",
  "files.name": "Nome",
  "files.path": "Cartella",
  ...
  "files.deleteSetConfirm": "Rimuovere questo set di file dall'elenco? I suoi backup non vengono eliminati e potranno essere riscoperti in seguito.",
  "files.deleteBackupsConfirm": "Eliminare TUTTI i backup di questo set di file? Gli snapshot vengono rimossi definitivamente, il repository viene potato e il set viene dimenticato. Operazione irreversibile.",
