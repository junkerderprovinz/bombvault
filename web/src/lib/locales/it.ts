...
const it: Partial<Translations> = {
  ...
  "about.report": "Hai trovato qualcosa o ti manca qualcosa? Apri una segnalazione su GitHub o invia un'email. La versione qui sopra aiuta in entrambi i casi.",
  "about.repo": "Repository",
  "about.mail": "Scrivi un'email",
