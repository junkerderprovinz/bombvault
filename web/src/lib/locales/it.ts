...
const it: Partial<Translations> = {
  ...
  "settings.labelsHint": "Quanto di un controllo viene mostrato: le parole, il simbolo o entrambi. I pulsanti mantengono la stessa larghezza in tutti e tre i casi, quindi cambiare non riorganizza la pagina.",
