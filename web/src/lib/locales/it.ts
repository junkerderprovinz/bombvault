...
const it: Partial<Translations> = {
  ...
  "settings.dashTileCa": "Potrebbe essere disponibile anche nelle Community Applications — cerca BombVault Dashboard.",
  "settings.dashTileNotInstalled": "Il plugin del riquadro della dashboard non è installato.",
  "settings.dashTileConfirm": "Installa installa il plugin bombvault-dashboard sul tuo host Unraid tramite il normale meccanismo dei plugin di Unraid. Compare sotto Plugins come qualsiasi altro plugin e può essere rimosso lì (o qui) in qualsiasi momento.",
