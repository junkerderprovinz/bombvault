...
const it: Partial<Translations> = {
  ...
  "pull.snapshotsPulled": "{n} snapshot prelevati",
  "pull.nothingNew": "Niente di nuovo da prelevare.",
  "pull.pulled": "Prelevati {n} snapshot.",
