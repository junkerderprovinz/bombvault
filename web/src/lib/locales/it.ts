...
const it: Partial<Translations> = {
  ...
  "offsite.replicatingSnapshotPercentWithDuration": "Replica snapshot {index} di {total} in corso ({percent}%) · {duration}",
  ...
  "activityLog.lineOffsiteRunningSnapshotPercent": "Caricamento off-site — {domain} … snapshot {index} di {total} ({percent}%)",
  "activityLog.lineOffsiteRunningSnapshotPercentWithDuration": "Caricamento off-site — {domain} … snapshot {index} di {total} ({percent}%) · {duration}",
  ...
  "schedule.overrideHint": "Vuoto usa la pianificazione della categoria. Le sovrascritture per elemento non supportano la modalità ogni N giorni.",
