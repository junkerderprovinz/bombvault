...
const it: Partial<Translations> = {
  ...
  "dbdump.importStopsOne": "Durante l'importazione BombVault ferma anche {app} e poi lo riavvia.",
  "dbdump.importStopsMany": "Durante l'importazione BombVault ferma anche queste applicazioni e poi le riavvia: {apps}.",
