...
const hu: Partial<Translations> = {
  ...
  "takeover.historyOne": "A(z) {old} mentése a(z) {new} előzményeinek része lesz.",
  "takeover.historyMany": "A(z) {old} {n} mentése a(z) {new} előzményeinek része lesz.",
