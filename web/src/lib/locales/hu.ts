...
const hu: Partial<Translations> = {
  ...
  "offsite.replicatingSnapshotPercentWithDuration": "Pillanatkép replikálása: {index}/{total} ({percent}%) · {duration}",
  ...
  "activityLog.lineOffsiteRunningSnapshotPercent": "Telephelyen kívüli feltöltés — {domain} … pillanatkép {index}/{total} ({percent}%)",
  "activityLog.lineOffsiteRunningSnapshotPercentWithDuration": "Telephelyen kívüli feltöltés — {domain} … pillanatkép {index}/{total} ({percent}%) · {duration}",
  ...
  "schedule.overrideHint": "Üresen a kategória ütemezését használja. Az elemenkénti felülírások nem támogatják az N naponta módot.",
