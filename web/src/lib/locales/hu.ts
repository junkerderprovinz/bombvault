...
const hu: Partial<Translations> = {
  ...
  "settings.offsiteHint": "Minden sikeres helyi mentés után másolja egy második tárolóba is a restic copy paranccsal. Adjon meg egy távoli tárolót (rest:http://host:8000/repo, s3:…) vagy egy helyi alútvonalat; hagyja üresen a letiltáshoz. A helyi mentés marad az elsődleges.",
  "source.label": "Forrás:",
  "source.local": "Helyi",
  ...
  "pull.repoLocationHint": "A forráspéldány tárolója: rest:, s3:, sftp:, illetve egy alútvonal a gazdacsatolás alatt. Az rclone: helyet elutasítja, mert azt az rclone EZ a példány távoli tárhelyeivel érné el.",
  ...
  "pull.credsHint": "Annak a tárolónak a bejelentkezése, amelyen a forrás tárháza fekszik: s3: vagy jelszavas rest: kiszolgáló. A behúzás soha nem használja ennek a gépnek a saját adatait, így az a forrás, amelynek bejelentkezés kell és itt nincs kiválasztva semmi, elutasításra kerül.",
  ...
  "repos.location": "Hely",
  "repos.locationPlaceholder": "backups/cold vagy s3:s3.eu-central-003.backblazeb2.com/bucket/path",
  "repos.locationHint": "Mappa a gazdagép csatolási pontja alatt, vagy távoli restic tároló, például s3:..., sftp:..., rest:... vagy rclone:... A távolira közvetlenül ír, helyi köztes másolat nélkül.",
  ...
  "repos.offPremises": "Az épületen kívül",
  "repos.offPremisesHint": "A kártyákon a helyszínek és a 3-2-1 szempontjából önálló helyszínnek számít. A másolatokat nem érinti. Az ugyanabban az épületben lévő rest-servernél ezt ki kell kapcsolni.",
  ...
  "placement.titleHint": "Hová íródnak ennek az elemnek a biztonsági mentései, és utána hová másolódnak. A hely az első biztonsági mentéstől fogva rögzített, a másolatok bármikor módosíthatók.",
  "placement.unreadable": "Az elhelyezést nem sikerült beolvasni",
  "placement.noCopyNow": "Most nincs másolat, kikapcsolva: {targets}. Jelölj ki egy célt, vagy válaszd a Helyit.",
  "placement.followsDefault": "Az alapértelmezést követi",
  "placement.ownCopies": "Saját másolatok",
  "placement.homeSet": "Hely beállítva: {home}",
  "placement.copiesFollow": "A másolatok az alapértelmezést követik",
  "placement.reset": "Visszaállítás",
  ...
  // Timeline
  "timeline.deleteAsk": "Törlöd ezt a mentést itt: {list}?",
  ...
  "timeline.onlyHere": "csak itt",
  "timeline.incomplete": "hiányos",
  "timeline.incompleteHint": "Nincs itt e futás összes lemeze, ezért ez a hely nincs kiválasztva visszaállításra.",
  "timeline.snapshotMissing": "A {place}-nek már nincs meg ez a mentés. Visszaállítás innen: {next}?",
  "timeline.stackDirMissing": "A projektmappa nincs itt: {place}. Használjuk a(z) {home} állapotát?",
  // Direct repository
  ...
  "placementDefaults.homeOff": "{home} ki van kapcsolva. A hely nélküli elemek nem mentődnek, amíg újra be nem kapcsol, vagy az alapértelmezés meg nem változik.",
  "placementDefaults.homeMissing": "Az alapértelmezés olyan tárolóra mutat, amely már nem létezik. A hely nélküli elemek nem mentődnek.",
  "placementDefaults.confirmHome": "A {domain} új elemei az első biztonsági mentésükkor {home} helyet veszik fel. A hellyel rendelkező elemek megtartják azt.",
  "placementDefaults.dropAsk": "Elemek és projektmappák, amelyeket {target} már nem kap meg: {n}. Ott maradó másolatok: {copies}.",
  "placementDefaults.dropAskUnknown": "Elemek és projektmappák, amelyeket {target} már nem kap meg: {n}. A {target} soha nem szerepelt ennél a tartománynál, így egyelőre nem ismert, hány másolat marad ott.",
  "placementDefaults.addAsk": "Elemek és projektmappák, amelyeket {target} mostantól megkap: {n}. A következő futáskor feltöltött pillanatképek: legfeljebb {snapshots}.",
  "placementDefaults.openTakeHome": "Hely nélküli elemek, amelyek az első biztonsági mentésükkor {home} helyet veszik fel: {n}.",
  "placementDefaults.apply": "Alkalmazás a biztonsági mentés nélküli elemekre",
  "placementDefaults.applyAsk": "A hely és a másolatok visszaállnak az alapértelmezésre ezeknél az elemeknél: {n}.",
  "placementDefaults.applyLoses": "Ezzel elveszítik saját választásukat: {list}",
  "placementDefaults.applyKeptBackups": "Változatlanok maradnak, van biztonsági mentésük: {list}",
  "placementDefaults.applyKeptUnreadable": "Változatlanok maradnak, a helyüket nem sikerült beolvasni: {list}",
  "placementDefaults.applyKeptChanged": "Időközben megváltoztak, és érintetlenül maradtak: {list}",
  "placementDefaults.applyNone": "Egyetlen biztonsági mentés nélküli elem sem tér el az alapértelmezéstől.",
  "placementDefaults.applyBusy": "Biztonsági mentés fut. Alkalmazza újra, ha befejeződött.",
  "placementDefaults.paused": "A telephelyen kívüli újraépítés után szünetel",
  "placementDefaults.pausedHint": "A szabályok és az alapértelmezések elvesztek a régi konfigurációval. A {domain} tartományból semmi nem másolódik a telephelyen kívülre, amíg ez az alapértelmezés meg nem erősítést nyer. A kártyával rendelkező elemek előbb Helyire állíthatók.",
  "placementDefaults.confirm": "Alapértelmezés megerősítése",
  "placementDefaults.confirmAsk": "A következő futáskor ez másolódik:",
  "placementDefaults.unmatched": "Nevek a biztonsági mentésekben, amelyeknek itt nincs bejegyzésük. A kipipáltak kimaradnak:",
  "placementDefaults.unmatchedLine": "{name}, pillanatképek: {n}",
  "placementDefaults.confirmed": "Az alapértelmezés megerősítve. A telephelyen kívüli másolatok a következő futáskor folytatódnak.",
  ...
  "placement.older": "Régebbi másolatok itt: {target}: {n}, utoljára látva {date}",
  "placement.noCopyYet": "{place}: még nincs másolat",
  "placement.notListedYet": "{place}: még nincs listázva",

  // Removal
  "offsiteRemoval.delete": "Törlés itt: {target}",
  "offsiteRemoval.ask": "Törlöd a(z) {name} minden másolatát itt: {target}? Másolatok: {n}.",
  "offsiteRemoval.onlyThere": "Ezek a pillanatképek sehol máshol nem léteznek, és utána véglegesen eltűnnek:",
