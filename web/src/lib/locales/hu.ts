...
const hu: Partial<Translations> = {
  ...
  "files.empty": "Még nincsenek fájlkészletek. Adj hozzá egy mappát — megosztások, dokumentumok, fotók, bármi a csatolásaid alatt — és a BombVault ugyanúgy védi, mint minden mást: ütemezések, telephelyen kívüli másolatok, integritás-ellenőrzések és visszaállítások. Nincs szükség külön fájlmentő eszközre.",
  "files.addSet": "Fájlkészlet hozzáadása",
  "files.editSet": "Fájlkészlet szerkesztése",
  "files.name": "Név",
  "files.path": "Mappa",
  ...
  "files.deleteSetConfirm": "Eltávolítod ezt a fájlkészletet a listáról? A mentései nem törlődnek, és később újra felfedezhetők.",
  "files.deleteBackupsConfirm": "Törlöd ennek a fájlkészletnek az ÖSSZES mentését? A pillanatképek véglegesen eltávolításra kerülnek, a tároló megnyesésre kerül, és a készlet elfelejtődik. Nem vonható vissza.",
  ...
  "activityLog.domainFiles": "Fájlok",
