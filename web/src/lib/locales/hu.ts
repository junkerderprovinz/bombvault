...
const hu: Partial<Translations> = {
  ...
  "settings.everythingOverlapWarning": "Ez a fenti egyes területek saját ütemezésétől függetlenül fut. Ha mindkettő be van kapcsolva, a konténerek, a VM-ek, a flash, a mappák és az önmentés is kétszer mentődik: egyszer itt, egyszer a saját ütemezésén. Kapcsold ki azokat a területeket, amelyeknél nem szeretnéd a duplázást.",
