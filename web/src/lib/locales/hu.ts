...
const hu: Partial<Translations> = {
  ...
  "files.emptySelectionBlocked": "A készlethez legalább egy mappa kell, ezért az utolsó jelölés nem távolítható el. Ha már nem kell ez a készlet, használd a Készlet eltávolítása lehetőséget.",
