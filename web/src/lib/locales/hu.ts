...
const hu: Partial<Translations> = {
  ...
  "dbdump.introNotice": "A BombVault {count} felismert adatbázisról készít mentést minden biztonsági mentés előtt, saját visszaállítási pontként. Konténerenként a kártyáján, vagy minden konténernél a Beállításokban kapcsolhatod ki.",
  ...
  "dbdump.fixRepository": "A mentési tároló nem fogadta be az adatbázismentést, vagy kevesebb bájtot tárolt el, mint amennyi kiíródott. Ellenőrizd a tárolót a Beállítások, Tárolás részben; a mentés a következő biztonsági mentéssel újra fut.",
  ...
  "recovery.dumpOnlySkipped": "{count} csak mentésként meglévő adatbázis kimarad; állítsd vissza és importáld őket a saját listájukból.",
