...
const hu: Partial<Translations> = {
  ...
  "settings.dashTileCa": "Lehet, hogy a Community Applications-ben is elérhető — keressen rá: BombVault Dashboard.",
  "settings.dashTileNotInstalled": "Az irányítópult-csempe bővítmény nincs telepítve.",
  "settings.dashTileConfirm": "A Telepítés a bombvault-dashboard bővítményt az Unraid szokásos bővítménymechanizmusával telepíti az Unraid gazdagépre. A Plugins alatt jelenik meg, mint bármely más bővítmény, és ott (vagy itt) bármikor eltávolítható.",
