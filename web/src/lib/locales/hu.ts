...
const hu: Partial<Translations> = {
  ...
  "settings.labelsHint": "Mennyi látszik egy vezérlőből: a szavai, a szimbóluma vagy mindkettő. A gombok mindhárom esetben ugyanolyan szélesek maradnak, így a váltás nem rendezi át az oldalt.",
  ...
  "settingsIO.chooseFile": "Válasszon beállításfájlt",
