...
const hu: Partial<Translations> = {
  ...
  "about.body": "Egy lovag, egy hadjárat: szabad, jól kinéző, nyílt forráskódú eszközök, amelyek abban a formában, ahogy én akartam, nem léteztek. Addig épül, amíg semmi sem hiányzik. Semmi fiók, semmi telemetria, semmi hirdetés. Semmi próbaidő, semmi előfizetési szint, semmi apró betűs csillag. Semmi olvasható nem hagyja el a saját falaidat. Estéken és hétvégéken kovácsolva, szívvel és makacssággal.",
  "about.coffee": "Ha a BombVault hasznodra van, egy adomány fedezi, amibe a fenntartása kerül: a domaint, a szervert és az esti órákat, amik belemennek. Ráadásul ennek a lovagnak a szíve is gyorsabban ver tőle. Lent három út van, válaszd azt, amelyik kézre esik.",
  ...
  "auth.twoFactorEnable": "Bekapcsolás",
