...
const hu: Partial<Translations> = {
  ...
  "anomaly.cardHint": "A BombVault minden mentést összevet az elem korábbi mentéseivel, és megnevezi, ami kilóg: a szokásosnál sokkal több új adat, az adatok nagy részének újraírása, erősen összement vagy megnőtt forrás, kisebb adatbázismentés, hirtelen sokkal tovább tartó mentés, ismétlődő hibák, visszaállítási ellenőrzés, ami már nem megy át, és hamarosan betelő lemez. A legtöbb ellenőrzéshez előbb 10 mentés kell egy elemről.",
  ...
  "anomaly.items.hint": "Minden mentett elem a tanulási előrehaladásával, a szokásos értékeivel, valamint a saját érzékenységével és értesítésével. Egy elem a globális beállításokat követi, amíg itt mást nem választasz.",
