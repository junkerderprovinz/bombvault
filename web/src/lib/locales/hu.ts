...
const hu: Partial<Translations> = {
  ...
  "settings.domainsHint": "Kapcsold be vagy ki egyenként az egyes biztonsági mentési tartományokat. Minden bekapcsolt tartománynak saját bejegyzése van az oldalsávban.",
  ...
  "vm.ssh.title": "Gazdagép SSH",
  "vm.ssh.desc": "A VM- és ZFS-mentések SSH-n keresztül futtatják parancsaikat ezen a szerveren (csatolás nélkül). Engedélyezze ezt a kulcsot az Unraidben, majd tesztelje.",
  "vm.ssh.host": "Hoszt",
  ...
  "vm.ssh.testNoLibvirt": "Csatlakozva. A libvirt nem érhető el, de csak a VM-mentéseknek kell.",
  ...
  "vm.ssh.step3": "Kattintson a Kapcsolat tesztelése gombra. Ha zöld, engedélyezze a VM-eket vagy a ZFS-adatkészleteket a Tartományok alatt.",
  ...
  "dbdump.stackRestoreWarn": "one=A(z) {names} adatai a stack futása közben másolódnak. A visszaállítás után töltsd be a legfrissebb adatbázismentését, mielőtt használnád az alkalmazást.|other=A(z) {names} adatai a stack futása közben másolódnak. A visszaállítás után töltsd be a legfrissebb adatbázismentésüket, mielőtt használnád az alkalmazásokat.",
  "dbdump.introNotice": "one=A BombVault minden biztonsági mentés előtt mentést készít a felismert adatbázisokról, saját visszaállítási pontként. Itt felismerve: {n} adatbázis, {name}. Konténerenként a kártyáján, vagy minden konténernél a Beállításokban kapcsolhatod ki.|other=A BombVault minden biztonsági mentés előtt mentést készít a felismert adatbázisokról, saját visszaállítási pontként. Itt felismerve: {n} adatbázis, az első: {name}. Konténerenként a kártyáján, vagy minden konténernél a Beállításokban kapcsolhatod ki.",
  ...
  "dbdump.importStops": "one=Az importálás idejére a BombVault a(z) {apps} alkalmazást is leállítja, utána pedig újraindítja. Ha az importálás a megkezdése után hiúsul meg, a régi adatok félretéve maradnak, az alkalmazás pedig leállítva.|other=Az importálás idejére a BombVault ezeket az alkalmazásokat is leállítja: {apps}. Utána újraindítja őket. Ha az importálás a megkezdése után hiúsul meg, a régi adatok félretéve maradnak, az alkalmazások pedig leállítva.",
  ...
  // Schedules / Plans tab
  "jobs.syncSchedules": "A konténerek ütemezésének használata a VM-ekhez, a Flashhez, a Mappákhoz és a ZFS-adatkészletekhez is",
  "jobs.syncSchedulesHint": "Ha be van kapcsolva, a VM-ek, a Flash, a Mappák és a ZFS-adatkészletek a saját ütemezésük helyett a konténerek ütemezését követik. Kapcsolja ki, ha minden tartománynak külön ritmust szeretne beállítani.",
  ...
  "settings.everythingHint": "Minden területet egyszer, sorban lefuttat (konténerek, VM-ek, flash, mappák, ZFS-adatkészletek, majd az önmentés), így az utána küldött egyetlen ping (az alábbi post-paranccsal) igazolja, hogy az egész szerver védve van. Alapértelmezetten kikapcsolva, és független a fenti egyes területek saját ütemezésétől.",
  "settings.everythingDuplicateWarning": "A konténerek, a VM-ek, a flash, a mappák, a ZFS-adatkészletek és az önmentés kétszer készül el, amíg egyszerre be van kapcsolva ez az ütemezés és a sajátjuk is: egyszer itt, egyszer a saját ütemezésük szerint. Kapcsold ki azokat a területeket, amelyeket nem akarsz duplán menteni.",
  ...
  "jobs.zfsSection": "ZFS-adatkészletek",
  "jobs.zfsIncludeHint": "Minden ZFS-elemet ment, amelynél a „felvétel az ütemezésbe“ be van kapcsolva, mindegyiket az összes gyermekadatkészletével. Ha az elemenkénti ütemezés be van kapcsolva, egy elem saját ritmust vihet, ami egyben ki is veszi a Mindent menteni futásból.",
  "jobs.noZfsDatasetsIncluded": "Még nincsenek ZFS-adatkészletek. Vegye fel őket a ZFS oldalon.",
  "activityLog.domainZFS": "ZFS",
  "dashboard.domainZFS": "ZFS",
  "recovery.zfsFound": "Talált ZFS-elemek: {n}",
  "recovery.zfsRestoreHint": "Az újra megtalált ZFS-elemek kikapcsolva maradnak. Nézze át minden elem adatkészleteit és beállításait, mielőtt bekapcsolja; a mappába való visszaállítás azonnal működik.",
  "zfs.emptyTitle": "Még nincs ZFS adatkészlet",
  "zfs.empty": "Adj hozzá egy adatkészletet, és a BombVault egyetlen ZFS pillanatképből menti azt a gyermekadatkészleteivel együtt, így minden fájl ugyanabból a pillanatból való.",
  "zfs.loadFailed": "A ZFS adatkészleteket nem sikerült betölteni",
  "zfs.backupAll": "Mentsd mindet most",
  "zfs.discoverHint": "Elveszett a lista? Építsd fel újra a tárolóban lévő mentésekből.",
  "zfs.discovered": "Visszanyert ZFS tételek: {n}. Kikapcsolva maradnak, amíg át nem nézed őket.",
  "zfs.notInItem": "A gépen lévő adatkészletek, amelyek egyetlen tételhez sem tartoznak: {n}",
  "zfs.unusedZvols": "Kötetek, amelyeket egyetlen virtuális gép sem használ: {n}",
  "zfs.unusedZvolsHint": "Egy kötetben virtuális lemez van, nem fájlok. A virtuális gép által használt köteteket a virtuális gépek oldala menti. Ezek egyik géphez sem tartoznak, például egy iSCSI megosztás vagy egy lemez, amit leválasztottál, és a BombVault még nem menti őket. Egy későbbi verzió megteszi.",
  "zfs.connection.title": "Kapcsolat ezzel a kiszolgálóval",
  "zfs.connection.hint": "A BombVault SSH-n keresztül futtat zfs parancsokat ezen a kiszolgálón, ugyanazon a kapcsolaton, amit a virtuális gépek mentése használ. Ha a kapcsolat elakad, ez a kártya megmutatja a BombVault kulcsát és a parancsot, ami engedélyezi.",
  "zfs.connection.target": "Csatlakozva mint {target}",
  "zfs.connection.version": "OpenZFS {version}",
  "zfs.connection.test": "Próbáld újra",
  "zfs.connection.testing": "A kapcsolat próbája folyik…",
  "zfs.connection.details": "Részletek",
  "zfs.connection.authorize": "Futtasd ezt egyszer a kiszolgáló termináljában, hogy engedélyezd a BombVault kulcsát:",
  "zfs.code.ok": "A pillanatképek elérése működik.",
  "zfs.code.ssh-missing": "Az SSH kapcsolat ehhez a kiszolgálóhoz nincs beállítva ebben a konténerben.",
  "zfs.code.host-placeholder": "A gép címe még mindig a minta 192.168.x.x, és a host.docker.internal sem válaszolt.",
  "zfs.code.host-fallback": "A gép címe még mindig a minta, ezért a BombVault a host.docker.internal címet használta, és ez működik.",
  "zfs.code.ssh-unreachable": "Ez a kiszolgáló SSH-n nem érhető el a következő címen: {target}.",
  "zfs.code.ssh-auth": "A kiszolgáló elutasította a BombVault SSH kulcsát.",
  "zfs.code.zfs-not-found": "A kiszolgálón nincs zfs parancs.",
  "zfs.code.zfs-permission": "Az SSH felhasználó nem futtathatja ezt a zfs parancsot.",
  "zfs.code.uri-mismatch": "A LIBVIRT_URI ide mutat: {uriTarget}, a zfs parancsok viszont ide mennek: {target}.",
  "zfs.code.zfs-error": "A zfs hibát jelzett.",
  "zfs.code.propagation-missing": "A kiszolgáló új csatolásai nem jutnak el a BombVaultig, így a pillanatképek nem olvashatók.",
  "zfs.code.invalid-name": "Ez az adatkészletnév olyan karaktereket tartalmaz, amelyeket a BombVault nem fogad el.",
  "zfs.code.name-too-long": "Ebben a fában egy adatkészletnév túl hosszú pillanatképnévhez (határ {max} karakter): {names}",
  "zfs.code.invalid-exclude": "Ez a sor nem illik ehhez a tételhez: {names}",
  "zfs.code.not-found": "Az adatkészlet nincs a kiszolgálón.",
  "zfs.code.not-filesystem": "Ez kötet, nem fájlrendszer.",
  "zfs.code.overlaps-item": "Ez átfedésben van egy tétellel, ami már megvan: {names}",
  "zfs.code.docker-storage": "Ebben a fában van a Docker képtára. Egy pillanatkép megakadályozná, hogy a Docker képeket töröljön a mentés alatt.",
  "zfs.code.nothing-readable": "Most egyetlen adatkészlet sem olvasható ebből a tételből.",
  "zfs.code.snapshot-failed": "A pillanatképet nem sikerült létrehozni.",
  "zfs.code.containers-busy": "A konténereket nem lehetett leállítani, mert még futott egy konténermentés.",
  "zfs.code.consistency-stop-failed": "Egy konténert nem lehetett leállítani, ezért nem készült pillanatkép: {names}",
  "zfs.code.pre-snapshot-failed": "A pillanatkép előtti parancs elhasalt, ezért nem készült pillanatkép.",
  "zfs.code.container-unknown": "A listán szereplő konténer nem létezik: {names}",
  "zfs.code.container-is-self": "A BombVault nem tudja leállítani a saját konténerét.",
  "zfs.code.hook-container-missing": "A pillanatkép előtti vagy utáni parancsnak kell egy konténer, amelyben fut.",
  "zfs.code.leftover-snapshots": "A kiszolgálón maradt BombVault pillanatképek: {n}",
  "zfs.code.zvol": "Kötet, kihagyva. Ez a mentésfajta fájlrendszereket olvas.",
  "zfs.code.canmount-off": "Sosem csatolódik (canmount=off), kihagyva.",
  "zfs.code.legacy-mount": "Legacy csatolási pont, kihagyva.",
  "zfs.code.no-mountpoint": "Nincs csatolási pont, kihagyva.",
  "zfs.code.not-mounted": "A kiszolgálón nincs csatolva, kihagyva.",
  "zfs.code.key-not-loaded": "Titkosított, és a kulcs nincs betöltve, kihagyva.",
  "zfs.code.snapdir-disabled": "A pillanatképek elérése ehhez az adatkészlethez ki van kapcsolva, kihagyva.",
  "zfs.code.not-visible": "A BombVault nem látja ezt az adatkészletet. A kiszolgálón ide van csatolva: {path}.",
  "zfs.notVisibleNoPath": "A BombVault nem látja ezt az adatkészletet.",
  "zfs.code.shfs-only": "A BombVault csak a /mnt/user útján látja ezt az adatkészletet, ami elrejti a pillanatképeket.",
  "zfs.code.snapshot-not-visible": "A pillanatkép elkészült, de a BombVaulton belül nem jelent meg.",
  ...
  "zfs.code.not-enough-space": "A célon nincs elég szabad hely.",
  "zfs.code.safety-snapshot-failed": "A biztonsági pillanatképet nem sikerült elkészíteni, ezért semmi sem állt vissza.",
  "zfs.code.safety-name-too-long": "Ez az adatkészletnév túl hosszú egy biztonsági pillanatképhez.",
  ...
  "zfs.fix.ssh-unreachable": "Ellenőrizd a címet és a portot a konténersablonban, és hogy az SSH be van-e kapcsolva a kiszolgáló beállításaiban.",
  "zfs.fix.zfs-not-found": "Irányítsd a Host SSH: Address mezőt arra a gépre, amelyé a poolok.",
  "zfs.fix.zfs-permission": "Használj rootot, vagy add meg a felhasználónak a zfs allow paranccsal a snapshot, destroy és mount jogot a tétel adatkészletén.",
  "zfs.fix.uri-mismatch": "Állítsd a Host SSH: Address és a Host SSH: User mezőt ugyanarra a gépre és felhasználóra, mint a LIBVIRT_URI, vagy ürítsd ki őket, hogy a BombVault mindkettőt az URI-ból vegye.",
  "zfs.fix.propagation-missing": "Szerkeszd a konténert, és állítsd a Host Data útvonal Access Mode értékét Read/Write - Slave értékre, majd indítsd újra a BombVaultot.",
  "zfs.fix.overlaps-item": "Töröld előbb a másik tételt, a mentéseit megtartva. A története ebben a tételben folytatódik.",
  "zfs.fix.docker-storage": "Inkább az alatta lévő adatkészleteket add hozzá, például az appdata készletet, a Docker tárát pedig hagyd ki.",
  "zfs.fix.name-too-long": "Nevezd át azt az adatkészletet, vagy vegyél tételnek egy lejjebb lévő készletet.",
  "zfs.fix.zvol": "A virtuális géphez tartozó kötetet a virtuális gépek oldala menti. A gép nélküli kötetet a BombVault még nem menti.",
  "zfs.fix.canmount-off": "Ha ebben az adatkészletben adat van, csatold a kiszolgálón, vagy tedd át az adatot egy gyermekkészletbe.",
  "zfs.fix.legacy-mount": "Adj az adatkészletnek csatolási pontot a /mnt alatt, ha az adatát menteni kell.",
  "zfs.fix.not-mounted": "Csatold az adatkészletet a kiszolgálón (zfs mount), vagy állítsd be a canmount=on értéket.",
  "zfs.fix.key-not-loaded": "Töltsd be a kulcsot a kiszolgálón (zfs load-key), majd csatold az adatkészletet.",
  "zfs.fix.snapdir-disabled": "Futtasd az adatkészleten a zfs set snapdir=hidden parancsot. A .zfs mappa rejtve marad, de a pillanatképek olvashatóvá válnak.",
  "zfs.fix.not-visible": "Tedd az adatkészlet csatolási pontját a Host Data útvonal alá, vagy csatold be a konténerbe ugyanarra az útvonalra Access Mode Read/Write - Slave beállítással.",
  "zfs.fix.shfs-only": "Csatold a /mnt könyvtárat (nem a /mnt/user utat) Host Dataként, ahogy az alapértelmezett sablon teszi.",
  "zfs.fix.containers-busy": "Indítsd újra a mentést, ha a konténermentés befejeződött. Az ütemezett futások maguktól várnak.",
  "zfs.fix.consistency-stop-failed": "Nézd meg a konténert a Docker fülön, vagy vedd ki a leállítandó konténerek listájából.",
  "zfs.fix.pre-snapshot-failed": "Ellenőrizd a parancsot és a konténert, amelyben fut; a futás részletei mutatják a kimenetét.",
  "zfs.fix.leftover-snapshots": "Nyomd meg az Eltávolítás most gombot. Ha nem megy, futtasd a kiszolgálón a zfs destroy -r parancsot a részletekben megnevezett pillanatképekre.",
  "zfs.fix.read-only-mount": "Állítsd a csatolás Access Mode értékét Read/Write - Slave értékre, vagy állíts vissza mappába.",
  "zfs.fix.destination-not-mounted": "Válassz mappát poolon vagy megosztáson.",
  "zfs.member.backed-up": "Mentve",
  "zfs.member.empty": "Üres, nincs mit menteni",
  "zfs.member.excluded": "Kihagyva",
  "zfs.member.new": "Új",
  "zfs.member.structure": "Csak szerkezet",
  "zfs.enabled": "Vedd be az ütemezésbe",
  "zfs.checkedAt": "Ellenőrizve {when}",
  "zfs.notChecked": "Még nincs ellenőrizve",
  "zfs.probe": "Próbáld ki a pillanatképek elérését",
  "zfs.probing": "A pillanatképek elérésének próbája folyik…",
  ...
  "zfs.membersSummary": "Adatkészletek: {n}",
  "zfs.skippedCount": "Kihagyott adatkészletek: {n}",
  "zfs.children": "A tétel adatkészletei",
  "zfs.childrenHint": "Ez a tétel az adatkészletet és minden alatta lévő készletet egyetlen pillanatképből menti. Az új gyermekkészletek maguktól bekerülnek. Kapcsolj ki egyet, hogy kimaradjon mindennel együtt, ami alatta van. A nem olvasható készletek kimaradnak, és minden futásnál fel vannak sorolva.",
  "zfs.excludedGone": "Kihagyva, már nincs a kiszolgálón",
  "zfs.excludes": "Kizárási minták",
  "zfs.excludesHint": "Soronként egy minta. A / jellel kezdődő minta ennek a tételnek az adatkészletétől számít, és egy gyermekkészlet a saját nevével szereplő mappa, például /plex/Library/Cache. A / nélkül kezdődő minta minden mélységben és minden készletben illeszkedik, például *.tmp vagy Library/Cache. Ez eltér a Mappáktól, ahol a / a konténer gyökerét jelenti.",
  "zfs.excludesCount": "Kizárások: {n}",
  "zfs.stopContainers": "Állítsd le ezeket a konténereket a pillanatképhez",
  "zfs.stopContainersHint": "A BombVault leállítja őket, elkészíti a pillanatképet, majd rögtön újraindítja őket, rendszerint másodpercek alatt. A mentés ezután a pillanatképet olvassa, miközben az alkalmazások már futnak. Adatbázisokhoz és más, folyamatosan író alkalmazásokhoz való.",
  "zfs.stopContainersPlaceholder": "Konténer hozzáadása",
  "zfs.stopContainersNone": "Egy sem. A pillanatkép akkor készül, amikor minden fut.",
  "zfs.overlapContainers": "A Konténerek oldalon is mentve: {names}. Az adataik kétszer kerülnek tárba, és a Mentsd mindet kétszer állítja le őket.",
  "zfs.hookContainer": "Parancsok futtatása itt",
  "zfs.hookContainerNone": "Nincs, nem fut parancs",
  "zfs.preSnapshot": "Parancs a pillanatkép előtt",
  "zfs.postSnapshot": "Parancs a pillanatkép után",
  "zfs.hooksHint": "A választott konténerben fut. Használd például arra, hogy közvetlenül a pillanatkép előtt kiírj egy adatbázist ebbe az adatkészletbe, anélkül hogy bármit leállítanál. Ha a pillanatkép előtti parancs elhasal, nem készül mentés.",
  "zfs.consistencyChips": "Leállítva a pillanatképhez: {names}",
  "zfs.window": "A konténerek {seconds} másodpercig álltak",
  "zfs.restartPending": "Megszakadt pillanatkép után még mindig leállítva: {names}",
  "zfs.restartPendingHint": "A BombVault leállította ezeket a konténereket egy pillanatképhez, és nem tudta újraindítani őket. Indítsd el őket a Docker fülön. A BombVault a saját újraindulásakor is megpróbálja.",
  "zfs.leftovers": "A kiszolgálón maradt pillanatképek: {n}",
  "zfs.leftoversHint": "A BombVault nem tudta eltávolítani ezeket a pillanatképeket a mentés után. Amíg ott vannak, törölt adatot tartanak a poolban.",
  "zfs.removeLeftovers": "Eltávolítás most",
  "zfs.sweepDone": "A maradék pillanatképek eltávolítva.",
  "zfs.sweepRemaining": "Pillanatképek még a kiszolgálón: {n}",
  "zfs.removeMissing": "Vedd ki a listából",
  "zfs.safety.title": "Biztonsági pillanatképek: {n}",
  "zfs.safety.row": "{dataset}, {age}, {size}",
  "zfs.safety.old": "A legrégebbi biztonsági pillanatkép 30 napnál idősebb. Törölt és módosított adatot tart a poolban, amíg le nem törlöd.",
  "zfs.safety.hint": "A BombVault ezeket a pillanatképeket közvetlenül egy adatkészletbe való visszaállítás előtt készítette, hogy az azt megelőző állapot visszanyerhető legyen. A BombVault soha nem törli őket magától. Egyes fájlokat úgy kapsz vissza, hogy átmásolod őket a .zfs/snapshot/<name> könyvtárból az adatkészleten belül. A zfs rollback csak addig működik, amíg ez a készlet legfrissebb pillanatképe; a zfs rollback -r minden újabb pillanatképet töröl, az automatikusakat is.",
  ...
  "zfs.add.title": "ZFS adatkészletek hozzáadása",
  "zfs.add.hint": "A lista erről a gépről jön. Egy tétel egy adatkészlet az alatta lévő összes adatkészlettel együtt, egyetlen pillanatképből mentve. Válaszd ki a legfelső adatkészletet abból, amit szeretnél, aztán kapcsold ki azokat az alsóbb adatkészleteket, amelyek kimaradnak.",
  "zfs.add.loading": "Az adatkészletek beolvasása a gépről…",
  "zfs.add.unavailable": "Az adatkészleteket nem sikerült beolvasni a gépről.",
  "zfs.add.retry": "Próbáld újra",
  "zfs.add.filter": "Adatkészletek szűrése…",
  "zfs.add.none": "Egyetlen adatkészlet sem illik rá.",
  "zfs.add.asItem": "Hozzáadás tételként",
  "zfs.add.size": "Körülbelül {size} menteni való",
  "zfs.add.encrypted": "Titkosított",
  "zfs.add.selected": "Kijelölve: {n}",
  "zfs.add.isItem": "Már tétel",
  "zfs.add.inItem": "A(z) {dataset} része",
  "zfs.add.vmDisk": "A virtuális gépével együtt már mentésre kerül",
  "zfs.add.system": "Rendszeradatok",
  "zfs.add.willSkip": "Ki lesz hagyva: {reason}",
  "zfs.add.vmVolume": "A virtuális gépével együtt mentődik",
  "zfs.add.unusedZvol": "Egyetlen virtuális gép sem használja, nem kerül mentésre",
  "zfs.add.unusedZvols": "Kötetek, amelyeket egyetlen virtuális gép sem használ: {n}. A BombVault nem menti őket.",
  ...
  "zfs.add.testing": "A(z) {dataset} pillanatkép-hozzáférésének próbája…",
  "zfs.add.probeFailed": "A(z) {dataset} pillanatkép-hozzáférését most nem sikerült kipróbálni. Az első mentés újra ellenőrzi.",
  "zfs.add.done": "Kész",
  "zfs.restore.title": "{dataset} visszaállítása",
  "zfs.restore.point": "Mentés ideje",
  "zfs.restore.dataset": "Adatkészlet",
  "zfs.restore.wholeTree": "Ennek a mentésnek az összes adatkészlete",
  "zfs.restore.inPlace": "Visszaállítás az adatkészletbe",
  "zfs.restore.inPlaceHint": "A mentés fájljai ide íródnak: {path}. Az azonos nevű fájlok felülíródnak, a többi marad. Magát az adatkészletet soha nem forgatjuk vissza és nem cseréljük ki.",
  "zfs.restore.selectFiles": "Fájlok kiválasztása",
  "zfs.restore.toFolder": "Visszaállítás mappába",
  "zfs.restore.safetySnapshot": "Előbb ZFS pillanatkép a mostani állapotról",
  "zfs.restore.safetySnapshotHint": "A BombVault pillanatképet készít erről az adatkészletről, mielőtt bármit írna, így a visszaállítás előtti állapot visszaszerezhető. Addig marad, amíg a Biztonsági pillanatképek alatt nem törlöd.",
  "zfs.restore.safetyOffConfirm": "Biztonsági pillanatkép nélkül állítsuk vissza? Amit a visszaállítás felülír, azt utána nem lehet visszaszerezni.",
  "zfs.restore.stopContainers": "{names} leállítása a visszaállítás idejére",
  "zfs.restore.stopContainersHint": "Leállítva maradnak, amíg a visszaállítás be nem fejeződik, és ez sokáig tarthat. A konténerek mentései addig várnak.",
  "zfs.restore.confirm": "Visszaállítod ezt a mentést ide: {path}? Az azonos nevű fájlok felülíródnak.",
  "zfs.restore.started": "A visszaállítás elindult ide: {target}.",
  "zfs.restore.safetyTaken": "Biztonsági pillanatkép: {snapshot}",
  ...
  "recovery.foreignDbDumps": "one={n} adatbázis-mentés van ebben a tárolóban. Szedd ki a restic parancssorával, ahogy a helyreállítási csomag leírja.|other={n} adatbázis-mentés van ebben a tárolóban. Szedj ki egyet a restic parancssorával, ahogy a helyreállítási csomag leírja.",
  ...
  "recovery.dumpOnlySkipped": "one={n} csak mentésként meglévő adatbázis itt kimarad. Állítsd vissza és importáld a saját listájából.|other={n} csak mentésként meglévő adatbázis itt kimarad. Állítsd vissza és importáld őket a saját listájukból.",
  ...
  "mcp.restoreRevokedNotice": "A konfiguráció visszaállítása minden MCP-kulcsot visszavont. Hozz létre új kulcsokat az asszisztenseidnek.",
  "mcp.appKeyChanged": "Az APP_KEY megváltozott a kulcsok létrehozása óta, ezért már nem működnek. Cserélj le minden kulcsot, és frissítsd az asszisztenseidet.",
  "mcp.keyUnusable": "Az APP_KEY módosítása után már érvénytelen",
  "mcp.loadFailed": "Az MCP-kulcsokat nem sikerült betölteni",
  "mcp.endpointLabel": "Végpont",
  "mcp.endpointHint": "A cím, amelyhez az asszisztensed csatlakozik. Streamable HTTP-t beszél, és kulcsot vár az Authorization vagy az X-API-Key fejlécben; OAuth-bejelentkezés nincs.",
  "mcp.newKey": "Új kulcs",
  "mcp.labelLabel": "A kulcs neve",
  "mcp.labelPlaceholder": "Claude Code a laptopon",
  "mcp.allowStart": "Mentések indításának engedélyezése",
  "mcp.allowStartHint": "Bekapcsolva az asszisztens elindíthatja egy elem, egy teljes terület vagy a Backup Everything mentését, és megszakíthatja az általa indított mentéseket: óránként legfeljebb {n}, ugyanarra az elemre {minutes} perc szünettel, elemenként naponta {perDay}. A mentés a futó konténereket leállítja, amíg be nem fejeződik. Kikapcsolva a kulcs csak olvasni tud.",
  "mcp.createKey": "Kulcs létrehozása",
  "mcp.created": "Kulcs létrehozva",
  "mcp.labelInvalid": "Adj a kulcsnak legfeljebb 64 karakteres nevet.",
  "mcp.labelTaken": "Egy aktív kulcsot már így hívnak.",
  "mcp.limitReached": "one=Már van {n} aktív kulcs. Vond vissza, mielőtt újat hozol létre.|other=Már van {n} aktív kulcs. Vonj vissza egyet, mielőtt újat hozol létre.",
  "mcp.newKeyTitle": "Az új kulcsod",
  "mcp.showOnce": "Másold ki most. A BombVault csak egy ujjlenyomatot őriz belőle, és nem tudja újra megmutatni.",
  "mcp.copyKey": "Kulcs másolása",
  "mcp.dismissKey": "Kimásoltam",
  "mcp.snippetsLabel": "Kliens csatlakoztatása",
  "mcp.snippetOther": "Más kliensek",
  "mcp.snippetClaudeCodeHint": "Futtasd ezt egyszer a terminálban. A Claude Code a kulcsot a felhasználói beállításaidban tárolja, nem projektfájlban. A kapcsolatot a /mcp paranccsal ellenőrizheted a Claude Code-on belül.",
  "mcp.snippetShellHistory": "A parancs tartalmazza a kulcsot, és a parancsértelmeződ megőrizheti az előzményeiben. A dokumentáció mutat olyan formát, amely ezt elkerüli.",
  "mcp.snippetDesktopHint": "Vedd fel ezt a bejegyzést a claude_desktop_config.json \"mcpServers\" részébe (a Claude Desktopban: Settings, Developer, Edit Config), majd indítsd újra a Claude Desktopot. Node.js kell hozzá, mert az mcp-remote köti össze az asztali alkalmazást ezzel a kiszolgálóval.",
  "mcp.snippetOtherHint": "Bármelyik kliens megfelel, amely Streamable HTTP-t beszél. A kulcsot Authorization: Bearer vagy X-API-Key formában küldd.",
  "mcp.snippetOtherCert": "A kliensnek a bombvault-cert.pem fájlban is meg kell bíznia. Töltsd le a végpont melletti gombbal.",
  "mcp.copySnippet": "Részlet másolása",
  "mcp.tlsHint": "A Claude Code és a Claude Desktop csak olyan tanúsítványon keresztül csatlakozik, amelyben megbízik. A BombVault saját tanúsítványa esetén vedd fel ide, a kártyán ezt a címet, és töltsd le a tanúsítványt; a részletek ekkor erre a fájlra irányítják a Node.js-t. Fordított proxy vagy megbízható tanúsítvánnyal működő Tailscale e lépés nélkül is jó. A HTTP_ONLY az egész webes felületet sima HTTP-re állítja, módosítást kíván a konténer beállításain, és titkosítatlanul küldi a kulcsot. A tanúsítványellenőrzést soha ne kapcsold ki. A Claude saját beállításaiban felvett összekötők nem működnek BombVault-kulcsokkal, mert OAuthtal lépnek be, azt pedig a BombVault nem kínálja.",
  "mcp.privacyHint": "Amit az asszisztens olvas, például elemek nevét, futási előzményeket, hibaüzeneteket és szokatlan mentéseket, az elmegy a mögötte álló MI-szolgáltatóhoz. A BombVault eltávolítja a gazdagép útvonalait, a tárolók helyét és a hitelesítő adatokat, mielőtt bármi kikerülne.",
  "mcp.certNotForThisAddress": "A BombVault tanúsítványa nem nevezi meg a következőt: {host}, ezért az asszisztensek megtagadják a kapcsolódást ehhez a címhez. Vedd fel a címet a tanúsítványba, majd töltsd le a részletekhez.",
  "mcp.certOwnNotForThisAddress": "A tanúsítványod nem nevezi meg a következőt: {host}, ezért az asszisztensek megtagadják a kapcsolódást ehhez a címhez. Csatlakozz olyan néven, amelyet a tanúsítvány lefed.",
  "mcp.certAddAddress": "Cím felvétele a tanúsítványba",
  "mcp.certAddTitle": "Felveszed a(z) {host} címet a tanúsítványba?",
  "mcp.certAddConfirm": "A BombVault újra kiállítja a tanúsítványát, ezúttal a(z) {host} címmel. A böngésződ egyszer figyelmeztet az új tanúsítványra, ahogy első alkalommal is tette.",
  "mcp.certAdded": "A cím bekerült a tanúsítványba",
  "mcp.certDownload": "Tanúsítvány letöltése",
  "mcp.certNotOwn": "A BombVault az általad hozott tanúsítványt használja, ezért érintetlenül hagyja.",
  "mcp.certNameInvalid": "Ez a cím nem vehető fel tanúsítványba.",
  "mcp.certNameLimit": "A tanúsítvány már annyi címet nevez meg, amennyit elbír.",
  "mcp.certWriteFailed": "A tanúsítványt nem sikerült kiírni. A régi marad használatban.",
  "mcp.keyHint": "Vége: {hint}",
  "mcp.keyCreated": "Létrehozva {date}",
  "mcp.keyRotated": "Lecserélve {date}",
  "mcp.keyLastUsed": "Utoljára használva {when} innen: {addr}",
  "mcp.keyLastUsedNoAddr": "Utoljára használva {when}",
  "mcp.keyNeverUsed": "Még nem használták",
  "mcp.permissionSaved": "Mentve. Az asszisztens következő kérésétől érvényes.",
  "mcp.rotate": "Kulcs cseréje",
  "mcp.rotateTitle": "Lecseréled ezt a kulcsot?",
  "mcp.rotateConfirm": "{name} új kulcsot kap, a régi azonnal érvényét veszti. Frissítsd minden klienst, amely használja.",
  "mcp.rotated": "Kulcs lecserélve",
  "mcp.revoke": "Visszavonás",
  "mcp.revokeTitle": "Visszavonod ezt a kulcsot?",
  "mcp.revokeConfirm": "{name} azonnal érvényét veszti, és nem kapcsolható vissza. Az általa indított futások megtartják a nevét az előzményekben.",
  "mcp.revoked": "Kulcs visszavonva",
  "mcp.revokedList": "one={n} visszavont kulcs|other={n} visszavont kulcs",
  "mcp.revokedAt": "Visszavonva {date}",
  "mcp.revokedByRestore": "A konfiguráció visszaállítása vonta vissza, {date}",
  "mcp.inUseTip": "A futási előzmények még megnevezik ezt a kulcsot, ezért a listán marad.",
  "mcp.purgeTitle": "Törlöd ezt a visszavont kulcsot?",
  "mcp.purgeConfirm": "{name} végleg eltűnik a listáról.",
  "mcp.purged": "Kulcs törölve",
  "mcp.notFound": "Ez a kulcs már nem létezik. A lista újratöltődött.",
  "mcp.canStart": "Mentéseket indít",
  "mcp.readOnly": "Csak olvasás",
  "mcp.callsToday": "one={n} hívás ma|other={n} hívás ma",
  "mcp.log": "Napló",
  ...
  "nav.anomalies": "Anomáliák",
  "anomaly.navCountAria": "Nyitott kritikus anomáliák és figyelmeztetések: {n}",
  "anomaly.title": "Anomáliák",
  "anomaly.cardHint": "A BombVault minden mentést összevet az elem korábbi mentéseivel, és megnevezi, ami kilóg: a szokásosnál sokkal több új adat, az adatok nagy részének újraírása, erősen összement vagy megnőtt forrás, kisebb adatbázismentés, hirtelen sokkal tovább tartó mentés, ismétlődő hibák, visszaállítási ellenőrzés, ami már nem megy át, és hamarosan betelő lemez. A legtöbb ellenőrzéshez előbb 10 mentés kell egy elemről. A BombVault a ZFS-elemeket adatkészletenként ellenőrzi, így egy kiürített gyermek-adatkészlet egy nagy fában is feltűnik.",
  "anomaly.allClear": "Nincs anomália a mentéseidben.",
  "anomaly.learningCount": "Még tanuló elemek: {n}",
  "anomaly.checking": "A mentések előzményeinek átnézése folyik.",
  "anomaly.loadFailed": "Az anomáliákat nem sikerült betölteni. Ez nem jelenti azt, hogy minden rendben van.",
  "anomaly.off": "Az anomáliafelismerés ki van kapcsolva.",
  "anomaly.showEarlier": "Korábbi anomáliák megjelenítése",
  "anomaly.notesCount": "Megjegyzések: {n}",
  "anomaly.openSettings": "Beállítások megnyitása",
  "anomaly.evalErrors": "Nem ellenőrizhető elemek: {n}. A napló megnevezi őket.",
  "anomaly.showAll": "Összes megjelenítése",
  "anomaly.moreCount": "Itt nem látható: {n}",
  "anomaly.countCritical": "Kritikus: {n}",
  "anomaly.countWarning": "Figyelmeztetések: {n}",
  "anomaly.countHeld": "Régi mentéseiket megtartó elemek: {n}",
  "anomaly.recovered": "megszűnt",
  "anomaly.recoveredHint": "Az ok {date} napján megszűnt. Nyugtázd, hogy lezárd ezt az anomáliát.",
  "anomaly.retentionPaused": "Az elem régi mentései megmaradnak, amíg nem nyugtázod az anomáliát vagy nem jelölöd várhatónak.",
  "anomaly.lastGood": "Utolsó jó mentés: {date}",
  "anomaly.action.restoreLastGood": "A {date} napi mentés visszaállítása",
  "anomaly.stillPresent": "Továbbra is fennáll. Csak akkor jelentjük újra, ha az ok egyszer megszűnt.",
  "anomaly.closedAt": "Lezárva: {date}",
  "anomaly.noteLabel": "Megjegyzés",
  "anomaly.releaseConfirm": "A(z) {name} régi mentéseit a következő takarítás ismét törli. Ha adat hiányzik vagy titkosították, előbb állítsd vissza. Folytatod?",
  "anomaly.dumpOf": "A(z) {name} adatbázismentése",
  "anomaly.occurrences": "Hányszor észleltük: {n}",
  "anomaly.severity.critical": "Kritikus",
  "anomaly.severity.warning": "Figyelmeztetés",
  "anomaly.severity.info": "Információ",
  "anomaly.state.open": "Nyitott",
  "anomaly.state.resolved": "Megoldva",
  "anomaly.state.acknowledged": "Nyugtázva",
  "anomaly.state.expected": "Várható",
  "anomaly.detector.newData": "Új adat",
  "anomaly.detector.source": "Forrás mérete",
  "anomaly.detector.duration": "Időtartam",
  "anomaly.detector.reliability": "Hibák",
  "anomaly.detector.integrity": "Visszaállítási ellenőrzések",
  "anomaly.detector.capacity": "Lemezterület",
  "anomaly.action.acknowledge": "Nyugtázás",
  "anomaly.action.expected": "Jelölés várhatóként",
  "anomaly.action.details": "Részletek",
  "anomaly.acknowledgeHint": "Megjelöli az anomáliát látottként és lezárja. Amíg az ok fennáll, nem jelentjük újra; ha az ok megszűnt és visszatér, igen. Ha ez az anomália visszatart régi mentéseket, azokat a következő takarítástól kezdve ismét törli a rendszer. Ha a változás szándékos volt, jobb várhatónak jelölni.",
  "anomaly.expectedHint": "Közli a BombVaulttal, hogy a változás szándékos volt. Az új méret vagy időtartam további 10 mentés után lesz a szokásos szint, a majdnem üres forrás ellenőrzése pedig bekapcsolva marad. Új adat esetén az ekkoráig terjedő mennyiségeket már nem jelentjük ennél az elemnél. Ha ez az anomália visszatart régi mentéseket, azokat a következő takarítástól kezdve ismét törli a rendszer.",
  "anomaly.detail.observed": "Mért érték",
  "anomaly.detail.expected": "Szokásos",
  "anomaly.detail.threshold": "Jelentés ettől",
  "anomaly.detail.samples": "Összevetett mentések",
  "anomaly.detail.samplesDisk": "Összevetett lemezmérések",
  "anomaly.detail.checksCompared": "Összevetett ellenőrzések",
  "anomaly.detail.sensitivity": "Érzékenység",
  "anomaly.detail.firstSeen": "Először észlelve",
  "anomaly.detail.lastSeen": "Utoljára észlelve",
  "anomaly.detail.median": "Medián",
  "anomaly.detail.mad": "Szokásos szórás (MAD)",
  "anomaly.detail.z": "Eltérési mutató",
  "anomaly.detail.refBytes": "Legnagyobb szokásos mennyiség",
  "anomaly.detail.refRate": "Legnagyobb szokásos mennyiség óránként",
  "anomaly.detail.etaGrowth": "Megtelik, a mentések növekedése alapján",
  "anomaly.detail.etaFree": "Megtelik, a szabad hely alakulása alapján",
  "anomaly.detail.slope": "Szabad hely változása naponta",
  "anomaly.sensitivity.strict": "Szigorú",
  "anomaly.sensitivity.balanced": "Kiegyensúlyozott",
  "anomaly.sensitivity.permissive": "Megengedő",
  "anomaly.openItem": "Elem megnyitása",
  "anomaly.error.badFilter": "Ez a szűrő értelmezhetetlen. Állítsd vissza a szűrőket, és próbáld újra.",
  "anomaly.error.badRequest": "A kérést elutasítottuk. Töltsd újra az oldalt, és próbáld újra.",
  "anomaly.error.notFound": "Ez a bejegyzés már nem létezik. Töltsd újra az oldalt.",
  "anomaly.error.generic": "A módosítást nem sikerült menteni.",
  "anomaly.days.lessThanOne": "kevesebb mint egy nap",
  "anomaly.sentence.newData": "A(z) {name} egyetlen mentésben {bytes} új adatot tett hozzá. Szokásosan legfeljebb {typical} kerül hozzá.",
  "anomaly.sentence.newDataRewrite": "A(z) {name} egyetlen mentésben {bytes} adatot írt újra, legalább a felét mindannak, amit ment ({source}). Ha nem változtattál ennyit, ellenőrizd, hogy a fájlokat nem titkosították vagy cserélték-e ki.",
  "anomaly.sentence.newDataRenamed": "A(z) {name} minden fájlja újnak tűnik, pedig van korábbi mentés, és {source} méretből {bytes} újra tárolásra került. Az egyszerre átnevezett és újraírt fájlok a zsarolóvírusokra jellemzők. Mindenekelőtt ellenőrizd a fájlokat.",
  "anomaly.sentence.newDataFull": "A BombVault újra beolvasta a(z) {name} minden fájlját, mert egyetlen korábbi mentés sem illeszkedett (új tároló, új mappák vagy megváltozott titkosítás). Tárolt új adat: {bytes}.",
  "anomaly.sentence.sourceCollapse": "A(z) {name} majdnem üres: {current}, szokásosan {typical}. Ellenőrizd, hogy törölték-e az adatokat, vagy nincs-e csatolatlan lemez.",
  "anomaly.sentence.sourceDrain": "A(z) {name} az elmúlt hetekben elvesztette adatai nagy részét: {current}, korábban {typical}.",
  "anomaly.sentence.sourceShrink": "A(z) {name} {current} méretűre zsugorodott, szokásosan {typical}.",
  "anomaly.sentence.sourceGrowth": "A(z) {name} {current} méretűre nőtt, szokásosan {typical}.",
  "anomaly.sentence.dumpCollapse": "A(z) {name} adatbázismentése majdnem üres: {current}, szokásosan {typical}. Ellenőrizd, hogy az adatbázis nem vesztette-e el az adatait.",
  "anomaly.sentence.dumpShrink": "A(z) {name} adatbázismentése {current} méretűre zsugorodott, szokásosan {typical}.",
  "anomaly.sentence.dumpGrowth": "A(z) {name} adatbázismentése {current} méretűre nőtt, szokásosan {typical}.",
  "anomaly.sentence.dumpDuration": "A(z) {name} adatbázismentése {current} ideig tartott, szokásosan {typical}.",
  "anomaly.sentence.dumpFailureStreak": "A(z) {name} adatbázismentése újra és újra meghiúsul. Egymást követő sikertelen mentések: {count}.",
  "anomaly.sentence.dumpFlaky": "A(z) {name} adatbázismentése időnként meghiúsul, pedig a legutóbbi sikerült. Az utolsó {total} közül sikertelen: {failed}.",
  "anomaly.sentence.filesCollapse": "A(z) {name} már alig tartalmaz fájlt. Fájlok száma: {current}, szokásosan {typical}.",
  "anomaly.sentence.filesShrink": "A(z) {name} fájljainak száma {current} értékre esett, szokásosan {typical}.",
  "anomaly.sentence.duration": "A(z) {name} mentése {current} ideig tartott, szokásosan {typical}.",
  "anomaly.sentence.failureStreak": "A(z) {name} újra és újra meghiúsul. Egymást követő sikertelen mentések: {count}.",
  "anomaly.sentence.flaky": "A(z) {name} időnként meghiúsul, pedig a legutóbbi mentés sikerült. Az utolsó {total} közül sikertelen: {failed}.",
  "anomaly.sentence.drill": "A(z) {domain} visszaállítási ellenőrzése ({source}) meghiúsult, pedig korábban átment.",
  "anomaly.sentence.drillTarget": "A(z) {domain} visszaállítási ellenőrzése a(z) {target} külső célon meghiúsult, pedig korábban átment.",
  "anomaly.sentence.drillDr": "A(z) {domain} külső próba-visszaállítása meghiúsult, pedig korábban átment.",
  "anomaly.sentence.drillDrTarget": "A(z) {domain} próba-visszaállítása a(z) {target} külső célról meghiúsult, pedig korábban átment.",
  ...
  "anomaly.tab.findings": "Leletek",
  "anomaly.tab.items": "Elemek",
  "anomaly.filter.state": "Állapot",
  "anomaly.filter.period": "Időszak",
  "anomaly.filter.period7": "Utolsó 7 nap",
  "anomaly.filter.period30": "Utolsó 30 nap",
  "anomaly.filter.period90": "Utolsó 90 nap",
  "anomaly.filter.periodAll": "Minden megőrzött",
  "anomaly.filter.severity": "Súlyosság",
  "anomaly.filter.detector": "Fajta",
  "anomaly.filter.any": "Mind",
  "anomaly.filter.stateOpen": "Nyitott",
  "anomaly.filter.stateClosed": "Lezárt",
  "anomaly.filter.itemChip": "Csak {name}",
  "anomaly.filter.removeChip": "Mutasd újra az összes elemet",
  "anomaly.bulk.selectAll": "Az összes látható kijelölése",
  "anomaly.bulk.loadedOnly": "Csak a betöltött bejegyzések vannak kijelölve. Tölts be többet, hogy a többi is beleférjen.",
  "anomaly.bulk.selected": "Kijelölve: {n}",
  "anomaly.bulk.clearSelection": "Kijelölés törlése",
  "anomaly.bulk.done": "Megváltoztatva: {changed}. Kihagyva: {skipped}.",
  "anomaly.notePlaceholder": "Megjegyzés (nem kötelező)",
  "anomaly.loadMore": "Több betöltése",
  "anomaly.emptyOpen": "Nincs nyitott anomália.",
  "anomaly.emptyClosed": "Ebben az időszakban nincs lezárt anomália.",
  "anomaly.emptyAny": "Ebben az időszakban nincs anomália.",
  "anomaly.emptyFiltered": "Egy anomália sem illik ezekre a szűrőkre.",
  "anomaly.releaseConfirmMany": "A kijelölt elemek régi mentéseit a következő takarítás újra törli: {names}. Ha adat hiányzik vagy titkosítva lett, előbb állítsd helyre. Folytatod?",
  "anomaly.items.hint": "Minden mentett elem a tanulási előrehaladásával, a szokásos értékeivel, valamint a saját érzékenységével és értesítésével. Egy elem a globális beállításokat követi, amíg itt mást nem választasz. Egy konténer adatbázismentésének és egy ZFS-elem minden adatkészletének saját sora van az elem alatt.",
  "anomaly.items.sensitivity": "Érzékenység",
  "anomaly.items.notifyMin": "Értesítés ehhez az elemhez",
  "anomaly.items.notifyFollow": "Mint a globális ({value})",
  "anomaly.items.notScheduled": "Nincs ütemezve",
  "anomaly.items.typical": "Szokásosan: {size}, új adat legfeljebb {newData}, restic ideje {duration}",
  "anomaly.items.typicalSize": "Szokásosan: {size}, restic ideje {duration}",
  "anomaly.items.dumpSeries": "Adatbázismentés",
  "anomaly.items.empty": "Még nincsenek elemek.",
  "anomaly.items.learningDetail": "Ellenőrzésenként tanult mentések. Új adat: {newData}. Forrás mérete: {source}. Időtartam: {duration}. Szükséges: {needed}.",
  "anomaly.learning": "Tanul {n}/{needed}",
  "anomaly.learningDone": "Megtanulva",
  "anomaly.noData": "Nincs miből tanulni: ez az elem nem ment semmilyen adatot.",
  "anomaly.sensitivity.follow": "Mint a globális ({preset})",
  "anomaly.family.newData": "Új adat",
  "anomaly.family.sourceBytesDown": "Forrás mérete, csökkenő",
  "anomaly.family.sourceBytesUp": "Forrás mérete, növekvő",
  "anomaly.family.sourceFilesDown": "Fájlok száma",
  "anomaly.family.duration": "Időtartam",
  "anomaly.family.dumpBytesDown": "Adatbázismentés mérete, csökkenő",
  "anomaly.family.dumpBytesUp": "Adatbázismentés mérete, növekvő",
  "anomaly.family.dumpDuration": "Adatbázismentés időtartama",
  "anomaly.expectation.since": "{family}: összehasonlítás {date} napjától",
  "anomaly.expectation.ceiling": "{family}: {bytes} méretig normális",
  "anomaly.expectation.selectionSince": "Összehasonlítás {date} napjától, mert akkor változott meg, hogy mi kerül mentésre",
  "anomaly.expectation.forget": "Felejtsd el",
  "anomaly.expectation.forgetConfirm": "Elfelejtsük, amit itt vártként jelöltél? Az ilyen méretű változásokat újra jelenteni fogjuk.",
  "anomaly.itemBadgeAria": "{name} nyitott anomáliái: {n}",
  "anomaly.settings.notify.critical": "Csak kritikus leletek",
  "anomaly.settings.notify.warning": "Figyelmeztetések és kritikus leletek",
  "anomaly.settings.notify.info": "Minden lelet",
  "anomaly.settings.notify.off": "Semmi",
  "anomaly.runBadge": "Anomália",
  "anomaly.snapshotFlagged": "Anomáliaként megjelölve",
  "anomaly.prunePaused": "Takarítás kész. A nyitott anomáliájú elemek régi mentései megmaradtak: {names}",
  "anomaly.settings.title": "Anomáliák",
  "anomaly.settings.hint": "Egy elem minden mentését összeveti a saját előzményeivel, és jelzi, ami nem illik bele. Minden mentés után a háttérben fut, és egyiket sem lassítja. A legtöbb ellenőrzés az elem 10 mentése után indul; a hibák, az adatok nagy részének újraírása és a majdnem üres forrás az elejétől ellenőrzött. A szabad helyet a helyi tárolóknál és azoknál az rclone tárolóknál figyeli, amelyek jelentik; az Unraid felhasználói megosztásán ez az egész tömb szabad helye.",
  "anomaly.settings.toggle": "Anomáliák felismerése",
  "anomaly.settings.sensitivity": "Érzékenység",
  "anomaly.settings.sensitivityHint": "A Szigorú a kisebb változásokat is jelzi, a Megengedő csak a nagyokat, a Kiegyensúlyozott a legtöbb szerverhez illik. Minden elem saját beállítást kaphat az Anomáliák, Elemek alatt.",
  "anomaly.settings.notifyMin": "Értesítés küldése ekkor",
  "anomaly.settings.notifyHint": "Az Értesítések alatt beállított csatornákat használja. Minden elem módosíthatja az Anomáliák, Elemek alatt. Az ismétlődő mentési és dumphibák és a sikertelen ütemezett visszaállítási ellenőrzések már saját üzenetet küldenek, ezért nem mennek ki másodszor.",
  "anomaly.settings.notifyMuted": "Most semmi sem megy ki: az értesítések ki vannak kapcsolva, vagy nincs beállított csatorna.",
  "anomaly.settings.openNotifications": "Értesítési beállítások megnyitása",
  "anomaly.settings.notifyCrossLink": "Hogy mely anomáliák küldenek értesítést, az Integritás, Anomáliák alatt állítható.",
  "anomaly.settings.holdToggle": "Régi mentések megtartása, ha egy forrás erősen zsugorodik vagy újraíródik",
  "anomaly.settings.holdHint": "Három lelet állítja meg a régi mentések törlését: a hirtelen majdnem üres forrás, a sokkal kisebbre zsugorodott forrás, és az a mentés, amely az adatok nagy részét újra eltárolta, ahogy egy zsarolóvírus kinéz. A megőrzés különben egyenként törölné a jó régebbi mentéseket. Amíg egy ilyen anomália nyitva van, csak annak az egy elemnek (vagy annak az adatbázismentésnek vagy ZFS adatkészletnek) a régi mentései maradnak meg; minden más a szokott módon takarítódik. A folytatáshoz nyugtázd az anomáliát, vagy jelöld várhatónak.",
  "anomaly.settings.backfill": "Tárolókból beolvasott előzmények: {done} / {slots}",
  "anomaly.settings.backfillPending": "A korábbi mentések beolvasása a tárolókból folyamatban.",
  "anomaly.settings.backfillFailed": "Tárolók, amelyek előzményei nem olvashatók: {failed}. Naponta egyszer újrapróbálja.",
  "anomaly.settings.backfillOld": "restic 0.17 előtti mentések méret-előzmény nélkül: {n}",
