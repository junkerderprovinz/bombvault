...
const fr: Partial<Translations> = {
  ...
  "about.body": "Un seul chevalier, une croisade : des outils libres, open source et soignés, qui n'existaient pas sous la forme que je voulais. Construits jusqu'à ce que plus rien ne manque. Pas de comptes, pas de télémétrie, pas de publicité. Pas d'essai, pas de formules payantes, pas d'astérisque en bas de page. Rien de lisible ne quitte jamais tes propres murs. Forgé le soir et le week-end, avec du cœur et de l'entêtement.",
  "about.coffee": "Si BombVault te sert, un don couvre ce que coûte son entretien : le domaine, le serveur et les soirées qui y passent. Et il fait battre un peu plus vite le cœur de ce chevalier. Trois chemins plus bas, prends celui qui te convient.",
