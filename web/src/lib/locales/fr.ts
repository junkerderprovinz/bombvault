...
const fr: Partial<Translations> = {
  ...
  "dbdump.globalOff": "Les dumps automatiques de base de données sont désactivés pour tous les conteneurs dans Réglages, Général.",
  ...
  "dbdump.introNotice": "BombVault fait un dump de {count} bases de données reconnues avant chaque sauvegarde, comme points de restauration à part entière. Vous pouvez le désactiver par conteneur sur sa carte, ou pour tous les conteneurs dans les Réglages.",
  ...
  "dbdump.fixRepository": "Le dépôt de sauvegarde n'a pas accepté le dump, ou a stocké moins d'octets qu'il n'en a été extrait. Vérifiez le dépôt dans Réglages, Stockage ; le dump est retenté à la prochaine sauvegarde.",
  ...
  "dbdump.deleteConfirm": "Supprimer cette sauvegarde SQL ? Elle est retirée du dépôt (lancez Prune dans les Réglages pour récupérer la place). C'est sans retour.",
  ...
  "recovery.dumpOnlySkipped": "{count} bases sauvegardées uniquement en export SQL sont laissées de côté ; restaurez-les et importez-les depuis leur propre liste.",
