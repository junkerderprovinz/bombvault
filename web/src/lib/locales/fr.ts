...
const fr: Partial<Translations> = {
  ...
  "settings.labelsHint": "Ce qui est affiché d'un contrôle : ses mots, son symbole ou les deux. Les boutons gardent la même largeur dans les trois cas, le changement ne réorganise donc pas la page.",
