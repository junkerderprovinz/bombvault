...
const fr: Partial<Translations> = {
  ...
  "settings.everythingOverlapWarning": "Ceci s'exécute indépendamment des plannings propres à chaque domaine ci-dessus. Si les deux sont actifs, les conteneurs, les VMs, le flash, les dossiers et l'auto-sauvegarde sont chacun sauvegardés deux fois : une fois ici, une fois selon leur propre planning. Désactive les domaines que tu ne veux pas voir dupliqués.",
