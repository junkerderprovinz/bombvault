...
const fr: Partial<Translations> = {
  ...
  "files.empty": "Aucun jeu de fichiers pour l'instant. Ajoutez un dossier — partages, documents, photos, tout ce qui se trouve sous vos montages — et BombVault le protège comme tout le reste : plannings, copies hors site, contrôles d'intégrité et restaurations. Aucun outil de sauvegarde de fichiers séparé n'est nécessaire.",
  "files.addSet": "Ajouter un jeu de fichiers",
  "files.editSet": "Modifier le jeu de fichiers",
  "files.name": "Nom",
  "files.path": "Dossier",
  ...
  "files.deleteSetConfirm": "Retirer ce jeu de fichiers de la liste ? Ses sauvegardes ne sont pas supprimées et pourront être redécouvertes plus tard.",
  "files.deleteBackupsConfirm": "Supprimer TOUTES les sauvegardes de ce jeu de fichiers ? Les instantanés sont définitivement supprimés, le dépôt est élagué et le jeu est oublié. Irréversible.",
  ...
  "activityLog.domainFiles": "Fichiers",
