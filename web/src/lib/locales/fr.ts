...
const fr: Partial<Translations> = {
  ...
  "settings.offsiteHint": "Après chaque sauvegarde locale réussie, la répliquer aussi vers un second dépôt avec restic copy. Indiquez un dépôt distant (rest:http://host:8000/repo, s3:…) ou un sous-chemin local ; laissez vide pour désactiver. La sauvegarde locale reste principale.",
  "source.label": "Source :",
  "source.local": "Local",
  ...
  "settingsIO.previewCopyRules": "Règles de copie",
  "settingsIO.previewNotInFile": "absent du fichier, reste inchangé",
  ...
  "pull.repoLocationHint": "Le dépôt de l'instance source : rest:, s3:, sftp:, ou un sous-chemin sous le montage hôte. Un emplacement rclone: est refusé, car rclone l'atteindrait avec les remotes de CETTE instance.",
  ...
  "pull.credsHint": "Les identifiants du stockage sur lequel se trouve le dépôt de la source : s3: ou un serveur rest: protégé par mot de passe. Une récupération n'utilise jamais les identifiants de cette machine, donc une source qui en a besoin et n'en a aucun choisi ici est refusée.",
  ...
  "repos.locationHint": "Un dossier sous le montage de l'hôte, ou un dépôt restic distant tel que s3:..., sftp:..., rest:... ou rclone:... L'écriture vers le distant est directe, sans copie locale intermédiaire.",
  ...
  "repos.offPremises": "Hors des locaux",
  ...
  "placement.segLocalOffsite": "Local + hors site",
  "placement.segOffsiteOnly": "Hors site uniquement",
  "placement.homeDomain": "{host} · dépôt du domaine · {path}",
  "placement.homeDomainRemote": "Dépôt du domaine · distant · {scheme}",
  "placement.homeLocal": "{name} · monté",
  "placement.homeRemote": "{name} · distant",
  "placement.homeDirect": "{target} · direct",
  "placement.directNotYet": "créé au premier choix",
  "placement.off": "{name} (éteint)",
  "placement.unknown": "{name} (inconnu)",
  "placement.noTarget": "Aucune cible hors site configurée",
  ...
  "placement.title": "Emplacement",
  "placement.storedOn": "Stocké sur",
  "placement.copyTo": "Copier vers",
  "placement.sendTo": "Envoyer vers",
  "placement.titleHint": "Où les sauvegardes de cet élément sont écrites et où elles sont copiées ensuite. L'emplacement est fixé dès la première sauvegarde, les copies peuvent changer à tout moment.",
  "placement.unreadable": "Impossible de lire l'emplacement",
  "placement.noCopyNow": "Aucune copie pour l'instant, désactivée : {targets}. Cochez une cible ou choisissez Local.",
  "placement.followsDefault": "Suit la valeur par défaut",
  "placement.ownCopies": "Copies propres",
  "placement.homeSet": "Emplacement défini : {home}",
  "placement.copiesFollow": "Les copies suivent la valeur par défaut",
  "placement.reset": "Réinitialiser",
  ...
  // Timeline
  "timeline.deleteAsk": "Supprimer cette sauvegarde ici : {list} ?",
  ...
  "timeline.onlyHere": "ici seulement",
  "timeline.incomplete": "incomplet",
  "timeline.incompleteHint": "Tous les disques de cette exécution ne sont pas ici, donc cet endroit n'est pas retenu pour une restauration.",
  "timeline.snapshotMissing": "{place} n'a plus cette sauvegarde. Restaurer depuis {next} ?",
  "timeline.stackDirMissing": "Le dossier du projet n'est pas dans {place}. Utiliser l'état de {home} ?",
  // Direct repository
  ...
  "placementDefaults.homeOff": "{home} est éteint. Les éléments sans emplacement ne sont pas sauvegardés tant qu'il n'est pas rallumé ou que la valeur par défaut ne change pas.",
  "placementDefaults.homeMissing": "La valeur par défaut pointe vers un dépôt qui n'existe plus. Les éléments sans emplacement ne sont pas sauvegardés.",
  "placementDefaults.confirmHome": "Les nouveaux éléments de {domain} prennent {home} à leur première sauvegarde. Les éléments avec un emplacement le conservent.",
  "placementDefaults.dropAsk": "Éléments et dossiers de projet que {target} ne reçoit plus : {n}. Copies qui y restent : {copies}.",
  "placementDefaults.dropAskUnknown": "Éléments et dossiers de projet que {target} ne reçoit plus : {n}. {target} n'a jamais été répertorié pour ce domaine, donc le nombre de copies qui y restent n'est pas encore connu.",
  "placementDefaults.addAsk": "Éléments et dossiers de projet que {target} reçoit désormais : {n}. Instantanés envoyés à la prochaine exécution : au plus {snapshots}.",
  "placementDefaults.openTakeHome": "Éléments sans emplacement qui prennent {home} à leur première sauvegarde : {n}.",
  "placementDefaults.apply": "Appliquer aux éléments sans sauvegarde",
  "placementDefaults.applyAsk": "L'emplacement et les copies reviennent à la valeur par défaut pour ces éléments : {n}.",
  "placementDefaults.applyLoses": "Perdent leur choix propre : {list}",
  "placementDefaults.applyKeptBackups": "Restent tels quels, ils ont des sauvegardes : {list}",
  "placementDefaults.applyKeptUnreadable": "Restent tels quels, leur emplacement n'a pas pu être lu : {list}",
  "placementDefaults.applyKeptChanged": "Changés entre-temps et laissés tranquilles : {list}",
  "placementDefaults.applyNone": "Aucun élément sans sauvegarde ne diffère de la valeur par défaut.",
  "placementDefaults.applyBusy": "Une sauvegarde est en cours. Appliquez de nouveau une fois terminée.",
  "placementDefaults.paused": "Hors site en pause après une reconstruction",
  "placementDefaults.pausedHint": "Les règles et les valeurs par défaut ont été perdues avec l'ancienne configuration. Rien de {domain} n'est copié hors site tant que cette valeur par défaut n'est pas confirmée. Les éléments avec une carte peuvent d'abord être réglés sur Local.",
  "placementDefaults.confirm": "Confirmer la valeur par défaut",
  "placementDefaults.confirmAsk": "À la prochaine exécution, voici ce qui est copié :",
  "placementDefaults.unmatched": "Noms dans les sauvegardes sans entrée ici. Ceux cochés sont laissés de côté :",
  "placementDefaults.unmatchedLine": "{name}, instantanés : {n}",
  "placementDefaults.confirmed": "Valeur par défaut confirmée. Les copies hors site reprennent à la prochaine exécution.",
  ...
  "newTarget.importHeading": "Nouvelle cible {target} pour {domain}",

  // Discover
  "discover.paused": "Les copies hors site pour {domains} sont en pause jusqu'à ce que la valeur par défaut soit confirmée sous {where}.",
  "discover.leftOpen": "Emplacement laissé ouvert car une sauvegarde était en cours : {list}",
  ...
  "placement.older": "Copies plus anciennes dans {target} : {n}, vues pour la dernière fois {date}",
  "placement.noCopyYet": "{place} : pas encore de copie",
  "placement.notListedYet": "{place} : pas encore listé",

  // Removal
  "offsiteRemoval.delete": "Supprimer dans {target}",
  "offsiteRemoval.ask": "Supprimer chaque copie de {name} dans {target} ? Copies : {n}.",
  "offsiteRemoval.onlyThere": "Ces instantanés n'existent nulle part ailleurs et disparaîtront définitivement ensuite :",
