...
const fr: Partial<Translations> = {
  ...
  "repos.itemHint": "Où vont les sauvegardes de cet élément. Laissez-le sur le dépôt du domaine à moins que cet élément n'ait besoin du sien; la raison habituelle est un élément volumineux et rarement modifié dont on ne veut qu'une copie hors site. La liste contient ce que vous avez créé dans les Réglages. La réplication hors site ne recopie pas un dépôt distant ni un dépôt marqué comme déjà hors site.",
  ...
  "repos.offsite": "Déjà hors site",
  "repos.offsiteHint": "Pour un partage sur une autre machine, comme un NAS servant de stockage à froid. La réplication hors site laisse alors ce dépôt de côté, comme un dépôt distant, et ses sauvegardes ne sont pas copiées une seconde fois. Laissez-le désactivé pour un disque ou un partage de cette machine, qui a toujours besoin de la copie hors site.",
  "repos.offsiteRemote": "hors site",
  "repos.offsiteRemoteHint": "Un dépôt distant est déjà hors site, la réplication hors site ne le recopie donc jamais.",
