...
const fr: Partial<Translations> = {
  ...
  "offsite.replicatingSnapshotPercentWithDuration": "Réplication du snapshot {index} sur {total} ({percent} %) · {duration}",
  ...
  "activityLog.lineOffsiteRunningSnapshotPercent": "Envoi hors site — {domain} … snapshot {index} sur {total} ({percent} %)",
  "activityLog.lineOffsiteRunningSnapshotPercentWithDuration": "Envoi hors site — {domain} … snapshot {index} sur {total} ({percent} %) · {duration}",
  ...
  "schedule.overrideHint": "Vide utilise le planning de la catégorie. Les remplacements par élément ne prennent pas en charge le mode tous les N jours.",
