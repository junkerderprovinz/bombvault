...
const fr: Partial<Translations> = {
  ...
  "files.emptySelectionBlocked": "Un jeu a besoin d'au moins un dossier, donc le dernier cochage ne peut pas être retiré. Utilise Retirer le jeu si tu ne veux plus de ce jeu.",
