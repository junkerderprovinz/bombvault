...
const fr: Partial<Translations> = {
  ...
  "receiver.snapshotsCount": "{n} sauvegardes",
  ...
  "pull.snapshotsPulled": "{n} snapshots rapatriés",
  "pull.nothingNew": "Rien de nouveau à rapatrier.",
  "pull.pulled": "{n} snapshots rapatriés.",
