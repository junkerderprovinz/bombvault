...
const fr: Partial<Translations> = {
  ...
  "takeover.backup": "1 sauvegarde",
  "takeover.backups": "{n} sauvegardes",
  ...
  "takeover.historyOne": "La sauvegarde de {old} devient l'historique de {new}.",
  "takeover.historyMany": "Les {n} sauvegardes de {old} deviennent l'historique de {new}.",
