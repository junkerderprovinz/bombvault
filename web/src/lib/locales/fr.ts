...
const fr: Partial<Translations> = {
  ...
  "settings.dashTileCa": "Il est peut-être aussi disponible dans les Community Applications — cherchez BombVault Dashboard.",
  "settings.dashTileNotInstalled": "Le plugin de tuile du tableau de bord n'est pas installé.",
  "settings.dashTileConfirm": "Installer installe le plugin bombvault-dashboard sur votre hôte Unraid via le mécanisme de plugins habituel d'Unraid. Il apparaît sous Plugins comme n'importe quel autre plugin et peut y être retiré (ou ici) à tout moment.",
