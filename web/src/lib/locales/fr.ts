...
const fr: Partial<Translations> = {
  ...
  "dbdump.importStopsOne": "Pendant l'import, BombVault arrête aussi {app} et le redémarre ensuite.",
  "dbdump.importStopsMany": "Pendant l'import, BombVault arrête aussi ces applications et les redémarre ensuite : {apps}.",
