...
const fr: Partial<Translations> = {
  ...
  "about.report": "Vous avez trouvé quelque chose, ou quelque chose manque ? Ouvrez un ticket sur GitHub ou envoyez un courriel. La version ci-dessus aide dans les deux cas.",
  "about.repo": "Dépôt",
