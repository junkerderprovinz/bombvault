...
const ja: Partial<Translations> = {
  ...
  "settings.dashTileCa": "Community Applications でも入手できる場合があります — BombVault Dashboard で検索してください。",
  "settings.dashTileNotInstalled": "ダッシュボードタイルのプラグインはインストールされていません。",
  "settings.dashTileConfirm": "「インストール」は、Unraid の通常のプラグイン機構を使って bombvault-dashboard プラグインを Unraid ホストにインストールします。他のプラグインと同様に Plugins に表示され、そこ（またはここ）からいつでも削除できます。",
