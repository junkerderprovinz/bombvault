...
const ja: Partial<Translations> = {
  ...
  "offsite.replicatingSnapshotPercentWithDuration": "スナップショット {index}/{total} を複製中…（{percent}%・{duration}）",
  ...
  "activityLog.lineOffsiteRunningSnapshotPercent": "オフサイトへアップロード中 — {domain} … スナップショット {index}/{total}（{percent}%）",
  "activityLog.lineOffsiteRunningSnapshotPercentWithDuration": "オフサイトへアップロード中 — {domain} … スナップショット {index}/{total}（{percent}%・{duration}）",
  ...
  "schedule.overrideHint": "空の場合はカテゴリのスケジュールを使用します。項目ごとの上書きは N 日ごとモードに対応していません。",
