...
const ja: Partial<Translations> = {
  ...
  "about.body": "騎士ひとりの遠征。思いどおりの形では存在しなかった、自由で見た目のよいオープンソースの道具です。足りないものがなくなるまで作り続けます。アカウントなし、テレメトリなし、広告なし。試用期間なし、有料プランなし、小さな注釈なし。読めるものが自分の城壁の外へ出ることはありません。夜と週末に、心と意地で鍛えました。",
  "about.coffee": "BombVault が役に立っているなら、寄付が運営にかかるものを支えます。ドメイン、サーバー、そして注ぎ込まれる夜の時間です。それに、この騎士の心臓も少し速く打ちます。下に三つの方法があります。好きなものをどうぞ。",
