...
const pl: Partial<Translations> = {
  ...
  "settings.labelsHint": "Ile z elementu sterującego jest pokazywane: jego słowa, symbol albo oba. Przyciski zachowują tę samą szerokość we wszystkich trzech, więc przełączanie nie przestawia strony.",
