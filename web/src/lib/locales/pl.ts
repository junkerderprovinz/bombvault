...
const pl: Partial<Translations> = {
  ...
  "dbdump.stackRestoreWarn": "Dane {names} są kopiowane w trakcie pracy stosu. Po przywróceniu zaimportuj ich najnowszy zrzut bazy danych, zanim użyjesz aplikacji.",
  "dbdump.introNotice": "BombVault zrzuca rozpoznane bazy danych przed każdą kopią, jako osobne punkty przywracania. Rozpoznane tutaj: {count}, pierwsza to {name}. Możesz to wyłączyć dla pojedynczego kontenera na jego karcie albo dla wszystkich kontenerów w Ustawieniach.",
  ...
  "dbdump.importStopsOne": "Na czas importu BombVault zatrzymuje też {app}. Potem uruchamia go ponownie, chyba że import się nie powiedzie, a starych danych nie da się przywrócić.",
  "dbdump.importStopsMany": "Na czas importu BombVault zatrzymuje też te aplikacje: {apps}. Potem uruchamia je ponownie, chyba że import się nie powiedzie, a starych danych nie da się przywrócić.",
  ...
  "recovery.foreignDbDumps": "Zrzuty baz danych w tym repozytorium: {count}. Wyciągnij jeden przez wiersz poleceń restic, jak opisuje zestaw ratunkowy.",
  ...
  "recovery.dumpOnlySkipped": "Bazy danych zachowane tylko jako zrzut są tu pomijane: {count}. Przywróć je i zaimportuj z ich własnej listy.",
