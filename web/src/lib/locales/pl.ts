...
const pl: Partial<Translations> = {
  ...
  "takeover.backup": "1 kopia zapasowa",
  "takeover.backups": "{n} kopii zapasowych",
  ...
  "takeover.historyOne": "Kopia zapasowa wpisu {old} stanie się częścią historii wpisu {new}.",
  "takeover.historyMany": "{n} kopii zapasowych wpisu {old} stanie się częścią historii wpisu {new}.",
  ...
  "settings.discoHint": "Każdy kolorowy wiersz i element płynnie przechodzi do następnego koloru palety, jeden co trzy sekundy, dopóki tryb tęczy jest włączony.",
  ...
  "auth.recoveryLeft": "Pozostało {n} kodów zapasowych",
  "auth.recoverySaved": "Zapisałem je",
  "auth.disableCodePrompt": "Wpisz aktualny kod, aby wyłączyć",
  "auth.passwordMinHint": "Co najmniej {n} znaków.",
  ...
  "pull.snapshotsPulled": "Pobrane migawki: {n}",
  "pull.nothingNew": "Nie ma nic nowego do pobrania.",
  "pull.pulled": "Pobrano migawki: {n}.",
