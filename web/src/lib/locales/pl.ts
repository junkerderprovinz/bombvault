...
const pl: Partial<Translations> = {
  ...
  "about.body": "Jeden rycerz, jedna wyprawa: wolne, ładne narzędzia z otwartym kodem, których w takiej postaci, jakiej chciałem, nie było. Budowane, aż niczego nie zabraknie. Żadnych kont, żadnej telemetrii, żadnych reklam. Żadnego okresu próbnego, żadnych pakietów, żadnej gwiazdki drobnym drukiem. Nic czytelnego nigdy nie opuszcza twoich murów. Kute wieczorami i w weekendy, z sercem i uporem.",
  "about.coffee": "Jeśli BombVault ci się przydaje, darowizna pokrywa to, co kosztuje utrzymanie: domenę, serwer i wieczory, które w niego idą. A do tego serce tego rycerza bije trochę szybciej. Niżej są trzy drogi, wybierz tę, która ci pasuje.",
