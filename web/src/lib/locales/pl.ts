...
const pl: Partial<Translations> = {
  ...
  "dbdump.introNotice": "BombVault zrzuca {count} rozpoznanych baz danych przed każdą kopią, jako osobne punkty przywracania. Możesz to wyłączyć dla pojedynczego kontenera na jego karcie albo dla wszystkich kontenerów w Ustawieniach.",
  ...
  "dbdump.fixRepository": "Repozytorium kopii nie przyjęło zrzutu albo zapisało mniej bajtów, niż zostało zrzucone. Sprawdź repozytorium w Ustawieniach, Magazyn; zrzut zostanie ponowiony przy następnej kopii.",
  ...
  "recovery.dumpOnlySkipped": "{count} baz danych zachowanych tylko jako zrzut zostaje pominiętych; przywróć je i zaimportuj z ich własnej listy.",
