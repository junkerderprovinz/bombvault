...
const pl: Partial<Translations> = {
  ...
  "settings.dashTileCa": "Może być też dostępny w Community Applications — wyszukaj BombVault Dashboard.",
  "settings.dashTileNotInstalled": "Plugin kafelka panelu nie jest zainstalowany.",
  "settings.dashTileConfirm": "Zainstaluj instaluje plugin bombvault-dashboard na Twoim hoście Unraid przez zwykły mechanizm pluginów Unraid. Pojawia się w Plugins jak każdy inny plugin i można go tam (lub tutaj) w każdej chwili usunąć.",
