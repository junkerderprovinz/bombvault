...
const pl: Partial<Translations> = {
  ...
  "settings.everythingOverlapWarning": "Działa to niezależnie od harmonogramów poszczególnych domen powyżej. Jeśli oba są włączone, kontenery, maszyny wirtualne, flash, foldery i autokopia są każdorazowo kopiowane dwa razy: raz tutaj, raz według własnego harmonogramu. Wyłącz domeny, których nie chcesz dublować.",
