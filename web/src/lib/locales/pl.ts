...
const pl: Partial<Translations> = {
  ...
  "files.empty": "Nie ma jeszcze zestawów plików. Dodaj folder — udziały, dokumenty, zdjęcia, cokolwiek pod Twoimi punktami montowania — a BombVault ochroni go jak wszystko inne: harmonogramy, kopie poza siedzibą, kontrole integralności i przywracanie. Osobne narzędzie do kopii plików nie jest potrzebne.",
  "files.addSet": "Dodaj zestaw plików",
  "files.editSet": "Edytuj zestaw plików",
  "files.name": "Nazwa",
  "files.path": "Folder",
  ...
  "files.deleteSetConfirm": "Usunąć ten zestaw plików z listy? Jego kopie zapasowe nie zostaną usunięte i można je później odkryć ponownie.",
  "files.deleteBackupsConfirm": "Usunąć WSZYSTKIE kopie zapasowe tego zestawu plików? Migawki zostaną trwale usunięte, repozytorium przycięte, a zestaw zapomniany. Nie można cofnąć.",
