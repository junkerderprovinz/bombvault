...
const pl: Partial<Translations> = {
  ...
  "settings.offsiteHint": "Po każdej udanej kopii lokalnej replikuj ją także do drugiego repozytorium poleceniem restic copy. Podaj zdalne repo (rest:http://host:8000/repo, s3:…) lub lokalną podścieżkę; pozostaw puste, aby wyłączyć. Kopia lokalna pozostaje główną.",
  "source.label": "Źródło:",
  ...
  "settingsIO.previewCopyRules": "Reguły kopiowania",
  "settingsIO.previewNotInFile": "brak w pliku, pozostaje bez zmian",
  ...
  "pull.repoLocationHint": "Repozytorium instancji źródłowej: rest:, s3:, sftp:, albo podścieżka w punkcie montowania hosta. Lokalizacja rclone: jest odrzucana, bo rclone sięgnąłby po nią przez zdalne TEJ instancji.",
  ...
  "pull.credsHint": "Dane logowania do magazynu, na którym leży repozytorium źródła: s3: lub serwer rest: z hasłem. Pobieranie nigdy nie używa danych tej maszyny, więc źródło, które wymaga logowania i nie ma tu nic wybranego, zostanie odrzucone.",
  ...
  "repos.locationPlaceholder": "backups/cold lub s3:s3.eu-central-003.backblazeb2.com/bucket/path",
  "repos.locationHint": "Folder pod punktem montowania hosta albo zdalne repozytorium restic, na przykład s3:..., sftp:..., rest:... lub rclone:... Do zdalnego zapisuje się bezpośrednio, bez lokalnej kopii pośredniej.",
  ...
  "repos.offPremises": "Poza obiektem",
  ...
  "placementCode.copyRuleTaken": "Ta nazwa ma już własne reguły kopiowania.",
  ...
  "placement.titleHint": "Gdzie zapisywane są kopie zapasowe tego elementu i dokąd są potem kopiowane. Lokalizacja jest ustalona od pierwszej kopii zapasowej, kopie można zmieniać w dowolnym momencie.",
  "placement.unreadable": "Nie udało się odczytać rozmieszczenia",
  "placement.noCopyNow": "Teraz brak kopii, wyłączone: {targets}. Zaznacz cel lub wybierz Lokalne.",
  "placement.followsDefault": "Podąża za domyślnym",
  "placement.ownCopies": "Własne kopie",
  "placement.homeSet": "Lokalizacja ustawiona: {home}",
  "placement.copiesFollow": "Kopie podążają za domyślnym",
  "placement.reset": "Resetuj",
  ...
  // Timeline
  "timeline.deleteAsk": "Usunąć tę kopię zapasową tutaj: {list}?",
  ...
  "timeline.onlyHere": "tylko tutaj",
  "timeline.incomplete": "niekompletne",
  "timeline.incompleteHint": "Nie wszystkie dyski tego przebiegu są tutaj, więc to miejsce nie jest wybierane do przywracania.",
  "timeline.snapshotMissing": "{place} nie ma już tej kopii zapasowej. Przywrócić z {next}?",
  "timeline.stackDirMissing": "Folderu projektu nie ma w {place}. Użyć stanu z {home}?",
  // Direct repository
  ...
  "placementDefaults.homeOff": "{home} jest wyłączone. Elementy bez lokalizacji nie są kopiowane zapasowo, dopóki nie zostanie znów włączone lub domyślne nie ulegnie zmianie.",
  "placementDefaults.homeMissing": "Domyślne wskazuje na repozytorium, którego już nie ma. Elementy bez lokalizacji nie są kopiowane zapasowo.",
  "placementDefaults.confirmHome": "Nowe elementy w {domain} przejmują {home} przy pierwszej kopii zapasowej. Elementy z lokalizacją ją zachowują.",
  "placementDefaults.dropAsk": "Elementy i foldery projektu, których {target} już nie otrzymuje: {n}. Kopie, które tam pozostają: {copies}.",
  "placementDefaults.dropAskUnknown": "Elementy i foldery projektu, których {target} już nie otrzymuje: {n}. {target} nigdy nie był wymieniony dla tej domeny, więc liczba kopii, które tam pozostają, nie jest jeszcze znana.",
  "placementDefaults.addAsk": "Elementy i foldery projektu, które {target} otrzymuje od teraz: {n}. Migawki przesyłane przy następnym uruchomieniu: najwyżej {snapshots}.",
  "placementDefaults.openTakeHome": "Elementy bez lokalizacji, które przejmują {home} przy pierwszej kopii zapasowej: {n}.",
  "placementDefaults.apply": "Zastosuj do elementów bez kopii zapasowych",
  "placementDefaults.applyAsk": "Lokalizacja i kopie wracają do domyślnych dla tych elementów: {n}.",
  "placementDefaults.applyLoses": "Tracą przy tym własny wybór: {list}",
  "placementDefaults.applyKeptBackups": "Pozostają bez zmian, mają kopie zapasowe: {list}",
  "placementDefaults.applyKeptUnreadable": "Pozostają bez zmian, ich lokalizacji nie udało się odczytać: {list}",
  "placementDefaults.applyKeptChanged": "Zmienione w międzyczasie i pozostawione bez zmian: {list}",
  "placementDefaults.applyNone": "Żaden element bez kopii zapasowych nie różni się od domyślnego.",
  "placementDefaults.applyBusy": "Trwa kopia zapasowa. Zastosuj ponownie po jej zakończeniu.",
  "placementDefaults.paused": "Poza siedzibą wstrzymane po odbudowie",
  "placementDefaults.pausedHint": "Reguły i wartości domyślne zostały utracone wraz ze starą konfiguracją. Nic z {domain} nie jest kopiowane poza siedzibę, dopóki to domyślne nie zostanie potwierdzone. Elementy z kartą można najpierw ustawić na Lokalne.",
  "placementDefaults.confirm": "Potwierdź domyślne",
  "placementDefaults.confirmAsk": "Przy następnym uruchomieniu skopiowane zostanie to:",
  "placementDefaults.unmatched": "Nazwy w kopiach zapasowych bez wpisu tutaj. Zaznaczone są pomijane:",
  "placementDefaults.unmatchedLine": "{name}, migawki: {n}",
  "placementDefaults.confirmed": "Domyślne potwierdzone. Kopie poza siedzibą wznawiają się przy następnym uruchomieniu.",
  ...
  "placement.older": "Starsze kopie w {target}: {n}, ostatnio widziano {date}",
  "placement.noCopyYet": "{place}: jeszcze brak kopii",
  "placement.notListedYet": "{place}: jeszcze nie na liście",

  // Removal
  "offsiteRemoval.delete": "Usuń w {target}",
  "offsiteRemoval.ask": "Usunąć każdą kopię {name} w {target}? Kopie: {n}.",
  "offsiteRemoval.onlyThere": "Te migawki nie istnieją nigdzie indziej i po tym znikną na zawsze:",
