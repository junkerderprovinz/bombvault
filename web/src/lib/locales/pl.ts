...
const pl: Partial<Translations> = {
  ...
  "repos.itemHint": "Dokąd trafiają kopie tego wpisu. Zostaw repozytorium domeny, chyba że akurat ten wpis potrzebuje własnego; zwykłym powodem jest duży, rzadko zmieniany wpis, z którego chce się tylko kopii poza siedzibą. Lista zawiera to, co utworzyłeś w Ustawieniach. Replikacja poza siedzibą nie kopiuje drugi raz zdalnego repozytorium ani takiego, które oznaczono jako już poza siedzibą.",
  ...
  "repos.offsite": "Już poza siedzibą",
  "repos.offsiteHint": "Dla udziału na innej maszynie, np. NAS-a jako magazynu chłodnego. Replikacja poza siedzibą pomija wtedy to repozytorium, tak jak zdalne, i jego kopie nie są kopiowane drugi raz. Dla dysku lub udziału na tej maszynie zostaw wyłączone, one wciąż potrzebują kopii poza siedzibą.",
  "repos.offsiteRemote": "poza siedzibą",
  "repos.offsiteRemoteHint": "Zdalne repozytorium jest już poza siedzibą, więc replikacja poza siedzibą nigdy nie kopiuje go ponownie.",
