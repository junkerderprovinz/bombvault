...
const pl: Partial<Translations> = {
  ...
  "settings.everythingDuplicateWarning": "Kontenery, maszyny wirtualne, flash, foldery i autokopia są kopiowane dwa razy, dopóki jednocześnie włączony jest ten harmonogram i ich własny: raz tutaj i raz we własnym harmonogramie. Wyłącz domeny, których nie chcesz kopiować podwójnie.",
