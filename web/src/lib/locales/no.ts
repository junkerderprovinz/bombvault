...
const no: Partial<Translations> = {
  ...
  "settings.dashTileCa": "Den kan også være tilgjengelig i Community Applications — søk etter BombVault Dashboard.",
  "settings.dashTileNotInstalled": "Dashbordflis-pluginen er ikke installert.",
  "settings.dashTileConfirm": "Installer installerer pluginen bombvault-dashboard på Unraid-verten din via Unraids vanlige pluginmekanisme. Den dukker opp under Plugins som enhver annen plugin og kan fjernes der (eller her) når som helst.",
