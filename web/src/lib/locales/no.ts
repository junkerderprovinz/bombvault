...
const no: Partial<Translations> = {
  ...
  "settings.offsiteHint": "Etter hver vellykket lokal sikkerhetskopi replikeres den også til et annet repo med restic copy. Angi et fjern-repo (rest:http://host:8000/repo, s3:…) eller en lokal understi; la stå tomt for å deaktivere. Den lokale sikkerhetskopien forblir den primære.",
  "source.label": "Kilde:",
  "source.local": "Lokal",
  ...
  "pull.repoLocationHint": "Arkivet til kildeinstansen: rest:, s3:, sftp:, eller en understi under vertsmonteringen. En rclone:-plassering avvises, fordi rclone ville nå den med remotene til DENNE instansen.",
  ...
  "pull.credsHint": "Innloggingen til lagringen som kildens repositorium ligger på: s3: eller en rest:-tjener med passord. En henting bruker aldri denne maskinens egne opplysninger, så en kilde som trenger innlogging og ikke har valgt noe her, blir avvist.",
  ...
  "repos.locationPlaceholder": "backups/cold eller s3:s3.eu-central-003.backblazeb2.com/bucket/path",
  "repos.locationHint": "En mappe under vertens montering, eller et eksternt restic-depot som s3:..., sftp:..., rest:... eller rclone:... Til det eksterne skrives det direkte, uten en lokal mellomkopi.",
  ...
  "placementCode.copyRuleTaken": "Det navnet har allerede sine egne kopieringsregler.",
