...
const no: Partial<Translations> = {
  ...
  "settings.everythingOverlapWarning": "Dette kjører uavhengig av tidsplanene for hvert domene ovenfor. Hvis begge er på, blir kontainere, VM-er, flash, mapper og auto-sikkerhetskopien hver sikkerhetskopiert to ganger: én gang her, én gang på sin egen tidsplan. Slå av domenene du ikke vil ha duplisert.",
