...
const no: Partial<Translations> = {
  ...
  "files.empty": "Ingen filsett ennå. Legg til en mappe — delinger, dokumenter, bilder, hva som helst under monteringene dine — og BombVault beskytter den som alt annet: tidsplaner, off-site-kopier, integritetssjekker og gjenoppretting. Ikke behov for et eget verktøy for filsikkerhetskopiering.",
  "files.addSet": "Legg til filsett",
  "files.editSet": "Rediger filsett",
  "files.name": "Navn",
  "files.path": "Mappe",
  ...
  "files.deleteSetConfirm": "Fjerne dette filsettet fra listen? Sikkerhetskopiene slettes ikke og kan gjenoppdages senere.",
  "files.deleteBackupsConfirm": "Slette ALLE sikkerhetskopier av dette filsettet? Snapshotene fjernes permanent, repositoriet beskjæres og settet glemmes. Kan ikke angres.",
