...
const no: Partial<Translations> = {
  ...
  "dbdump.introNotice": "BombVault dumper {count} gjenkjente databaser før hver sikkerhetskopi, som egne gjenopprettingspunkter. Du kan slå det av per container på kortet dens eller for alle containere under Innstillinger.",
  ...
  "dbdump.fixRepository": "Sikkerhetskopi-arkivet tok ikke imot dumpen, eller lagret færre byte enn det som ble dumpet. Sjekk arkivet under Innstillinger, Lagring; dumpen prøves igjen med neste sikkerhetskopi.",
  ...
  "recovery.dumpOnlySkipped": "{count} databaser som bare finnes som dump holdes utenfor; gjenopprett og importer dem fra deres egen liste.",
