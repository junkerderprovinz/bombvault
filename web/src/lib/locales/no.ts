...
const no: Partial<Translations> = {
  ...
  "files.emptySelectionBlocked": "Et sett trenger minst én mappe, så den siste haken kan ikke fjernes. Bruk Fjern sett hvis du ikke vil ha dette settet lenger.",
