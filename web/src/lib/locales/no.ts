...
const no: Partial<Translations> = {
  ...
  "repos.directOf": "tilhører {target} · elementer: {n}",
  ...
  "repos.offPremises": "Utenfor bygningen",
  "repos.offPremisesHint": "Telles som et eget sted for stedene og 3-2-1 på kortene. Kopier påvirkes ikke. En rest-server i samme bygning bør ha dette slått av.",
  ...
  "placementCode.copyRuleTaken": "Det navnet har allerede sine egne kopieringsregler. Tilbakestill dem der først.",
  ...
  "placementCode.appendOnly": "Målet er kun-tillegg. Herfra kan ingenting slettes fra det.",
  "placementCode.removalGrown": "Det finnes nå flere øyeblikksbilder der enn det som ble vist. Sjekk listen på nytt.",
  ...
  "placement.titleHint": "Hvor sikkerhetskopiene til dette elementet skrives, og hvor de kopieres til etterpå. Plasseringen er fast fra den første sikkerhetskopien, kopiene kan endres når som helst.",
  "placement.unreadable": "Plassering kunne ikke leses",
  "placement.noCopyNow": "Ingen kopi akkurat nå, slått av: {targets}. Kryss av et mål eller velg Lokal.",
  "placement.followsDefault": "Følger standarden",
  "placement.ownCopies": "Egne kopier",
  "placement.homeSet": "Plassering angitt: {home}",
  "placement.copiesFollow": "Kopier følger standarden",
  "placement.reset": "Tilbakestill",
  "placement.confirmHome": "Sikkerhetskopiere {name} til {home} fra nå av? Plasseringen er fast fra den første sikkerhetskopien.",
  "placement.paused": "Ekstern er pauset til standarden er bekreftet.",
  "placement.uploadIntro": "Ved neste kjøring lastes øyeblikksbilder av {name} opp:",
  "placement.uploadUnknown": "Det kunne ikke beregnes hvor mye av {name} som lastes opp.",
  ...
  // Timeline
  "timeline.deleteAsk": "Slette denne sikkerhetskopien her: {list}?",
  "timeline.deleteRow": "Slett overalt",
  "timeline.deleteLast": "Dette er den siste kopien av denne sikkerhetskopien.",
  "timeline.deleteHeldBy": "Fortsatt holdt av: {list}",
  "timeline.deleteSkipped": "Utelatt, kun-tillegg: {list}",
  "timeline.deletePartial": "Allerede slettet hos: {list}",
  ...
  "timeline.onlyHere": "kun her",
  "timeline.incomplete": "ufullstendig",
  "timeline.incompleteHint": "Ikke alle diskene fra denne kjøringen er her, så dette stedet velges ikke for en gjenoppretting.",
  "timeline.snapshotMissing": "{place} har ikke lenger denne sikkerhetskopien. Gjenopprette fra {next}?",
  "timeline.stackDirMissing": "Prosjektmappen er ikke i {place}. Bruke tilstanden fra {home}?",
  // Direct repository
  ...
  "directRepo.test": "Test tilkobling",
  "directRepo.testEmpty": "Tilgjengelig, tom",
  "directRepo.testExisting": "Inneholder allerede et depot",
  "directRepo.testFailed": "Ikke tilgjengelig: {error}",
  "directRepo.bucketRoot": "{target} ligger ved roten av sin bucket, så enhver sti i den bucketen ville ligge inni det. Velg en annen bucket.",
  "directRepo.pathNeeded": "Denne rest-serveren holder private depoter. Angi stien til det direkte depotet.",
  "directRepo.addAndUse": "Opprett og bruk",
  "directRepo.draftNote": "Opprettes sammen med mappesettet.",
  ...
  "placementDefaults.homeOff": "{home} er slått av. Elementer uten plassering sikkerhetskopieres ikke før det er slått på igjen eller standarden endres.",
  "placementDefaults.homeMissing": "Standarden peker på et repositorium som ikke lenger finnes. Elementer uten plassering sikkerhetskopieres ikke.",
  "placementDefaults.confirmHome": "Nye elementer i {domain} overtar {home} ved sin første sikkerhetskopi. Elementer med en plassering beholder den.",
  "placementDefaults.dropAsk": "Elementer og prosjektmapper som {target} ikke lenger får: {n}. Kopier som blir værende der: {copies}.",
  "placementDefaults.dropAskUnknown": "Elementer og prosjektmapper som {target} ikke lenger får: {n}. {target} har aldri vært oppført for dette domenet, så hvor mange kopier som blir værende der er ikke kjent ennå.",
  "placementDefaults.addAsk": "Elementer og prosjektmapper som {target} får fra nå av: {n}. Øyeblikksbilder lastet opp ved neste kjøring: høyst {snapshots}.",
  "placementDefaults.openTakeHome": "Elementer uten plassering som overtar {home} ved sin første sikkerhetskopi: {n}.",
  "placementDefaults.apply": "Bruk på elementer uten sikkerhetskopier",
  "placementDefaults.applyAsk": "Plassering og kopier går tilbake til standarden for disse elementene: {n}.",
  "placementDefaults.applyLoses": "Mister sitt eget valg: {list}",
  "placementDefaults.applyKeptBackups": "Forblir som de er, de har sikkerhetskopier: {list}",
  "placementDefaults.applyKeptUnreadable": "Forblir som de er, plasseringen kunne ikke leses: {list}",
  "placementDefaults.applyKeptChanged": "Endret i mellomtiden og latt være: {list}",
  "placementDefaults.applyNone": "Ingen elementer uten sikkerhetskopier skiller seg fra standarden.",
  "placementDefaults.applyBusy": "En sikkerhetskopi pågår. Bruk igjen når den er ferdig.",
  "placementDefaults.paused": "Ekstern er pauset etter en gjenoppbygging",
  "placementDefaults.pausedHint": "Regler og standarder gikk tapt med den gamle konfigurasjonen. Ingenting fra {domain} kopieres eksternt før denne standarden er bekreftet. Elementer med et kort kan settes til Lokal først.",
  "placementDefaults.confirm": "Bekreft standard",
  "placementDefaults.confirmAsk": "Ved neste kjøring kopieres dette:",
  "placementDefaults.unmatched": "Navn i sikkerhetskopiene uten en oppføring her. Avkryssede utelates:",
  "placementDefaults.unmatchedLine": "{name}, øyeblikksbilder: {n}",
  "placementDefaults.confirmed": "Standard bekreftet. Eksterne kopier fortsetter ved neste kjøring.",
  ...
  "placement.planStays": "Blir på {home}: sikkerhetskopier med dette navnet ligger der.",
  "placement.planDefaultHome": "På {home} (standarden, gjelder fra første sikkerhetskopi).",
  "placement.planDecides": "Plasseringen avgjøres ved første sikkerhetskopi.",
  "placement.planNotBackedUpOff": "Sikkerhetskopieres ikke: standarden peker på {home}, som er avslått.",
  "placement.planNotBackedUpMissing": "Sikkerhetskopieres ikke: standarden peker på et depot som ikke lenger finnes.",
  "placement.planCopied": "Kopiert til {targets}.",
  "placement.planNoCopy": "Ingen kopi utenfor bygningen.",
  "placement.planNoTarget": "Det er ikke satt opp noen ekstern kopi for {domain}.",
  "placement.sitesOne": "På ett sted",
  "placement.sites": "På {n} steder",
  "placement.seen": "{place} sist sett {time}",
  "placement.unreachable": "{place} utilgjengelig siden {since}, sist sett {time}",
  "placement.stateUnknown": "{place}: tilstand ukjent siden {since}",
  "placement.oldCopy": "{place}: siste kopi fra {date}",
  "placement.rule321Met": "3-2-1 oppfylt",
  "placement.rule321OneCopy": "3-2-1 ikke oppfylt: én sikkerhetskopi",
  "placement.rule321Unconfirmed": "3-2-1 ubekreftet",
  "placement.noBackup": "Ingen sikkerhetskopi ennå.",
  ...
  "placement.older": "Eldre kopier hos {target}: {n}, sist sett {date}",
  "placement.noCopyYet": "{place}: ingen kopi ennå",
  "placement.notListedYet": "{place}: ikke listet ennå",

  // Removal
  "offsiteRemoval.delete": "Slett hos {target}",
  "offsiteRemoval.ask": "Slette hver kopi av {name} hos {target}? Kopier: {n}.",
  "offsiteRemoval.onlyThere": "Disse øyeblikksbildene finnes ingen andre steder og er borte for godt etterpå:",
  "offsiteRemoval.homeUnreadable": "Kunne ikke sjekke om {home} fortsatt har dem.",
  "offsiteRemoval.typeName": "Skriv {name} for å bekrefte",
  "offsiteRemoval.done": "Slettet hos {target}: {n}",
  "offsiteRemoval.appendOnly": "{target} er kun-tillegg. Herfra kan ingenting slettes fra det.",
};
