...
const no: Partial<Translations> = {
  ...
  "repos.offsite": "Allerede utenfor huset",
  "repos.offsiteHint": "For en deling på en annen maskin, for eksempel en NAS brukt som kaldlager. Off-site-replikering hopper da over dette depotet, slik den gjør med et fjerndepot, og sikkerhetskopiene kopieres ikke en gang til. La den være av for en disk eller deling på denne maskinen, som fortsatt trenger kopien utenfor huset.",
  "repos.offsiteRemote": "utenfor huset",
  "repos.offsiteRemoteHint": "Et fjerndepot er allerede utenfor huset, så off-site-replikering kopierer det aldri igjen.",
