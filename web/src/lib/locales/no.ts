...
const no: Partial<Translations> = {
  ...
  "notify.unraidPlatformMismatch": "BombVault har oppdaget denne verten som \"{platform}\", ikke Unraid — Unraid-varsler forblir avslått selv om denne er slått på. Hvis dette FAKTISK er en Unraid-vert, sjekk at containerens /boot-sti er bind-mountet til /host/boot (se BombVault Unraid-malen), og start containeren på nytt.",
  "notify.save": "Lagre",
