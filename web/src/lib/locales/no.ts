...
const no: Partial<Translations> = {
  ...
  "dbdump.importStopsOne": "Under importen stopper BombVault også {app} og starter den igjen etterpå.",
  "dbdump.importStopsMany": "Under importen stopper BombVault også disse appene og starter dem igjen etterpå: {apps}.",
