...
const no: Partial<Translations> = {
  ...
  "about.body": "Én ridder, ett korstog: frie, velformede verktøy med åpen kildekode som ikke fantes i den formen jeg ville ha. Bygget til ingenting mangler. Ingen kontoer, ingen telemetri, ingen reklame. Ingen prøveperiode, ingen betalingstrinn, ingen liten stjerne med liten skrift. Ingenting lesbart forlater noen gang dine egne murer. Smidd på kvelder og i helger, med hjerte og stahet.",
  "about.coffee": "Hvis BombVault er til nytte for deg, dekker en gave det det koster å holde det i gang: domenet, serveren og kveldene som går med. Og den får hjertet til denne ridderen til å slå litt raskere. Nedenfor er det tre veier, ta den som passer deg.",
