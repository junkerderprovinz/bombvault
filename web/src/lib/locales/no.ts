...
const no: Partial<Translations> = {
  ...
  "offsite.replicatingSnapshotPercentWithDuration": "Replikerer snapshot {index} av {total} ({percent} %) · {duration}",
  ...
  "activityLog.lineOffsiteRunningSnapshotPercent": "Off-site-opplasting — {domain} … snapshot {index} av {total} ({percent} %)",
  "activityLog.lineOffsiteRunningSnapshotPercentWithDuration": "Off-site-opplasting — {domain} … snapshot {index} av {total} ({percent} %) · {duration}",
