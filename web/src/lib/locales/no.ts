...
const no: Partial<Translations> = {
  ...
  "takeover.backup": "1 sikkerhetskopi",
  "takeover.backups": "{n} sikkerhetskopier",
  ...
  "takeover.historyOne": "Sikkerhetskopien av {old} blir historikken til {new}.",
  "takeover.historyMany": "De {n} sikkerhetskopiene av {old} blir historikken til {new}.",
