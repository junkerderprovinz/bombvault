...
const no: Partial<Translations> = {
  ...
  "about.report": "Fant du noe, eller mangler det noe? Opprett en sak på GitHub eller send en e-post. Versjonen over hjelper i begge tilfeller.",
  "about.repo": "Kodelager",
  "about.mail": "Skriv en e-post",
