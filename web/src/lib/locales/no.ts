...
const no: Partial<Translations> = {
  ...
  "settings.labelsHint": "Hvor mye av en kontroll som vises: ordene, symbolet eller begge deler. Knapper beholder samme bredde i alle tre, så bytte omorganiserer ikke siden.",
