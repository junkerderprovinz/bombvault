...
const he: Partial<Translations> = {
  ...
  "offsite.replicatingSnapshotPercentWithDuration": "משכפל תמונת מצב {index} מתוך {total} ({percent}%) · {duration}",
  ...
  "activityLog.lineOffsiteRunningSnapshotPercent": "העלאה מחוץ לאתר — {domain} … תמונת מצב {index} מתוך {total} ({percent}%)",
  "activityLog.lineOffsiteRunningSnapshotPercentWithDuration": "העלאה מחוץ לאתר — {domain} … תמונת מצב {index} מתוך {total} ({percent}%) · {duration}",
  ...
  "schedule.overrideHint": "ריק משתמש בלוח הזמנים של הקטגוריה. עקיפות לכל פריט אינן תומכות במצב כל N ימים.",
