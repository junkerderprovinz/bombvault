...
const he: Partial<Translations> = {
  ...
  "coverage.hint": "כל מה שיש בשרת הזה ששום גיבוי אוטומטי לא מכסה. כרטיס ההגנה שלמעלה אומר אם הגיבויים המתוזמנים רצו בזמן; כאן רשום מה לא מתוזמן בכלל, וזה הפער שנשאר בלתי נראה בכל מקום אחר. סוג גיבוי שכובה הוא החלטה ואינו נספר כאן.",
