...
const he: Partial<Translations> = {
  ...
  "repos.itemHint": "לאן הולכים הגיבויים של הפריט הזה. השאר אותו על המאגר של התחום, אלא אם הפריט הזה צריך משלו; הסיבה הרגילה היא פריט גדול שמשתנה לעתים רחוקות ורוצים ממנו רק עותק מחוץ לאתר. ברשימה נמצא מה שיצרת בהגדרות. שכפול מחוץ לאתר לא מעתיק פעם שנייה מאגר מרוחק או מאגר שסומן ככבר מחוץ לאתר.",
  ...
  "repos.offsite": "כבר מחוץ לאתר",
  "repos.offsiteHint": "לשיתוף במכונה אחרת, למשל NAS שמשמש לאחסון קר. שכפול מחוץ לאתר משאיר אז את המאגר הזה בחוץ, כמו מאגר מרוחק, והגיבויים שלו לא מועתקים פעם שנייה. השאר את זה כבוי לדיסק או לשיתוף במכונה הזו, שעדיין צריכים את העותק מחוץ לאתר.",
  "repos.offsiteRemote": "מחוץ לאתר",
  "repos.offsiteRemoteHint": "מאגר מרוחק כבר נמצא מחוץ לאתר, ולכן שכפול מחוץ לאתר לעולם לא מעתיק אותו שוב.",
