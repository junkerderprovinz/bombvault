...
const he: Partial<Translations> = {
  ...
  "about.body": "אביר אחד, מסע צלב אחד: כלים חופשיים, יפים ובקוד פתוח, שלא היו קיימים בצורה שרציתי. נבנים עד שלא יחסר כלום. בלי חשבונות, בלי טלמטריה, בלי פרסומות. בלי תקופת ניסיון, בלי מסלולי תשלום, בלי כוכבית באותיות הקטנות. שום דבר קריא לא יוצא לעולם מהחומות שלך. נחשל בערבים ובסופי שבוע, בלב ובעקשנות.",
  "about.coffee": "אם BombVault מועיל לך, תרומה מכסה את מה שעולה להחזיק אותו באוויר: הדומיין, השרת והערבים שנכנסים אליו. והיא גם גורמת ללב של האביר הזה לפעום קצת יותר מהר. יש למטה שלוש דרכים, בחר את זו שמתאימה לך.",
