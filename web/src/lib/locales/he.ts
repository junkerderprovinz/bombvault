...
const he: Partial<Translations> = {
  ...
  "settings.labelsHint": "כמה מפקד תצוגה מוצג: המילים שלו, הסמל שלו או שניהם. כפתורים שומרים על אותו רוחב בשלושת המצבים, כך שמעבר אינו מסדר מחדש את הדף.",
  ...
  "settingsIO.chooseFile": "בחר קובץ הגדרות",
