...
const he: Partial<Translations> = {
  ...
  "settings.everythingOverlapWarning": "זה רץ באופן בלתי תלוי בלוחות הזמנים של כל תחום בנפרד למעלה. אם שניהם פעילים, ה-Containers, ה-VMs, ה-Flash, התיקיות והגיבוי העצמי מגובים כל אחד פעמיים: פעם כאן, פעם בלוח הזמנים שלו. כבה את התחומים שאתה לא רוצה שיוכפלו.",
