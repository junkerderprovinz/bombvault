...
const he: Partial<Translations> = {
  ...
  "files.empty": "אין עדיין ערכות קבצים. הוסף תיקייה — שיתופים, מסמכים, תמונות, כל דבר תחת נקודות העיגון שלך — ו-BombVault יגן עליה כמו על כל השאר: לוחות זמנים, עותקים מחוץ לאתר, בדיקות תקינות ושחזורים. אין צורך בכלי גיבוי קבצים נפרד.",
  "files.addSet": "הוסף ערכת קבצים",
  "files.editSet": "ערוך ערכת קבצים",
  "files.name": "שם",
  "files.path": "תיקייה",
  ...
  "files.deleteSetConfirm": "להסיר את ערכת הקבצים הזו מהרשימה? הגיבויים שלה לא יימחקו וניתן לגלות אותם מחדש מאוחר יותר.",
  "files.deleteBackupsConfirm": "למחוק את כל הגיבויים של ערכת הקבצים הזו? ה-snapshots יוסרו לצמיתות, המאגר ייגזם והערכה תישכח. לא ניתן לבטל.",
