...
const he: Partial<Translations> = {
  ...
  "settings.dashTileCa": "ייתכן שהוא זמין גם ב-Community Applications — חפשו BombVault Dashboard.",
  "settings.dashTileNotInstalled": "תוסף אריח לוח הבקרה אינו מותקן.",
  "settings.dashTileConfirm": "התקנה מתקינה את התוסף bombvault-dashboard על מארח ה-Unraid שלכם דרך מנגנון התוספים הרגיל של Unraid. הוא מופיע תחת Plugins כמו כל תוסף אחר וניתן להסירו שם (או כאן) בכל עת.",
