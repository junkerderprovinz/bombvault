...
const he: Partial<Translations> = {
  ...
  "takeover.backup": "גיבוי אחד",
  "takeover.backups": "{n} גיבויים",
  "takeover.accept": "מזג",
  ...
  "takeover.historyOne": "הגיבוי של {old} הופך לחלק מההיסטוריה של {new}.",
  "takeover.historyMany": "{n} הגיבויים של {old} הופכים לחלק מההיסטוריה של {new}.",
