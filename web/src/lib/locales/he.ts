...
const he: Partial<Translations> = {
  ...
  "runReason.dbimportAppsDown": "לא ניתן היה להפעיל מחדש את היישומים האלה: {apps}",
  "runReason.dbimportAppsStopped": "היישומים האלה נשארים עצורים עד שתיקיית הנתונים תוסדר: {apps}",
  ...
  "dbdump.stackRestoreWarn": "הנתונים של {names} מועתקים בזמן שהערימה פועלת. אחרי השחזור, ייבא את ההיטל העדכני ביותר של בסיס הנתונים שלהם לפני שתשתמש ביישומים.",
  "dbdump.introNotice": "BombVault מייצר היטל של בסיסי הנתונים שהוא מזהה לפני כל גיבוי, כנקודות שחזור עצמאיות. זוהו כאן: {count}, הראשון הוא {name}. אפשר לכבות זאת לכל מכולה בכרטיס שלה או לכל המכולות בהגדרות.",
  ...
  "dbdump.importStopsOne": "במהלך הייבוא BombVault עוצר גם את {app}. לאחר מכן הוא מפעיל אותו מחדש, אלא אם הייבוא נכשל ואי אפשר להחזיר את הנתונים הישנים.",
  "dbdump.importStopsMany": "במהלך הייבוא BombVault עוצר גם את היישומים האלה: {apps}. לאחר מכן הוא מפעיל אותם מחדש, אלא אם הייבוא נכשל ואי אפשר להחזיר את הנתונים הישנים.",
  ...
  "recovery.foreignDbDumps": "גיבויי SQL במאגר הזה: {count}. הוצא אחד עם שורת הפקודה של restic, כפי שמתארת ערכת השחזור.",
  ...
  "recovery.dumpOnlySkipped": "מסדי נתונים ששמורים רק כגיבוי SQL נשארים כאן בחוץ: {count}. שחזר וייבא אותם מהרשימה שלהם.",
