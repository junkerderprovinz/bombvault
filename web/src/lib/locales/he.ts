...
const he: Partial<Translations> = {
  ...
  "excludes.advisoryImmichDb": "Immich שומר את האלבומים, הפנים והתאריכים של כל תמונה במסד נתונים PostgreSQL שרץ בקונטיינר נפרד לגמרי, ולכן הגיבוי הזה לא מכיל אותו. שחזור מכאן מחזיר את התמונות בלי כל זה. תן למסד הנתונים הזה גיבוי משלו, או הפעל את ייצוא מסד הנתונים המובנה של Immich כדי שיגיע לתיקייה שהגיבוי הזה מכסה.",
  "excludes.advisoryNextcloudDb": "Nextcloud שומר את החשבונות, השיתופים והתגיות שלו במסד נתונים שרץ בדרך כלל בקונטיינר נפרד, ולכן הגיבוי הזה לא מכיל אותו. הקבצים חוזרים, השיתופים לא. גבה גם את מסד הנתונים הזה.",
  ...
  "dbdump.introNotice": "BombVault מייצר היטל של {count} בסיסי נתונים מזוהים לפני כל גיבוי, כנקודות שחזור עצמאיות. אפשר לכבות זאת לכל מכולה בכרטיס שלה או לכל המכולות בהגדרות.",
  ...
  "dbdump.fixRepository": "מאגר הגיבויים לא קיבל את ההיטל, או שמר פחות בתים ממה שיוצא. בדוק את המאגר בהגדרות, אחסון; ייעשה ניסיון נוסף בגיבוי הבא.",
  ...
  "recovery.dumpOnlySkipped": "{count} מסדי נתונים ששמורים רק כגיבוי SQL נשארים בחוץ; שחזר וייבא אותם מהרשימה שלהם.",
