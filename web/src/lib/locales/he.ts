...
const he: Partial<Translations> = {
  ...
  "dbdump.importStopsOne": "במהלך הייבוא BombVault עוצר גם את {app} ומפעיל אותו מחדש לאחר מכן.",
  "dbdump.importStopsMany": "במהלך הייבוא BombVault עוצר גם את היישומים האלה ומפעיל אותם מחדש לאחר מכן: {apps}.",
