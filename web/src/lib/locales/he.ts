...
const he: Partial<Translations> = {
  ...
  "settings.offsiteHint": "אחרי כל גיבוי מקומי מוצלח, לשכפל אותו גם למאגר שני באמצעות restic copy. הזינו מאגר מרוחק (rest:http://host:8000/repo, s3:…) או נתיב משנה מקומי; השאירו ריק כדי להשבית. הגיבוי המקומי נשאר הראשי.",
  "source.label": "מקור:",
  "source.local": "מקומי",
  ...
  "pull.repoLocationHint": "המאגר של מופע המקור: rest:, s3:, sftp:, או תת-נתיב תחת נקודת העגינה של המארח. מיקום rclone: נדחה, מפני ש-rclone היה מגיע אליו דרך ה-remotes של מופע זה.",
  ...
  "pull.credsHint": "פרטי הכניסה לאחסון שעליו נמצא המאגר של המקור: s3: או שרת rest: עם סיסמה. משיכה לעולם אינה משתמשת בפרטים של המכונה הזו, ולכן מקור שזקוק לכניסה ואין לו בחירה כאן יידחה.",
  ...
  "repos.locationPlaceholder": "backups/cold או s3:s3.eu-central-003.backblazeb2.com/bucket/path",
  "repos.locationHint": "תיקייה מתחת לנקודת העגינה של המארח, או מאגר restic מרוחק כמו s3:..., sftp:..., rest:... או rclone:... אל המרוחק נכתב ישירות, בלי עותק מקומי ביניים.",
  ...
  "repos.offPremises": "מחוץ למבנה",
  "repos.offPremisesHint": "נספר כאתר משלו לצורך האתרים וכלל 3-2-1 בכרטיסים. זה לא משפיע על העותקים. שרת rest-server באותו מבנה צריך שזה יהיה כבוי אצלו.",
  ...
  "placementCode.copyRuleTaken": "לשם הזה כבר יש כללי העתקה משלו.",
  ...
  "placement.titleHint": "היכן נכתבים הגיבויים של הפריט הזה ולאן הם מועתקים לאחר מכן. המיקום קבוע מהגיבוי הראשון, אפשר לשנות את ההעתקים בכל עת.",
  "placement.unreadable": "לא ניתן היה לקרוא את המיקום",
  "placement.noCopyNow": "אין העתק כרגע, כבוי: {targets}. סמן יעד או בחר מקומי.",
  "placement.followsDefault": "עוקב אחרי ברירת המחדל",
  "placement.ownCopies": "העתקים משלו",
  "placement.homeSet": "מיקום נקבע: {home}",
  "placement.copiesFollow": "ההעתקים עוקבים אחרי ברירת המחדל",
  "placement.reset": "איפוס",
  ...
  // Timeline
  "timeline.deleteAsk": "למחוק את הגיבוי הזה כאן: {list}?",
  ...
  "timeline.onlyHere": "כאן בלבד",
  "timeline.incomplete": "לא שלם",
  "timeline.incompleteHint": "לא כל הדיסקים של ריצה זו נמצאים כאן, כך שמקום זה אינו נבחר לשחזור.",
  "timeline.snapshotMissing": "ל-{place} כבר אין את הגיבוי הזה. לשחזר מ-{next}?",
  "timeline.stackDirMissing": "תיקיית הפרויקט אינה נמצאת ב-{place}. להשתמש במצב מ-{home}?",
  // Direct repository
  ...
  "placementDefaults.homeOff": "{home} כבוי. פריטים בלי מיקום לא מגובים עד שהוא יופעל שוב או שברירת המחדל תשתנה.",
  "placementDefaults.homeMissing": "ברירת המחדל מצביעה על מאגר שכבר לא קיים. פריטים בלי מיקום לא מגובים.",
  "placementDefaults.confirmHome": "פריטים חדשים ב-{domain} מקבלים את {home} בגיבוי הראשון שלהם. פריטים עם מיקום שומרים עליו.",
  "placementDefaults.dropAsk": "פריטים ותיקיות פרויקט ש-{target} כבר לא מקבל: {n}. עותקים שנשארים שם: {copies}.",
  "placementDefaults.dropAskUnknown": "פריטים ותיקיות פרויקט ש-{target} כבר לא מקבל: {n}. {target} מעולם לא הופיע ברשימה של תחום זה, כך שעדיין לא ידוע כמה עותקים נשארים שם.",
  "placementDefaults.addAsk": "פריטים ותיקיות פרויקט ש-{target} מקבל מעכשיו: {n}. תצלומים שיועלו בהרצה הבאה: עד {snapshots} לכל היותר.",
  "placementDefaults.openTakeHome": "פריטים בלי מיקום שמקבלים את {home} בגיבוי הראשון שלהם: {n}.",
  "placementDefaults.apply": "החלה על פריטים בלי גיבויים",
  "placementDefaults.applyAsk": "המיקום והעותקים חוזרים לברירת המחדל עבור הפריטים האלה: {n}.",
  "placementDefaults.applyLoses": "מאבדים בכך את הבחירה שלהם: {list}",
  "placementDefaults.applyKeptBackups": "נשארים כפי שהם, יש להם גיבויים: {list}",
  "placementDefaults.applyKeptUnreadable": "נשארים כפי שהם, המיקום שלהם לא ניתן היה לקרוא: {list}",
  "placementDefaults.applyKeptChanged": "השתנו בינתיים ונשארו ללא נגיעה: {list}",
  "placementDefaults.applyNone": "אין פריט בלי גיבויים שנבדל מברירת המחדל.",
  "placementDefaults.applyBusy": "גיבוי פועל כרגע. יש להחיל שוב אחרי שהוא יסתיים.",
  "placementDefaults.paused": "מחוץ לאתר מושהה אחרי בנייה מחדש",
  "placementDefaults.pausedHint": "כללים וברירות מחדל אבדו עם התצורה הישנה. שום דבר מ-{domain} לא מועתק מחוץ לאתר עד שברירת המחדל הזו תאושר. אפשר להגדיר פריטים עם כרטיס למקומי תחילה.",
  "placementDefaults.confirm": "אישור ברירת המחדל",
  "placementDefaults.confirmAsk": "בהרצה הבאה, זה מה שיועתק:",
  "placementDefaults.unmatched": "שמות בגיבויים שאין להם רשומה כאן. המסומנים יושארו בחוץ:",
  "placementDefaults.unmatchedLine": "{name}, תצלומים: {n}",
  "placementDefaults.confirmed": "ברירת המחדל אושרה. עותקים מחוץ לאתר ימשיכו בהרצה הבאה.",
  ...
  "placement.older": "עותקים ישנים יותר ב-{target}: {n}, נראה לאחרונה {date}",
  "placement.noCopyYet": "{place}: אין עדיין עותק",
  "placement.notListedYet": "{place}: עדיין לא רשום",

  // Removal
  "offsiteRemoval.delete": "מחיקה ב-{target}",
  "offsiteRemoval.ask": "למחוק כל עותק של {name} ב-{target}? עותקים: {n}.",
  "offsiteRemoval.onlyThere": "התצלומים האלה לא קיימים בשום מקום אחר ויעלמו לצמיתות לאחר מכן:",
